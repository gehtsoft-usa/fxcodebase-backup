...
function Init() --The strategy profile initialization
    strategy:name("Stochastic Overbought/Oversold strategy")
    strategy:setTag("NonOptimizableParameters", "Email,SendEmail,SoundFile,RecurrentSound,PlaySound,ShowAlert")
    strategy:description("Stochastic Overbought/Oversold strategy")
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if Stochastic.K[period - 1] > instance.parameters.UpLevel and Stochastic.K[period] < instance.parameters.UpLevel then
    ...
    if Stochastic.K[period - 1] < instance.parameters.DownLevel and Stochastic.K[period] > instance.parameters.DownLevel then
        if instance.parameters.TypeSignal == "direct" then
            MustOpenB = true
        else
            MustOpenS = true
