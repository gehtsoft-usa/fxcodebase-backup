...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=63814
...
function Init()
    indicator:name("Larry Williams' Percent Range MA Cross Alert");
    indicator:description("");
    indicator:requiredSource(core.Bar);
    indicator:type(core.Oscillator);
   

    indicator.parameters:addGroup("RLW Calculation");
