...
function Prepare(nameOnly) 
	...
	local name = profile:id() .. "(" .. source:name() .. ", " .. Multiplier	..  ")";
    instance:name(name);
	if   (nameOnly) then
        return;
    end
	
	Output = instance:addStream("Output", core.Line, name, "", instance.parameters.color, first);
...
function Update(period, mode)
    ...
    Output[period]= source[period]*Multiplier;
