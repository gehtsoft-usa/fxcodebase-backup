...
function Prepare(nameOnly)
    ...
    if (not (nameOnly)) then
		...
		Cumulative= instance:addStream("Cumulative", core.Bar, name .. ".Cumulative", "Cumulative", instance.parameters.Up, first);
		Cumulative:addLevel (0)
    Cumulative:setPrecision(math.max(2, instance.source:getPrecision()));
		elseif Method == "Absolute" then
		Up = instance:addInternalStream(0, 0);
		Down = instance:addInternalStream(0, 0);
		Absolute= instance:addStream("Absolute", core.Bar, name .. ".Absolute Cumulative", "Absolute Cumulative", instance.parameters.Up, first);
		Absolute:addLevel (0)
