...
function Init()
    indicator:name("Previous Candle Body Swing Candle View");
    indicator:description("A chart will add a new Candle show the new candle when the price goes above or below the previous candle.");
   ...
   return;
    ...
    if period== 1 then 	
		...
		LastCandle=period;
	         ...
	         if (History.close[period] > math.max(History.open[period-1],History.close[period-1])		 
			 or History.close[period] < math.min(History.open[period-1],History.close[period-1] ))		
