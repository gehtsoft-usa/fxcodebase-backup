...
{ 
    {
        ...
        UpCondition = function (period)
            ...
            return core.crossesOver(pgo, instance.parameters.overbought_level, period);
        end,
        DownCondition = function (period)
            if period == 0 then
                return false;
            end
            return core.crossesUnder(pgo, instance.parameters.overbought_level, period);
        end,
        FormatMessage = function(source, period, level, label, isUp)
            return string.format(
                ...
                "Price: %s\013\010" .. 
                "Date: %s", 
                isUp and (label .. " Cross over") or (label .. " Cross under"), 
                source:instrument(), 
                source:barSize(), 
    ...
    },
    {
        ...
        UpCondition = function (period)
            ...
            return core.crossesOver(pgo, instance.parameters.oversold_level, period);
        end,
        DownCondition = function (period)
            if period == 0 then
                return false;
            end
            return core.crossesUnder(pgo, instance.parameters.oversold_level, period);
        end,
        FormatMessage = function(source, period, level, label, isUp)
            return string.format(
                "Label: %s\013\010" ..
    ...
    },
    {
        ...
        UpCondition = function (period)
            ...
            return core.crossesOver(pgo, instance.parameters.custom_level, period);
        end,
        DownCondition = function (period)
            if period == 0 then
                return false;
            end
            return core.crossesUnder(pgo, instance.parameters.custom_level, period);
        end,
        FormatMessage = function(source, period, level, label, isUp)
            return string.format(
                "Label: %s\013\010" ..
...
function Init()
    ...
    indicator.parameters:addDouble("oversold_level", "Oversold level", "", -3);
    indicator.parameters:addColor("os_color", "Oversolf Color", "Color", core.colors().Green);
    indicator.parameters:addInteger("os_width", "Oversolf Width", "Width", 1, 1, 5);
    indicator.parameters:addInteger("os_style", "Oversolf Style", "Style", core.LINE_SOLID);
    indicator.parameters:setFlag("os_style", core.FLAG_LINE_STYLE);

    indicator.parameters:addDouble("overbought_level", "Overbought level", "", 3);
    indicator.parameters:addColor("ob_color", "Overbought Color", "Color", core.colors().Red);
    indicator.parameters:addInteger("ob_width", "Overbought Width", "Width", 1, 1, 5);
    indicator.parameters:addInteger("ob_style", "Overbought Style", "Style", core.LINE_SOLID);
    indicator.parameters:setFlag("ob_style", core.FLAG_LINE_STYLE);

    indicator.parameters:addDouble("custom_level", "Custom Level", "", 0);
    indicator.parameters:addColor("custom_color", "Custom Level Color", "Color", core.colors().Red);
    indicator.parameters:addInteger("custom_width", "Custom Level Width", "Width", 1, 1, 5);
    indicator.parameters:addInteger("custom_style", "Custom Level Style", "Style", core.LINE_SOLID);
    indicator.parameters:setFlag("custom_style", core.FLAG_LINE_STYLE);
...
function Prepare(nameOnly)
    ...
    pgo:addLevel(instance.parameters.oversold_level, instance.parameters.os_style, instance.parameters.os_width, instance.parameters.os_color);
    pgo:addLevel(instance.parameters.overbought_level, instance.parameters.ob_style, instance.parameters.ob_width, instance.parameters.ob_color);
    pgo:addLevel(instance.parameters.custom_level, instance.parameters.custom_style, instance.parameters.custom_width, instance.parameters.custom_color);
