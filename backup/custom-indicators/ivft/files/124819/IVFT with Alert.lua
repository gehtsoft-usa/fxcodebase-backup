...
function Init()
	...
	indicator.parameters:addDouble("TL", "Top Line", "", 0.5);
	indicator.parameters:addDouble("BL", "Bottom Line", "", -0.5);
...
function Activate (id, period)
   ...
   Alert[id][period]=0;
	  ...
	  if id == 2  and ON[id]  then
			...
			if  Value[period] > TL
			and   Value[period-1] <= TL
			then
			           
						    
         
                Alert[id][period]= 1;	
 				AlertLevel[id][period]=  TL;
	  ...
	  if id == 3  and ON[id]  then
			...
			if  Value[period] > BL
			and   Value[period-1] <= BL
			then
			           
						    
         
                Alert[id][period]= 1;	
 				AlertLevel[id][period]=  BL;
