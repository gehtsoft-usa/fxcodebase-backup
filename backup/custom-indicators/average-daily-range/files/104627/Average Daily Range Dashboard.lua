...
function CreateIndicators(source)
    ...
    p:setInteger("N", instance.parameters.N);
    p:setDouble("Multiplier", instance.parameters.Multiplier);
...
function GetLastSignal(indi, source)
    return 0, win32.formatNumber(indi[1].DATA[NOW], false, 2);
end
