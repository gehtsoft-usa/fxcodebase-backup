...
function Prepare(nameOnly)
    ...
    firstPeriod = source:first()+ SSP*2 + SSK;
    ...
    SL = instance:addStream("SL", core.Line, name .. ".SL", "SL", instance.parameters.clrTS, firstPeriod)
    if M then
	ML = instance:addStream("ML", core.Line, name .. ".ML", "ML", instance.parameters.clrKS, firstPeriod)	
    ...
    SA = instance:addStream("SA", core.Line, name .. ".SA", "SA", instance.parameters.clrSSA, firstPeriod)
    SB = instance:addStream("SB", core.Line, name .. ".SB", "SB", instance.parameters.clrSSB,  firstPeriod)
