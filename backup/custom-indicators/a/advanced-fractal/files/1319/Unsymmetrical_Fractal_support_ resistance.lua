...
function Init()
    ...
    indicator.parameters:addInteger("Left", "Number of fractals (Left)", "", 5, 5,99);
    indicator.parameters:addInteger("Right", "Number of fractals (Right) ", "", 5, 5,99);	
    indicator.parameters:addInteger("Shift", "Shift ", "Shift", 5, 5,99);		
	indicator.parameters:addInteger("Lenght", "Length", "", 50, 1, 1000);
