...
function Init()
    ...
    indicator.parameters:setFlag("frame", core.FLAG_BARPERIODS_EDIT)
    ...
    indicator.parameters:setFlag("atr_frame", core.FLAG_BARPERIODS_EDIT)
...
function Prepare(onlyName)
    ...
    atr_source = core.host:execute("getHistory", 1001, instrument, instance.parameters.atr_frame, instance.parameters.from_atr, instance.parameters.to, instance.parameters.type)
