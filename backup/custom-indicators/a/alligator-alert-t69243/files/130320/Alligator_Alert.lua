...
--http://fxcodebase.com/code/viewtopic.php?f=17&t=69243
...
{ 
    {
        ...
        UpCondition = function (period)
            if period == 0 
                or not indi.Jaw:hasData(period - 1) 
                or not indi.Lips:hasData(period - 1)
                or not indi.Teeth:hasData(period - 1)
            then
                return false;
            end
            return core.crossesUnder(source.close, indi.Teeth, period);
        end,
        DownCondition = function (period)
            ...
            return core.crossesOver(source.close, indi.Teeth, period);
        end,
    ...
    },
    {
        ...
        UpCondition = function (period)
            ...
            return indi.Jaw[period] > indi.Jaw[period - 1]
                and indi.Lips[period] > indi.Lips[period - 1]
                and indi.Teeth[period] > indi.Teeth[period - 1];
        end,
        DownCondition = function (period)
            if period == 0 
                or not indi.Jaw:hasData(period - 1) 
...
function Init()
    indicator:name("Alligator Alert");
    ...
    indicator.parameters:addColor("jaw_color", "Jaw Color", "Jaw Color", core.colors().Red);
    indicator.parameters:addInteger("jaw_width", "Jaw Width", "Jaw Width", 1, 1, 5);
    indicator.parameters:addInteger("jaw_style", "Jaw Style", "Jaw Style", core.LINE_SOLID);
    indicator.parameters:setFlag("jaw_style", core.FLAG_LINE_STYLE);

    indicator.parameters:addColor("lips_color", "Lips Color", "Lips Color", core.colors().Green);
    indicator.parameters:addInteger("lips_width", "Lips Width", "Lips Width", 1, 1, 5);
    indicator.parameters:addInteger("lips_style", "Lips Style", "Lips Style", core.LINE_SOLID);
    indicator.parameters:setFlag("lips_style", core.FLAG_LINE_STYLE);

    indicator.parameters:addColor("teeth_color", "Teeth Color", "Teeth Color", core.colors().Blue);
    indicator.parameters:addInteger("teeth_width", "Teeth Width", "Teeth Width", 1, 1, 5);
    indicator.parameters:addInteger("teeth_style", "Teeth Style", "Teeth Style", core.LINE_SOLID);
    indicator.parameters:setFlag("teeth_style", core.FLAG_LINE_STYLE);
...
function Prepare(nameOnly)
    ...
    indi = core.indicators:create("ALLIGATOR", source, instance.parameters.JawN, instance.parameters.JawS,
        instance.parameters.TeethN, instance.parameters.TeethS,
        instance.parameters.LipsN, instance.parameters.LipsS);

    jaw = instance:addStream("Jaw", core.Line, "Jaw", "Jaw", instance.parameters.jaw_color, 0, 0);
    jaw:setWidth(instance.parameters.jaw_width);
    jaw:setStyle(instance.parameters.jaw_style);

    lips = instance:addStream("Lips", core.Line, "Lips", "Lips", instance.parameters.lips_color, 0, 0);
    lips:setWidth(instance.parameters.lips_width);
    lips:setStyle(instance.parameters.lips_style);

    teeth = instance:addStream("Teeth", core.Line, "Teeth", "Teeth", instance.parameters.teeth_color, 0, 0);
    teeth:setWidth(instance.parameters.teeth_width);
    teeth:setStyle(instance.parameters.teeth_style);
end
...
function Update(period, mode)
    indi:update(mode);
    jaw[period] = indi.Jaw[period];
    lips[period] = indi.Lips[period];
    teeth[period] = indi.Teeth[period];
