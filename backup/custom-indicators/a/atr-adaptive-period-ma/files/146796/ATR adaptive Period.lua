...
function Init()
    indicator:name("ATR adaptive Period");
...
function Update(period, mode)
	...
	local min,max, pmin, pmax= mathex.minmax(Indicator.DATA, period-Period+1,period);
	
		
     Oscillator[period]=math.abs(pmin - pmax);
