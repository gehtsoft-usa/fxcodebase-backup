...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=71508
...
function Init()
    indicator:name("Average Period Up Down Change Ratio");
...
function Update(period, mode)
    ...
    Up[period]= mathex.avg(ChangeUp, period-Period+1, period)/(mathex.sum(ChangeUp, period-Period+1, period)/mathex.sum(SumUp, period-Period+1, period));
	Down[period]= mathex.avg(ChangeDown, period-Period+1, period)/(mathex.sum(ChangeDown, period-Period+1, period)/mathex.sum(SumDown, period-Period+1, period));
