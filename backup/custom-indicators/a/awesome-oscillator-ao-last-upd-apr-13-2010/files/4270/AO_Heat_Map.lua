...
function Init()
    indicator:name("MTF MCP AO Heat Map");
	...
	indicator.parameters:addColor("UpDown", "Down in Up Trend Color","", core.rgb(255, 0, 0));
	indicator.parameters:addColor("DownUp", "Up in Down Trend Color","", core.rgb(0, 200, 0));
	...
	s2, e2 = core.getcandle(iTF[i], 0, 0, 0);
	 ...
	 Label[Number]="";
                ...
                Label[Number]=Label[Number] .. " - " ..  TF[Number];				
			  	...
			  	Temp1= core.indicators:create("AO", source ,  FM[Number] ,  SM[Number]);  				
				ifirst= Temp1.DATA:first()*2;
				 ...
				 loading[Number]  = true;  	 
				 Indicator[Number] = core.indicators:create("AO", SourceData[Number]  ,  FM[Number] ,  SM[Number]);   
