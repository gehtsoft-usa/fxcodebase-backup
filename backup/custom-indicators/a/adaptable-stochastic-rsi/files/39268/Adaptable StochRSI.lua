...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=22756
...
local MVA1 = nil;
local MVA2 = nil;
local N1, N2, P1,P2,Method1, Method2;
-- Routine
function Prepare(nameOnly)
    ...
    local name = profile:id() .. "(" .. source:name() .. ", " .. N .. ", " .. K .. ", " .. N1.. ", " .. Method1 .. ", " .. N2 ..", " .. Method2.. ")";
    instance:name(name);
    if nameOnly then
        return;
    end
