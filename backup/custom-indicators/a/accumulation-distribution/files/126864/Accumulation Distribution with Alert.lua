...
function Init()
	...
	Parameters (1, "Accumulation Distribution");	
...
function Activate (id, period)
   ...
   Alert[id][period]=0;
	  ...
	  if id == 1  and ON[id]  then
			...
			if  Accumulation[period] > Distribution[period] 
			and   Accumulation[period-1] <= Distribution[period-1] 
			then
			           
						    
         
                Alert[id][period]= 1;	
 				AlertLevel[id][period]= Distribution[period] 
			...
			elseif  Accumulation[period] < Distribution[period] 
			and   Accumulation[period-1] >= Distribution[period-1]
            then			
