...
function Init()
    ...
    indicator.parameters:addColor("clr1Up", "Color 1 Up", "Color 1 Up", core.rgb(0, 255, 0));
    indicator.parameters:addColor("clr2Up", "Color 2 Up", "Color 2 Up", core.rgb(255, 0, 0));
    indicator.parameters:addColor("clr3Up", "Color 3 Up", "Color 3 Up", core.rgb(0, 0, 255));
    indicator.parameters:addColor("clr1Dn", "Color 1 Dn", "Color 1 Dn", core.rgb(0, 180, 0));
    indicator.parameters:addColor("clr2Dn", "Color 2 Dn", "Color 2 Dn", core.rgb(180, 0, 0));
    indicator.parameters:addColor("clr3Dn", "Color 3 Dn", "Color 3 Dn", core.rgb(0, 0, 180));
end
...
function Update(period, mode)
   ...
   return;
    ...
    Stoch:update(mode);
    if Stoch.K[period]>Stoch.D[period] then
			 if Stoch.D[period]<Level1 then
			open:setColor(period, instance.parameters.clr1Up);	  
			elseif Stoch.D[period]>=Level1 and Stoch.D[period]<=Level2 then
			open:setColor(period, instance.parameters.clr2Up);  
			elseif Stoch.D[period]>Level2 then
			open:setColor(period, instance.parameters.clr3Up); 
			end
    else
			if Stoch.D[period]<Level1 then
			open:setColor(period, instance.parameters.clr1Dn);	  
			elseif Stoch.D[period]>=Level1 and Stoch.D[period]<=Level2 then
			open:setColor(period, instance.parameters.clr2Dn);  
			elseif Stoch.D[period]>Level2 then
			open:setColor(period, instance.parameters.clr3Dn); 
			end
    end 
