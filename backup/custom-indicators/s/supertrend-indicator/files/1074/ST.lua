...
-- Routine
 function Prepare(nameOnly)   
    ...
    Tr = instance:addStream("UP", core.Line, name .. ".UP", "UP", instance.parameters.UP_color, first);
   	Tr:setWidth(instance.parameters.width);
    Tr:setStyle(instance.parameters.style);
    ...
    if period >= first then
        ...
        if period >= first + 1 then
			...
			Tr[period] = DN[period];
              ...
              Tr:setColor(period, instance.parameters.UP_color);
            end

            if TR[period] == -1 then
			  Tr[period] = UP[period];
                Tr:setColor(period, instance.parameters.DN_color);
            end
        end
    end
end
