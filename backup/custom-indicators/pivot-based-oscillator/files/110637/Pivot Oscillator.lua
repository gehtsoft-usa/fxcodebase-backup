...
function Init()
    indicator:name("Pivot Oscillator");
...
function Prepare(nameOnly)
	...
	ma3 = core.indicators:create(Method3, source.typical, Period3);
...
Also all MA (Fast, Medium and Slow) are calculated (H + L + C) / 3 instead of (H+L)/2.
	...
	local Differential3= ma1.DATA[period]-ma2.DATA[period];
        ...
        PP[period] = (Differential1+Differential2+Differential3)/source.typical[period];
