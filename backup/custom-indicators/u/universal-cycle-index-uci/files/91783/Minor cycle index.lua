...
function Init()
    indicator:name("Minor cycle index");
    ...
    indicator.parameters:addInteger("SummarizingPeriod", "Summarizing Period", "Summarizing Period", 50);
	 ...
	 indicator.parameters:addInteger("Short", "Short MA Period", "Short MA Period", 6);
	 indicator.parameters:addInteger("Long", "Long MA Period", "Long MA Period", 12);
