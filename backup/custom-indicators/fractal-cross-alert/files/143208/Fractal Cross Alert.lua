...
local Number = 2;
local Symbols={"\225","\226" };
local Font={"Wingdings", "Wingdings" };
local Alert_Name={ "Top Fractal Level" ,"Bottom Fractal Level" };
...
function Init()
    indicator:name("Fractal Cross Alert");
       ...
       Top, Bottom= FindLast(period);
	    ...
	    if id== 1  then   
			...
			then
                ...
                Alert[id][period]= 1;	
 				AlertLevel[id][period]=source.high[Top]
		...
		if id== 2   then  
			...
			then
                ...
                Alert[id][period]= 1;	
 				AlertLevel[id][period]= source.low[Bottom]
				Alignment[id][period]= 1;		   
