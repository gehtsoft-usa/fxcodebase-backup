...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=73159
...
function Init()
    indicator:name("Heiken Ashi Delta");
    ...
    indicator.parameters:addInteger("Period2", "MA Period", "", 3, 1, 2000);
...
-- Routine
 function Prepare(nameOnly)   
    ...
    Signal = instance:addStream("Signal", core.Line, name, "Signal", instance.parameters.color2, first+Period2 );
...
function Update(period, mode)
	...
	Delta[period]= xClose[period]-xClose[period-Period1];
	...
	Signal[period]= mathex.avg(Delta, period-Period2+1, period);
end
