...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=23133
...
function Prepare(nameOnly)
    ...
    Clear:setPrecision(math.max(2, instance.source:getPrecision()));
