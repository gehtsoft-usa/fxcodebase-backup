...
function Init()
    ...
    indicator.parameters:addColor(
        "UPHISTOGRAM_color",
        "Up Histogram color",
        "The color of Up Histogram.",
        core.rgb(0, 255, 0)
    )
    indicator.parameters:addColor(
        "DOWNHISTOGRAM_color",
        "Down Histogram color",
        "The color of Down Histogram.",
        core.rgb(255, 0, 0)
    )
...
function Prepare(nameOnly)
    ...
    if MH then
        ...
        OUT =
            ...
            name .. ".MACD",
            "MACD",
            instance.parameters.MACD_color_UP,
            firstPeriodMACD
        )
    ...
    if not MH then
        SIGNALOUT =
            ...
            name .. ".SIGNAL",
            "SIGNAL",
            instance.parameters.SIGNAL_color,
            firstPeriodSIGNAL
        )
        ...
        if Type == "Absolute" then
            HISTOGRAM =
                ...
                name .. "HISTOGRAM",
                "HISTOGRAM",
                instance.parameters.UPHISTOGRAM_color,
                firstPeriodSIGNAL
            )
