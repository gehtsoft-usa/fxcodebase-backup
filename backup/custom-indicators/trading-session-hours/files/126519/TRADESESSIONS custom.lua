...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=1974&start=50
...
function Init()
    indicator:name("The indicator highlights custom trade sessions");
    ...
    indicator.parameters:addBoolean("NY_L", "Show session labels", "", true);	
    indicator.parameters:addString("NY_Start", "Session Start", "", "08:00:00");
    indicator.parameters:addString("NY_End", "Session End", "", "17:00:00");
    indicator.parameters:addBoolean("NY_show_median_line", "Show median line", "", false);
    indicator.parameters:addBoolean("NY_extend", "Extend to EOD", "", false);
    indicator.parameters:addColor("NY_C", "Session color", "", core.rgb(255, 0, 0));
...
function Prepare(nameOnly)
    ...
    Start, valid = ParseTime(instance.parameters.NY_Start);
    assert(valid, "Time " .. instance.parameters.NY_Start .. " is invalid");
    End, valid = ParseTime(instance.parameters.NY_End);
    assert(valid, "Time " .. instance.parameters.NY_End .. " is invalid");

    new_york = CreateSession(Start
        , End
...
function CreateSession(from, to, color, name, iname, labels, show_median_line, extend)
    local session = {};
    local n;
