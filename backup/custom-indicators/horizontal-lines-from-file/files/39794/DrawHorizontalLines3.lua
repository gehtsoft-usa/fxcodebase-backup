...
function Init()
    ...
    indicator.parameters:addInteger("widthLin2", "Multiple Line width", "Multiple Line width", 2, 1, 5);
...
function CheckPrice(Price)
 local ii;
 PriceArray[PriceCount]=Price;
 for ii=1,PriceCount-1,1 do
  if Price==PriceArray[ii] then
   return true;
  end
 end
 return false;
...
function DrawLine(id, Str)
 ...
 if CheckPrice(Price) then
  Width=instance.parameters.widthLin2;
 end
