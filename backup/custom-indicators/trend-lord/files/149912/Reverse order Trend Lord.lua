...
function Init()
    indicator:name("Reverse order Trend Lord");
    ...
    indicator.parameters:setFlag("style", core.FLAG_LINE_STYLE);
	 ...
	 indicator.parameters:addColor("color1", "Up Line in Up Trend Color", "", core.rgb(0, 255, 0)); 
	 indicator.parameters:addColor("color2", "Down Line in Up Trend Color", "", core.rgb(0, 200, 0));   
end
...
-- Routine
 function Prepare(nameOnly)   
	...
	Indicator1= core.indicators:create(Method, source,   math.sqrt(Period) );
