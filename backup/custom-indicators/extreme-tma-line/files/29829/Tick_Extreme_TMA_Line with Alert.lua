   ...
   if Live~= "Live" then
	...
	Shift=1;
	  ...
	  if id == 1  and ON[id]  then
			...
			if  source[period] > TMA[period] 
			and   source[period-1] <= TMA[period-1] 
			then
			...
			elseif  source[period] < TMA[period] 
			and   source[period-1] >= TMA[period-1] 
            then			
	   ...
	   if id == 2  and ON[id]  then
			...
			if  source[period] > Upper[period] 
			and   source[period-1] <= Upper[period-1] 
			then
			...
			elseif  source[period] < Upper[period] 
			and   source[period-1] >= Upper[period-1] 
            then			
	   ...
	   if id == 3  and ON[id]  then
			...
			if  source[period] > Lower[period] 
			and   source[period-1] <= Lower[period-1] 
			then
			...
			elseif  source[period] < Lower[period] 
			and   source[period-1] >= Lower[period-1] 
            then			
