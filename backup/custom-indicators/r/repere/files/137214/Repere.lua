...
--http://fxcodebase.com/code/viewtopic.php?f=17&t=70360
...
local source;
local dema12, dema26, mm7, ema9, LigneMACDZR
local indi_alerts = {};
...
{ 
    {
        ...
        UpCondition = function (period)
            ...
            return source[period] > mm7.DATA[period]
                and mm7.DATA[period] > mm7.DATA[period - 1]
                and ema9.DATA[period] > ema9.DATA[period - 1]
        end,
...
function Prepare(nameOnly)
    ...
    local profile = core.indicators:findIndicator("DEMA");
    assert(profile ~= nil, "Please, download and install " .. "DEMA" .. ".LUA indicator");
    dema12 = core.indicators:create("DEMA", source, 12)
    dema26 = core.indicators:create("DEMA", source, 26)
    mm7 = core.indicators:create("MVA", source, 7)
    LigneMACDZR = instance:addInternalStream(0, 0);
    ema9 = core.indicators:create("EMA", LigneMACDZR, 9)
end
...
function Update(period, mode)
    dema12:update(mode)
    dema26:update(mode)
    LigneMACDZR[period] = dema12.DATA[period] - dema26.DATA[period];
    mm7:update(mode)
    ema9:update(mode)
