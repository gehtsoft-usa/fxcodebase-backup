...
function Init()
    ...
    indicator:name("Renko Chart Tick ATR");
    indicator:description("Renko Chart Tick ATR");
	...
	indicator.parameters:addString("atr_Method", "ATR MA Method", "Method" , "MVA");
    indicator.parameters:addStringAlternative("atr_Method", "MVA", "MVA" , "MVA");
    indicator.parameters:addStringAlternative("atr_Method", "EMA", "EMA" , "EMA");
    indicator.parameters:addStringAlternative("atr_Method", "LWMA", "LWMA" , "LWMA");
    indicator.parameters:addStringAlternative("atr_Method", "TMA", "TMA" , "TMA");
    indicator.parameters:addStringAlternative("atr_Method", "SMMA", "SMMA" , "SMMA");
    indicator.parameters:addStringAlternative("atr_Method", "KAMA", "KAMA" , "KAMA");
    indicator.parameters:addStringAlternative("atr_Method", "VIDYA", "VIDYA" , "VIDYA");
    indicator.parameters:addStringAlternative("atr_Method", "WMA", "WMA" , "WMA");
	
	
    indicator.parameters:addBoolean("smooth_ATR", "Use smoothing for ATR", "", false);
...
function Prepare(onlyName)
	...
	local atr_Method = instance.parameters.atr_Method;
    local smooth = "";
    if smooth_ATR then
    ...
    atr = core.indicators:create("TATR", atr_history, ATR_period,  atr_Method );
    if smooth_ATR then
