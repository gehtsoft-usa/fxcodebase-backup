...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=72148
...
function Init()
    ...
    indicator.parameters:addInteger("Period1", "Fast MA", "", 7, 1, 2000);
    indicator.parameters:addInteger("Period2", "Mid MA", "", 14, 1, 2000);
    indicator.parameters:addInteger("Period3", "Slow MA", "", 28, 1, 2000);	
...
-- Routine
 function Prepare(nameOnly)   
    ...
    local name = profile:id() .. "(" ..  instance.source:name().. "," ..  Period1.. "," ..  Period2.. "," ..  Period3.. "," ..  Method    .. ")";
    instance:name(name); 
...
function Update(period, mode)
	...
	Line1[period]= source[period]-Indicator1.DATA[period];
	Line2[period]= source[period]-Indicator2.DATA[period];
	Line3[period]= source[period]-Indicator3.DATA[period];	
end