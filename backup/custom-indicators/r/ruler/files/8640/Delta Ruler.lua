		...
		iCount=iCount+1;
	 	core.host:execute("drawLabel1", id, 200+(iCount-1)*100 ,  core.CR_LEFT, 40  +Shift, core.CR_TOP, core.H_Left, core.V_Center, Bold, Color,  Sorted[1][i]);	
			...
			id = id+1;	
				...
				core.host:execute("drawLabel1", id, 200+(iCount-1)*100 ,  core.CR_LEFT, 40+ Size*2  +Shift, core.CR_TOP, core.H_Left, core.V_Center, Bold, Color,  "No Data"	);			  
			    id = id+1;	
				else
			
					 if Rainbow then					 
					core.host:execute("drawLabel1", id, 200+(iCount-1)*100 ,  core.CR_LEFT, 40+ Size*2  +Shift, core.CR_TOP, core.H_Left, core.V_Center, Bold,  Coloring (( 100/8)*i, 50),  	string.format("%." .. 2 .. "f", Sorted[2][i])	);			  
					id = id+1;	
					else 
					core.host:execute("drawLabel1", id, 200+(iCount-1)*100 ,  core.CR_LEFT, 40+ Size*2  +Shift, core.CR_TOP, core.H_Left, core.V_Center, Bold, Color,  	string.format("%." .. 2 .. "f", Sorted[2][i])	);			  
					id = id+1;	
					 end
				end
		end	
