	    ...
	    if id == 2  and ON[id]  then
			...
			then
			 ...
			 D[id] = nil;
							  ...
							  U[id]=source:serial(period);
							  SoundAlert(Up[id]);
							  EmailAlert(  Label[id], " Oversold Exit  ", period);
							  SendAlert(" Oversold Exit ");  
							  Pop(Label[id], " Oversold Exit " );  	
								    
								 
							  end
			elseif  Signal[period] == 0
			and  Signal[period-1] == 1 
            ...
            then			
		     ...
		     U[id] = nil;
							 ...
							 D[id]=source:serial(period);
							 SoundAlert(Down[id]);			 
							 EmailAlert( Label[id] , " Overbought Exit ", period);	
								 
									Pop(Label[id], " Overbought Exit " );  	
								    SendAlert(" Overbought Exit ");
