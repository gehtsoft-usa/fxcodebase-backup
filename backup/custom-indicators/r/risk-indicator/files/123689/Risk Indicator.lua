...
function Update(period)
    ...
    if total_amount_buy ~= 0 then
        ...
        buy.stop_level = buy.breakeven_level - buy.breakeven_level * instance.parameters.sl / 100;
        buy.limit_1_level = buy.breakeven_level + buy.breakeven_level * instance.parameters.tp1 / 100;
        buy.limit_2_level = buy.breakeven_level + buy.breakeven_level * instance.parameters.tp2 / 100;
    end
    if total_amount_sell ~= 0 then
        sell.breakeven_level = total_pl_sell / total_amount_sell;
        sell.stop_level = sell.breakeven_level + sell.breakeven_level * instance.parameters.sl / 100;
        sell.limit_1_level = sell.breakeven_level - sell.breakeven_level * instance.parameters.tp1 / 100;
        sell.limit_2_level = sell.breakeven_level - sell.breakeven_level * instance.parameters.tp2 / 100;
    end
end
