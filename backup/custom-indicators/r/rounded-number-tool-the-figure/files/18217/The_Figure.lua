		...
		ON =nil;
		 ...
		 if MAX > 10 then
		    ...
		    Level=i*0.1;
  		    ...
  		    if   L[1] and(Level % 1)==0 then
			ON=1;
			end
			if  L[2]and (Level % 5)==0  then
			ON=2;
			end
			if   L[3]and(Level % 10)==0 then
			ON=3;
			end
			if   L[4]and (Level %  25)==0  then
			ON=4;		
			end
			if  L[5] and(Level % 50)==0    then
			ON=5;
			end
			if   L[6]and (Level % 100)==0  then
			ON=6;
		    end
		else		
			...
			if  L[1] and modulo(Level, 0.01)==0  then
			ON=1;
			end
			if  L[2]  and modulo(Level, 0.05)==0  then
			ON=2;
			end
			if  L[3] and modulo(Level, 0.1)==0  then
            ON=3;
			end
			if  L[4] and modulo(Level, 0.25)==0  then
            ON=4;
			end
			if L[5] and modulo(Level, 0.5)==0  then
			ON=5;
			end
			if  L[6]  and modulo(Level, 1)==0  then
			ON=6;
			end
