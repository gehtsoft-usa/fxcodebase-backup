...
function Prepare(nameOnly)
	...
	MA1 = core.indicators:create("MVA", source, 2);
	MA2 = core.indicators:create("MVA", MA1.DATA, 2);
	MA3 = core.indicators:create("MVA", MA2.DATA, 2);
	MA4 = core.indicators:create("MVA", MA3.DATA, 2);
	MA5 = core.indicators:create("MVA", MA4.DATA, 2);
	MA6 = core.indicators:create("MVA", MA5.DATA, 2);
	MA7 = core.indicators:create("MVA", MA6.DATA, 2);
	MA8 = core.indicators:create("MVA", MA7.DATA, 2);
	MA9 = core.indicators:create("MVA", MA8.DATA, 2);
	MA10 = core.indicators:create("MVA", MA9.DATA, 2);
	
	first = MA10.DATA:first();
...
function Update(period, mode)
   ...
   local min, max;
   min, max=mathex.minmax(source, period-10+1, period);
   local x= source[period] - (MA1.DATA[period]+MA2.DATA[period]+MA3.DATA[period]+MA4.DATA[period]+MA5.DATA[period]+MA6.DATA[period]+MA7.DATA[period]+MA8.DATA[period]+MA9.DATA[period]+MA10.DATA[period])/10 ;
