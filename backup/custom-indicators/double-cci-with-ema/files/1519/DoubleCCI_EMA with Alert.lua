...
function Init()
	...
	indicator.parameters:addGroup("EntryCCI/Zero Alert");
	indicator.parameters:addBoolean("Confirmation", "Use TrendCCI Confirmation", "" , true);
	
	Parameters (1, "EntryCCI/Zero");	
end
...
function Activate (id, period)
   ...
   Alert[id][period]=0;
	  ...
	  if id == 1  and ON[id]  then
			...
			if  EntryCCI[period] > 0
			and   EntryCCI[period-1] <= 0
			and( not Confirmation
			or (Confirmation and TrendCCI[period]> 0)
			)
			then
