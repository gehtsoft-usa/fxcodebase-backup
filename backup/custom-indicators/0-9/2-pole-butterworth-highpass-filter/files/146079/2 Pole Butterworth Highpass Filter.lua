...
function Init()
    indicator:name("2 Pole Butterworth Highpass Filter");
...
function Update(period, mode)
    ...
    local tmp    =  source[period-1] 
    local whiten =    source[period] + source[period-2]  - 2.0 * tmp 
    Oscillator[period]= COEF0 *     whiten     +
