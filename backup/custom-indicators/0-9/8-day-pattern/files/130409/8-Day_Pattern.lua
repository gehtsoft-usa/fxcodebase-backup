...
--http://fxcodebase.com/code/viewtopic.php?f=17&t=69263
...
{ 
    {
        ...
        UpCondition = function (period)
            ...
            local max_60 = mathex.max(source, period - 67, period - 8);
            local max_2_7 = mathex.max(source, period - 6, period - 1);
            local min_2_6 = mathex.min(source, period - 6, period - 2);
            return source.close[period] > source.open[period]
                and source.close[period - 1] > source.open[period - 1]
                and source.high[period - 7] > max_60
                and source.high[period - 7] > max_2_7
                and (source.high[period - 7] - min_2_6) / source.high[period - 7] >= 0.03
        ...
        DownCondition = function (period)
            ...
            local min_60 = mathex.min(source, period - 67, period - 8);
            local min_2_7 = mathex.min(source, period - 6, period - 1);
            local max_2_6 = mathex.max(source, period - 6, period - 2);
            return source.close[period] < source.open[period]
                and source.close[period - 1] < source.open[period - 1]
                and source.low[period - 7] < min_60
                and source.low[period - 7] < min_2_7
                and (max_2_6 - source.low[period - 7]) / source.low[period - 7] >= 0.03
