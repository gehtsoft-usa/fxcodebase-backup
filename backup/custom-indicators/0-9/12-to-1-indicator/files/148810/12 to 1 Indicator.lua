...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=73078
...
function Init()
    indicator:name("12 to 1 Indicator");
...
-- Routine
 function Prepare(nameOnly)   
    ...
    Line = instance:addStream("Line", core.Bar, name, "Line", instance.parameters.color1, first );
...
function Update(period, mode)
	...
	Line[period]=  (source.close[period] - source.open[period-Period1 + 1]) - (source.close[period] - source.open[period-Period2 + 1]);
