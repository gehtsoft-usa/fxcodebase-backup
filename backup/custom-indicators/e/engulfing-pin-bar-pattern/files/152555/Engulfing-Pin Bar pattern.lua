-- Available @ https://fxcodebase.com/code/viewtopic.php?f=17&t=74155
--+------------------------------------------------------------------------------------------------+
...
local Alert_Name={ "Bullish engulfing pinbar" ,"Bearish engulfing pinbar"};
local Signal_Name={"Bullish pattern", "Bearish pattern"};
...
function Init()
    indicator:name("Engulfing-Pin Bar pattern");
