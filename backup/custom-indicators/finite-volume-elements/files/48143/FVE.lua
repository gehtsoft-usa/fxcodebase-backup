...
--http://fxcodebase.com/code/viewtopic.php?f=17&t=27510
...
function Prepare(nameOnly)
	...
	MA1 = core.indicators:create(Method1, source.volume, Period1);
		...
		FVE:setPrecision(math.max(2, source:getPrecision()));
		if Period2 > 0 then 
