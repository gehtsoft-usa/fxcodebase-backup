...
function Init()
    ...
    indicator.parameters:addInteger("frame", "Maximum Triagle Lengt", "", 50);
	indicator.parameters:addInteger("Only", "Lookback Search Lengt", "", 100, 0, 1000);
...
function Update(period)
   ...
   if  period < source:size() - 1 - Only  then
   return;
   end
...
function drawline(x1, y1, x2, y2, ix, iy, color)
    ...
    core.host:execute("drawLine", line_id, date1, ly1, date2, ly2, color);
    line_id = line_id + 1;
end
