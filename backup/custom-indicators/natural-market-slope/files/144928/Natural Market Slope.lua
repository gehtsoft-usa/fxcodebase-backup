...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=71849
...
function Init()
    indicator:name("Natural Market Slope");
    ...
    indicator.parameters:addInteger("Length", "Length", "", 40, 1, 2000);
...
-- Routine
 function Prepare(nameOnly)   
	...
	ln = instance:addInternalStream(0, 0);
...
function Update(period, mode)
   ...
   ln[period] =  math.log(source[period]) * 1000;
   lreg[period]= mathex.lreg(ln, period-Length+1, period);
   
   Line[period] = (lreg[period]-lreg[period-1] ) * math.sqrt(Length) ;	 


    local slo = Line[period] -  Line[period-1]; 
