...
function Init()
    indicator:name("Peyton Indicator Heat Map");
...
-- Routine
 function Prepare(nameOnly)
	...
	WPR1=core.indicators:create("RLW", source, Fast_Period);
	WPR2=core.indicators:create("RLW", source, Slow_Period);
	CCI= core.indicators:create("CCI", source, CCI_Period);	
	AEFI= core.indicators:create("AEFI", source, SM, N);	 
