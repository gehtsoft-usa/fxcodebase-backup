...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=72862
...
function Init()
    indicator:name("Long Short Differential Gain");
...
function Update(period, mode)
	...
	Line[period]= 100 * (min + max - 2 * source[period-Period+1]) / source[period-Period+1];
