...
local first;
local source = nil;
local Period , Method,SqrtLength; 
local Indicator;
...
-- Routine
 function Prepare(nameOnly)   
	...
	Indicator2= core.indicators:create(Method,Indicator1.DATA , SqrtLength);	
