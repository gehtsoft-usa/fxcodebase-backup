...
local Indicator2 = {} ;
 function Prepare(nameOnly)   
   ...
   assert(core.indicators:findIndicator("AVERAGES") ~= nil, "Please, download and install AVERAGES.LUA indicator");    
	 ...
	 Indicator1[i] = core.indicators:create("AVERAGES", source[instance.parameters:getString("Price1" .. i)] , instance.parameters:getString("M1" .. i), instance.parameters:getInteger("P1" .. i),true);   			 
	 Indicator2[i] = core.indicators:create("AVERAGES",source[instance.parameters:getString("Price2" .. i)]  ,  instance.parameters:getString("M2" .. i), instance.parameters:getInteger("P2" .. i),true);   					   
     end 
