...
-- Routine
 function Prepare(nameOnly)   
	...
	MVA= core.indicators:create(Method, source, Period);
	first=MVA.DATA:first()*2 ; 
...
function Update(period, mode)
	...
	Line[period]= mathex.sum(MVA.DATA, period-Period+1, period) / Period;
