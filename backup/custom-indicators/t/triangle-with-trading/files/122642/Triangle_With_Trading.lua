...
function CreateCustomActions()
    ...
    action1.IsPass = function (source, period) 
        for _, line in pairs(lines_top) do
            if executed_up[line.date1] ~= true and line:crossesOver(source.close, period) then
    ...
    action2.IsPass = function (source, period) 
        for _, line in pairs(lines_top) do
            if executed_up[line.date1] ~= true and line:crossesUnder(source.close, period) then
                executed_up[line.date1] = true;
                return true;
            end
        end
    ...
    action3.IsPass = function (source, period)
        for _, line in pairs(lines_bottom) do
            if executed_down[line.date1] ~= true and line:crossesOver(source.close, period) then
    ...
    action4.IsPass = function (source, period)
        for _, line in pairs(lines_bottom) do
            if executed_down[line.date1] ~= true and line:crossesUnder(source.close, period) then
                executed_down[line.date1] = true;
                return true;
            end
        end
