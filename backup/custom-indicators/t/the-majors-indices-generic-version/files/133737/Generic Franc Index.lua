...
function Init()
	indicator:name("Generic Franc Index")
	...
	AddInstrument(1, "USD/CHF")
	AddInstrument(2, "EUR/CHF")
	AddInstrument(3, "CHF/JPY")
	AddInstrument(4, "GBP/CHF")

	indicator.parameters:addGroup("Calculation")
	indicator.parameters:addString("base_instrument", "Base Instrument", "Base Instrument", "CHF")
