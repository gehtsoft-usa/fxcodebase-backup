...
--+------------------------------------------------------------------------------------------------+
function Init()
	indicator:name("Generic Dollar Index")
	...
	AddInstrument(1, "EUR/USD", true)
	AddInstrument(2, "USD/JPY", true)
	AddInstrument(3, "GBP/USD", true)
	AddInstrument(4, "USD/CHF", true)

	AddInstrument(5, "USD/CNH", false)
	AddInstrument(6, "USD/MXN", false)

	AddInstrument(7, "USD/ZAR", false)
	AddInstrument(8, "USD/HKD", false)
	AddInstrument(9, "USD/TRY", false)
	AddInstrument(10, "XAG/USD", false)
	AddInstrument(11, "XAU/USD", false)

	AddInstrument(12, "BTC/USD", false)

	AddInstrument(13, "BCH/USD", false)
	AddInstrument(14, "ETH/USD", false)
	AddInstrument(15, "LTC/USD", false)
	AddInstrument(16, "XRP/USD", false)

	AddInstrument(17, "EOS/USD", false)
	AddInstrument(18, "XLM/USD", false)
	AddInstrument(19, "EOS/USD", false)
	AddInstrument(20, "XLM/USD", false)

	indicator.parameters:addGroup("Calculation")
	indicator.parameters:addString("base_instrument", "Base Instrument", "Base Instrument", "USD")
...
function AddInstrument(id, Instrument, Flag)
	indicator.parameters:addBoolean("Use" .. id, " Use " .. id .. " Instrument", "Use", Flag)
...
function Update(period)
	...
	for i = 1, Number, 1 do
		...
		if p[i] == false or not SourceData[i].close:hasData(p[i]) then
			RETURN = true
		end
	end
	...
	local RETURN = false
	for i = 1, Number, 1 do
		if tmp[i] == nil or Index[i] == nil then
			RETURN = true
		end
	end
