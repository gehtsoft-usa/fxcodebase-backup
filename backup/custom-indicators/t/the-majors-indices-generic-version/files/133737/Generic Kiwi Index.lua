...
function Init()
	...
	AddInstrument(1, "EUR/NZD")
	AddInstrument(2, "NZD/JPY")
	AddInstrument(3, "AUD/NZD")
	AddInstrument(4, "NZD/USD")

	indicator.parameters:addGroup("Calculation")
	indicator.parameters:addString("base_instrument", "Base Instrument", "Base Instrument", "NZD")
