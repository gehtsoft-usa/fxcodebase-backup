...
function Init()
	indicator:name("Generic Pound Index")
	...
	AddInstrument(1, "GBP/USD")
	AddInstrument(2, "EUR/GBP")
	AddInstrument(3, "GBP/JPY")
	AddInstrument(4, "GBP/CHF")

	indicator.parameters:addGroup("Calculation")
	indicator.parameters:addString("base_instrument", "Base Instrument", "Base Instrument", "GBP")
