...
function Init()
	indicator:name("Generic Euro Index")
	...
	AddInstrument(1, "EUR/USD")
	AddInstrument(2, "EUR/JPY")
	AddInstrument(3, "EUR/GBP")
	AddInstrument(4, "EUR/CHF")

	indicator.parameters:addGroup("Calculation")
	indicator.parameters:addString("base_instrument", "Base Instrument", "Base Instrument", "EUR")
