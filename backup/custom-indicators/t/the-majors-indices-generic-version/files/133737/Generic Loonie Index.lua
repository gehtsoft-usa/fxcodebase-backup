...
function Init()
	indicator:name("Generic Loonie Index")
	...
	AddInstrument(1, "EUR/CAD")
	AddInstrument(2, "GBP/CAD")
	AddInstrument(3, "USD/CAD")
	AddInstrument(4, "CAD/JPY")

	indicator.parameters:addGroup("Calculation")
	indicator.parameters:addString("base_instrument", "Base Instrument", "Base Instrument", "CAD")
