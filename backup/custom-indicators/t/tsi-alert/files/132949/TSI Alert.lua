...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=69691
...
function Init()
   ...
   indicator:requiredSource(core.Tick);
    ...
    indicator.parameters:addInteger("Period1", "Fast Period MA", "", 7, 1, 2000 ); 	
	indicator.parameters:addInteger("Period2", "Slow Period MA", "", 14, 1, 2000); 
	...
	indicator.parameters:addDouble("Level1", "OB Level","", 25);
	indicator.parameters:addDouble("Level2", "OS Level","", -25); 
...
-- Routine
 function Prepare(nameOnly)   
   ...
   Indicator = core.indicators:create("TSI", source , Period1, Period2);
	
	first=Indicator.DATA:first() ;

    TSI = instance:addStream("TSI", core.Line, name .. ".TSI", "TSI", instance.parameters.color1,  first);
	TSI:setWidth(instance.parameters.width1);
    TSI:setStyle(instance.parameters.style1);
	
    
	TSI:addLevel(0, instance.parameters.level_overboughtsold_style, instance.parameters.level_overboughtsold_width, instance.parameters.level_overboughtsold_color);
	TSI:addLevel(instance.parameters.Level1, instance.parameters.level_overboughtsold_style, instance.parameters.level_overboughtsold_width, instance.parameters.level_overboughtsold_color);
	TSI:addLevel(instance.parameters.Level2, instance.parameters.level_overboughtsold_style, instance.parameters.level_overboughtsold_width, instance.parameters.level_overboughtsold_color);
...
function  Initialization ()
 ...
 function Calculate(period, mode)
	...
	TSI[period]= Indicator.DATA[period];
...
function Update(period, mode) 
    ...
    Activate (1, period, 0)
    Activate (2, period,instance.parameters.Level1)
	Activate (3, period,instance.parameters.Level2)

 
end


function Activate (id, period, LocalLevel )
   ...
   Alert[id][period]=0;
	  ...
	  if   ON[id]  then
			...
			if  TSI[period] > LocalLevel
			and   TSI[period-1] <=LocalLevel
			then
			           
						    
         
                Alert[id][period]= 1;	
 				AlertLevel[id][period]= LocalLevel
