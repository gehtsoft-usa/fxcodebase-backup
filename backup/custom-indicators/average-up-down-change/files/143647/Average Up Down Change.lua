...
function Init()
    indicator:name("Average Up Down Change");
...
function Update(period, mode)
    ...
    Up[period]= mathex.sum(ChangeUp, period-Period+1, period)/mathex.sum(SumUp, period-Period+1, period);
	Down[period]= mathex.sum(ChangeDown, period-Period+1, period)/mathex.sum(SumDown, period-Period+1, period);
