...
function Init()
    indicator:name("Average Period Up Down Change");
...
function Update(period, mode)
    ...
    Up[period]= mathex.avg(ChangeUp, period-Period+1, period);
	Down[period]= mathex.avg(ChangeDown, period-Period+1, period);
