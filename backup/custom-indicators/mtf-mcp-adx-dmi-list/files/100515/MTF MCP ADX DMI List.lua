...
function Init()
	...
	indicator.parameters:addInteger("ADX_Period" , "ADX Period", "", 20);
	indicator.parameters:addInteger("DMI_Period" , "DMI Period", "", 20);
	indicator.parameters:addDouble("Entry" , "Entry Level", "", 30);
	indicator.parameters:addDouble("Exit" , "Exit Level", "", 45);
...
function Draw(stage, context)
 ...
 function Calculate (context,i, j )
    ...
    YELLOW DOT: OTHER WICE
		  ...
		  and ADX[i][j].DATA [ADX[i][j].DATA:size()-1]  > Entry
		  and ADX[i][j].DATA [ADX[i][j].DATA:size()-1] < Exit
