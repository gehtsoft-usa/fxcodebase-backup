...
function Init()
    ...
    indicator.parameters:addInteger("Frame", "Period", "No description", 13, 2 , 2000);
...
-- Routine
 function Prepare(nameOnly)  
    ...
    Bulls = instance:addStream("Bulls", core.Bar, name, "Bulls", instance.parameters.Bulls_color, first);
