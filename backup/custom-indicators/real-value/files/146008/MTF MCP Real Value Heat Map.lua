...
--+------------------------------------------------------------------------------------------------+
 ...
 function Add(id, TF,Flag, Instrument )
    ...
    indicator.parameters:addDouble("Alpha".. id, "Alpha", "", 1, 0, 2000);
    indicator.parameters:addDouble("Variation".. id, "Variation", "", 3, 0, 2000);
    indicator.parameters:addInteger("Period".. id, "Period", "", 20, 1, 2000);	
...
function Init()
    indicator:name("MTF MCP Real Value Heat Map");
...
function Prepare(nameOnly)
	...
	s2, e2 = core.getcandle(iTF[i], 0, 0, 0);
	 ...
	 Number=Number+1;
	      ...
	      Variation[Number]= instance.parameters:getDouble("Variation" .. i);
	      Alpha[Number]= instance.parameters:getDouble("Alpha" .. i);		  
	 ...
	 Label[Number]="";
                ...
                Label[Number]=Label[Number] .. " - " ..  TF[Number];				
			  	...
			  	Temp1= core.indicators:create("REAL VALUE", source ,  Alpha[Number],  Variation[Number],  Period[Number]);  				
				ifirst= Temp1.DATA:first()*2;
				 ...
				 loading[Number]  = true;  	 
				 Indicator[Number] = core.indicators:create("REAL VALUE", SourceData[Number] , Alpha[Number],  Variation[Number],  Period[Number]);   
