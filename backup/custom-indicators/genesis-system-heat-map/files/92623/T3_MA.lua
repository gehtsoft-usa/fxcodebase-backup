...
local c1, c2, c3, c4, w1, w2;
 function Prepare(nameOnly)   
    ...
    T3_MA = instance:addStream("T3_MA", core.Line, name .. ".T3_MA", "T3_MA", instance.parameters.Up, first);
...
function Update(period, mode)
   if period>first then
	...
	T3_MA:setColor(period, instance.parameters.Up);
	else
	T3_MA:setColor(period, instance.parameters.Down);
	end
   end 
end
