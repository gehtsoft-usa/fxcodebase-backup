...
function Init()
    ...
    indicator.parameters:addColor("Trend_color", "Trend Color", "Color", core.colors().Yellow);
    indicator.parameters:addInteger("Trend_width", "Trend Width", "Width", 1, 1, 5);
    indicator.parameters:addInteger("Trend_style", "Trend Style", "Style", core.LINE_SOLID);
...
function Prepare(nameOnly)
    ...
    Trend = instance:addStream("Trend", core.Line, "Trend", "Trend", instance.parameters.Trend_color, 0, 0);
    Trend:setWidth(instance.parameters.Trend_width);
    Trend:setStyle(instance.parameters.Trend_style);
