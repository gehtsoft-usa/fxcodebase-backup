...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=71540
...
-- Routine
 function Prepare(nameOnly)   
    ...
    rf= instance:addInternalStream(0, 0);
...
function Update(period, mode)
   ...
   if (source[period]>source[period-1]) then rf[period] = 1; end
   if (source[period]<source[period-1]) then rf[period] = 0; end
 
	  
    Oscillator[period]= 100.0*mathex.avg(rf, period-Period+1, period);
