...
function Init()
    indicator:name("Triangular MA StairStep with percent variation");
...
local first;
local source = nil;
local percent, Period,SignalPeriod ; 
local Indicator;
...
-- Routine
 function Prepare(nameOnly)   
    ...
    local name = profile:id() .. "(" ..  instance.source:name().. "," ..  percent.. "," ..  Period .. "," ..  SignalPeriod  .. ")";
    instance:name(name); 
	...
	Indicator= core.indicators:create("TMA", source, Period);
