...
function Prepare(nameOnly)
    ...
    One = core.indicators:create( "CMA" , source, Period);
	 ...
	 first = One.DATA:first()+Period/2+ 1;
        ...
        CMAD = instance:addStream("CMAD", core.Line, name, "CMAD", instance.parameters.UPUP, first);
		CMAD:setWidth(instance.parameters.width);
        CMAD:setStyle(instance.parameters.style);
