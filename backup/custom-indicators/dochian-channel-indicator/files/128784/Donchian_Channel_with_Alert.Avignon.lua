...
{ 
    {
		...
		UpCondition = function (period)
			...
			return core.crossesOver(source.close, Out[1], period);
        end,
	...
	},
	{
		...
		UpCondition = function (period)
			...
			return core.crossesOver(source.close, Out[2], period);
        end,
		DownCondition = function (period)
			if period < 1 then
				return false;
    ...
    },
	{
		...
		DownCondition = function (period)
			...
			return core.crossesUnder(source.close, Out[4], period);
        end,
        OnChange = false,
    ...
    },
	{
		...
		DownCondition = function (period)
			...
			return core.crossesUnder(source.close, Out[5], period);
        end,
        OnChange = false,
