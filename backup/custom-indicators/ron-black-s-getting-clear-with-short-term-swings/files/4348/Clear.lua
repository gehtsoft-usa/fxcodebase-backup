...
function Prepare(nameOnly)
    ...
    Clear = instance:addStream("Clear", core.Dot, name .. ".Clear", "Clear",  core.rgb(128, 128, 128), first);
    Clear:setWidth(instance.parameters.width);
end
...
function Update(period, mode)
    ...
    if swing[period] > 0 then
        Clear[period] = hl[period];     
        Clear:setColor(period, instance.parameters.Up); 		
    elseif swing[period] < 0 then
       Clear[period] = lh[period];
