-- Available @ https://fxcodebase.com/code/viewtopic.php?f=17&p=158293#p158293
...
local indi_name = "False Breackout Detector Dashboard";
local indi_id = "FALSE_BREACKOUT_DETECTOR";
...
function GetLastSignal(indi, source)
    local up = indi[1]:getTextOutput(2);
    local down = indi[1]:getTextOutput(3);
