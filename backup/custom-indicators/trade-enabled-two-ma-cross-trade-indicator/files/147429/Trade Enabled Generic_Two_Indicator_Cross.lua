...
local Account, Offer, CanClose, Amount, pos, fstTck, stp, lmt, setSL, trlStp
...
function Prepare(nameOnly)
    ...
    local name = profile:id() .. " " .. source:name()  .. " : " .. source:barSize()..", stp="..stp..", lmt="..lmt..", setSL="..setSL
	instance:name(name );
	if nameOnly then
		return;
	end
    ...
    Indicator_FIRST=math.max(INDEX1:first(),INDEX2:first() );
   ...
   Alert[id][period]=0;
	  ...
	  if id == 1  and ON[id]  then
			...
			then
                ...
                Alert[id][period]= 1;	
 				AlertLevel[id][period]= INDEX2[period] 
