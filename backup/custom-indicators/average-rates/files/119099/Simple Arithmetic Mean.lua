...
function Init()
    indicator:name("Simple Arithmetic Mean");
    indicator:description("Simple Arithmetic Mean");
...
function Prepare(nameOnly)
	...
	Close = instance:addStream("Mean", core.Line, "Mean", "Mean", instance.parameters.color1, first);
...
function Update(period )
	...
	return;
						   ...
						   for i= 1, Number, 1 do	
							   ...
							   if Inverse[i] then
							   iClose= iClose+ (1/SourceData[i].close[p[i]]) *Weight[i];
							   else						   
							   iClose= iClose+ SourceData[i].close[p[i]] *Weight[i];		
							   end						   
