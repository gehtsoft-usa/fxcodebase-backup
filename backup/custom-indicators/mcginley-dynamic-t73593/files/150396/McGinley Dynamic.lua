...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=73593
...
function Init()
    ...
    indicator.parameters:addInteger("Periods", "Periods", "", 12, 1, 2000);
...
local first;
local source = nil;
local Periods, Smoothing,Method; 
local MA;
...
-- Routine
 function Prepare(nameOnly)   
    ...
    local name = profile:id() .. "(" ..  instance.source:name().. "," .. Method .. "," .. Periods.. "," ..  Smoothing  .. ")";
    instance:name(name); 
	...
	MA= core.indicators:create(Method, source, Periods);
...
function Update(period, mode)
	...
	Line[period]= MA.DATA[period-1] +
	(	
	(source[period]-MA.DATA[period-1])
	/
	(source[period]/MA.DATA[period-1]*Smoothing)	
	);
