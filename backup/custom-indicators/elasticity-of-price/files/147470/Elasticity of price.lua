...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=72721
...
function Init()
    indicator:name("Elasticity of price");
	...
	indicator.parameters:addDouble("Level2", "2. Level","", 1);
	indicator.parameters:addDouble("Level3", "3. Level","", 2); 
...
function Update(period, mode) 
	...
	local Average=mathex.avg(source,  period-Period+1, period)+(stdev*2)
 
    Line[period]=((Average-source[period])/stdev)/2  
end
