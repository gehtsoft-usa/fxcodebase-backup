-- Available @ https://fxcodebase.com/code/viewtopic.php?f=17&t=75736
...
local indi_name = "Open Line Dashboard";
...
function GetLastSignal(indi, source)
    ...
    if source.open[NOW] <= source.close[NOW] then
        return 1, source:date(NOW), "H";
    end
    return -1, source:date(NOW), "L";
end
