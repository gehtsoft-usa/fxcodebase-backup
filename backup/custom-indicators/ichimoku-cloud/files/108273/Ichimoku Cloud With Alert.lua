...
function Init()
	...
	Parameters (1, "A/B");	
	Parameters (2, "Price/A");	
	Parameters (3, "Price/B");	
end
...
function Activate (id, period)
   ...
   Alert[id][period]=0;
	  ...
	  if id == 1  and ON[id]  then
			...
			and   A[period-1] <= B[period-1] 
			then
			           
						    
         
                Alert[id][period]= 1;	
 				AlertLevel[id][period]= B[period] 
	  ...
	  if id == 2  and ON[id]  then
			...
			if  source.close[period] > A[period] 
			and   source.close[period-1] <= A[period-1] 
			then
			           
						    
         
                Alert[id][period]= 1;	
 				AlertLevel[id][period]= A[period] 
			...
			elseif  source.close[period] < A[period] 
			and   source.close[period-1] >= A[period-1] 
            then			
	  ...
	  if id == 3  and ON[id]  then
			...
			if  source.close[period] > B[period] 
			and   source.close[period-1] <= B[period-1] 
			then
			...
			elseif  source.close[period] < B[period] 
			and   source.close[period-1] >= B[period-1] 
            then			
