...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=72369
...
function Init()
    indicator:name("BS Trend Indicator");
...
-- Routine
 function Prepare(nameOnly)   
    ...
    Bar = instance:addStream("Bar", core.Bar, name, "Bar", instance.parameters.Up, first );
...
function Update(period, mode)
	 ...
	 return;
	  ...
	  local ld_96, ld_104 = mathex.minmax(source, period-Period+1, period);
	  
      local ld_16 = (source.high[period] + source.low[period]) / 2.0;
      ld_48[period] = 0.66 * ((ld_16 - ld_96) / (ld_104 - ld_96) - 0.5) + 0.67 * ld_48[period-1];
