...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=71893
...
function Init()
    indicator:name("Forex Distance indicator");
...
-- Routine
 function Prepare(nameOnly)   
    ...
    local name = profile:id() .. "(" ..  instance.source:name().. "," ..  HalfLength .. "," ..  Deviation  .. ")";
    instance:name(name); 
...
function Update(period, mode)
    ...
    local sum=(HalfLength+1)*source[period];
    ...
    Top[period] = (1+Deviation/100)* sum/sumw;
    Bottom[period] = (1-Deviation/100)* sum/sumw;
	...
	for i= period, period+HalfLength, 1 do
	New(i);
	end
