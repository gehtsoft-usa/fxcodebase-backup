...
-- https://fxcodebase.com/code/viewtopic.php?f=17&p=154010
...
local Alert_Name={ "1. OB Level" ,"2. OB Level", "1. OS Level" ,"2. OS Level"};
...
--indicator.parameters:addBoolean("Show_Unconfirmed", "Show Unconfirmed Signals", "", false);
    ...
    indicator.parameters:addDouble("Level", "Level","", 0.005);	
...
function Prepare(nameOnly)
	...
	return;
        ...
        FlowPrice:addLevel(instance.parameters.Level, instance.parameters.level_overboughtsold_style, instance.parameters.level_overboughtsold_width, instance.parameters.level_overboughtsold_color);
        FlowPrice:addLevel(-instance.parameters.Level, instance.parameters.level_overboughtsold_style, instance.parameters.level_overboughtsold_width, instance.parameters.level_overboughtsold_color);
...
function Signal_Logic (id, period)
	    ...
	    if id== 1  then   
			if  FlowPrice[period] > Level
			and   FlowPrice[period-1] <= Level
			then
