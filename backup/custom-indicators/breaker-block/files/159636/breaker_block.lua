-- Available @ https://fxcodebase.com/code/viewtopic.php?f=17&t=76043&p=159636#p159636
...
{ 
    {
        ...
        UpCondition = function (period)
            ...
            local _, value, next_side = peaks:GetData();
            if next_side == 1 or value == nil then
                return false;
            end
            core.host:trace("UP " .. source.close[period] .. " " .. value);
