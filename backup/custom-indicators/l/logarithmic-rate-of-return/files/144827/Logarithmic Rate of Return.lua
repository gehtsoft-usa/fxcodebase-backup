...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=71815
...
function Init()
    indicator:name("Logarithmic Rate of Return");
...
function Update(period, mode)
    ...
    Source[period]= math.log(source.close[period])-math.log(source.open[period]);
