...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=66648
...
function Init()
    indicator:name("MTF MCP Low Frequency Filter Moving Average Indicator Heat Map");
...
function Prepare(nameOnly)
	...
	assert(core.indicators:findIndicator("LOW FREQUENCY FILTER MOVING AVERAGE INDICATOR") ~= nil, "Please, download and install LOW FREQUENCY FILTER MOVING AVERAGE INDICATOR.LUA indicator");    
	...
	s2, e2 = core.getcandle(iTF[i], 0, 0, 0);
	 ...
	 Label[Number]="";
                ...
                Label[Number]=Label[Number] .. " - " ..  TF[Number];				
			  	...
			  	Temp1= core.indicators:create("LOW FREQUENCY FILTER MOVING AVERAGE INDICATOR", source ,  Period[Number]);  				
				ifirst= Temp1.DATA:first()*2;
				 ...
				 loading[Number]  = true;  	 
				 Indicator[Number] = core.indicators:create("LOW FREQUENCY FILTER MOVING AVERAGE INDICATOR", SourceData[Number] ,  Period[Number]);   
