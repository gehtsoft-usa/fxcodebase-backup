...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=72620
...
-- Routine
 function Prepare(nameOnly)   
	...
	Indicator1= core.indicators:create("EMA", a, Period);
	Indicator2= core.indicators:create("EMA", b, Period);	
...
function Update(period, mode)
    ...
    local A  = source[Price][period]-source[Price][period-1];
    local B = source.volume[period]-source.volume[period-1];   
	
	a[period]=math.max(A,0)*math.max(B,0);
	b[period]=math.abs(A)*math.abs(B);	
	...
	Line[period]= 100*Indicator1.DATA[period]/Indicator2.DATA[period];
