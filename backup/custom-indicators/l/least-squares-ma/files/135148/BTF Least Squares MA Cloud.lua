...
function Init()
    indicator:name("BTF Least Squares MA Cloud");
    ...
    indicator.parameters:addInteger("SF", "Period", "", 34);
	...
	indicator.parameters:addInteger("LF", "Second Averege Period", "Second Averege Period", 55);
...
function Prepare()
	...
	assert(core.indicators:findIndicator("LEAST SQUARES MA") ~= nil, "Please, download and install LEAST SQUARES MA indicator");
    ...
    local name = profile:id() .. "(" .. source:name() .. "," .. BS ..", ".. ShortFrame .. ", " .. LongFrame .. ")";
    instance:name(name);
   ...
   DDS=instance:addInternalStream(0, 0);
	...
	instance:createChannelGroup("DownGroup","Down" , DDL, DDS, instance.parameters.Down, Transparency);
	  ...
	  loading=true;
       ...
       ShortDATA= core.indicators:create("LEAST SQUARES MA", Source[Type1],  ShortFrame,false);	
	   LongDATA= core.indicators:create("LEAST SQUARES MA", Source[Type2],  LongFrame,false);
