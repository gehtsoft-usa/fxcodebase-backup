...
function Init()
    indicator:name("Multi Currency ROC");
    indicator:description("Multi Currency ROC");
...
function Update(period)
   ...
   return;
	...
	return;
     ...
     Instruments[1][period]= ((mEURUSD+mEURJPY+mEURGBP+mEURCHF+mEURCAD+mEURAUD+mEURNZD)/(TotalDevise-1)); 
     Instruments[2][period]= ((mUSDJPY-mEURUSD-mGBPUSD+mUSDCHF+mUSDCAD- mAUDUSD - mNZDUSD   )/(TotalDevise-1)); 
     Instruments[3][period]= ((mEURJPY-mUSDJPY-mGBPJPY-mCHFJPY-mCADJPY-mAUDJPY -mNZDJPY)/(TotalDevise-1)); 
     Instruments[4][period]= ((mEURGBP+mGBPJPY+mGBPUSD+mGBPCHF+mGBPCAD+mGBPAUD  +mGBPNZD  )/(TotalDevise-1)); 
     Instruments[5][period]= ((mCHFJPY-mGBPCHF-mUSDCHF-mEURCHF+mCADCHF-mAUDCHF  +mNZDCHF)/(TotalDevise-1)); 
	 Instruments[6][period]= ((mCADJPY-mGBPCAD-mUSDCAD-mEURCAD-mAUDCAD  -mNZDCAD+mCADCHF)/(TotalDevise-1)); 
     Instruments[7][period]= ((mAUDJPY-mGBPAUD   -mEURAUD + mAUDUSD + mAUDCHF - mNZDCAD +mAUDCAD )/(TotalDevise-1)); 
     Instruments[8][period]= ((mNZDUSD -mEURNZD-mGBPNZD+ mNZDJPY+  mNZDCHF +mNZDCAD - mAUDNZD)/(TotalDevise-1)); 
