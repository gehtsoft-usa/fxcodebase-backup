...
function Init()
    ...
    indicator:name("Advances - Declines Indicator");
    indicator:description("Advances - Declines");
    ...
    indicator.parameters:addColor("A_color", "Color of Advances", "Color of Advances", core.rgb(0, 255, 0));
	 indicator.parameters:addInteger("style1", "Line Style", "", core.LINE_SOLID);
    indicator.parameters:setFlag("style1", core.FLAG_LEVEL_STYLE);	
	indicator.parameters:addInteger("width1", "Line Width", "", 3, 1, 5);
	 indicator.parameters:addColor("D_color", "Color of Declines", "Color of Declines", core.rgb(255, 0, 0));
...
function Prepare(nameOnly)
    ...
    if (not (nameOnly)) then
        A = instance:addStream("A", core.Line, name, "A", instance.parameters.A_color, first);
    A:setPrecision(math.max(2, instance.source:getPrecision()));
		...
		D = instance:addStream("D", core.Line, name, "D", instance.parameters.D_color, first);
    D:setPrecision(math.max(2, instance.source:getPrecision()));
		D:setWidth(instance.parameters.width1);
        D:setStyle(instance.parameters.style1);
    end
end
