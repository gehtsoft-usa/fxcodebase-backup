...
{ 
    {
        ...
        UpCondition = function (period)
            ...
            return core.crosses(k, d, period) 
                and k[period] < os and d[period] < os;
        end,
        DownCondition = function (period)
            ...
            return core.crosses(k, d, period) 
                and k[period] > ob and d[period] > ob;
        end,
...
function Init()
    indicator:name("Stochastic Arrows");
    ...
    indicator.parameters:addInteger("os", "Oversold", "", 20);
    indicator.parameters:addInteger("ob", "Overbought", "", 80);
    ...
    indicator.parameters:addColor("d_color", "D Color", "Color", core.colors().Green);
...
function Prepare(nameOnly)
    ...
    d = instance:addStream("D", core.Line, "D", "D", instance.parameters.d_color, ssd.K:first(), 0);
