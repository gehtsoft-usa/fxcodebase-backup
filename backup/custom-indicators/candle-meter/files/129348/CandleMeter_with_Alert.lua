...
{ 
    {
		...
		UpCondition = function (period)
			return CandleMeter[period] > Level and CandleMeter[period - 1] <= Level;
        end,
...
function Prepare(nameOnly)
	...
	CandleMeter = instance:addStream("CandleMeter", core.Bar, name .. ".CandleMeter", "CandleMeter", 0, first)
