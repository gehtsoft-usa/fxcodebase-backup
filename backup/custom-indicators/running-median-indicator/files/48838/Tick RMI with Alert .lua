   ...
   if Live~= "Live" then
	...
	Shift=1;
	  ...
	  if id == 1  and ON[id]  then
			...
			if  source[period] > RMI[period] 
			and   source[period-1] <= RMI[period-1] 
			then
			           
						    
             core.host:execute("drawLabel1", source:serial(period), source:date(period),  core.CR_CHART, RMI[period], core.CR_CHART, core.H_Center, core.V_Bottom, font, UpTrendColor, "\225");
			...
			elseif  source[period] < RMI[period] 
			and   source[period-1] >= RMI[period-1] 
            then			
			
			            			 
			               core.host:execute("drawLabel1", source:serial(period), source:date(period),  core.CR_CHART, RMI[period], core.CR_CHART, core.H_Center, core.V_Top, font, DownTrendColor, "\226");						   
