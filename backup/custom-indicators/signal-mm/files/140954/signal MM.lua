...
--http://fxcodebase.com/code/viewtopic.php?f=17&t=70962
...
local source, ma1, ma2, ma1Line, ma2Line;
local indi_alerts = {};
...
{ 
    {
        ...
        UpCondition = function (period)
            ...
            return source.open[period] < ma1.DATA[period] 
                and source.open[period] < ma2.DATA[period]
                and source.close[period] > ma1.DATA[period] 
...
function Init()
    ...
    indicator.parameters:addColor("ma1Line_color", "MA 1 Color", "Color", core.colors().Red);
    indicator.parameters:addInteger("ma1Line_width", "MA 1 Width", "Width", 1, 1, 5);
    indicator.parameters:addInteger("ma1Line_style", "MA 1 Style", "Style", core.LINE_SOLID);
    indicator.parameters:setFlag("ma1Line_style", core.FLAG_LINE_STYLE);
    indicator.parameters:addColor("ma2Line_color", "MA 2 Color", "Color", core.colors().Green);
    indicator.parameters:addInteger("ma2Line_width", "MA 2 Width", "Width", 1, 1, 5);
    indicator.parameters:addInteger("ma2Line_style", "MA 2 Style", "Style", core.LINE_SOLID);
    indicator.parameters:setFlag("ma2Line_style", core.FLAG_LINE_STYLE);
...
function Prepare(nameOnly)
    ...
    ma1Line = instance:addStream("MA1", core.Line, "MA1", "MA1", instance.parameters.ma1Line_color, 0, 0);
    ma1Line:setWidth(instance.parameters.ma1Line_width);
    ma1Line:setStyle(instance.parameters.ma1Line_style);
    ma2Line = instance:addStream("MA2", core.Line, "MA2", "MA2", instance.parameters.ma2Line_color, 0, 0);
    ma2Line:setWidth(instance.parameters.ma2Line_width);
    ma2Line:setStyle(instance.parameters.ma2Line_style);
...
function Update(period, mode)
    ...
    ma1Line[period] = ma1.DATA[period];
    ma2Line[period] = ma2.DATA[period];
