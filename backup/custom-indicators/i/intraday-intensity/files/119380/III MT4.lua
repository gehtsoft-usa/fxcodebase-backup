...
function Prepare(nameOnly)
   Period = instance.parameters.Period;
	...
	Avg = core.indicators:create("MVA", Raw, Period);
	AvgVol = core.indicators:create("MVA", source.volume, Period);
...
function Update(period, mode)
    ...
    Raw[period]= ((2*source.close[period]-source.high[period]-source.low[period])/(source.high[period]-source.low[period]));  
    end
    ...
    return;   
	  ...
	  III[period]= 100.*Avg.DATA[period]/(AvgVol.DATA[period]*source:pipSize());
