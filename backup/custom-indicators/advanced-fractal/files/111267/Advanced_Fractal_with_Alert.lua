...
function Parameters ( id, Label )
   ...
   indicator.parameters:addGroup(Label .. " Alert");
	...
	indicator.parameters:addBoolean("ExecuteCommandOnUp", "Execute External Command on Up Signal", "", false);
    indicator.parameters:addFile("CommandOnUp", "External Command on Up Signal", "", "");
	indicator.parameters:addBoolean("ExecuteCommandOnDown", "Execute External Command on Down Signal", "", false);
    indicator.parameters:addFile("CommandOnDown", "External Command on Down Signal", "", "");
end 
	...
	if id == 1  and ON[id]  then
		if flag  then
			...
			then
				...
				if instance.parameters.ExecuteCommandOnUp then
					os.execute(instance.parameters.CommandOnUp);
				end
				SoundAlert(Up[id]);
			...
			then
				...
				if instance.parameters.ExecuteCommandOnDown then
					os.execute(instance.parameters.CommandOnDown);
				end
				SoundAlert(Down[id]);			 
