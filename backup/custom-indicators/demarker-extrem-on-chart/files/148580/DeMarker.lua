...
-- Routine
 function Prepare(nameOnly)   
    ...
    DeMark = instance:addStream("DeMark", core.Line, name, "DeMark", instance.parameters.color, first );
    DeMark:setPrecision(math.max(2, instance.source:getPrecision())); 
    DeMark:addLevel(0);	
    DeMark:addLevel(instance.parameters.Level1, instance.parameters.level_overboughtsold_style, instance.parameters.level_overboughtsold_width, instance.parameters.level_overboughtsold_color);
    DeMark:addLevel(instance.parameters.Level2, instance.parameters.level_overboughtsold_style, instance.parameters.level_overboughtsold_width, instance.parameters.level_overboughtsold_color);
