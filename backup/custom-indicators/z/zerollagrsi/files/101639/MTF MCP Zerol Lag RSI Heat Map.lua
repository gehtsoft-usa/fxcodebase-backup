...
--+------------------------------------------------------------------+
 ...
 function Add(id, TF,Flag, Instrument )
    ...
    indicator.parameters:addInteger("smoothing1".. id, "1. Smoothing","", 15);  
	indicator.parameters:addInteger("smoothing2".. id, "2. Smoothing","", 7);  
	
	indicator.parameters:addDouble("Factor1".. id, "1. Factor","", 0.05);
	indicator.parameters:addInteger("RSI_period1".. id, "1. RSI Period","", 8);	
	
	indicator.parameters:addDouble("Factor2".. id, "2. Factor","", 0.1);
	indicator.parameters:addInteger("RSI_period2".. id, "2. RSI Period","", 21);
	
	indicator.parameters:addDouble("Factor3".. id, "3. Factor","", 0.16);
	indicator.parameters:addInteger("RSI_period3".. id, "3. RSI Period","", 34);
	
	indicator.parameters:addDouble("Factor4".. id, "4. Factor","", 0.26);
	indicator.parameters:addInteger("RSI_period4".. id, "4. RSI Period","", 55);
	
	indicator.parameters:addDouble("Factor5".. id, "5. Factor","", 0.43);
  	indicator.parameters:addInteger("RSI_period5".. id, "5. RSI Period","", 89);
...
function Init()
    indicator:name("MTF MCP Zerol Lag RSI Heat Map");
...
local smoothing1={};--Integer
local smoothing2={};--Integer
local Factor1={};--Double
local RSI_period1={};--Integer
local Factor2={};--Double
local RSI_period2={};--Integer
local Factor3={};--Double
local RSI_period3={};--Integer
local Factor4={};--Double
local RSI_period4={};--Integer
local Factor5={};--Double
local RSI_period5={};--Integer
...
function Prepare(nameOnly)
	...
	assert(core.indicators:findIndicator("ZEROLLAGRSI") ~= nil, "Please, download and install ZEROLLAGRSI.LUA indicator");    
	...
	smoothing1[Number]= instance.parameters:getInteger("smoothing1" .. i);
	smoothing2[Number]= instance.parameters:getInteger("smoothing2" .. i);
	Factor1[Number]=instance.parameters:getDouble("Factor1" .. i);
	RSI_period1[Number]= instance.parameters:getInteger("RSI_period1" .. i);
	Factor2[Number]= instance.parameters:getDouble("Factor2" .. i);
	RSI_period2[Number]= instance.parameters:getInteger("RSI_period2" .. i);
	Factor3[Number]= instance.parameters:getDouble("Factor3" .. i);
	RSI_period3[Number]= instance.parameters:getInteger("RSI_period3" .. i);
	Factor4[Number]= instance.parameters:getDouble("Factor4" .. i);
	RSI_period4[Number]= instance.parameters:getInteger("RSI_period4" .. i);
	Factor5[Number]= instance.parameters:getDouble("Factor5" .. i);
	RSI_period5[Number]= instance.parameters:getInteger("RSI_period5" .. i);
	 ...
	 Label[Number]="";
                ...
                Label[Number]=Label[Number] .. " - " ..  TF[Number];				
			  	...
			  	Temp1= core.indicators:create("ZEROLLAGRSI", source.close , 
				smoothing1[Number], smoothing2[Number],Factor1[Number], RSI_period1[Number],Factor2[Number], RSI_period2[Number],Factor3[Number], RSI_period3[Number],Factor4[Number], RSI_period4[Number],Factor5[Number], RSI_period5[Number]);  				
				ifirst= Temp1.DATA:first()*2;
				 ...
				 loading[Number]  = true;  	 
				 Indicator[Number] = core.indicators:create("ZEROLLAGRSI", SourceData[Number].close ,
				 smoothing1[Number], smoothing2[Number],Factor1[Number], RSI_period1[Number],Factor2[Number], RSI_period2[Number],Factor3[Number], RSI_period3[Number],Factor4[Number], RSI_period4[Number],Factor5[Number], RSI_period5[Number],
				 Neutral, UpUp, UpDown, DownUp,DownDown);   
...
function Draw (stage, context)
   ...
   context:setClipRectangle(context:left(), context:top(), context:right(), context:bottom());
        ...
        if not init then
			...
			context:createPen (51, context.SOLID, 1, Neutral)       
