...
function Draw(stage, context) 
    ...
    local _, extension_y_1 = context:pointOfPrice(math.max(peak1, peak2) * (1 + extension_1u / 100));
    local _, extension_y_2 = context:pointOfPrice(math.min(peak1, peak2) * (1 + extension_2u / 100));
    local _, extension_y_3 = context:pointOfPrice(math.min(peak1, peak2) * (1 + extension_3u / 100));
    ...
    local _, extension_y_1 = context:pointOfPrice(math.max(peak1, peak2) * (1 - extension_1d / 100));
    local _, extension_y_2 = context:pointOfPrice(math.min(peak1, peak2) * (1 - extension_2d / 100));
    local _, extension_y_3 = context:pointOfPrice(math.min(peak1, peak2) * (1 - extension_3d / 100));
