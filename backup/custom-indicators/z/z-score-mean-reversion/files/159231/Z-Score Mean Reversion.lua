...
-- Indicator profile
function Init()
    indicator:name("Z-Score Mean Reversion")
    ...
    indicator.parameters:addDouble("EntryZ", "Z-score Entry Threshold", "", 2.0)
    indicator.parameters:addDouble("ExitZ", "Z-score Exit Threshold", "", 0.5)
...
function Update(periodIndex, mode)
    ...
    local z = (source[periodIndex] - s) / std
