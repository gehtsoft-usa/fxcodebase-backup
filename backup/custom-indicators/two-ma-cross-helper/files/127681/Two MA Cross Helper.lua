...
function Init()
	indicator:name("Two MA Cross Helper")
...
function Prepare(nameOnly)
	...
	MA1 =
		core.indicators:create(instance.parameters.Method1, source[instance.parameters.Price1], instance.parameters.Period1)
	assert(
		core.indicators:findIndicator(instance.parameters.Method2) ~= nil,
		instance.parameters.Method2 .. " indicator must be installed"
	)
	MA2 =
		core.indicators:create(instance.parameters.Method2, source[instance.parameters.Price2], instance.parameters.Period2)
