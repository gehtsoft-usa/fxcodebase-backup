...
function Prepare(nameOnly)
    ...
    local name = profile:id() .. "(" .. source:name() .. ", " .. tostring(S) .. ", " .. tostring(M) .. ")";
    instance:name(name);
