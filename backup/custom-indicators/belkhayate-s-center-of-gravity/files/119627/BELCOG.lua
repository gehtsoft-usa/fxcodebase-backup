...
function Init()
    ...
    indicator.parameters:addColor("L1_color_Up", "Color of L1 Up", "Color of L1", core.rgb(0, 255, 0));
	indicator.parameters:addColor("L1_color_Down", "Color of L1 Down", "Color of L1", core.rgb(255, 0, 0));
	
	indicator.parameters:addInteger("width1", "Line width", "", 1, 1, 5);
    indicator.parameters:addInteger("style1", "Line style", "", core.LINE_SOLID);
    indicator.parameters:setFlag("style1", core.FLAG_LINE_STYLE);
	
    indicator.parameters:addColor("L2_color_Up", "Color of L2 Up", "Color of L2",  core.rgb(0, 255, 0));
	indicator.parameters:addColor("L2_color_Down", "Color of L2 Down", "Color of L2", core.rgb(255, 0, 0));
	
	indicator.parameters:addInteger("width2", "Line width", "", 1, 1, 5);
    indicator.parameters:addInteger("style2", "Line style", "", core.LINE_SOLID);
    indicator.parameters:setFlag("style2", core.FLAG_LINE_STYLE);
	
    indicator.parameters:addColor("L3_color_Up", "Color of L3 Up", "Color of L3", core.rgb(0, 255, 0));
	indicator.parameters:addColor("L3_color_Down", "Color of L3 Down", "Color of L3", core.rgb(255, 0, 0));
	
	indicator.parameters:addInteger("width3", "Line width", "", 1, 1, 5);
    indicator.parameters:addInteger("style3", "Line style", "", core.LINE_SOLID);
    indicator.parameters:setFlag("style3", core.FLAG_LINE_STYLE);
	
    indicator.parameters:addColor("L4_color_Up", "Color of L4 Up", "Color of L4", core.rgb(0, 255, 0));
	indicator.parameters:addColor("L4_color_Down", "Color of L4 Down", "Color of L4", core.rgb(255, 0, 0));
    ...
    indicator.parameters:addColor("L5_color_Up", "Color of L5 Up", "Color of L5", core.rgb(0, 255, 0));
	indicator.parameters:addColor("L5_color_Down", "Color of L5 Down", "Color of L5", core.rgb(255, 0, 0));
    ...
    indicator.parameters:addColor("L6_color_Up", "Color of L6 Up", "Color of L6", core.rgb(0, 255, 0));
	indicator.parameters:addColor("L6_color_Down", "Color of L6 Down", "Color of L6", core.rgb(255, 0, 0));
    ...
    indicator.parameters:addColor("L7_color_Up", "Color of L7 Up", "Color of L7",  core.rgb(0, 255, 0));
	indicator.parameters:addColor("L7_color_Down", "Color of L7 Down", "Color of L7",  core.rgb(255, 0, 0));
...
function Update(period)
    ...
    if source:size() > 0 and (source:size() - source:first()) > N and period == source:size() - 1 then
        ...
        for i = 0, N, 1 do
			...
			if L1[period - i]  > L1[period - i-1] then
			L1:setColor(period - i,  instance.parameters.L1_color_Up);
			L2:setColor(period - i,  instance.parameters.L2_color_Up);
			L3:setColor(period - i,  instance.parameters.L3_color_Up);
			L4:setColor(period - i,  instance.parameters.L4_color_Up);
			L5:setColor(period - i,  instance.parameters.L5_color_Up);
			L6:setColor(period - i,  instance.parameters.L6_color_Up);
			L7:setColor(period - i,  instance.parameters.L7_color_Up);
            else
			L1:setColor(period - i,  instance.parameters.L1_color_Down);
			L2:setColor(period - i,  instance.parameters.L2_color_Down);
			L3:setColor(period - i,  instance.parameters.L3_color_Down);
			L4:setColor(period - i,  instance.parameters.L4_color_Down);
			L5:setColor(period - i,  instance.parameters.L5_color_Down);
			L6:setColor(period - i,  instance.parameters.L6_color_Down);
			L7:setColor(period - i,  instance.parameters.L7_color_Down);
            end		
        end
        for i = N + 1, N + 10, 1 do
            j = period - i;
