-- Available @ https://fxcodebase.com/code/viewtopic.php?f=17&t=75675
...
function Prepare(nameOnly)
    ...
    local profile = core.indicators:findIndicator("CCI_DIVERGENCE");
    assert(profile ~= nil, "Please, download and install " .. "CCI_DIVERGENCE" .. ".LUA indicator");
    indi = core.indicators:create("CCI_DIVERGENCE", source, instance.parameters.N, false);
