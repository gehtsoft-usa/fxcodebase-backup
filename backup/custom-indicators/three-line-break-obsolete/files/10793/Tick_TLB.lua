...
--http://fxcodebase.com/code/viewtopic.php?f=17&t=3532
...
function Init()
    ...
    indicator:description("Three Line Break ");
...
function Update(period)
	...
	LAST=1;
				...
				TOP[LAST] = source[period];
				BOTTOM[LAST] = source[period-1];
				else
				TOP[LAST] = source[period-1];
				BOTTOM[LAST] = source[period];				
				end		
			...
			if source[period] > MAX then
			Shift();
			TES(period,true);
			elseif source[period] < MIN  then
			Shift();
			TES(period, false);			
