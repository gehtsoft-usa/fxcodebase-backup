...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=71892
...
function Init()
    ...
    indicator.parameters:addInteger("Period", "Period", "", 144, 1, 2000);
...
-- Routine
 function Prepare(nameOnly)   
    ...
    Line = instance:addStream("Line", core.Line, name, "Line", instance.parameters.Up, MA2.DATA:first()+Period );
