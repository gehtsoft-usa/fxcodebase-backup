...
function Init()
    indicator:name("MTF MCP Vortex Heat Map");
	...
	indicator.parameters:addColor("Neutral", "Neutral Trend color", "", core.COLOR_LABEL);
	...
	s2, e2 = core.getcandle(iTF[i], 0, 0, 0);
	 ...
	 Label[Number]="";
                ...
                Label[Number]=Label[Number] .. " - " ..  TF[Number];				
			  	...
			  	Temp1= core.indicators:create("VORTEX", source ,  Period[Number]);  				
				ifirst= Temp1.DATA:first()*2;
				 ...
				 loading[Number]  = true;  	 
				 Indicator[Number] = core.indicators:create("VORTEX", SourceData[Number] ,  Period[Number]);   
				  ...
				  if p~= false then
										...
										if Indicator[j].DATA:hasData(p)  then 
												    ...
												    if  Indicator[j]:getStream(0)[p] >  Indicator[j]:getStream(1)[p] then		 
															...
															C2=12;
															C1=11;
													elseif  Indicator[j]:getStream(0)[p] <  Indicator[j]:getStream(1)[p] then		 
															C2=22;
															C1=21;
