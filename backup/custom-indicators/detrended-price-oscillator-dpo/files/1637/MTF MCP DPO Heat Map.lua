...
function Init()
    indicator:name("MTF MCP DPO Heat Map");
...
local Indicator = {} ;
 ...
 function Prepare(nameOnly)   
   ...
   instance:ownerDrawn(true);
	...
	assert(core.indicators:findIndicator("DPO") ~= nil, "Please, download and install DPO.LUA indicator");    
	...
	s2, e2 = core.getcandle(iTF[i], 0, 0, 0);
	 ...
	 Label[Number]="";
                ...
                Label[Number]=Label[Number] .. " - " ..  TF[Number];				
			  	...
			  	Temp1= core.indicators:create("DPO", source.close ,  Period[Number]);  				
				ifirst= Temp1.DATA:first()*2;
				 ...
				 loading[Number]  = true;  	 
				 Indicator[Number] = core.indicators:create("DPO", SourceData[Number].close ,  Period[Number]);   
