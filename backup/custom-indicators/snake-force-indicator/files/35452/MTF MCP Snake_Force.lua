...
function Init()
    indicator:name("MTF MCP Snake_Force List");
...
function Draw(stage, context)
 ...
 function Calculate (context,i, j )
    ...
    local SymbolColor=Neutral;	
		  ...
		  if Indicator[i][j].ForceUp [Indicator[i][j].ForceUp:size()-1] > 0 
		  and Indicator[i][j].ResistanceDn [Indicator[i][j].ResistanceDn:size()-1] == 0 
		  then
		  Symbol="\225"; 
		  SymbolColor=Up;
		  elseif Indicator[i][j].ForceDn [Indicator[i][j].ForceDn:size()-1] < 0 
		  and Indicator[i][j].ResistanceUp [Indicator[i][j].ResistanceUp:size()-1] == 0 
		  then
		  Symbol="\226"; 
		  SymbolColor=Down;
		  elseif Indicator[i][j].ForceUp [Indicator[i][j].ForceUp:size()-1] > 0 
		  and Indicator[i][j].ResistanceDn [Indicator[i][j].ResistanceDn:size()-1] < 0 
		  then
		  Symbol="\167"; 
		  SymbolColor=Up;
