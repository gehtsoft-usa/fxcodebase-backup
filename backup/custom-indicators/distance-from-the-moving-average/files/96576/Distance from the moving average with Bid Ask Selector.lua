...
function Init()
	...
	indicator.parameters:addString("Type", "Price Type", "Price Type", "Chart");
	indicator.parameters:addStringAlternative("Type", "Chart Select", "Chart Select" , "Chart");
	indicator.parameters:addStringAlternative("Type", "Bid", "Bid" , "Bid");
    indicator.parameters:addStringAlternative("Type", "Ask", "Ask" , "Ask");
...
function Prepare(nameOnly)
	...
	if Type== "Ask" then
    source = core.host:execute("getAskPrice");
	elseif Type== "Bid" then
	source = core.host:execute("getBidPrice");
	else
...
function Update(period,mode)
	...
	return;
	    ...
	    if Mode== "Pip" then
		Distance[period] = (source[Price][period]- ma1.DATA[period])/source:pipSize();
		else
        Distance[period] = source[Price][period]- ma1.DATA[period];
		end
