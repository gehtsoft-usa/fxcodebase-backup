...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=12322
...
function Prepare(nameOnly)
    ...
    if (not (nameOnly)) then
        Volume = instance:addStream("Volume", core.Bar, name, "Volume", instance.parameters.Color1, first +Period );
...
function Update(period)
	...
	return;
     ...
     Volume[period]  =source.volume[period] /  mathex.avg (source.volume, period- Period+1, period);
