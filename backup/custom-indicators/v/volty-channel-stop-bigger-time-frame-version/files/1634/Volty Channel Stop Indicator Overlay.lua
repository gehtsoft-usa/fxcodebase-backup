...
function Init()
    indicator:name("Volty Channel Stop Indicator Overlay");
...
function Update(period, mode)
	...
	return;
        ...
        if (HiLoB) then
			...
			open:setColor(period, instance.parameters.UpBuffer_color);
			elseif Trend[period]== -1 then
			open:setColor(period, instance.parameters.DnBuffer_color);
			else
