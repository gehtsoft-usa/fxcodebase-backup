...
function Init()
    indicator:name("Weight of Evidence with Real volume/Transactions");
    indicator:description("Weight of Evidence with Real volume/Transactions");
...
function Prepare(nameOnly)
    ...
    assert(core.indicators:findIndicator("WAD") ~= nil, "WAD" .. " indicator must be installed");
...
function Update(period,mode)
 ...
 PVT[period] = ((source.close [period] - source.close [period-1] ) / source.close[period-1]) * Ind.DATA[period] + PVT [period - 1];        
