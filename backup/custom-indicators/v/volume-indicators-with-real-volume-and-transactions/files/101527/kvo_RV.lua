...
function Init()
    indicator:name("Klinger Oscillator with Real volume/Transactions");
...
function Update(period, mode)
    ...
    if period >= first1 then
        ...
        if CM[period] == 0 then
            ...
            VF[period] = Ind.DATA[period] * math.abs(2 * DM[period] / CM[period] - 1) * trend * 100;
        end
    end
