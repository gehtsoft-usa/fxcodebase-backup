...
function Init()
    indicator:name("Elastic Volume Weighted Moving Average with Real volume/Transactions");
    indicator:description("Elastic Volume Weighted Moving Average with Real volume/Transactions");
...
function Update(period, mode)
	...
	local Total = mathex.sum(Ind.DATA, period-Period+1, period);	
	
        EVWMA[period] = ((Total-Ind.DATA[period])*EVWMA[period-1]+Ind.DATA[period]*source.close[period])/Total;
