...
function Update(period, mode)
	...
	volaValue[period] = mathex.sum( tpSeries, period-Period_Vola+1, period ) / ( Period_Vola * Dev_Factor );
	   ...
	   local devHigh = AVG1.DATA[period]; 
	   local devLow = devHigh* Low_Band_Adjust;
