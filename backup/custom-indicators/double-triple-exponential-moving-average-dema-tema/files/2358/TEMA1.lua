...
function Init()
    indicator:name("Triple Exponential Moving Average (tick version)");
    indicator:description("Unlike the TEMA.lua it allows to apply the indicator at any price series");
