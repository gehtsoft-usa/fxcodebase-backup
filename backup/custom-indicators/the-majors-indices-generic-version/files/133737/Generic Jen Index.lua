...
function Init()
	indicator:name("Generic Jen Index")
	...
	AddInstrument(1, "USD/JPY")
	AddInstrument(2, "EUR/JPY")
	AddInstrument(3, "GBP/JPY")
	AddInstrument(4, "CHF/JPY")

	indicator.parameters:addGroup("Calculation")
	indicator.parameters:addString("base_instrument", "Base Instrument", "Base Instrument", "JPY")
