...
function Init()
	indicator:name("Generic Kiwi Index")
	...
	AddInstrument(1, "USD/NOK")
	AddInstrument(2, "EUR/NOK")
	AddInstrument(3, "NOK/JPY")
	AddInstrument(4, "CHF/NOK")

	indicator.parameters:addGroup("Calculation")
	indicator.parameters:addString("base_instrument", "Base Instrument", "Base Instrument", "NOK")
