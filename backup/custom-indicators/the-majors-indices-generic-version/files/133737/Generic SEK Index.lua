...
function Init()
	...
	AddInstrument(1, "USD/SEK")
	AddInstrument(2, "EUR/SEK")
	AddInstrument(3, "SEK/JPY")
	AddInstrument(4, "CHF/SEK")

	indicator.parameters:addGroup("Calculation")
	indicator.parameters:addString("base_instrument", "Base Instrument", "Base Instrument", "SEK")
