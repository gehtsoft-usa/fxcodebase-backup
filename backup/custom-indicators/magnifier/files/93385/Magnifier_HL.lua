...
function Init()
    ...
    indicator:description("Shows detailed history in an additional window.");
    ...
    indicator.parameters:addColor("color", "Color", "", core.rgb(128, 255, 255));
...
function Draw(stage, context)
    if stage == 2 then
        ...
        if not init then
            ...
            context:createSolidBrush(7, color);
