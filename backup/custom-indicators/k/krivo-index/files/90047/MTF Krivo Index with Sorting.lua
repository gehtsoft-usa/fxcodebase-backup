...
local iCount=0;
	...
	for i = 1, 8, 1 do
		...
		iCount=iCount+1;
		 ...
		 if Rainbow then		
	 	core.host:execute("drawLabel1", id, 100+(iCount-1)*Size*4 ,  core.CR_LEFT, Size*2+ (j-1)*Size +Shift, core.CR_TOP, core.H_Left, core.V_Center, Bold,  Coloring (( 100/8)*i, 50),  Sorted[1][i]);	
        id = id+1;	
		else
		core.host:execute("drawLabel1", id, 100+(iCount-1)*Size*4 ,  core.CR_LEFT, Size*2+ (j-1)*Size +Shift, core.CR_TOP, core.H_Left, core.V_Center, Bold, Color,  Sorted[1][i]);	
        id = id+1;	
		end
	  	
	
		
			core.host:execute("drawLabel1", id, 50 ,  core.CR_LEFT              , Size*2+ (j-1)*Size +Shift , core.CR_TOP, core.H_Left, core.V_Center, Bold, Color,  TF[j]);	
			id = id+1;	
