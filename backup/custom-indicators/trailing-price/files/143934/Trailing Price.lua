...
function Init()
      indicator:name("Trailing Price");
    indicator:description("Trailing Price");
    ...
    indicator.parameters:addColor("POC", "POC Color", "", core.rgb(0, 0, 255));
 ...
 local y= core.findDate(source, e, false);
  ...
  return;
	...
	for j= x , y, 1 do	
							...
							Max=Profile[min];	
							PocMark:set(period, source [j], "\108");
	                        Signal[period]=  source [j];	
