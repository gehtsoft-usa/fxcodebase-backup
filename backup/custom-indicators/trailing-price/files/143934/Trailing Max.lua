...
function Init()
      indicator:name("Trailing Max");
    indicator:description("Trailing Max");
	...
	indicator.parameters:addString("ThePrice", "Price Source", "", "high");
    ...
    indicator.parameters:addColor("POC", "POC Color", "", core.rgb(0, 255, 0));
