...
function Prepare(nameOnly)  
    ...
    HLM = instance:addInternalStream(0, 0);
    AbsHLM = instance:addInternalStream(0, 0);
    ...
    Blau_DTI = instance:addStream("Blau_DTI", core.Bar, name .. ".Blau_DTI", "Blau_DTI", instance.parameters.clr, AbsEMA3.DATA:first());
	...
	Blau_DTI:setPrecision(math.max(2, instance.source:getPrecision()));
end
