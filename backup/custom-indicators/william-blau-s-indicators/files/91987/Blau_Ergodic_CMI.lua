...
--+------------------------------------------------------------------+
function Init()
    indicator:name("William Blau Ergodic Candlestick Momentum Index");
    indicator:description("William Blau Ergodic Candlestick Momentum Index");
...
function Prepare(nameOnly)  
    ...
    Blau_CMI = instance:addStream("Blau_CMI", core.Bar, name .. ".Blau_CMI", "Blau_CMI", instance.parameters.clr, AbsEMA3.DATA:first());
    Signal_EMA = core.indicators:create("EMA", Blau_CMI, Signal_Period);
