...
function Prepare(nameOnly)  
	...
	local name = profile:id() .. "(" .. source:name() .. ", " .. instance.parameters.Period .. ", " .. instance.parameters.Smooth_Period1 .. ", " .. instance.parameters.Smooth_Period2 .. ", " .. instance.parameters.Smooth_Period3 .. ", " .. instance.parameters.Price1 .. ", " .. instance.parameters.Price2 .. ")";
    instance:name(name);
    ...
    Blau_CMI = instance:addStream("Blau_CMI", core.Line, name .. ".Blau_CMI", "Blau_CMI", instance.parameters.clr, AbsEMA3.DATA:first());
    Blau_CMI:setWidth(instance.parameters.widthLinReg);
    Blau_CMI:setStyle(instance.parameters.styleLinReg);
    Blau_CMI:addLevel(25);
    Blau_CMI:addLevel(-25);
	
	Blau_CMI:setPrecision(math.max(2, instance.source:getPrecision()));
end
