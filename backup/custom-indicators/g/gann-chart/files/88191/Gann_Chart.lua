...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=58826
-- Id: 9640
...
function Prepare(onlyName)
    ...
    instance:createCandleGroup("GC", "GC", open, high, low, close);
    ...
    if stage == 2 then
        ...
        while true do
            ...
            if source.open[index]<=source.close[index] then
             context:setPixel(c1, po, UPcolor);
             context:drawLine(1, c2, ph, c2, pl);
             context:drawLine(1, c2, pc, x, pc);
             context:drawLine(1, c2, ph, c1, ph);
             context:drawLine(1, c2, pl, c1, pl);
            else
             context:setPixel(c1, po, DNcolor);
             context:drawLine(2, c2, ph, c2, pl);
             context:drawLine(2, c2, pc, x, pc);
             context:drawLine(2, c2, ph, c1, ph);
             context:drawLine(2, c2, pl, c1, pl);
	    end 
