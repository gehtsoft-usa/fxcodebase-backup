...
function Init()
    indicator:name("Generic Five Line Indicator Cross");
	...
	Parameters (4, "1./5. Line Cross");	
	Parameters (5, "2./3. Line Cross");	
	Parameters (6, "2./4. Line Cross");	
	Parameters (7, "2./5. Line Cross");	
	Parameters (8, "3./4. Line Cross");		
	Parameters (9, "3./5. Line Cross");			
end
...
Fifth_Line:setColor(period,instance.parameters.color53);   
													...
													if INDEX1[period]>  INDEX2[period] 
														...
														if INDEX1[period]>  INDEX5[period] 
														and  INDEX1[period-1]<=  INDEX5[period-1] 
														then
														Signal[4][period]=1;													
														elseif  INDEX1[period]<  INDEX5[period]
														and  INDEX1[period-1]>=  INDEX5[period-1] 
														then
														Signal[4][period]=-1;		
														else
														...
														if INDEX2[period]>  INDEX5[period] 
														and  INDEX2[period-1]<=  INDEX5[period-1] 
														then
														Signal[7][period]=1;													
														elseif  INDEX2[period]<  INDEX5[period]
														and  INDEX2[period-1]>=  INDEX5[period-1] 
														then
														Signal[7][period]=-1;		
														else
														...
														if INDEX3[period]>  INDEX5[period] 
														and  INDEX3[period-1]<=  INDEX5[period-1] 
														then
														Signal[9][period]=1;													
														elseif  INDEX3[period]<  INDEX5[period]
														and  INDEX3[period-1]>=  INDEX5[period-1] 
														then
														Signal[9][period]=-1;		
														else
