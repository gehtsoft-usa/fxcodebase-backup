...
function Init()
    indicator:name("Generic Five Line Price Cross Indicator");
	...
	Parameters (2, "2. Line Cross");	
	Parameters (3, "3. Line Cross");	
	Parameters (4, "4. Line Cross");	
	Parameters (5, "5. Line Cross");	
...
Fifth_Line:setColor(period,instance.parameters.color53);   
														...
														and  source.close[period-1]<=  INDEX2[period-1] 
														then
														Signal[2][period]=1;													
														...
														and  source.close[period-1]<=  INDEX3[period-1] 
														then
														Signal[3][period]=1;													
														...
														and  source.close[period-1]<=  INDEX4[period-1] 
														then
														Signal[4][period]=1;													
														...
														and  source.close[period-1]<=  INDEX5[period-1] 
														then
														Signal[5][period]=1;													
	...
	for i= 1, 5 , 1 do
			if i== 1 then
			Activate (i, period,INDEX1[period] );   
			elseif i== 2 then
			Activate (i, period,INDEX2[period] );
			elseif i== 3 then
			Activate (i, period,INDEX3[period] );	
			elseif i== 4 then
			Activate (i, period,INDEX5[period] );	
			elseif i== 5 then
			Activate (i, period,INDEX3[period] ); 
			end
    end
