...
function Init()
    indicator:name("ADX ROC Oscillator");
...
function Prepare(nameOnly)
	...
	Value = instance:addStream("Value", core.Bar, name, "Value", core.rgb(0, 0, 0), first)
