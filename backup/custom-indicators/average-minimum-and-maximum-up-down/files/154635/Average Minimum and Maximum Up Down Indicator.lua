...
function Init()
    indicator:name("Average Minimum and Maximum Up Down Indicator");
    ...
    indicator.parameters:addInteger("Shift", "Shift", "", 3 ); 
...
-- Routine
 function Prepare(nameOnly)   
    ...
    local name = profile:id() .. "(" ..  instance.source:name().. "," ..  Period .. "," ..  Multiplier .. "," ..  Shift  .. ")";
    instance:name(name); 
    ...
    UpMax = instance:addStream("UpMax", core.Line, name, "Up Max", instance.parameters.color1, first+Period, Shift );
    ...
    UpMin = instance:addStream("UpMin", core.Line, name, "Up Min", instance.parameters.color1, first+Period, Shift );
    ...
    UpAverage = instance:addStream("UpAverage", core.Dot, name, "Up Average", instance.parameters.color1, first+Period, Shift );
    ...
    DownMax = instance:addStream("DownMax", core.Line, name, "Down Max", instance.parameters.color2, first+Period, Shift );
    ...
    DownMin = instance:addStream("DownMin", core.Line, name, "Down Min", instance.parameters.color2, first+Period, Shift );
    ...
    DownAverage = instance:addStream("DownAverage", core.Dot, name, "Down Average", instance.parameters.color2, first+Period, Shift );
...
function Update(period, mode)
	...
	local Difference= source.close[period] - source.close[period-1];
	...
	UpMax[period+Shift]=source.open[period] + MaxUp*Multiplier;
	UpAverage[period+Shift]=source.open[period] +AverageUp*Multiplier;
	DownMax[period+Shift]=source.open[period] + MaxDown*Multiplier;
	DownAverage[period+Shift]=source.open[period] +AverageDown*Multiplier;	
	UpMin[period+Shift]=source.open[period] +MinUp*Multiplier; 	
	DownMin[period+Shift]=source.open[period] +MinDown*Multiplier; 
