-- Available @ https://fxcodebase.com/code/viewtopic.php?f=17&t=74882
...
function Init()
    indicator:name("Intraday Momentum Strategy Indicator");
...
function Update(period, mode)
	...
	local  stdev= mathex.stdev(source.close, period-Period+1, period);
 	
	Top[period]=source.open[period]+ (stdev*Multiplier);
	Bottom[period]=source.open[period] - (stdev*Multiplier);
