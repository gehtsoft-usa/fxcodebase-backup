...
function Update(period, mode)
    ...
    local g_alpha   = gamma -math.sqrt(gamma*gamma-1.0);
     ...
     Line[period] =  0.5*(1.0-g_alpha)*(source[inpPrice][period]-source[inpPrice][period-2] )+g_beta*(1.0+g_alpha)*Line[period-1] -g_alpha*Line[period-2];
