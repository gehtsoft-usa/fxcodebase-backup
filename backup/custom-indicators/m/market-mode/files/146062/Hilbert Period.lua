...
-- Routine
 function Prepare(nameOnly)   
	...
	Period = instance:addStream("Period" , core.Line, " Period"," Period",instance.parameters.color, first);
	Period:setWidth(instance.parameters.width);
    Period:setStyle(instance.parameters.style);
    Period:setPrecision(math.max(2, source:getPrecision()));
