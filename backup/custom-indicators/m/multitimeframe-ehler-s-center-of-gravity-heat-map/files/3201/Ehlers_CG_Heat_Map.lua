...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=1617
...
--+------------------------------------------------------------------+
 ...
 function Add(id, TF,Flag, Instrument ,P1, P2)
	...
	indicator.parameters:addInteger("N" .. id, "Length " .. id .. " parameter", "", P1);
    indicator.parameters:addDouble("Level" .. id, "Level value " .. id .. " parameter", "", P2);
...
function Init()
    indicator:name("Multitimeframe Ehlers Heat Map");
    ...
    Add(1, "m1",  "Off", "EUR/USD", 10, 0); 
    Add(2, "m5",  "Off", "USD/JPY", 10, 0); 
    Add(3, "m15",  "Off", "GBP/USD", 10, 0); 
    Add(4, "m30",  "Off", "USD/CHF", 10, 0); 
    Add(5, "H1",  "Off", "EUR/CHF", 10, 0); 
    Add(6, "H2", "View", "AUD/USD", 10, 0); 
    Add(7, "H3",  "Off", "USD/CAD", 10, 0); 
    Add(8, "H4", "View", "NZD/USD", 10, 0 ); 
    Add(9, "H6",  "Off", "NZD/USD" , 10, 0); 
    Add(10, "H8", "View", "EUR/JPY", 10, 0); 
    Add(11, "D1",  "Off", "GBP/JPY", 10, 0); 
    Add(12, "W1",  "Off", "CHF/JPY", 10, 0); 
    Add(13, "M1",  "Off", "GBP/CHF", 10, 0);
	...
	s2, e2 = core.getcandle(iTF[i], 0, 0, 0);
	 ...
	 Label[Number]="";
                ...
                Label[Number]=Label[Number] .. " - " ..  TF[Number];				
			  	...
			  	Temp1= core.indicators:create("EHLERS_CG", source ,  N[Number]);  				
				ifirst=  Temp1.Buff2:first()*2;
				 ...
				 loading[Number]  = true;  	 
				 Indicator[Number] = core.indicators:create("EHLERS_CG", SourceData[Number] , N[Number]);   
			   ...
			   x0, x1, x2 = context:positionOfBar (i);
			    ...
			    for j= 1, Number , 1 do
				  ...
				  if p~= false then
										...
										if Indicator[j].Buff2:hasData(p)  then 
										
												   
																									
												 if Indicator[j].Buff1[p] > Indicator[j].Buff2[p] then
												
													if Indicator[j].Buff1[p] > Level[j] then
													 C1=11; C2=12;	
													else
													 C1=21; C2=22;	
													end
