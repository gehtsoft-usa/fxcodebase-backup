...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=18236
...
function Init()
    indicator:name("MTF MCP Linear Regression Slope Heat Map");
	...
	indicator.parameters:addColor("UpDown", "Neutral Trend Color","", core.rgb(128, 128, 128)); 
	...
	s2, e2 = core.getcandle(iTF[i], 0, 0, 0);
	 ...
	 Label[Number]="";
                ...
                Label[Number]=Label[Number] .. " - " ..  TF[Number];				
			  	...
			  	Temp1= core.indicators:create("LRS", source ,  Period[Number]);  				
				ifirst= Temp1.DATA:first()*2;
				 ...
				 loading[Number]  = true;  	 
				 Indicator[Number] = core.indicators:create("LRS", SourceData[Number] ,  Period[Number]);   
...
function Draw (stage, context)
   ...
   context:setClipRectangle(context:left(), context:top(), context:right(), context:bottom());
        ...
        if not init then
			...
			context:createPen (31, context.SOLID, 1, DownDown)       
			context:createSolidBrush(32, DownDown);
