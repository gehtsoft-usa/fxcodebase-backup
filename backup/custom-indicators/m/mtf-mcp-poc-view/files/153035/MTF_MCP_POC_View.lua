...
function Prepare(nameOnly)
    ...
    local box_size_type = instance.parameters.box_size_type;
    local bars_limit = instance.parameters.bars_limit;
        ...
        for i = 1, Count, 1 do
           ...
           -- Status[i] = {}
            ...
            for j = 1, Num, 1 do
                ...
                loading[i][j] = true
                Indicator[i][j] = core.indicators:create("VPOC", Source[i][j], BoxSize, box_size_type, bars_limit)
            end
        end
    end
