...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=36268
-- Id: 9100
...
function Prepare(nameOnly)
    ...
    local name = profile:id() .. "(" .. source:name() .. ", " .. instance.parameters.MA_Period .. ", " .. instance.parameters.K_Period .. ")";
    instance:name(name);
    if nameOnly then
        return;
    end
    ...
    Pbuff = instance:addStream("Pbuff", core.Line, name .. ".Pbuff", "Pbuff", instance.parameters.UPclr, first+K_Period);
    Pbuff:setPrecision(math.max(2, instance.source:getPrecision()));
    Mbuff = instance:addStream("Mbuff", core.Line, name .. ".Mbuff", "Mbuff", instance.parameters.UPclr, first+K_Period);
    ...
    Pbuff:addLevel(-100, instance.parameters.Lstyle, instance.parameters.Lwidth, instance.parameters.Levelclr);
    Ubuff = instance:addStream("Ubuff", core.Dot, name .. ".Ubuff", "Ubuff", instance.parameters.Uclr, first+K_Period);
    Ubuff:setPrecision(math.max(2, instance.source:getPrecision()));
    Lbuff = instance:addStream("Lbuff", core.Dot, name .. ".Lbuff", "Lbuff", instance.parameters.Lclr, first+K_Period);
...
function Update(period, mode)
    ...
    SMA_Value[Count[0]]=MA1.DATA[period]
    EMA_Value[Count[0]]=MA2.DATA[period]
