...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=19194
...
function Init()
    indicator:name("MIDAS");
    indicator:description("MIDAS");
...
function Update(period)
    ...
    return;
			...
			CumVol[period]=CumVol[period-1]+source.volume[period];
			 CumPVol[period]=CumPVol[period-1]+source.volume[period]*AvgPrice[period];  
