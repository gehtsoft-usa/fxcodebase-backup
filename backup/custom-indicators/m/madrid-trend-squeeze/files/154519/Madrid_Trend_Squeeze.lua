...
function Prepare(nameOnly)
    ...
    plot4_open = instance:addStream("plot4_open", core.Line, "Open", "Open", core.colors().Black, 0, 0);
    plot4_high = instance:addStream("plot4_high", core.Line, "High", "High", core.colors().Black, 0, 0);
    plot4_low = instance:addStream("plot4_low", core.Line, "Low", "Low", core.colors().Black, 0, 0);
    plot4_close = instance:addStream("plot4_close", core.Line, "Close", "Close", core.colors().Black, 0, 0);
