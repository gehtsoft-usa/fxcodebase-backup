...
function Init()
    indicator:name("Multiple Timeframe Stochastic");
...
-- Routine
 function Prepare(nameOnly)   
	...
	assert(core.indicators:findIndicator("RAW_STOCHASTIC") ~= nil, "Please, download and install RAW_STOCHASTIC.LUA indicator");
	...
	for i= 1, 6, 1 do
	 ...
	 s2, e2 = core.getcandle(TF[i], 0, 0, 0);
			...
			Indicator[Number] = core.indicators:create("RAW_STOCHASTIC", Source[Number], Period);
			end
	end
