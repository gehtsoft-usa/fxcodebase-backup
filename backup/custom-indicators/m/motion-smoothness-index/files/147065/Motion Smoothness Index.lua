...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=72623
...
function Init()
    indicator:name("Motion Smoothness Index");
...
function Update(period, mode)
	...
	Line[period]= mathex.stdev(Change, period-Period+1, period)/mathex.stdev(source, period-Period+1, period);
