...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=73101
...
function Init()
    indicator:name("Moving Average Weighted, Volume Adjusted");
...
function Update(period, mode)
	 ...
	 return;
		...
		local vol = 0.0
		for m = 1 , Period, 1 do  
		 vol = vol + source.volume[period-Period+m] * m
		 sum = sum + source.median[period-Period+m] * source.volume[period-Period+m] * m;
		end
