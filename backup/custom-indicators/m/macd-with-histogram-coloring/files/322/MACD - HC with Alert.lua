...
local Alert_Name={ "MACD/Signal Line" ,"MACD/Signal Line", "Histogram Color" ,"Histogram Color"};
local Signal_Name={"Cross Over", "Cross Under", "Up Color", "Down Color"};
--//////////////////////////////////////////////////////////////////////////////
--\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
...
--indicator.parameters:addBoolean("Show_Unconfirmed", "Show Unconfirmed Signals", "", false);
	...
	local Color={};
	Color[1]= core.rgb(0, 0, 255);
	Color[2]= core.rgb(0, 0, 255);
...
function Signal_Logic (id, period)
	    ...
	    if id== 1  then   
			...
			then
                ...
                Alert[id][period]= 1;	
 				AlertLevel[id][period]= SIGNAL[period]
	    ...
	    if id== 3  then   
			...
			and ( HISTOGRAM[period-1] <= HISTOGRAM[period - 2]) 
			then
			...
			elseif( HISTOGRAM[period] < HISTOGRAM[period - 1]) 
            then			
			--We will reset CrossOver Alert 
...
function AsyncOperationFinished (cookie, success, message)
	...
	Last_Period=Last_Period-1;	 
     ...
     if Last_Period < firstPeriodSIGNAL + 2
	 or Last_Period < 0
	 then
	 return;
	 end
