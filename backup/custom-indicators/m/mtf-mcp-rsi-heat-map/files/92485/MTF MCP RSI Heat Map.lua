...
--http://fxcodebase.com/code/viewtopic.php?f=17&t=60277
...
--+------------------------------------------------------------------+
 ...
 function Add(id, TF,Flag, Instrument )
	...
	indicator.parameters:addString("Method".. id, "RSI Method", "RSI Method" , "Slope");
    indicator.parameters:addStringAlternative("Method".. id, "Slope", "Slope" , "Slope");
    indicator.parameters:addStringAlternative("Method".. id, "Central Line Position", "Central Line Position" , "Central Line Position");
	indicator.parameters:addStringAlternative("Method".. id, "RSI Value", "RSI Value" , "RSI Value"); 
...
function Init()
    indicator:name("MTF MCP RSI Heat Map");
	...
	s2, e2 = core.getcandle(iTF[i], 0, 0, 0);
	 ...
	 Label[Number]="";
                ...
                Label[Number]=Label[Number] .. " - " ..  TF[Number];				
			  	...
			  	Temp1= core.indicators:create("RSI", source[Price[Number]] ,  Period[Number]);  				
				ifirst= Temp1.DATA:first()*2;
				 ...
				 loading[Number]  = true;  	 
				 Indicator[Number] = core.indicators:create("RSI", SourceData[Number][Price[Number]]  ,  Period[Number]);   
...
function Draw (stage, context)
   ...
   context:setClipRectangle(context:left(), context:top(), context:right(), context:bottom());
        ...
        if not init then
			...
			context:createPen (21, context.SOLID, 1, DownDown)       
			context:createSolidBrush(22, DownDown);
			    ...
			    for j= 1, Number , 1 do
				  ...
				  if p~= false then
										...
										if Indicator[j].DATA:hasData(p) and Indicator[j].DATA:hasData(p-1) then 
												   ...
												   if Method[j] == "Slope" then  
													if Indicator[j].DATA[p] >Indicator[j].DATA[p-1] then
													      C1= 11;
														  C2= 12;
													elseif Indicator[j].DATA[p] < Indicator[j].DATA[p-1] then
													      C1= 21;
														  C2= 22;
													else
													       C1= 31;
												  ...
												  elseif Method[j] == "Central Line Position" then  
												  
															if Indicator[j].DATA[p] >  50 then
															   C1= 11;
														       C2= 12;
															elseif Indicator[j].DATA[p] <50 then
															    C1= 21;
														       C2= 22;
															else
															    C1= 31;
														  ...
														  Coloring (context, Indicator[j].DATA[p], 50); 
														  C1= 51;
														  C2= 52;
												  end				  
