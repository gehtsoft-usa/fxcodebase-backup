...
function Init()
    indicator:name("MTF MCP ZIGZAG HEAT MAP");
...
function Prepare(nameOnly) 
	...
	s2, e2 = core.getcandle(iTF[i], 0, 0, 0);
	 ...
	 Number=Number+1;
		 ...
		 Depth[Number]= instance.parameters:getInteger("Depth" .. i);
		 Deviation[Number]= instance.parameters:getInteger("Deviation" .. i);
		 Backstep[Number]= instance.parameters:getInteger("Backstep" .. i);
	 ...
	 Label[Number]="";
                ...
                Label[Number]=Label[Number] .. " - " ..  TF[Number];				
				 ...
				 loading[Number]  = true;  	 
				 Indicator[Number] = core.indicators:create("ZIGZAG", SourceData[Number] ,   Depth[Number], Deviation[Number],Backstep[Number], Up, Down);   
