...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=32957
	...
	s2, e2 = core.getcandle(iTF[i], 0, 0, 0);
	 ...
	 Label[Number]="";
                ...
                Label[Number]=Label[Number] .. " - " ..  TF[Number];				
				 ...
				 loading[Number]  = true;  	 
				 Indicator[Number] = core.indicators:create("INSYNC", SourceData[Number] ,
				 instance.parameters.B1,instance.parameters.B2, instance.parameters.MFI1, instance.parameters.C1, instance.parameters.R1, instance.parameters.S1, instance.parameters.S2, instance.parameters.S3,
				 instance.parameters.E1, instance.parameters.M1, instance.parameters.M2, instance.parameters.M3, instance.parameters.M4, instance.parameters.ROC1, instance.parameters.ROC2);   
			     MA[Number] = core.indicators:create(instance.parameters.MA_Method, Indicator[Number].DATA, instance.parameters.MA_Period);
