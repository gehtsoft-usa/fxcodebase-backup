...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=69690
   ...
   Alert[id][period]=0;
	...
	--"HA Trend Change (without wicks) First only"
	  ...
	  if id == 1  and ON[id]  then
			...
			and   HA.close[period-1] <= HA.open[period-1] 
			then
			...
			if  HA.close[period] > HA.open[period]   
			and  HA.open[period] == HA.low[period] 
			then
			...
			elseif  HA.close[period] < HA.open[period]  
			and  HA.open[period] == HA.high[period] 
            then			
	  ...
	  if id == 3  and ON[id]  then
			...
			then
                ...
                if HA.open[period] == HA.low[period] 
				and  Trend[period]~=1 
				then
            ...
            then			
				        ...
				        if  HA.open[period] == HA.high[period] 
			            and  Trend[period]~=-1 
			            then			 
			                Alert[id][period]= -1;	
							AlertLevel[id][period]= HA.high[period] 
