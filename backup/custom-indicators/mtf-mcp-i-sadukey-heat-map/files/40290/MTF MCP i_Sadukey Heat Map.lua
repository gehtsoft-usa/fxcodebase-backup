...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=23404
...
function Init()
    indicator:name("MTF MCP i_Sadukey Heat Map");
...
local Indicator = {} ;
 ...
 function Prepare(nameOnly)   
   ...
   assert(core.indicators:findIndicator("I_SADUKEY") ~= nil, "Please, download and install I_SADUKEY.LUA indicator");    
	...
	s2, e2 = core.getcandle(iTF[i], 0, 0, 0);
	 ...
	 Label[Number]="";
                ...
                Label[Number]=Label[Number] .. " - " ..  TF[Number];				
			  	...
			  	Temp1= core.indicators:create("I_SADUKEY", source, true );  				
				ifirst= Temp1.DATA:first()*2;
				 ...
				 loading[Number]  = true;  	 
				 Indicator[Number] = core.indicators:create("I_SADUKEY", SourceData[Number], true, core.rgb(0, 255, 0),  core.rgb(255, 0, 0) );   
			    ...
			    for j= 1, Number , 1 do
				  ...
				  if p~= false then
										...
										if Indicator[j].DATA:hasData(p)  then 
										          if Indicator[j].DATA:colorI(p) ==  core.rgb(0, 255, 0) then
												  
															C2=12;
															C1=11;
															 	
												 
												    elseif Indicator[j].DATA:colorI(p) ==  core.rgb(255, 0, 0) then 
