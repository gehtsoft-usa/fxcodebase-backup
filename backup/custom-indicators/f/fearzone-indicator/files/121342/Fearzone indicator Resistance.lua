...
function Init()
    indicator:name("Fearzone indicator Resistance");
...
function Update(period, mode)
    ...
    FZ1[period]=(source.close[period]-min)/min;
    ...
    high[period]=source.high[period]+ 2*Range;
	low[period]=source.high[period]+Range;	
	open[period]=source.high[period]+Range;
	close[period]=source.high[period]+2*Range; 
	else
	high[period]=nil;
	low[period]=nil;
	open[period]=nil;
