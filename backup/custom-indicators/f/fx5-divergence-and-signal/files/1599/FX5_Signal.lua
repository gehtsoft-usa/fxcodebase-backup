...
function Init()
    strategy:name("FX5 Divergence");
	strategy:setTag("NonOptimizableParameters", "Email,SendEmail,SoundFile,RecurrentSound,PlaySound,ShowAlert");
    strategy:description("Signals when the FX5 Divergence detected");
...
function ExtUpdate(id, source, period)
    ...
    assert(core.indicators:findIndicator("FX5") ~= nil, "FX5" .. " indicator must be installed");
        MACD = core.indicators:create("FX5", gSource, instance.parameters.MACD_Short,instance.parameters.MACD_Long,instance.parameters.MACD_Signal, false);
    end
