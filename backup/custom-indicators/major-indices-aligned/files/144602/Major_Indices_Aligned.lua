...
--https://fxcodebase.com/code/viewtopic.php?f=17&t=71754
...
{ 
    {
        ...
        UpCondition = function (period)
            ...
            for i, src in ipairs(sources.items) do
                local index = core.findDate(src, source:date(period), true);
                if index < 0 then
                    return false;
                end
                if src.close[index] <= src.open[index] then
                    return false;
                end
            end
            return true;
...
function Init()
    indicator:name("Major Indices Aligned");
    indicator:description("");
    indicator:requiredSource(core.Bar);
    indicator:type(core.Indicator);
    
    indicator.parameters:addString("instr_2", "Instrument #2", "", "NAS100");
    indicator.parameters:setFlag("instr_2", core.FLAG_INSTRUMENTS);
    indicator.parameters:addString("instr_3", "Instrument #3", "", "SPX500");
    indicator.parameters:setFlag("instr_3", core.FLAG_INSTRUMENTS);
    indicator.parameters:addString("instr_4", "Instrument #4", "", "US2000");
    indicator.parameters:setFlag("instr_4", core.FLAG_INSTRUMENTS);
    indicator.parameters:addString("instr_5", "Instrument #5", "", "US30");
    indicator.parameters:setFlag("instr_5", core.FLAG_INSTRUMENTS);
    indicator.parameters:addString("instr_6", "Instrument #6", "", "UK100");
    indicator.parameters:setFlag("instr_6", core.FLAG_INSTRUMENTS);	
...
function Prepare(nameOnly)
    ...
    sources:Request(2, source, nil, nil, instance.parameters.instr_2);
    sources:Request(3, source, nil, nil, instance.parameters.instr_3);
    sources:Request(4, source, nil, nil, instance.parameters.instr_4);
    sources:Request(5, source, nil, nil, instance.parameters.instr_5);
    sources:Request(6, source, nil, nil, instance.parameters.instr_6);	
end
