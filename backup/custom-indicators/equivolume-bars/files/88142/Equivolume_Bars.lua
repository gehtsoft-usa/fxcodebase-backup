...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=58798
-- Id: 9632
...
function Init()
    indicator:name("Equivolume bars");
    indicator:description("Builds the bars with the same volume.");
    ...
    indicator.parameters:addInteger("Volume", "Volime in each bar", "", 2000);
