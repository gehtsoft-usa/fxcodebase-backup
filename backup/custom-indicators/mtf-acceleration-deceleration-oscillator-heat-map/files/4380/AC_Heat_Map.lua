...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=2126
...
function Init()
    indicator:name("MTF MCP AC Heat Map");
	...
	s2, e2 = core.getcandle(iTF[i], 0, 0, 0);
	 ...
	 Label[Number]="";
                ...
                Label[Number]=Label[Number] .. " - " ..  TF[Number];				
			  	...
			  	Temp1= core.indicators:create("AC", source ,  FM[Number],SM[Number],M[Number]);  				
				ifirst= Temp1.DATA:first()*2;
				 ...
				 loading[Number]  = true;  	 
				 Indicator[Number] = core.indicators:create("AC", SourceData[Number] , FM[Number],SM[Number],M[Number]);   
