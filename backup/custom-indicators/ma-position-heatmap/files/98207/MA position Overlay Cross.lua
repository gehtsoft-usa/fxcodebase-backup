...
function Init()
    indicator:name("MA position Overlay");
...
function Update(period, mode)
   ...
   return;
		   ...
		   if core.crossesOver (  Indicator[1].DATA ,Indicator[3].DATA, period) then
		   Number[period]=1;
		   elseif core.crossesUnder (  Indicator[1].DATA ,Indicator[3].DATA, period) then
		   Number[period]= -1;
		   end
		   
		   if  core.crossesUnder (  Indicator[1].DATA ,Indicator[2].DATA, period) then
		    Number[period]= 0;
