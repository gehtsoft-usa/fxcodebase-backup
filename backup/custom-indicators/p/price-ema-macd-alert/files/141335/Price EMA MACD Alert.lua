...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=71008
...
function Init()
	...
	indicator.parameters:addInteger("P1", "Short Period", "", 12, 1, 2000);
	indicator.parameters:addInteger("P2", "Long Period", "", 26, 1, 2000);
	indicator.parameters:addInteger("P3", "Signal Period", "", 9, 1, 2000);
...
function Update(period, mode) 
	...
	then
    Signal[period]=1;
	elseif source[period]< MA.DATA[period]
	and MACD.MACD[period]< MACD.SIGNAL[period]	
	and MACD.MACD[period-1]>= MACD.SIGNAL[period-1]	
	and  MACD.MACD[period]> 0
    then	
	...
	return;
	    ...
	    if id== 1  then   
			...
			then
                ...
                Alert[id][period]= 1;	
 				AlertLevel[id][period]= MA.DATA[period] 
