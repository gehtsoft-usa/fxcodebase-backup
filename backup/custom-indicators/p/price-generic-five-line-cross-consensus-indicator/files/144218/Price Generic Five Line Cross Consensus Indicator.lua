...
-- https://fxcodebase.com/code/viewtopic.php?f=17&p=144198#p144198
...
function Init()
    indicator:name("Price Generic Five Line Cross Consensus Indicator");
	...
	indicator.parameters:addBoolean("Use2", "Use 2. Line", "", false);		
	...
	indicator.parameters:addBoolean("Use3", "Use 3. Line", "", false);	
	...
	indicator.parameters:addBoolean("Use4", "Use 4. Line", "", false);	
	...
	indicator.parameters:addGroup("5. Indicator Selection");	
	indicator.parameters:addBoolean("Use5", "Use 5. Line", "", false);		
	indicator.parameters:addString("INDICATOR5", "Indicator", "", "");
    indicator.parameters:setFlag("INDICATOR5",core.FLAG_INDICATOR);
	indicator.parameters:addInteger("Number5", "Data Stream Number", "", 1, 1 , 100);
	
    
	indicator.parameters:addGroup("1.Line Style");  
	indicator.parameters:addColor("color11", "Up Line Color", "", core.rgb(0, 255, 0));
	indicator.parameters:addColor("color12", "Down Line Color", "", core.rgb(255, 0, 0));
	indicator.parameters:addColor("color13", "Neutral Line Color", "", core.rgb(0, 0, 255));
    indicator.parameters:addInteger("width1", "Line width", "", 1, 1, 5);
    indicator.parameters:addInteger("style1", "Line style", "", core.LINE_SOLID);
    indicator.parameters:setFlag("style1", core.FLAG_LINE_STYLE);
    
	indicator.parameters:addGroup("2.Line Style");
	indicator.parameters:addColor("color21", "Up Line Color", "", core.rgb(0, 255, 0));
	indicator.parameters:addColor("color22", "Down Line Color", "", core.rgb(255, 0, 0));
	indicator.parameters:addColor("color23", "Neutral Line Color", "", core.rgb(0, 0, 255));
	...
	indicator.parameters:addColor("color31", "Up Line Color", "", core.rgb(0, 255, 0));
	indicator.parameters:addColor("color32", "Down Line Color", "", core.rgb(255, 0, 0));
	indicator.parameters:addColor("color33", "Neutral Line Color", "", core.rgb(0, 0, 255));	
	...
	indicator.parameters:addColor("color41", "Up Line Color", "", core.rgb(0, 255, 0));
	indicator.parameters:addColor("color42", "Down Line Color", "", core.rgb(255, 0, 0));
	indicator.parameters:addColor("color43", "Neutral Line Color", "", core.rgb(0, 0, 255));	
	indicator.parameters:addInteger("width4", "Line width", "", 4, 1, 5);
    indicator.parameters:addInteger("style4", "Line style", "", core.LINE_SOLID);
    indicator.parameters:setFlag("style4", core.FLAG_LINE_STYLE);

	indicator.parameters:addGroup("5.Line Style");
	indicator.parameters:addColor("color51", "Up Line Color", "", core.rgb(0, 255, 0));
	indicator.parameters:addColor("color52", "Down Line Color", "", core.rgb(255, 0, 0));
	indicator.parameters:addColor("color53", "Neutral Line Color", "", core.rgb(0, 0, 255));	
	indicator.parameters:addInteger("width5", "Line width", "", 5, 1, 5);
...
local Use={};
local First_Line,Second_Line, Third_Line,Fourth_Line,Fifth_Line;
function Prepare(nameOnly)
    ...
    INDICATOR5=instance.parameters.INDICATOR5;    
   	Number5=instance.parameters.Number5;
	Number5=Number5-1;	
	...
	Signal[i]= instance:addInternalStream(0, 0);	 
		...
		local iprofile5 = core.indicators:findIndicator(instance.parameters:getString("INDICATOR5"));
		local iparams5 = instance.parameters:getCustomParameters("INDICATOR5");
		...
		if  iprofile5:requiredSource() == core.Tick then			
			Indicator5 = iprofile5:createInstance( source.close, iparams5);
		else
			Indicator5 = iprofile5:createInstance(source, iparams5);
		end
	 ...
	 Count5= Indicator5:getStreamCount ();
    ...
    if Number5 >= Count5 then
	 Number5 = Count5;
	  assert( false, "Incorrect index of stream. The indicator has only ".. Count5  .. " stream(s).");
	 end	
	...
	INDEX5=  Indicator5:getStream (Number5);		
 
    Indicator_FIRST=math.max(INDEX1:first(),INDEX2:first(),INDEX3:first(),INDEX4:first(),INDEX5:first() );
   
     First_Line = instance:addStream("First_Line", core.Line, "First_Line", "First_Line", instance.parameters.color11, Indicator_FIRST);
	 First_Line:setWidth(instance.parameters.width1);
     First_Line:setStyle(instance.parameters.style1);
	 
	 
	 if Use[2] then
	 Second_Line = instance:addStream("Second_Line", core.Line, "Second_Line", "Second_Line", instance.parameters.color21, Indicator_FIRST);	 
	 Second_Line:setWidth(instance.parameters.width2);
     Second_Line:setStyle(instance.parameters.style2);
	 else
     Second_Line =instance:addInternalStream(0, 0);	 
	 end

	 if Use[3] then	 
	 Third_Line = instance:addStream("Third_Line", core.Line, "Third_Line", "Third_Line", instance.parameters.color31, Indicator_FIRST);	 
	 Third_Line:setWidth(instance.parameters.width3);
     Third_Line:setStyle(instance.parameters.style3);
	 else
     Third_Line =instance:addInternalStream(0, 0);	 
	 end
	 
	 if Use[4] then	 
	 Fourth_Line = instance:addStream("Fourth_Line", core.Line, "Fourth_Line", "Fourth_Line", instance.parameters.color41, Indicator_FIRST);	 
	 Fourth_Line:setWidth(instance.parameters.width4);
     Fourth_Line:setStyle(instance.parameters.style4);
	 else
     Fourth_Line =instance:addInternalStream(0, 0);	 
	 end
	 
	 if Use[5] then	 
	 Fifth_Line = instance:addStream("Fifth_Line", core.Line, "Fifth_Line", "Fifth_Line", instance.parameters.color51, Indicator_FIRST);	 
	 Fifth_Line:setWidth(instance.parameters.width5);
     Fifth_Line:setStyle(instance.parameters.style5);
	 else
     Fifth_Line =instance:addInternalStream(0, 0);	 
	 end
...
function Update(period, mode)
   ...
   Fifth_Line[period]=INDEX5[period];   	


if First_Line[period]> First_Line[period-1] then
First_Line:setColor(period, instance.parameters.color11); 
elseif First_Line[period]< First_Line[period-1] then
First_Line:setColor(period,instance.parameters.color12);  
else
First_Line:setColor(period,instance.parameters.color12);  
end		
...
if Use[2] then	 
if Second_Line[period]> Second_Line[period-1] then
Second_Line:setColor(period, instance.parameters.color21); 
elseif Second_Line[period]< Second_Line[period-1] then
Second_Line:setColor(period,instance.parameters.color22);  
else
Second_Line:setColor(period,instance.parameters.color23);
end	
end

if Use[3] then	 
if Third_Line[period]> Third_Line[period-1] then
Third_Line:setColor(period, instance.parameters.color31); 
elseif Third_Line[period]< Third_Line[period-1] then
Third_Line:setColor(period,instance.parameters.color32);
else
Third_Line:setColor(period,instance.parameters.color33);  
end	
end

if Use[4] then	 
if Fourth_Line[period]> Fourth_Line[period-1] then
Fourth_Line:setColor(period, instance.parameters.color41); 
elseif Fourth_Line[period]< Fourth_Line[period-1] then
Fourth_Line:setColor(period,instance.parameters.color42);
else  
Fourth_Line:setColor(period,instance.parameters.color43);
end	
end


if Use[5] then	 
if Fifth_Line[period]> Fifth_Line[period-1] then
Fifth_Line:setColor(period, instance.parameters.color51); 
elseif Fifth_Line[period]< Fifth_Line[period-1] then
Fifth_Line:setColor(period,instance.parameters.color52); 
else
Fifth_Line:setColor(period,instance.parameters.color53);   
end	
end
													    ...
													    if source.close[period]>  INDEX1[period] 
														and  source.close[period-1]<=  INDEX1[period-1] 
														then
														Signal[1][period]=1;													
														elseif  source.close[period]<  INDEX1[period]
														and  source.close[period-1]>=  INDEX1[period-1] 
														then
														Signal[1][period]=-1;		
														else
	                                                    ...
	                                                    if Use[2] then	 				                             
                                                        if source.close[period]>  INDEX2[period]  
														then
														Signal[2][period]=1;													
														elseif  source.close[period]<  INDEX2[period] 
														then
														Signal[2][period]=-1;		
														else
														Signal[2][period]=0;		
	                                                    ...
	                                                    if Use[3] then														
														if source.close[period]>  INDEX3[period]  
														then
														Signal[3][period]=1;													
														elseif  source.close[period]<  INDEX3[period] 
														then
														Signal[3][period]=-1;		
														else
														Signal[3][period]=0;		
	                                                    ...
	                                                    if Use[4] then														
														if source.close[period]>  INDEX4[period]  
														then
														Signal[4][period]=1;													
														elseif  source.close[period]<  INDEX4[period] 
														then
														Signal[4][period]=-1;		
														else
														Signal[4][period]=0;		
	                                                    ...
	                                                    if Use[5] then														
														if source.close[period]>  INDEX5[period]  
														then
														Signal[5][period]=1;													
														elseif  source.close[period]<  INDEX5[period] 
														then
														Signal[5][period]=-1;		
														else
														Signal[5][period]=0;		
	...
	Shift=0;
			...
			Activate (1, period,INDEX1[period] );   
...
function Activate (id, period, SignalLevel)
   ...
   Alert[id][period]=0;
	  ...
	  if  ON[id]  then
			...
			if  Signal[1][period]== 1 
			and  (Signal[2][period]== 1 or not Use[2])
			and  (Signal[3][period]== 1 or not Use[3])
			and  (Signal[4][period]== 1 or not Use[4])	
			and  (Signal[5][period]== 1 or not Use[5])			
			then
