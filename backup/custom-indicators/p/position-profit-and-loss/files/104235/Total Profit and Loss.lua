...
function Init()
	...
	indicator.parameters:addBoolean("S1", "Show Instrument", "", true);
	indicator.parameters:addBoolean("S2", "Show Number of Trades", "", true);
	indicator.parameters:addBoolean("S5", "Show Net Trade Direction", "", true);
	indicator.parameters:addBoolean("S3", "Show Total Lot Value", "", true);
	indicator.parameters:addBoolean("S4", "Show Amount(K)", "", true);
...
function Draw(stage, context)
	...
	if S1 then
	Text = " Instrument : " .. source:instrument();
