        ...
        for i, level in ipairs(levels) do
            if level.Lines ~= nil then
                for x, line in ipairs(level.Lines) do
                    if level.CrossOverAction ~= nil and level.CrossOverIsEntry and core.crossesOver(source.close, line, period) then
                        level.CrossOverAction.Execute(source, period, level.CrossOverAction.ExecuteData);
                    end
                    if level.CrossUnderAction ~= nil and level.CrossUnderIsEntry and core.crossesUnder(source.close, line, period) then
