...
function Init()
    indicator:name("Polynomial Regression Moving Average");
    ...
    indicator.parameters:addColor("Color", "Central Line Color", "Central Line Color", core.rgb(0, 255, 0));
...
function Prepare(nameOnly)
    ...
    BuffReg = instance:addStream("BuffReg", core.Line, name .. ".Regression", "Regression",  Color, first);
