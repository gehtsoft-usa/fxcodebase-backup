...
function Init()
	...
	indicator.parameters:addString("Type", "Presentation Mode", "", "Bar");
...
function Prepare(nameOnly)  
   PERIOD = instance.parameters.PERIOD;
	...
	OUT = instance:addStream("PERCENT", core.Bar, name .. ".PERCENT", "PERCENT", instance.parameters.clr, first);
	end
...
function Update(period)
	...
	if OUT[period] > 0  then
	 OUT:setColor(period, core.rgb(0, 255, 0));
	else
	 OUT:setColor(period, core.rgb(255, 0, 0));
	end
