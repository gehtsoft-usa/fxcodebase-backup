...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=66641
--+------------------------------------------------------------------------+
...
function IsEntryLong(source, period)
    return indi:getTextOutput(0):hasData(period) and source.close[period] > ma.DATA[period];
end
function IsEntryShort(source, period)
    return indi:getTextOutput(1):hasData(period) and source.close[period] < ma.DATA[period];
end
