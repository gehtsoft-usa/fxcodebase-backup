...
function Update(period)
    ...
    CloseClose[period]= (source.close[period]-source.close[period-1])/(source.close[period-1]/100);
	HighLow[period]= (source.high[period]-source.low[period-1])/(source.low[period-1]/100);
