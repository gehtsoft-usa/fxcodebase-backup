...
function Prepare(nameOnly)
	...
	first = math.max(MA1.DATA:first(), MA2.DATA:first());
			...
			PMO= instance:addStream("QRO", core.Line, name .. ".PMO", "PMO",  instance.parameters.Up_color, source:first());	
    PMO:setPrecision(math.max(2, instance.source:getPrecision()));
            PMO:setStyle (core.LINE_NONE);   			
			Zero = instance:addInternalStream(0, 0);
            instance:createChannelGroup("SA-SB", "SA-SB", PMO, Zero, instance.parameters.Up_color, 100 - instance.parameters.transp);
