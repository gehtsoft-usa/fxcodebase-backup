...
function Prepare(nameOnly)   
    ...
    CreateEMA(1, instance.parameters:getInteger("Period" .. 1) );
    CreateEMA(2, instance.parameters:getInteger("Period" .. 2) );
    CreateEMA(3, instance.parameters:getInteger("Period" .. 3) );
    CreateEMA(4, instance.parameters:getInteger("Period" .. 4) );
    CreateEMA(5, instance.parameters:getInteger("Period" .. 5) );
    CreateEMA(6, instance.parameters:getInteger("Period" .. 6) );

    CreateEMA(7, instance.parameters:getInteger("Period" .. 7) );
    CreateEMA(8, instance.parameters:getInteger("Period" .. 8) );
    CreateEMA(9, instance.parameters:getInteger("Period" .. 9) );
    CreateEMA(10, instance.parameters:getInteger("Period" .. 10) );
    CreateEMA(11, instance.parameters:getInteger("Period" .. 11) );
    CreateEMA(12, instance.parameters:getInteger("Period" .. 12) );
	
	
    out = instance:addStream("H", core.Bar, name .. ".H", "H", instance.parameters.COLOR, source:first());
