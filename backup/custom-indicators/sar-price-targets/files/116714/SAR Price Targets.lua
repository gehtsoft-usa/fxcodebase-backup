...
function Init()
    ...
    indicator.parameters:addDouble("Level3", "3. Target Ratio", "", 2 );
	 ...
	 indicator.parameters:addBoolean("Historical", "Show Historical", "", true);
	  indicator.parameters:addBoolean("ShowLabel", "Show Label", "", false);
...
function DrawLabel(label, context)
    if label.Text ~= nil then
        ...
        width, height = context:measureText(2, label.Text, 0);
        context:drawText(2, label.Text, LabelColor, LabelBackgroundColor,  x, y - height, x + width, y, context.LEFT + context.TOP);
    end
end
...
function Update(period)
    ...
    if p~=0 then
        ...
        if position[p] == 1 then
            ...
            --Start Line
            core.host:execute("drawLine", New(), source:date(p), source.high[p], source:date(period), source.high[p], StartLineColor, style1, width1, win32.formatNumber(source.high[p], false, source:getPrecision()));
            
            --Stop Line
            core.host:execute("drawLine", New(), source:date(p), SAR[p], source:date(period), SAR[p], StopLineColor, style2, width2, win32.formatNumber(SAR[p], false, source:getPrecision()) );
            
            --1. Target
            core.host:execute("drawLine", New(), source:date(p), source.high[p]+Delta*Level1, source:date(period), source.high[p]+Delta*Level1, TargetLineColor1, style3, width3 , win32.formatNumber(source.high[p]+Delta*Level1, false, source:getPrecision()));
            
            --2. Target
            core.host:execute("drawLine", New(), source:date(p), source.high[p]+Delta*Level2, source:date(period), source.high[p]+Delta*Level2, TargetLineColor2, style4, width4, win32.formatNumber(source.high[p]+Delta*Level2, false, source:getPrecision()));
            
            --3. Target
            core.host:execute("drawLine", New(), source:date(p), source.high[p]+Delta*Level3, source:date(period), source.high[p]+Delta*Level3, TargetLineColor3, style5, width5, win32.formatNumber(source.high[p]+Delta*Level3, false, source:getPrecision()));
            if Level4~= 0 then
			  --Trigger
            core.host:execute("drawLine", New(), source:date(p), source.high[p]+source:pipSize()*Level4, source:date(period), source.high[p]+source:pipSize()*Level4, TargetLineColor4, style6, width6, win32.formatNumber(source.high[p]+source:pipSize()*Level4, false, source:getPrecision()));
			end
            ...
            elseif ShowLabel then
                ...
                local label5 = string.format("3. Target : %s (%s)"
				  ...
				  local label6 = string.format("Trigger : %s (%s)"
                    ...
                    , win32.formatNumber(Level4, false, 1));	
                core.host:execute("drawLabel1", New(), source:date(p), core.CR_CHART, source.high[p], core.CR_CHART, core.H_Right, core.V_Top,  font, LabelColor, label1);
                core.host:execute("drawLabel1", New(), source:date(p), core.CR_CHART, SAR[p], core.CR_CHART, core.H_Right, core.V_Top,  font, LabelColor, label2);
                core.host:execute("drawLabel1", New(), source:date(p), core.CR_CHART, source.high[p]+Delta*Level1, core.CR_CHART, core.H_Right, core.V_Top,  font, LabelColor, label3);
                core.host:execute("drawLabel1", New(), source:date(p), core.CR_CHART, source.high[p]+Delta*Level2, core.CR_CHART, core.H_Right, core.V_Top,  font, LabelColor, label4);
                core.host:execute("drawLabel1", New(), source:date(p), core.CR_CHART, source.high[p]+Delta*Level3, core.CR_CHART, core.H_Right, core.V_Top,  font, LabelColor, label5);
				if Level4~= 0 then
				core.host:execute("drawLabel1", New(), source:date(p), core.CR_CHART, source.high[p]+source:pipSize()*Level4, core.CR_CHART, core.H_Right, core.V_Top,  font, LabelColor, label6);
				end
            end
        else
            ...
            --Start Line
            core.host:execute("drawLine", New(), source:date(p), source.low[p], source:date(period), source.low[p], StartLineColor, style1, width1, win32.formatNumber(source.low[p], false, source:getPrecision()));
            
            --Stop Line
            core.host:execute("drawLine", New(), source:date(p), SAR[p], source:date(period), SAR[p], StopLineColor, style2, width2, win32.formatNumber(SAR[p], false, source:getPrecision()));
            
            --1. Target
            core.host:execute("drawLine", New(), source:date(p), source.low[p]-Delta*Level1, source:date(period), source.low[p]-Delta*Level1, TargetLineColor1, style3, width3, win32.formatNumber(source.low[p]-Delta*Level1, false, source:getPrecision()));
            
            --2. Target
            core.host:execute("drawLine", New(), source:date(p), source.low[p]-Delta*Level2, source:date(period), source.low[p]-Delta*Level2, TargetLineColor2, style4, width4, win32.formatNumber(source.low[p]-Delta*Level2, false, source:getPrecision()));
            
            --3. Target
            core.host:execute("drawLine", New(), source:date(p), source.low[p]-Delta*Level3, source:date(period), source.low[p]-Delta*Level3, TargetLineColor3, style5, width5, win32.formatNumber(source.low[p]-Delta*Level3, false, source:getPrecision()));
			
			if Level4~= 0 then
			  --Trigger
            core.host:execute("drawLine", New(), source:date(p), source.low[p]-source:pipSize()*Level4, source:date(period), source.low[p]-source:pipSize()*Level4, TargetLineColor4, style5, width5, win32.formatNumber(source.low[p]-source:pipSize()*Level4, false, source:getPrecision()));
            end   
            if LabelBackground then
                label1.Text = string.format("Entry : %s"
            ...
            elseif ShowLabel then
                ...
                core.host:execute("drawLabel1", New(), source:date(p), core.CR_CHART, source.low[p], core.CR_CHART, core.H_Right, core.V_Top,  font, LabelColor, label1);
                core.host:execute("drawLabel1", New(), source:date(p), core.CR_CHART, SAR[p], core.CR_CHART, core.H_Right, core.V_Top,  font, LabelColor, label2);
                core.host:execute("drawLabel1", New(), source:date(p), core.CR_CHART, source.low[p]-Delta*Level1, core.CR_CHART, core.H_Right, core.V_Top,  font, LabelColor, label3);
                core.host:execute("drawLabel1", New(), source:date(p), core.CR_CHART, source.low[p]-Delta*Level2, core.CR_CHART, core.H_Right, core.V_Top,  font, LabelColor, label4);
                core.host:execute("drawLabel1", New(), source:date(p), core.CR_CHART, source.low[p]-Delta*Level3, core.CR_CHART, core.H_Right, core.V_Top,  font, LabelColor, label5);
				
				if Level4~= 0 then
				 core.host:execute("drawLabel1", New(), source:date(p), core.CR_CHART, source.low[p]-source:pipSize()*Level4, core.CR_CHART, core.H_Right, core.V_Top,  font, LabelColor, label6);
				 end
            end
        end
    end
