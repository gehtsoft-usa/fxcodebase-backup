...
function Init()
	...
	indicator.parameters:addStringAlternative("Mode", "Current Period", "", "Current")
...
function Update(period)
	...
	Value[1] = Source.high[p1 - shift]
	Value[2] = Source.low[p1 - shift]
	Value[3] = Source.close[p1 - shift]
...
function Draw(stage, context)
	...
	for i = 1, 14, 1 do
		if Value[i] ~= nil then
			...
			if Mode ~= "Historic" then
				context:drawLine(i + 1, Index1, y, X, y)
			end
		end
	end
end
