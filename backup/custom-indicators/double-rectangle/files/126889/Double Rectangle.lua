...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=68571
...
function Init()
    ...
    tool.parameters:addColor("top_color", "Top Color", "", core.COLOR_UPCANDLE);
    tool.parameters:addColor("bottom_color", "Bottom Color", "", core.COLOR_DOWNCANDLE);
