...
-- Routine
 function Prepare(nameOnly)   
	...
	AAA = instance:addStream("AAA" , core.Line, " AAA"," AAA",instance.parameters.color, first+1);
	AAA:setWidth(instance.parameters.width);
    AAA:setStyle(instance.parameters.style);
