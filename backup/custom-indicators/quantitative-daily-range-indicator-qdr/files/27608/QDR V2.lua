...
function Init()
    indicator:name("Quantitative Daily Range Indicator v2");
...
function Prepare()    
   ...
   Current=instance.parameters.Current;
    ...
    local name =  profile:id() .. ", "  .. instance.source:name()  .. ","    ..  SD;
	...
	if source:barSize() == "m1"	then P	= 1/1440 
	elseif source:barSize() == "m5" then P	= 5/1440
	elseif source:barSize() == "m15" then P	= 15/1440
	elseif source:barSize() == "m30" then P	= 30/1440
	elseif source:barSize() == "H1" then P	= 1/24
	elseif source:barSize() == "H2" then P	= 2/24
	elseif source:barSize() == "H3" then P	= 3/24
	elseif source:barSize() == "H4" then P	= 4/24
	elseif source:barSize() == "H6" then P	= 6/24
	elseif source:barSize() == "H8" then P	= 8/24
	elseif source:barSize() == "D1" then P	= 1
	elseif source:barSize() == "W1" then P	= 5
	elseif source:barSize() == "M1" then P	= 20
	end
...
function Update(period)
	...
	return;
		...
		if not stream[1].close:hasData ( stream[1].close:size()-1  ) then
        return;
       end		
