...
function Init()
	...
	Parameters (1, "Inverse reaction oscillator"); 
end
...
function Prepare(nameOnly)
    ...
    iU = instance:addStream("U", core.Line, name .. ".U", "U", instance.parameters.Uclr, first);
    iD = instance:addStream("D", core.Line, name .. ".D", "D", instance.parameters.Dclr, first);
    iU:setWidth(instance.parameters.widthLinReg);
    iU:setStyle(instance.parameters.styleLinReg);
    iD:setWidth(instance.parameters.widthLinReg);
    iD:setStyle(instance.parameters.styleLinReg);
	
	CO:setPrecision(math.max(2, instance.source:getPrecision()));
	iU:setPrecision(math.max(2, instance.source:getPrecision()));
...
function Update(period, mode)
   ...
   return;
    ...
    MA:update(mode);
    iU[period]=Coeff*MA.DATA[period];
    iD[period]=-iU[period];
   ...
   if Live~= "Live" then
	...
	Shift=1;
	  ...
	  if id == 1  and ON[id]  then
			...
			elseif   CO[period] < iD[period] 	
            then			
			
			            			 
			               core.host:execute("drawLabel1", source:serial(period), source:date(period),  core.CR_CHART, iD[period] , core.CR_CHART, core.H_Center, core.V_Top, font, DownTrendColor, "\226");						   
