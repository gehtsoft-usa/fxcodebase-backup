...
function Init()
	...
	indicator.parameters:addDouble("Entry", "Entry Level", "Level", 20);
	indicator.parameters:addDouble("Exit", "Exit Level", "Level", 75);
...
function Update(period, mode) 
	...
	if WAAB[period] > Entry and WAAB[period] < Exit and DIP[period]> DIM[period] then
	WAAB:setColor(period, Up);
	elseif WAAB[period] > Entry and WAAB[period] < Exit and DIP[period]< DIM[period]then
