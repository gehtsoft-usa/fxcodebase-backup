...
function Prepare(nameOnly) 
	...
	S = instance:addStream("S", core.Line, name .. ".S", "S", instance.parameters.S_color, first);
	S:setStyle(core.LINE_NONE );
	instance:createChannelGroup("M","M" , S, Zero, instance.parameters.S_color, 100-instance.parameters.Transparency);
