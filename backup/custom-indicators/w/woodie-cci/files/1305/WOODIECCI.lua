...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=719
...
function Prepare(nameOnly) 
    ...
    H = instance:addStream("H", core.Bar, name .. ".H", "H", instance.parameters.H_color, first);
    H:setPrecision(math.max(2, instance.source:getPrecision()));
    HR = instance:addStream("HR", core.Bar, name .. ".HR", "HR", instance.parameters.HR_color, first);
    HR:setPrecision(math.max(2, instance.source:getPrecision()));
    HB = instance:addStream("HB", core.Bar, name .. ".HB", "HB", instance.parameters.HB_color, first);
	...
	S:setWidth(instance.parameters.S_width);
    S:setStyle(instance.parameters.S_style);
