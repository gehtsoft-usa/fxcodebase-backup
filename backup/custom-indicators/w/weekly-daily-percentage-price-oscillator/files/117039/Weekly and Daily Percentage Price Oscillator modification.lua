...
function Init()
    ...
    indicator.parameters:addInteger("Length1", "Short Period", "Period", 12);
	indicator.parameters:addInteger("Length2", "Long Period", "Period", 26);
	indicator.parameters:addInteger("Factor", "Factor", "Factor", 1);
...
local S1, S2, S3;
 ...
 function Prepare(nameOnly)   
	...
	MA3 = core.indicators:create("EMA", source, Length1*Factor);
	MA4 = core.indicators:create("EMA", source, Length2*Factor);
...
function Update(period, mode)
	...
	WPP[period]= ((MA1.DATA[period] - MA2.DATA[period])/MA4.DATA[period])*100;   
	DPP[period]= ((MA3.DATA[period] - MA4.DATA[period])/MA4.DATA[period])*100;
