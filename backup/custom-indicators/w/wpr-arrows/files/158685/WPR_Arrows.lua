-- Available @ https://fxcodebase.com/code/viewtopic.php?f=17&t=75733
-- +------------------------------------------------------------------------------------------------+
...
{ 
    {
        ...
        UpCondition = function (period)
            return WPR[period] > instance.parameters.overbought;
        end,
        DownCondition = function (period)
            return WPR[period] < instance.parameters.oversold;
        end,
...
function Init()
    ...
    for i,alert in ipairs(alerts) do
        ...
        indicator.parameters:addBoolean("FilterConsecutive", "Filter Consecutive", "", true);
    end
    
    indicator.parameters:addGroup("Line Style")
    indicator.parameters:addColor(
        "clrWPR",
        "Color of Williams Percent Range",
        "Color of Williams Percent Range",
        core.rgb(0, 255, 0)
    )
...
function indi_alerts:Prepare()
    ...
    for i = 1, 100 do 
        ...
        alert.FilterConsecutive = instance.parameters.FilterConsecutive;
