...
function Init()
    indicator:name("Single Stream i Sadukey Indicator (dot version)");
...
function Prepare(nameOnly)
    ...
    buffer = instance:addStream("buffer", core.Dot, name .. ".buffer", "buffer", instance.parameters.UP_color, first);    
