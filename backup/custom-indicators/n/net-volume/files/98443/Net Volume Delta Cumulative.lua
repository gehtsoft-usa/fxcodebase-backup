...
function Init()
    indicator:name("Net Volume Delta Cumulative");
    indicator:description("Net Volume Delta Cumulative");
    ...
    indicator.parameters:addStringAlternative("Method", "EMA", "EMA" , "EMA");
	 ...
	 indicator.parameters:addColor("Volume_Neutral", "Color of Neutral", "Color of Neutral", core.rgb(0, 0, 255));
...
function Update(period)
    ...
    Volume[period]= Volume[period-1];
     
	 from, to = core.getcandle(source:barSize(), source:date(period), dayoffset, 0);
	...
	elseif Volume[period] <  Volume[period-1] then
	      ...
	      Volume:setColor(period, instance.parameters.Volume_Neutral);
	end
end
...
function   Initialization(period,from, to)
   ...
   for i=  S, E ,1  do
		 ...
		 Down[period]=Down[period]-1;
			 ...
			 Volume[period]= Volume[period-1]+  Up[period]+Down[period];  
