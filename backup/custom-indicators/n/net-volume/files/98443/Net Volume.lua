...
function Init()
    ...
    indicator.parameters:addStringAlternative("Method", "EMA", "EMA" , "EMA");
	 ...
	 indicator.parameters:addColor("Volume_color", "Color of Volume", "Color of Volume", core.rgb(0, 0, 255));
    indicator.parameters:addColor("Cumulative_color", "Color of Cumulative", "Color of Cumulative", core.rgb(0, 0, 0));
    indicator.parameters:addColor("Buy_color", "Color of Buy", "Color of Buy", core.rgb(0, 255, 0));
    indicator.parameters:addColor("Sell_color", "Color of Sell", "Color of Sell", core.rgb(255, 0, 0));
...
function Prepare(nameOnly)
    ...
    if (not (nameOnly)) then
	    ...
	    Volume = instance:addStream("Volume", core.Line, name .. ".Volume", "Volume", instance.parameters.Volume_color, first);
    Volume:setPrecision(math.max(2, instance.source:getPrecision()));
	    Cumulative = instance:addStream("Cumulative", core.Dot, name .. ".Cumulative", "Cumulative", instance.parameters.Cumulative_color, first);
    Cumulative:setPrecision(math.max(2, instance.source:getPrecision()));
		Cumulative:setWidth(5);
	     
        Buy = instance:addStream("Buy", core.Bar, name .. ".Buy", "Buy", instance.parameters.Buy_color, first);
    Buy:setPrecision(math.max(2, instance.source:getPrecision()));
        Sell = instance:addStream("Sell", core.Bar, name .. ".Sell", "Sell", instance.parameters.Sell_color, first);
...
function   Initialization(period,from, to)
   ...
   for i=  S, E ,1  do
		 ...
		 Down[period]=Down[period]-1;
			 ...
			 Buy[period]= Up[period];
			 Sell[period]= Down[period];
			 Volume[period]= Up[period] + math.abs(Down[period]);
