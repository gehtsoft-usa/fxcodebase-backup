...
--http://fxcodebase.com/code/viewtopic.php?f=17&t=9707
...
function Init()
    ...
    indicator:description("Negative Volume Index");
...
function Prepare(nameOnly) 
    ...
    Signal = instance:addStream("Signal", core.Line, name .. ".Signal", "Signal", instance.parameters.SignalClr,  MA.DATA:first());
