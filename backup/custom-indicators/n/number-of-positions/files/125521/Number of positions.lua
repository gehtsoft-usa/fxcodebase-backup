...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=68290
...
function Init()
    indicator:name("Number of positions");
	...
	indicator.parameters:addDouble("Position_Size", "Position Size", "", 200);
...
-- Routine
 ...
 function Prepare(nameOnly)   
    ...
    Position_Size=instance.parameters.Position_Size;
...
function AsyncOperationFinished(cookie)
 ...
 if   cookie== 1 then
   ...
   Balance =core.host:findTable("accounts"):find("AccountID", Account).Balance;
...
function Draw(stage, context)
	...
	local Text1=  "Number of positions : " ..   win32.formatNumber(Balance/Position_Size, false, 2); 
