...
--http://fxcodebase.com/code/viewtopic.php?f=17&t=70365
...
{ 
    {
        ...
        UpCondition = function (period)
            ...
            return ma1.DATA[period] > ma2.DATA[period] 
                and ma1.DATA[period] > ma1.DATA[period - 1] 
                and ma1.DATA[period - 1] < ma1.DATA[period - 2]
        end,
    ...
    },
    {
        ...
        UpCondition = function (period)
            ...
            return macd.MACD[period] > macd.SIGNAL[period]
                and macd.MACD[period] > macd.MACD[period - 1] 
                and macd.MACD[period - 1] < macd.MACD[period - 2]
        end,
        DownCondition = function (period)
            if period < 3 then
                return false;
...
function Init()
    indicator:name("No cross indicator");
    ...
    indicator.parameters:addInteger("macd_SN", "MACD Short EMA", "", 12, 2, 1000);
    indicator.parameters:addInteger("macd_LN", "MACD Long EMA", "", 26, 2, 1000);
    indicator.parameters:addInteger("macd_IN", "MACD Signal", "", 9, 2, 1000);
...
function Prepare(nameOnly)
    ...
    ma1 = core.indicators:create("MVA", source, instance.parameters.ma1_period);
    ma2 = core.indicators:create("MVA", source, instance.parameters.ma2_period);
