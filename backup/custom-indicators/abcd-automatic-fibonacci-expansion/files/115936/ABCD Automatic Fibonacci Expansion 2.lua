...
function Init()
    ...
    indicator.parameters:addString("RetrLevels", "Retracement levels", "Retracement levels", "-0.618, -0.382, -0.272, 0, 0.236, 0.382, 0.5, 0.618, 0.764, 1, 1.272, 1.618");
...
function Draw(stage, context)
	...
	return;
        ...
        if not init then
		   ...
		   context:createPen (3, context:convertPenStyle (instance.parameters.Rstyle),  context:pointsToPixels (instance.parameters.Rwidth), instance.parameters.Rcolor);
