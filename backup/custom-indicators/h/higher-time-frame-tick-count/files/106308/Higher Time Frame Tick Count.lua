...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=63490
...
function Init()
    indicator:name("Higher Time Frame Tick Count");
   ...
   indicator.parameters:addBoolean("Cumulative", "Cumulative", "", true);
	indicator.parameters:addGroup("Color");
...
function Prepare(nameOnly)
	...
	Count = instance:addStream("Count", core.Bar, name, "Count", instance.parameters.color, first);
