-- Available @ https://fxcodebase.com/code/viewtopic.php?f=17&t=73649
...
function Init()
    indicator:name("Higher Time Frame SIMPLE PIVOT LINE");
...
function Update(period, mode)
	    ...
	    if SourceData.high:hasData(p-1)then
        Line[period] = (SourceData.high[p-1] + SourceData.low[p-1] + SourceData.close[p-1] ) / 3; 	
		end
