...
-- Available @ http://fxcodebase.com/code/viewtopic.php?f=17&t=61275
...
function Init()
    ...
    indicator.parameters:addInteger("Period", "Shift Period", "Period", 0);
	...
	indicator.parameters:addBoolean("extend", "Extend Line", "", false);
...
function Draw(stage, context)
	...
	x, x1, x2  = context:positionOfBar (last);
	context:drawLine (1, context:left (), y, x, y); 
