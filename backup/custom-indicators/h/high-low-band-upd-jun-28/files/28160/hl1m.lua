...
function Init()
    ...
    indicator.parameters:addInteger("widthLinReg", "H/L line width", "H/L line width", 1, 1, 5);
    indicator.parameters:addInteger("styleLinReg", "H/L line style", "H/L line style", core.LINE_SOLID);
...
function Prepare()
    ...
    M = instance:addStream("M", core.Line, name .. ".M", "M", instance.parameters.clrB, 0);
    M:setStyle(core.LINE_DASH);
    H:setWidth(instance.parameters.widthLinReg);
    H:setStyle(instance.parameters.styleLinReg);
    L:setWidth(instance.parameters.widthLinReg);
    L:setStyle(instance.parameters.styleLinReg);
