-- Available @ https://fxcodebase.com/code/viewtopic.php?f=17&t=607&p=158680#p158680
...
function GetLastSignal(indi, source)
    if source.high[NOW] > source.high[NOW - 1] and source.low[NOW] > source.low[NOW - 1] then
