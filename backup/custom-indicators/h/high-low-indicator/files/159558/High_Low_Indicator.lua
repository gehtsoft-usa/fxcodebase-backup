-- available @ https://fxcodebase.com/code/viewtopic.php?f=17&t=76022
...
{ 
    {
        ...
        UpCondition = function (period)
            return up[period] < source.close[period];
        end,
        DownCondition = function (period)
            return down[period] > source.close[period];
        end,
...
function Init()
    indicator:name("High Low");
    indicator:description("");
    indicator:requiredSource(core.Bar);
    indicator:type(core.Indicator);
    
    indicator.parameters:addInteger("p", "Length", "", 10);
...
function Prepare(nameOnly)
    ...
    up = instance:addStream("up", core.Line, "Up", "Up", instance.parameters.up_color, 0, 0);
    down = instance:addStream("down", core.Line, "Down", "Down", instance.parameters.down_color, 0, 0);
    indi_alerts:Prepare();
...
function Update(period, mode)
    ...
    up[period] = mathex.max(source.high, core.rangeTo(period - 1, p));
    down[period] = mathex.min(source.high, core.rangeTo(period - 1, p));
