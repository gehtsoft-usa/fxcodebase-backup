...
function Activate (id, period)
   ...
   Alert[id][period]=0;
	  ...
	  if id == 1  and ON[id]  then
			...
			if HMA[period] >   HMA[period-1] 
			and  HMA[period-1] <=   HMA[period-2] 
			then
			           
						    
         
                Alert[id][period]= 1;	
 				AlertLevel[id][period]= HMA[period] 
			 ...
			 D[id] = nil;
							  ...
							  SoundAlert(Up[id]);
							  EmailAlert(  Label[id], " Up Slope ");
							  SendAlert( Label[id]," Up Slope "); 
							  Pop(Label[id], " Up Slope ", period );  
							  OnlyOnceFlag=false;
							  end
							  
			elseif HMA[period] <   HMA[period-1] 
			and  HMA[period-1] >=   HMA[period-2] 
            then			
		     ...
		     U[id] = nil;
							 ...
							 SoundAlert(Down[id]);			 
							 EmailAlert( Label[id] , " Down Slope ");								 
							 Pop(Label[id], " Down Slope ", period );  	
							 SendAlert( Label[id]," Down Slope ");
							 OnlyOnceFlag=false;
			                 end			   
	         end
