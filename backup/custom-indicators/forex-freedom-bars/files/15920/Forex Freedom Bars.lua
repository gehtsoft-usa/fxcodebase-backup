...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=7110
...
function Init()
    indicator:name("Forex Freedom Bars");
	...
	s2, e2 = core.getcandle(iTF[i], 0, 0, 0);
	 ...
	 Label[Number]="";
				...
				ifirst= Temp1.DATA:first()*2;
				   ...
				   Id=Id+1;
				 SourceData[Number]  = core.host:execute("getSyncHistory",  Instrument[Number],  TF[Number], source:isBid(), math.min(ifirst,300), 2000 + Id , 1000 +Id);	 	 
				 loading[Number]  = true;  	 
