...
Version:     
Date:        
Repository:  Available @ https://fxcodebase.com/code/viewtopic.php?f=17&p=161015#p161015
License:     GNU
*/
...
int start()
{
   ...
   if(Close[1] > TA[1] && Open[1] < TA[1])
   {
      ArrowUp[1] = Low[1] - (0.5 * Point);
   }
   if(Close[1] < TA[1] && Open[1] > TA[1])
   {
      ArrowDn[1] = High[1] + (0.5 * Point);
   }
