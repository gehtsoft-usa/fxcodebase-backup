...
--http://fxcodebase.com/code/viewtopic.php?f=17&t=70141
...
{ 
    {
        ...
        UpCondition = function (period)
            ...
            candle = source.high[period] - source.low[period];
            return core.crossesUnder(source.close, bb.BL, period) and body / candle >= body_size / 100;
        end,
        DownCondition = function (period)
            ...
            body = math.abs(source.close[period] - source.open[period]);
            candle = source.high[period] - source.low[period];
            return core.crossesOver(source.close, bb.TL, period) and body / candle >= body_size / 100;
        end,
...
function Init()
    indicator:name("BB with shadow filter");
    ...
    indicator.parameters:addDouble("body_size", "Min body size, %", "", 80);
...
function Prepare(nameOnly)
    ...
    body_size = instance.parameters.body_size;
    bb = core.indicators:create("BB", source, instance.parameters.bb_period, instance.parameters.bb_deviations);

    tl = instance:addStream("TL", core.Line, "TL", "TL", instance.parameters.tl_color, bb.TL:first(), 0);
    tl:setWidth(instance.parameters.tl_width);
    tl:setStyle(instance.parameters.tl_style);
    bl = instance:addStream("LB", core.Line, "BL", "BL", instance.parameters.bl_color, bb.BL:first(), 0);
