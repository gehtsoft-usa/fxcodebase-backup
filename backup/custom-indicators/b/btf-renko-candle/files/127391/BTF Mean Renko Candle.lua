...
function Init()
    indicator:name("Bigger timeframe Mean Renko Candle")
...
function Prepare(nameOnly)
    ...
    indiProfile = core.indicators:findIndicator("MEAN RENKO BARS VIEW")
    assert(indiProfile ~= nil, "Please download and install MEAN RENKO BARS VIEW.lua indicator")
    ...
    indicatorParams:setDouble("OpeningPricePercentage", instance.parameters.OpeningPricePercentage)
    indicatorParams:setDouble("ReversalPercentage", instance.parameters.ReversalPercentage)
    indicatorParams:setBoolean("Smoothed", instance.parameters.Smoothed)
    indicatorParams:setDate("from", instance.parameters.from)
    indicatorParams:setDate("to", instance.parameters.to)

    indi = core.indicators:create("MEAN RENKO BARS VIEW", source, indicatorParams)
