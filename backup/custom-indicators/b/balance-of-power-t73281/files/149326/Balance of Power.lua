-- Available @ https://fxcodebase.com/code/viewtopic.php?f=17&t=73281
...
function Init()
    ...
    indicator.parameters:addInteger("Period2", "Range", "", 28, 1, 2000); 
...
-- Routine
 function Prepare(nameOnly)   
    ...
    BOP = instance:addStream("BOP", core.Bar, name, "BOP", instance.parameters.Up, first+Period1 );
...
function Update(period, mode)
	...
	if (source.close[period]>min+(max-min)/2.0) then
