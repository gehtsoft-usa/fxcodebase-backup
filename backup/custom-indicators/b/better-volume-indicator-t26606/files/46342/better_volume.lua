...
function Init()
    indicator:name("Better Volume Indicator");
    indicator:description("Better Volume Indicator");
...
function Prepare(nameOnly)
    ...
    VolumeBar = instance:addStream("VolumeBar", core.Bar, name .. ".VolumeBar", "VolumeBar", instance.parameters.VolumeBar_color, 0);
    VolumeBar:setPrecision(0);
    VolumeBar:addLevel(0, core.LINE_NONE);
...
function Update(period, mode)
    ...
    if period < first then
        ...
        VolumeBar:setColor(period, colour);
    end
end
