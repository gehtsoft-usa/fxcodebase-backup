...
--http://fxcodebase.com/code/viewtopic.php?f=17&t=11904
...
function Prepare(nameOnly) 
   ...
   Last=nil;
	...
	Temp1= core.indicators:create("BULLS", source ,  Period);  				
	...
	s2, e2 = core.getcandle(iTF[i], 0, 0, 0);
	 ...
	 Label[Number]="";
                ...
                Label[Number]=Label[Number] .. " - " ..  TF[Number];				
				 ...
				 loading[Number]  = true;  	 
				Bulls[Number] = core.indicators:create("BULLS", SourceData[Number] ,  Period );   
				Bears[Number] = core.indicators:create("BEARS", SourceData[Number] ,  Period );   
			   ...
			   x0, x1, x2 = context:positionOfBar (i);
			    ...
			    for j= 1, Number , 1 do
				  ...
				  if p~= false then
										...
										if Bulls[j].DATA:hasData(p)  then 
										
												    if  math.abs(Bulls[j].DATA[p]) >  math.abs(Bears[j].DATA[p]) then		 
														 
															C2=12;
															C1=11;
															 
												 
												   elseif  math.abs(Bulls[j].DATA[p]) <  math.abs(Bears[j].DATA[p]) then	
															C2=22;
															C1=21;
