-- More information about this indicator can be found at:
 --http://fxcodebase.com/code/viewtopic.php?f=17&t=68631
...
function Init()
    indicator:name("Bollinger bands Normalized SMI");
    indicator:description("");
    indicator:requiredSource(core.Bar);
    indicator:type(core.Oscillator);
	
	indicator.parameters:addGroup("Calculation"); 
    indicator.parameters:addInteger("Period1", "SMI Period", "", 14, 2, 2000);
...
-- Routine
 function Prepare(nameOnly)   
	...
	RSI = core.indicators:create("SMI", source,Period1);
