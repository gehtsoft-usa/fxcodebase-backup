...
function Init()
    indicator:name("On Chart Bollinger Band Difference");
...
function Draw(stage, context)
	...
	local 	TLBL=(BB.TL[period]-BB.BL[period])/source:pipSize();
	local   TLAL=(BB.TL[period]-BB.AL[period])/source:pipSize();
	
			
	local Text1=  "Top/Bottom : " ..   win32.formatNumber(TLBL, false, source:getPrecision());
   ...
   local Text2=  "Top/Central : " ..   win32.formatNumber(TLAL, false, source:getPrecision());
