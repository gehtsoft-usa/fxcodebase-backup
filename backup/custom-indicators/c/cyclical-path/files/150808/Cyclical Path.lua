...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=73711
...
function Init()
    ...
    indicator.parameters:addInteger("Period1", "Slow Period", "", 14, 1, 2000);
    indicator.parameters:addInteger("Period2", "Fast Period", "", 2, 1, 2000);
...
function Update(period, mode)
	...
	local LR1= mathex.lreg(source, period-Period1+1, period);
	local LR2= mathex.lreg(source, period-Period2+1, period);	  	
