...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=74313
...
local Number = 2;
local Symbols={"\226", "\225" };
local Font={"Wingdings", "Wingdings" };
local Alert_Name={ "1. Signal" ,"2. Signal" };
...
function Init()
    indicator:name("Channeling Your Inner Chartist");
    ...
    indicator.parameters:setFlag("style", core.FLAG_LINE_STYLE);
	 ...
	 indicator.parameters:addColor("color3", "Cental Line Color", "", core.rgb(0, 0, 255)); 	 
--\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\
...
function  Initialization ()
	...
	Show_Unconfirmed= instance.parameters.Show_Unconfirmed;
     ...
     for i= 1, Number , 1 do		
		...
		--Alert[i]= instance:addStream("Signal"..i, core.Bar,  "Central", "Central".. i, instance.parameters.color3, first );
...
function Update(period, mode)
    ...
    if source.high[period]> Top[period-1] then
    Signal[period]=1;
    elseif source.low[period]< Bottom[period-1] then
    Signal[period]=-1;
    else
