...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=71926
...
function Init()
    ...
    indicator.parameters:addInteger("Period", "Fast MA", "", 5, 1, 2000);
...
-- Routine
 function Prepare(nameOnly)   
	...
	if Period <= 50 then
	delta = 12
	elseif Period <= 200 then
	delta = 16
	else
	delta = 16 * (200/Period)
	end
	 
	corrlength = Period + delta
