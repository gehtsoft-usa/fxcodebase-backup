	...
	Shift=1;
	  ...
	  if id == 1  and ON[id]  then
	   ...
	   if id == 2  and ON[id]  then
			...
			if CCI.DATA[period-1]<=OB and CCI.DATA[period]>OB 			
			then    
			...
			elseif CCI.DATA[period-1]>=OB and CCI.DATA[period]<OB 			
            then		   			   
	   ...
	   if id == 3  and ON[id]  then
			...
			if CCI.DATA[period-1]<=OS and CCI.DATA[period]>OS 			
			then    
			...
			elseif CCI.DATA[period-1]>=OS and CCI.DATA[period]<OS 			
            then	 							 		   
