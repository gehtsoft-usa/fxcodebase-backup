...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=987
...
function Init()
    ...
    indicator.parameters:addColor("out1_up", "Dollar Up color", "Dollar color", core.rgb(0, 255, 0));
	indicator.parameters:addColor("out1_dn", "Dollar Down color", "Dollar color", core.rgb(0, 255, 0));
	indicator.parameters:addBoolean("Dollar", "Dollar On", "Dollar On", true);
	indicator.parameters:addColor("out2_up", "Euro Up color", "Euro color", core.rgb(255, 0, 0));
	indicator.parameters:addColor("out2_dn", "Euro Down color", "Euro color", core.rgb(255, 0, 0));
	indicator.parameters:addBoolean("Euro", "Euro On", "Euro On", true);
	indicator.parameters:addColor("out3_up", "Jen  Up color", "Jen color", core.rgb(0, 0, 255));
	indicator.parameters:addColor("out3_dn", "Jen Down color", "Jen color", core.rgb(0, 0, 255));
	indicator.parameters:addBoolean("Jen", "Jen On", "Jen On", true);
	indicator.parameters:addColor("out4_up", "Pound Up color", "Pound color", core.rgb(128, 0, 128));
	indicator.parameters:addColor("out4_dn", "Pound Down color", "Pound color", core.rgb(128, 0, 128));
	indicator.parameters:addBoolean("Pound", "Pound On", "Pound On", true);
	indicator.parameters:addColor("out5_up", "Franc Up color", "Franc color", core.rgb(0, 128, 128));
	indicator.parameters:addColor("out5_dn", "Franc Down color", "Franc color", core.rgb(0, 128, 128));
	indicator.parameters:addBoolean("Franc", "Franc On", "Franc On", true);
	indicator.parameters:addColor("out6_up", "Kiwi  Up color", "Kiwi color", core.rgb(128, 0, 0));
	indicator.parameters:addColor("out6_dn", "Kiwi  Down color", "Kiwi color", core.rgb(128, 0, 0));
	indicator.parameters:addBoolean("Kiwi", "Kiwi On", "Kiwi On", true);
	indicator.parameters:addColor("out7_up", "Aussi  Up color", "Aussi color", core.rgb(255, 255, 255));
	indicator.parameters:addColor("out7_dn", "Aussi  Down color", "Aussi color", core.rgb(255, 255, 255));
	indicator.parameters:addBoolean("Aussi", "Aussi On", "Aussi On", true);
	indicator.parameters:addColor("out8_up", "Loonie Up color", "Loonie color", core.rgb(128, 128, 128));
	indicator.parameters:addColor("out8_dn", "Loonie Down  color", "Loonie color", core.rgb(128, 128, 128));
            ...
            for i = 0, #streams do
                period = math.min(period, streams[i].data:size() - 1)
					...
					for j=1, period,1 do
						 ...
						 if out1[j] > out1[j-1] then
						 out1:setColor(j, instance.parameters.out1_up);
						 else
						  out1:setColor(j, instance.parameters.out1_dn);
                         end		

                         if out2[j] > out2[j-1] then
						 out2:setColor(j, instance.parameters.out2_up);
						 else
						  out2:setColor(j, instance.parameters.out2_dn);
                         end		

						 if out3[j] > out3[j-1] then
						 out3:setColor(j, instance.parameters.out3_up);
						 else
						  out3:setColor(j, instance.parameters.out3_dn);
                         end		

                         if out4[j] > out4[j-1] then
						 out4:setColor(j, instance.parameters.out4_up);
						 else
						  out4:setColor(j, instance.parameters.out4_dn);
                         end		

                         if out5[j] > out5[j-1] then
						 out5:setColor(j, instance.parameters.out5_up);
						 else
						  out5:setColor(j, instance.parameters.out5_dn);
                         end			

                           if out6[j] > out6[j-1] then
						 out6:setColor(j, instance.parameters.out6_up);
						 else
						  out6:setColor(j, instance.parameters.out6_dn);
                         end	

                        if out7[j] > out7[j-1] then
						 out7:setColor(j, instance.parameters.out7_up);
						 else
						  out7:setColor(j, instance.parameters.out7_dn);
                         end		
                        
                         if out8[j] > out8[j-1] then
						 out8:setColor(j, instance.parameters.out8_up);
						 else
						  out8:setColor(j, instance.parameters.out8_dn);
                         end							
					end
