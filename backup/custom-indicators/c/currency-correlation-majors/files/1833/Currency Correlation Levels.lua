...
function Init()
	...
	indicator.parameters:addBoolean("Show", "Show  Overbouth /  Oversold levels", "", true);
	indicator.parameters:addGroup("Overbought/oversold level");
   
    indicator.parameters:addDouble("overbought","Overbought Level", "", 120, 0, 100);
    indicator.parameters:addDouble("oversold", "Oversold Level", "", 80, 0, 100);
...
function Prepare(nameOnly)
	...
	Helper = instance:addStream("Helper", core.Line, "", "", instance.parameters.color8, first);
    Helper:setPrecision(math.max(2, instance.source:getPrecision()));
	...
	Helper:addLevel(100, instance.parameters.level_overboughtsold_style, instance.parameters.level_overboughtsold_width, instance.parameters.level_overboughtsold_color);
	
	if Show then
	Helper:addLevel(instance.parameters.oversold, instance.parameters.level_overboughtsold_style, instance.parameters.level_overboughtsold_width, instance.parameters.level_overboughtsold_color);
    Helper:addLevel(instance.parameters.overbought, instance.parameters.level_overboughtsold_style, instance.parameters.level_overboughtsold_width, instance.parameters.level_overboughtsold_color);
	end
end
...
function registerStream(id, barSize, extent, instrument )
    ...
    InstrumentFlag = core.host:findTable("offers"):find("Instrument", instrument);
	assert(InstrumentFlag ~= nil, "Subscribed to " ..  instrument );    
