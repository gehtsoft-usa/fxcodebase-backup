...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=71716
...
function Update(period, mode)
	...
	Central[period]=mathex.avg(source, period-Period+1, period);
 	local Stdev=mathex.stdev(source, period-Period+1, period);
 
	Top[period]=Central[period]+3*Stdev;
	Bottom[period]=Central[period]-3*Stdev;	
end
