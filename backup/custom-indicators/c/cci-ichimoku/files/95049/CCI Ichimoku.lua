...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=60952
...
function Init()
    indicator:name("CCI Ichimoku");
    indicator:description("");
    indicator:requiredSource(core.Bar);
    indicator:type(core.Oscillator);

	indicator.parameters:addGroup("CCI  Calculation"); 
	indicator.parameters:addInteger("Period", "CCI Period","", 14, 1, 10000);
...
function Prepare(nameOnly)
	...
	CCI  = core.indicators:create("CCI CANDLE", source, Period);
	cci= CCI:getCandleOutput (0);
    ICH  = core.indicators:create("ICH", cci, X,Y,Z);
