...
function Init()
    ...
    indicator.parameters:addColor("clrLinRegUP", "Line color UP", "Line color UP", core.rgb(0, 255, 0));
    indicator.parameters:addColor("clrLinRegDN", "Line color DN", "Line color DN", core.rgb(255, 0, 0));
...
function Prepare(nameOnly)   
    ...
    Line = instance:addStream("Line", core.Line, name .. ".Line", "Line", instance.parameters.clrLinRegUP, first);
...
function Update(period, mode)
   ...
   Line[period]=Regression.DATA[period];
   
    if Regression.DATA[period]>Regression.DATA[period-1] then     
	Line:setColor(period,  instance.parameters.clrLinRegUP);
    else     
	Line:setColor(period,  instance.parameters.clrLinRegDN);
    end
