...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=72532
...
function Init()
    indicator:name("Median Stochastic");
    ...
    indicator.parameters:addDouble("Level1", "1. Level","", 0.40);
	indicator.parameters:addDouble("Level2", "2. Level","", 0.0);
	indicator.parameters:addDouble("Level3", "3. Level","", -0.40); 
...
function Update(period, mode)
    ...
    local median= mathex.median_s(source, period-length+1 ,period);
   
   
	 
	Line[period] = ( source[period]-median)/(max-min)
