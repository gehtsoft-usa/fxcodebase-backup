...
function Init()
    indicator:name("MACD Candle");
    indicator:description("MACD Candle");
...
function Prepare(nameOnly)
    ...
    MACDOpen = core.indicators:create("MACD", source.open, SN, LN,IN);
	MACDHigh = core.indicators:create("MACD", source.high, SN, LN,IN);
	MACDLow = core.indicators:create("MACD", source.low, SN, LN,IN);
	MACDClose = core.indicators:create("MACD", source.close, SN, LN,IN);	
