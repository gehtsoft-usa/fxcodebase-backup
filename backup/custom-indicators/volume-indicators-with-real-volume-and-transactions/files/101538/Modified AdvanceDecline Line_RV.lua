...
function Init()
    indicator:name("Modified Advance/Decline Line with Real volume/Transactions");
    indicator:description("Modified Advance/Decline Line with Real volume/Transactions");
...
function Update(period, mode) 
	...
	return;
        ...
        MAD[period] =  MAD[period-1] + ((source.close[period]-source.low[period])-(source.high[period]-source.close[period])/(source.high[period]-source.low[period]))*(Ind.DATA[period]- MA.DATA[period]);
        end
end
