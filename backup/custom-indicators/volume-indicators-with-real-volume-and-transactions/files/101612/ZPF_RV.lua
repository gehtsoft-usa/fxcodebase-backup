...
function Init()
    indicator:name("Zero Point Force with Real volume/Transactions");
    indicator:description("Zero Point Force with Real volume/Transactions");
...
function Prepare(nameOnly)
    ...
    assert(core.indicators:findIndicator(Method3) ~= nil, Method3 .. " indicator must be installed");
	 V = core.indicators:create(Method3, Ind.DATA, Volume );
	 first = source:first();
