...
function Init()
    indicator:name("Volume Accumulation Percentage Indicator with Real volume/Transactions");
    indicator:description("Volume Accumulation Percentage Indicator with Real volume/Transactions");
...
function Update(period, mode)
	...
	return;	
		...
		local TV= mathex.sum(Ind.DATA, period-Period+1, period);
