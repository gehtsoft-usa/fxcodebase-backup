...
local source, indi1, indi2, shift1, shift2;
local indi_alerts = {};
...
{ 
    {
        ...
        UpCondition = function (period)
            if period < math.max(shift1, shift2) + 1 then
                return false;
            end
            return core.crossesOver(indi1.DATA, indi2.DATA, period - shift1, period - shift2);
        end,
        DownCondition = function (period)
            if period < math.max(shift1, shift2) + 1 then
                return false;
            end
            return core.crossesUnder(indi1.DATA, indi2.DATA, period - shift1, period - shift2);
        end,
...
function Init()
    indicator:name("PPMA cross alert");
    indicator:description("");
    indicator:requiredSource(core.Bar);
    indicator:type(core.Indicator);
	
	
	indicator.parameters:addString("Method_1", "Method", "", "MVA");
    indicator.parameters:addStringAlternative("Method_1", "MVA", "", "MVA");
    indicator.parameters:addStringAlternative("Method_1", "EMA", "", "EMA");
    indicator.parameters:addStringAlternative("Method_1", "Wilder", "", "Wilder");
    indicator.parameters:addStringAlternative("Method_1", "LWMA", "", "LWMA");
    indicator.parameters:addStringAlternative("Method_1", "SineWMA", "", "SineWMA");
    indicator.parameters:addStringAlternative("Method_1", "TriMA", "", "TriMA");
    indicator.parameters:addStringAlternative("Method_1", "LSMA", "", "LSMA");
    indicator.parameters:addStringAlternative("Method_1", "SMMA", "", "SMMA");
    indicator.parameters:addStringAlternative("Method_1", "HMA", "", "HMA");
    indicator.parameters:addStringAlternative("Method_1", "ZeroLagEMA", "", "ZeroLagEMA");
    indicator.parameters:addStringAlternative("Method_1", "DEMA", "", "DEMA");
    indicator.parameters:addStringAlternative("Method_1", "T3", "", "T3");
    indicator.parameters:addStringAlternative("Method_1", "ITrend", "", "ITrend");
    indicator.parameters:addStringAlternative("Method_1", "Median", "", "Median");
    indicator.parameters:addStringAlternative("Method_1", "GeoMean", "", "GeoMean");
    indicator.parameters:addStringAlternative("Method_1", "REMA", "", "REMA");
    indicator.parameters:addStringAlternative("Method_1", "ILRS", "", "ILRS");
    indicator.parameters:addStringAlternative("Method_1", "IE/2", "", "IE/2");
    indicator.parameters:addStringAlternative("Method_1", "TriMAgen", "", "TriMAgen");
    indicator.parameters:addStringAlternative("Method_1", "JSmooth", "", "JSmooth");
    indicator.parameters:addStringAlternative("Method_1", "KAMA", "", "KAMA");
    indicator.parameters:addStringAlternative("Method_1", "ARSI", "", "ARSI");
    indicator.parameters:addStringAlternative("Method_1", "VIDYA", "", "VIDYA");
    indicator.parameters:addStringAlternative("Method_1", "HPF", "", "HPF");
    indicator.parameters:addStringAlternative("Method_1", "VAMA", "", "VAMA");


    indicator.parameters:addInteger("Period_1", "Period", "", 14);  
    indicator.parameters:addInteger("shift_1", "Shift 1", "", 0);
	
	
	indicator.parameters:addString("Method_2", "Method", "", "MVA");
    indicator.parameters:addStringAlternative("Method_2", "MVA", "", "MVA");
    indicator.parameters:addStringAlternative("Method_2", "EMA", "", "EMA");
    indicator.parameters:addStringAlternative("Method_2", "Wilder", "", "Wilder");
    indicator.parameters:addStringAlternative("Method_2", "LWMA", "", "LWMA");
    indicator.parameters:addStringAlternative("Method_2", "SineWMA", "", "SineWMA");
    indicator.parameters:addStringAlternative("Method_2", "TriMA", "", "TriMA");
    indicator.parameters:addStringAlternative("Method_2", "LSMA", "", "LSMA");
    indicator.parameters:addStringAlternative("Method_2", "SMMA", "", "SMMA");
    indicator.parameters:addStringAlternative("Method_2", "HMA", "", "HMA");
    indicator.parameters:addStringAlternative("Method_2", "ZeroLagEMA", "", "ZeroLagEMA");
    indicator.parameters:addStringAlternative("Method_2", "DEMA", "", "DEMA");
    indicator.parameters:addStringAlternative("Method_2", "T3", "", "T3");
    indicator.parameters:addStringAlternative("Method_2", "ITrend", "", "ITrend");
    indicator.parameters:addStringAlternative("Method_2", "Median", "", "Median");
    indicator.parameters:addStringAlternative("Method_2", "GeoMean", "", "GeoMean");
    indicator.parameters:addStringAlternative("Method_2", "REMA", "", "REMA");
    indicator.parameters:addStringAlternative("Method_2", "ILRS", "", "ILRS");
    indicator.parameters:addStringAlternative("Method_2", "IE/2", "", "IE/2");
    indicator.parameters:addStringAlternative("Method_2", "TriMAgen", "", "TriMAgen");
    indicator.parameters:addStringAlternative("Method_2", "JSmooth", "", "JSmooth");
    indicator.parameters:addStringAlternative("Method_2", "KAMA", "", "KAMA");
    indicator.parameters:addStringAlternative("Method_2", "ARSI", "", "ARSI");
    indicator.parameters:addStringAlternative("Method_2", "VIDYA", "", "VIDYA");
    indicator.parameters:addStringAlternative("Method_2", "HPF", "", "HPF");
    indicator.parameters:addStringAlternative("Method_2", "VAMA", "", "VAMA");
	
    indicator.parameters:addInteger("Period_2", "Period 2", "", 14);
    indicator.parameters:addInteger("shift_2", "Shift 2", "", 1);
...
function Prepare(nameOnly)
    ...
    shift1 = instance.parameters.shift_1;
    shift2 = instance.parameters.shift_2;

    assert(core.indicators:findIndicator("AVERAGES") ~= nil, "Please, download and install AVERAGES.LUA indicator");
	
    indi1 = core.indicators:create("AVERAGES", source.close, instance.parameters.Method_1 , instance.parameters.Period_1);
    indi2 = core.indicators:create("AVERAGES", source.close, instance.parameters.Method_2, instance.parameters.Period_2);
    indi_alerts:Prepare();
