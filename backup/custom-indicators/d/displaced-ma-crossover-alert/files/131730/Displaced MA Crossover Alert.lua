...
function Init()
    ...
    indicator.parameters:addInteger("period_1", "Period 1", "", 14);
...
function Prepare(nameOnly)
    ...
    indi1 = core.indicators:create("PPMA", source, instance.parameters.period_1);
    indi2 = core.indicators:create("PPMA", source, instance.parameters.period_2);
    indi_alerts:Prepare();
