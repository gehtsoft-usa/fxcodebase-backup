...
function Prepare(nameOnly)
    ...
    local name = profile:id() .. "(" .. source:name().. ", " .. tostring(Method) .. ", " .. tostring(Period) .. ", " .. tostring(InpLevelsCoeff) .. ")";
    instance:name(name);
	
	Buffer=instance:addInternalStream(0, 0);
	PriceMA = core.indicators:create("AVERAGES", source  , Method, Period);
	BufferMA = core.indicators:create("AVERAGES", Buffer  , Method, Period);
