...
function Init()
    ...
    indicator.parameters:addDouble("TOffset", "Timezone offset, in hours", "", 0);
end
...
function Prepare(onlyName)
    ...
    TOffset=instance.parameters.TOffset;
        ...
        characters = function(this, data)
            ...
            if table == 1 then              -- "closed_trades"
                ...
                elseif value == "open_date" and data ~= nil then
                    this.row.open_date = this.parseDate(data)+TOffset/24;
                elseif value == "close_date" and data ~= nil then
                    this.row.close_date = this.parseDate(data)+TOffset/24;
