...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=73004
...
function Init()
	...
	indicator.parameters:addColor("color", "Cloud Color", "", core.rgb(255, 255, 0)); 	
end
...
-- Routine
 function Prepare(nameOnly)   
   ...
   Transparency= 100-Transparency;		
    ...
    local name = profile:id() .. "(" ..  instance.source:name().. "," ..  Period.. "," ..  Method.. "," ..  Shift   .. ")";
    instance:name(name); 
    ...
    High = instance:addStream("High", core.Line, name, "High", instance.parameters.color1, first,Shift  );
    ...
    Low = instance:addStream("Low", core.Line, name, "Low", instance.parameters.color2, first,Shift );
	...
	instance:createChannelGroup("Group","Group" , High, Low, instance.parameters.color, Transparency);	
end
...
function Update(period, mode)
	...
	high:update(mode); 
	 ...
	 if period <= first or period+Shift < source:first() then
	 return;
     end
 
	  	
	High[period+Shift]= high.DATA[period];
	Low[period+Shift]= low.DATA[period];	
end
