...
-- http://fxcodebase.com/code/viewtopic.php?f=17&t=4564
...
--    core.host:trace(string.format("%s %s %i %i", core.formatDate(source:date(period)), core.formatDate(candle), firstHour, offset));
--end
