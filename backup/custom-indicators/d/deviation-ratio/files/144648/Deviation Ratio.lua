...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=71770
...
function Init()
    indicator:name("Deviation Ratio");
    indicator:description("");
    indicator:requiredSource(core.Tick);
    indicator:type(core.Oscillator);
	
	indicator.parameters:addGroup("Calculation"); 
    indicator.parameters:addInteger("Period1", "Fast StDev period", "", 6, 1, 2000);
    indicator.parameters:addInteger("Period2", "Slow StDev period", "", 27, 1, 2000);
...
function Update(period, mode)
	...
	return;
     ...
     Oscillator[period]= mathex.stdev(source, period-Period2+1, period)- mathex.stdev(source, period-Period1+1, period);
