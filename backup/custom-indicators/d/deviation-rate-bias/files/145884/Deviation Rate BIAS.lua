...
-- https://fxcodebase.com/code/viewtopic.php?f=17&t=72143
...
function Init()
    indicator:name("Deviation Rate BIAS");
    ...
    indicator.parameters:addInteger("Period1", "Fast MA", "", 6, 1, 2000);
    indicator.parameters:addInteger("Period2", "Mid MA", "", 12, 1, 2000);
    indicator.parameters:addInteger("Period3", "Slow MA", "", 24, 1, 2000);
	...
	indicator.parameters:addColor("color1", "Fast Line Color", "", core.rgb(0, 255, 0)); 
	indicator.parameters:addColor("color2", "Mid Line Color", "", core.rgb(0, 0, 255)); 
	indicator.parameters:addColor("color3", "Slow Line Color", "", core.rgb(255, 0, 0)); 
end
...
-- Routine
 function Prepare(nameOnly)   
    ...
    Line3 = instance:addStream("Line3", core.Line, name, "Line3", instance.parameters.color3, first );
...
function Update(period, mode)
    ...
    Line1[period]  = ((source[period]-Indicator1.DATA[period]) / (Indicator1.DATA[period]) *100);
    Line2[period]   = ((source[period]-Indicator2.DATA[period])  / (Indicator2.DATA[period])  *100);
    Line3[period] = ((source[period]-Indicator3.DATA[period])/ (Indicator3.DATA[period])*100);
