...
function Draw(stage, context)
    ...
    return;
        ...
        if not init then
            context:createPen (1,  instance.parameters.style,  1, Up)
			context:createPen (11,  instance.parameters.style,  1, Down)
			
			 context:createPen (2,  instance.parameters.style,  2, Up)
			context:createPen (12,  instance.parameters.style,  2, Down)
			
			context:createPen (3,  instance.parameters.style,  3, Up)
			context:createPen (13,  instance.parameters.style,  3, Down)
			
			context:createPen (4,  instance.parameters.style,  4, Up)
			context:createPen (14,  instance.parameters.style, 4, Down)
			
			context:createPen (5,  instance.parameters.style, 5, Up)
			context:createPen (15,  instance.parameters.style,  5, Down)
            init = true;
        end
    ...
    for i= source:size()-1, FIRST, -1 do	
		...
		--  x, y math2d.lineIntersection (l1x1, l1y1, l1x2, l1y2, l2x1, l2y1, l2x2, l2y2)
			...
			elseif X < 60 then
			  context:drawLine (3, x1, top, x1, bottom);
			 context:drawLine (3, left, y, right ,y )
			elseif X < 80 then
			  context:drawLine (4, x1, top, x1, bottom);
			 context:drawLine (4, left, y, right ,y )
			  else 
			  context:drawLine (5, x1, top, x1, bottom);
			 context:drawLine (5, left, y, right ,y )
			 end
			 end
			 ...
			 if X < 20 then
			 context:drawLine (11, x1, top, x1, bottom);
			 context:drawLine (11, left, y, right , y)
			 elseif X < 40 then
			 context:drawLine (12, x1, top, x1, bottom);
			 context:drawLine (12, left, y, right , y)
			 elseif X < 60 then
			 context:drawLine (13, x1, top, x1, bottom);
			 context:drawLine (13, left, y, right , y)
			 elseif X < 80 then
			 context:drawLine (14, x1, top, x1, bottom);
			 context:drawLine (14, left, y, right , y)
			 else
			 context:drawLine (15, x1, top, x1, bottom);
			 context:drawLine (15, left, y, right , y)
			 end
			 end
