...
function Init()
    ...
    indicator.parameters:addDouble("extension_1", "Extension 1, %", "", 1.272)
    indicator.parameters:addDouble("extension_2", "Extension 2, %", "", 1.5);
    indicator.parameters:addDouble("extension_3", "Extension 3, %", "", 1.618);
...
local extension_1, extension_2, extension_3
local init = false;
function Draw(stage, context) 
    ...
    if not init then
        ...
        extension_1 = instance.parameters.extension_1;
        extension_2 = instance.parameters.extension_2;
        extension_3 = instance.parameters.extension_3;
    ...
    local _, extension_y_1 = context:pointOfPrice(math.max(peak1, peak2) * (1 + extension_1 / 100));
    local _, extension_y_2 = context:pointOfPrice(math.min(peak1, peak2) * (1 + extension_2 / 100));
    local _, extension_y_3 = context:pointOfPrice(math.min(peak1, peak2) * (1 + extension_3 / 100));
