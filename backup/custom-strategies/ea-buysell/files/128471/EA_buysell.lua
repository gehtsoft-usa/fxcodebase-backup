...
local STRATEGY_NAME = "EA_buysell";
...
function CreateIndicators(source) 
    local profile = core.indicators:findIndicator("INDIC_BUYSELL");
    assert(profile ~= nil, "Please, download and install " .. "INDIC_BUYSELL" .. ".LUA indicator");
    local indicatorParams = profile:parameters();
    indi = core.indicators:create("INDIC_BUYSELL", source);
end
