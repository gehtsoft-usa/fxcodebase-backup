...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=69179
...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addInteger("P1", "Short Period", "", 7);
    strategy.parameters:addInteger("P2", "Long Period", "", 14);
	
     strategy.parameters:addGroup("MA Calculation");
	 strategy.parameters:addInteger("M1", "MA Period", "", 7);
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "TSIS");
...
function Prepare( nameOnly)
    ...
    TSI = core.indicators:create("TSI", Source.close, instance.parameters.P1, instance.parameters.P2 );
	MA1 = core.indicators:create(instance.parameters.Method, TSI.DATA, instance.parameters.M1 ); 
...
function ExitFunction(id, now,period)
	...
	--/////////////////////////////////////////////////////////////////////
		            ...
		            if   Source.close[period]< MA3.DATA[period]
					then
...
function EntryFunction( id, now,period)
    ...
    if   TSI.DATA[period]> MA1.DATA[period]
	and    TSI.DATA[period-1]<= MA1.DATA[period-1] 
	then	
		...
		Return=true;
    elseif   TSI.DATA[period]< MA1.DATA[period]
	and    TSI.DATA[period-1]>= MA1.DATA[period-1]
