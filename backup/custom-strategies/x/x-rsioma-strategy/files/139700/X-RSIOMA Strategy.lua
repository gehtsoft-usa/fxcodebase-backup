...
local STRATEGY_NAME = "X-RSIOMA Strategy";
...
function CreateEntryIndicators(source) 
    local profile = core.indicators:findIndicator("X-RSIOMA");
    assert(profile ~= nil, "Please, download and install " .. "X-RSIOMA" .. ".LUA indicator");
    local indicatorParams = profile:parameters();
    indicatorParams:setBoolean("rsi_use_obos", instance.parameters.rsi_use_obos);
    indicatorParams:setBoolean("strategy_output", true);
    indicatorParams:setInteger("RSIOMA", instance.parameters.RSIOMA);
    indicatorParams:setInteger("Ma_RSIOMA", instance.parameters.Ma_RSIOMA);
    indicatorParams:setInteger("rsi_os", instance.parameters.rsi_os);
    indicatorParams:setInteger("rsi_ob", instance.parameters.rsi_ob);
    indi = core.indicators:create("X-RSIOMA", source, indicatorParams)
end
