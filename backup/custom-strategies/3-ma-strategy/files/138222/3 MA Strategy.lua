...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=70532
...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addInteger("Period", "Cross Period", "", 5);

    strategy.parameters:addGroup("1. MA Calculation");
    
	
	strategy.parameters:addInteger("Period_1", "Period", "", 5);
	
	strategy.parameters:addString("Price_1", "Price Source", "", "close");
    strategy.parameters:addStringAlternative("Price_1", "OPEN", "", "open");
    strategy.parameters:addStringAlternative("Price_1", "HIGH", "", "high");
    strategy.parameters:addStringAlternative("Price_1", "LOW", "", "low");
    strategy.parameters:addStringAlternative("Price_1","CLOSE", "", "close");
    strategy.parameters:addStringAlternative("Price_1", "MEDIAN", "", "median");
    strategy.parameters:addStringAlternative("Price_1", "TYPICAL", "", "typical");
    strategy.parameters:addStringAlternative("Price_1", "WEIGHTED", "", "weighted");	

	strategy.parameters:addString("Method_1", "MA Method", "Method" , "EMA");
    strategy.parameters:addStringAlternative("Method_1", "MVA", "MVA" , "MVA");
    strategy.parameters:addStringAlternative("Method_1", "EMA", "EMA" , "EMA");
    strategy.parameters:addStringAlternative("Method_1", "LWMA", "LWMA" , "LWMA");
    strategy.parameters:addStringAlternative("Method_1", "TMA", "TMA" , "TMA");
    strategy.parameters:addStringAlternative("Method_1", "SMMA", "SMMA" , "SMMA");
    strategy.parameters:addStringAlternative("Method_1", "KAMA", "KAMA" , "KAMA");
    strategy.parameters:addStringAlternative("Method_1", "VIDYA", "VIDYA" , "VIDYA");
    strategy.parameters:addStringAlternative("Method_1", "WMA", "WMA" , "WMA");
	
	strategy.parameters:addGroup("2. MA Calculation");
    
	
	strategy.parameters:addInteger("Period_2", "Period", "", 20);
	
	strategy.parameters:addString("Price_2", "Price Source", "", "close");
    strategy.parameters:addStringAlternative("Price_2", "OPEN", "", "open");
    strategy.parameters:addStringAlternative("Price_2", "HIGH", "", "high");
    strategy.parameters:addStringAlternative("Price_2", "LOW", "", "low");
    strategy.parameters:addStringAlternative("Price_2","CLOSE", "", "close");
    strategy.parameters:addStringAlternative("Price_2", "MEDIAN", "", "median");
    strategy.parameters:addStringAlternative("Price_2", "TYPICAL", "", "typical");
    strategy.parameters:addStringAlternative("Price_2", "WEIGHTED", "", "weighted");	

	strategy.parameters:addString("Method_2", "MA Method", "Method" , "EMA");
    strategy.parameters:addStringAlternative("Method_2", "MVA", "MVA" , "MVA");
    strategy.parameters:addStringAlternative("Method_2", "EMA", "EMA" , "EMA");
    strategy.parameters:addStringAlternative("Method_2", "LWMA", "LWMA" , "LWMA");
    strategy.parameters:addStringAlternative("Method_2", "TMA", "TMA" , "TMA");
    strategy.parameters:addStringAlternative("Method_2", "SMMA", "SMMA" , "SMMA");
    strategy.parameters:addStringAlternative("Method_2", "KAMA", "KAMA" , "KAMA");
    strategy.parameters:addStringAlternative("Method_2", "VIDYA", "VIDYA" , "VIDYA");
    strategy.parameters:addStringAlternative("Method_2", "WMA", "WMA" , "WMA");
	
	
	strategy.parameters:addGroup("3. MA Calculation");
    
	
	strategy.parameters:addInteger("Period_3", "Period", "", 50);
	
	strategy.parameters:addString("Price_3", "Price Source", "", "close");
    strategy.parameters:addStringAlternative("Price_3", "OPEN", "", "open");
    strategy.parameters:addStringAlternative("Price_3", "HIGH", "", "high");
    strategy.parameters:addStringAlternative("Price_3", "LOW", "", "low");
    strategy.parameters:addStringAlternative("Price_3","CLOSE", "", "close");
    strategy.parameters:addStringAlternative("Price_3", "MEDIAN", "", "median");
    strategy.parameters:addStringAlternative("Price_3", "TYPICAL", "", "typical");
    strategy.parameters:addStringAlternative("Price_3", "WEIGHTED", "", "weighted");	

	strategy.parameters:addString("Method_3", "MA Method", "Method" , "EMA");
    strategy.parameters:addStringAlternative("Method_3", "MVA", "MVA" , "MVA");
    strategy.parameters:addStringAlternative("Method_3", "EMA", "EMA" , "EMA");
    strategy.parameters:addStringAlternative("Method_3", "LWMA", "LWMA" , "LWMA");
    strategy.parameters:addStringAlternative("Method_3", "TMA", "TMA" , "TMA");
    strategy.parameters:addStringAlternative("Method_3", "SMMA", "SMMA" , "SMMA");
    strategy.parameters:addStringAlternative("Method_3", "KAMA", "KAMA" , "KAMA");
    strategy.parameters:addStringAlternative("Method_3", "VIDYA", "VIDYA" , "VIDYA");
    strategy.parameters:addStringAlternative("Method_3", "WMA", "WMA" , "WMA");
...
function Prepare( nameOnly)
   ...
   Period = instance.parameters.Period;
    ...
    MA1 = core.indicators:create(instance.parameters.Method_1 , Source[instance.parameters.Price_1], instance.parameters.Period_1 );
	MA2 = core.indicators:create(instance.parameters.Method_2 , Source[instance.parameters.Price_2], instance.parameters.Period_2 );
    MA3 = core.indicators:create(instance.parameters.Method_3 , Source[instance.parameters.Price_3], instance.parameters.Period_3 );	
...
function ExitFunction(id, now,period)
	...
	--/////////////////////////////////////////////////////////////////////
					...
					or   MA1.DATA[period] <  MA3.DATA[period]
					or   MA2.DATA[period] <  MA3.DATA[period]
					then
...
function EntryFunction( id, now,period)
    ...
    local Return=false;
     ...
     --medium has crossed the slow within 5 hours of the fast crossing the slow
	  
    if   MA1.DATA[period] >   MA2.DATA[period]
	and  MA1.DATA[period-1] <=   MA2.DATA[period-1]
	and   MA1.DATA[period] >  MA3.DATA[period]
	and   MA2.DATA[period] >  MA3.DATA[period]
	and   Source.close[period] >  MA3.DATA[period]
	and  (period-Last_Cross(period)) <= Period
	then	
          if Direction then
                BUY();
            else
...
function Last_Cross(period)

	local Return=first;

	for i=period, first, -1 do

		if core.crosses(MA2.DATA, MA3.DATA, i) then
		Return=i;
		break;
		end
