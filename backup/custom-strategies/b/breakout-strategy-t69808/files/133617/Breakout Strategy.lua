...
--http://fxcodebase.com/code/viewtopic.php?f=31&t=69808
...
local STRATEGY_NAME = "Breakout Strategy";
...
function IsEntryLong(source, period)
    ...
    return source.open[period - 1] < source.close[period - 1]
...
function OpenTrade(side)
    ...
    if use_limit then
        valuemap.RateLimit = main_source.close[NOW] + (main_source.close[NOW] - main_source.low[NOW - 1]);
    end
