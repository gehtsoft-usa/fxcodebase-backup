...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=64022
...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addDouble("BL", "Buy Level", "", 0.5)
    strategy.parameters:addDouble("BE", "Buy Exit", "", 0.8)
    strategy.parameters:addDouble("SL", "Sell Level", "", 0.5)
    strategy.parameters:addDouble("SE", "Sell Exit", "", 0.2)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if
        Indicator.Line2[period] > BL and Indicator.Line1[period] < BE and
            Indicator.Line1[period] > Indicator.Line2[period] and
            Indicator.Line1[period - 1] <= Indicator.Line2[period - 1]
     then
        if Direction then
            BUY()
        else
    ...
    elseif
        Indicator.Line2[period] < SL and Indicator.Line1[period] > SE and
            Indicator.Line1[period] < Indicator.Line2[period] and
            Indicator.Line1[period - 1] >= Indicator.Line2[period - 1]
     then
        if Direction then
