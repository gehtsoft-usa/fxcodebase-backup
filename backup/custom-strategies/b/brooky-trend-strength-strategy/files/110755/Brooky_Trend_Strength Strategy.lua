...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=64361
...
function Init() --The strategy profile initialization
    strategy:name("Brooky_Trend_Strength")
    ...
    strategy.parameters:addInteger("slow_period", "slow_period", "", 26)
    strategy.parameters:addInteger("fast_period", "fast_period", "", 12)
    strategy.parameters:addInteger("signal_period", "signal_period", "", 9)
    strategy.parameters:addString("slow_period_method", "slow_period_method", "", "MVA")
    strategy.parameters:addStringAlternative("slow_period_method", "MVA", "", "MVA")
    strategy.parameters:addStringAlternative("slow_period_method", "EMA", "", "EMA")
    strategy.parameters:addStringAlternative("slow_period_method", "KAMA", "", "KAMA")
    strategy.parameters:addStringAlternative("slow_period_method", "LWMA", "", "LWMA")
    strategy.parameters:addStringAlternative("slow_period_method", "TMA", "", "TMA")
    strategy.parameters:addString("fast_period_method", "fast_period_method", "", "MVA")
    strategy.parameters:addStringAlternative("fast_period_method", "MVA", "", "MVA")
    strategy.parameters:addStringAlternative("fast_period_method", "EMA", "", "EMA")
    strategy.parameters:addStringAlternative("fast_period_method", "KAMA", "", "KAMA")
    strategy.parameters:addStringAlternative("fast_period_method", "LWMA", "", "LWMA")
    strategy.parameters:addStringAlternative("fast_period_method", "TMA", "", "TMA")
    strategy.parameters:addString("signal_period_method", "signal_period_method", "", "MVA")
    strategy.parameters:addStringAlternative("signal_period_method", "MVA", "", "MVA")
    strategy.parameters:addStringAlternative("signal_period_method", "EMA", "", "EMA")
    strategy.parameters:addStringAlternative("signal_period_method", "KAMA", "", "KAMA")
    strategy.parameters:addStringAlternative("signal_period_method", "LWMA", "", "LWMA")
    strategy.parameters:addStringAlternative("signal_period_method", "TMA", "", "TMA")
    ...
    strategy.parameters:addDouble("min_move", "min_move", "", 1.)
    strategy.parameters:addInteger("hi_lo_bars_back", "hi_lo_bars_back", "", 5)

    strategy.parameters:addDouble("BL", "Buy Level", "", 0)
    strategy.parameters:addDouble("SL", "Sell Level", "", 0)
...
function Prepare(nameOnly)
    ...
    assert(
        core.indicators:findIndicator("BROOKY_TREND_STRENGTH") ~= nil,
        "Please, download and install BROOKY_TREND_STRENGTH.LUA indicator"
    )
    ...
    first = Indicator.BuffSignal:first()
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if not Indicator.BuffSignal:hasData(period - 1) or period < first + 1 then
        return
    end
...
buy: signal < buy level and UP < buy level and UP cross over signal
    ...
    if
        Indicator.BuffSignal[period] < BL and Indicator.BuffUP[period] < BL and
            Indicator.BuffUP[period] > Indicator.BuffSignal[period] and
            Indicator.BuffUP[period - 1] <= Indicator.BuffSignal[period - 1]
     then
        --[[
sell; signal< sell level and DN < sell level and DN cross over signal
        ...
        Return = true
    elseif
        Indicator.BuffSignal[period] < SL and Indicator.BuffDN[period] < SL and
            Indicator.BuffDN[period] > Indicator.BuffSignal[period] and
            Indicator.BuffDN[period - 1] <= Indicator.BuffSignal[period - 1]
     then
        if Direction then
            SELL()
        else
