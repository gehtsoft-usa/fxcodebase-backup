...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=25449
...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addInteger("MP", " Period", " Period", 14);
	
	
     strategy.parameters:addGroup("RLW Calculation");
	  strategy.parameters:addInteger("RP", " Period", " Period", 14);
...
function Prepare(nameOnly)
    ...
    Indicator[1] = core.indicators:create("RLW", Source, RP  );
	Short[1] = Indicator[1]:getStream(0);
	
    assert(core.indicators:findIndicator(Method) ~= nil, Method .. " indicator must be installed");
	  Indicator[2] = core.indicators:create(Method, Short[1], MP  );
