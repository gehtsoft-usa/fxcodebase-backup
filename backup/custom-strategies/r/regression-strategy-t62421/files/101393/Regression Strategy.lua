...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=62421
...
strategy:setTag("NonOptimizableParameters", "Email,SendEmail,SoundFile,RecurrentSound,PlaySound, ShowAlert");
	...
	strategy.parameters:addString("Fast_Price", "Price Source", "", "close");
    strategy.parameters:addStringAlternative("Fast_Price", "OPEN", "", "open");
    strategy.parameters:addStringAlternative("Fast_Price", "HIGH", "", "high");
    strategy.parameters:addStringAlternative("Fast_Price", "LOW", "", "low");
    strategy.parameters:addStringAlternative("Fast_Price","CLOSE", "", "close");
    strategy.parameters:addStringAlternative("Fast_Price", "MEDIAN", "", "median");
    strategy.parameters:addStringAlternative("Fast_Price", "TYPICAL", "", "typical");
    strategy.parameters:addStringAlternative("Fast_Price", "WEIGHTED", "", "weighted");	
	strategy.parameters:addInteger("Fast_Period", "Period", "", 14);
	

	strategy.parameters:addString("Slow_Price", "Price Source", "", "close");
    strategy.parameters:addStringAlternative("Slow_Price", "OPEN", "", "open");
    strategy.parameters:addStringAlternative("Slow_Price", "HIGH", "", "high");
    strategy.parameters:addStringAlternative("Slow_Price", "LOW", "", "low");
    strategy.parameters:addStringAlternative("Slow_Price","CLOSE", "", "close");
    strategy.parameters:addStringAlternative("Slow_Price", "MEDIAN", "", "median");
    strategy.parameters:addStringAlternative("Slow_Price", "TYPICAL", "", "typical");
    strategy.parameters:addStringAlternative("Slow_Price", "WEIGHTED", "", "weighted");	
    strategy.parameters:addInteger("Slow_Period", "Period", "", 50);
...
local first;
local Fast,Slow;
local Slow_Period,Slow_Price,Fast_Period,Fast_Price;
local Short={};
local Direction;
local CustomID;
...
function Prepare( nameOnly)
    ...
    Fast = core.indicators:create("REGRESSION", Source[Fast_Price], Fast_Period  );
	Slow = core.indicators:create("REGRESSION", Source[Slow_Price], Slow_Period  );
