...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=60040
...
function Init() --The strategy profile initialization
    strategy:name("Repulse Indicator Strategy");
...
function Prepare(nameOnly)
   ...
   SL = instance.parameters.SL;
    ...
    local i;
	   ...
	   name = name .. ", " .. RepulsePeriod1 .. ", " .. RepulsePeriod2 .. ", " .. RepulsePeriod3;
    ...
    Indicator[1] = core.indicators:create("REPULSE", Source, RepulsePeriod1 , RepulsePeriod2, RepulsePeriod3   );
   ...
   -- get only time
    now = now - math.floor(now);
      ...
      return ;
        ...
        if   Short[2][period]> Short[3][period]
		and Short[1][period] > BL
		and core.crossesOver (Short[1], Short[2], period)
		then
		...
		elseif   Short[2][period]< Short[3][period]
		and Short[1][period] < SL
		and core.crossesUnder (Short[1], Short[2], period)
		 then
            if Direction then
                SELL();
            else
