...
function IsEntryLong(source, period)
    return RSI.DATA[period] > EMA.DATA[period] and EMA.DATA[period] > ma2.DATA[period];
end
function IsEntryShort(source, period)
    return RSI.DATA[period] < EMA.DATA[period] and EMA.DATA[period] < ma2.DATA[period];
end
function IsExitLong(source, period)
    return RSI.DATA[period] < EMA.DATA[period];
end
