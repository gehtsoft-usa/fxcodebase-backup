...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=3507
...
function Init() --The strategy profile initialization
    strategy:name("Regression/Super Trend Cross Strategy");
...
function Prepare( nameOnly)
   ...
   assert(core.indicators:findIndicator("SUPERTREND") ~= nil, "Please, download and install SUPERTREND.LUA indicator");
    ...
    local name;
    name = profile:id() .. "(" .. instance.bid:name() .. "." .. instance.parameters.TF..", " .. N ..", " .. M..", " .. RF .. ")";
    instance:name(name);
	...
	indicator[2]  = core.indicators:create("SUPERTREND", Source, N,M);
