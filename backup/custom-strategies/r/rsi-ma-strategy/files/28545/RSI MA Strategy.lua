...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=15072
...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addInteger("RP", "RSI Period", "", 14);
    

    strategy.parameters:addGroup("Trade");
    strategy.parameters:addInteger("MP", "Moving Average", "", 20, 1 , 1000);
	strategy.parameters:addString("Method", "Moving Average Method", "Method" , "MVA");
	...
	strategy.parameters:addStringAlternative("Method", "VAMA", "VAMA" , "VAMA");	
	strategy.parameters:addStringAlternative("Method", "NONLAGMA", "NONLAGMA", "NONLAGMA"); 
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "RS");
...
local Method,Price, RP, MP, Indicator, MA;
...
function Prepare( nameOnly)
    ...
    Indicator = core.indicators:create("RSI", Source[Price], RP   );	
	MA=core.indicators:create(Method, Indicator.DATA, MP   );
	first=MA.DATA:first(); 
