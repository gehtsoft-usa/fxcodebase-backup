...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addIntegerAlternative("EntryMethod", "Out of the zone cross", "Out of the zone cross" , 2);
	 ...
	 strategy.parameters:addInteger("ExitMethod", "In the zone cross", "Exit Method" , 1);
...
function ExtUpdate(id, source, period)  -- The method called every time when a new bid or ask price appears.
   ...
   -- get only time
	...
	--BuySignal =  core.crossesUnder(Indicator.DATA, BuyLevel,period);
	--SellSignal =  core.crossesOver(Indicator.DATA, SellLevel,period);
	...
	--BuySignal =  core.crossesOver(Indicator.DATA, BuyLevel,period);
	--SellSignal = core.crossesUnder(Indicator.DATA, SellLevel,period);
