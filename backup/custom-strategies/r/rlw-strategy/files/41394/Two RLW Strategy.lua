...
function Init() --The strategy profile initialization
    strategy:name("Two RLW Strategy");
    ...
    strategy.parameters:addInteger("SP", "Short Period", "", 50);
    strategy.parameters:addInteger("LP", "Long Period", "",  200);
...
function Prepare(nameOnly)
	...
	Indicator[2] = core.indicators:create("RLW", Source, LP );
