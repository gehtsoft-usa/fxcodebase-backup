...
--http://fxcodebase.com/code/viewtopic.php?f=31&t=63223
...
function Init() --The strategy profile initialization
    strategy:name("Reverse Candle Strategy");
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "RCS");
...
Stop loss should be set to the pipsize of the reverse candle (so distance between reverse candle high and low) with 1% of my account value, take profit individual.
Long reverse candles are the opposite.
	...
	Stop=(Source.high[period]-Source.low[period])/Source:pipSize();
