...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=65939
...
function Init() --The strategy profile initialization
    strategy:name("Range Indicator Strategy");
    ...
    strategy.parameters:setFlag("TF", core.FLAG_PERIODS);
   	...
   	strategy.parameters:addString("Mode", "Method", "Method" , "High/Low");
    strategy.parameters:addStringAlternative("Mode", "High/Low", "High/Low" , "High/Low");
    strategy.parameters:addStringAlternative("Mode", "Open/Close", "Open/Close" , "Open/Close");

	
	strategy.parameters:addDouble("Level", "Alert Level in pips", "" , 20);
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "RIS");
