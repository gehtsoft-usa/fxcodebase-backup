...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=10946
...
function Init() --The strategy profile initialization
    strategy:name("Super Trend Oscillator Strategy")
...
function Prepare(nameOnly)
    ...
    assert(
        core.indicators:findIndicator("SUPERTRENDOSCILLATOR") ~= nil,
        "Please, download and install SUPERTRENDOSCILLATOR.LUA indicator"
    )
    ...
    Indicator[1] = core.indicators:create("SUPERTRENDOSCILLATOR", Source, core.rgb(0, 255, 0), core.rgb(255, 0, 0))
    Short[1] = Indicator[1]:getStream(0)

    first = Short[1]:first() + 1
