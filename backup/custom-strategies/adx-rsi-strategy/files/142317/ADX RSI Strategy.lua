...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addDouble("RSI_Buy_Level", "Buy Level", "", 50);
	strategy.parameters:addDouble("RSI_Sell_Level", "Sell Level", "", 50);
...
local RSI, RSI_Period, RSI_Buy_Level,  RSI_Sell_Level, ADX,  ADX_Period, ADX_Level;
local MA1,MA2;
...
function ExitFunction(id, now,period)
	...
	--/////////////////////////////////////////////////////////////////////
	  	--RSI, RSI_Period, RSI_Buy_Level,  RSI_Sell_Level, ADX,  ADX_Period, ADX_Level; 
...
function EntryFunction( id, now,period)
    ...
    if RSI.DATA[period] > RSI_Buy_Level
	and   ADX.DATA[period] > ADX_Level
	and   ADX.DATA[period-1] <= ADX_Level
	and MA1.DATA[period1]>  MA2.DATA[period1]
	then	
          if Direction then
                BUY();
            else
		...
		Return=true;
    elseif RSI.DATA[period] < RSI_Sell_Level
	and   ADX.DATA[period] > ADX_Level
	and   ADX.DATA[period-1] <= ADX_Level
	and MA1.DATA[period1]<  MA2.DATA[period1]
	then
