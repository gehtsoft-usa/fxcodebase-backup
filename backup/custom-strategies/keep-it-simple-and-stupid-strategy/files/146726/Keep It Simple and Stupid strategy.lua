...
-- https://fxcodebase.com/code/viewtopic.php?f=31&t=72493
...
function Init() --The strategy profile initialization
    strategy:name(" Keep It Simple and Stupid  strategy");
    ...
    strategy.parameters:addGroup("Calculatiob");
    strategy.parameters:addInteger("Period1", "1. MA Period", "", 20);  
    strategy.parameters:addInteger("Period2", "2. MA Period", "", 180);  
    strategy.parameters:addInteger("Period3", "3. MA Period", "", 200);  	
    strategy.parameters:addInteger("Period", "ADX Period", "", 14);  
    strategy.parameters:addDouble("Level", "ADX Level", "", 12);   
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "KISASS");
...
function Prepare( nameOnly)
    ...
    MA1 = core.indicators:create("MVA", Source.close, instance.parameters.Period1 );
    MA2 = core.indicators:create("MVA", Source.close, instance.parameters.Period2 );
    MA3 = core.indicators:create("MVA", Source.close, instance.parameters.Period3 );
    ADX = core.indicators:create("ADX", Source, instance.parameters.Period );	
	first=math.max(MA1.DATA:first(),MA2.DATA:first(),MA3.DATA:first(),ADX.DATA:first()); 
