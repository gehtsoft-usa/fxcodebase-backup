...
-- https://fxcodebase.com/code/viewtopic.php?f=31&t=72483
...
function Init() --The strategy profile initialization
    strategy:name("SAR Trend Stop Strategy");
...
function CreateTradingParameters()
   ...
   -- strategy.parameters:addStringAlternative("ExitExecutionType", "End of Turn", "", "EndOfTurn");
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "STSS");
...
function Prepare( nameOnly)
    ...
    Indicator = core.indicators:create("TRENDSTOP", Source,  instance.parameters.Period,  instance.parameters.Mode)
   -- Line = Indicator:getStream(0)
...
function EntryFunction( id, now,period)
    ...
    if  Indicator.DATA[period] < Source.close[period] 
	...
	then	
		...
		Return=true;
    elseif Indicator.DATA[period] > Source.close[period] 
