...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=61144
...
Exit when price=20 period Bollinger mid band 
    ...
    if
        Source.close[period - 1] < BB.BL[period - 1] and Stochastic.K[period - 1] < 30 and
            RSI.DATA[period] > RSI.DATA[period - 1] and
            Stochastic.K[period] > Stochastic.K[period - 1]
     then
        if Reverse then
            SELL()
        else
    ...
    elseif
        Source.close[period - 1] > BB.TL[period - 1] and Stochastic.K[period - 1] > 70 and
            RSI.DATA[period] < RSI.DATA[period - 1] and
            Stochastic.K[period] < Stochastic.K[period - 1]
     then
        if Reverse then
