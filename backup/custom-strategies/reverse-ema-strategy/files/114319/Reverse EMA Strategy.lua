...
function Init() --The strategy profile initialization
    strategy:name("Reverse EMA Strategy")
    ...
    strategy.parameters:addDouble("Trend", "Trend", "", 0.05) --39
    strategy.parameters:addDouble("Cycle", "Cycle", "", 0.3) --6
...
function Prepare(nameOnly)
    ...
    assert(
        core.indicators:findIndicator("REVERSE EMA") ~= nil,
        "Please, download and install REVERSE EMA.LUA indicator"
    )
    ...
    Trend = core.indicators:create("REVERSE EMA", Source.close, instance.parameters.Trend)
    Cycle = core.indicators:create("REVERSE EMA", Source.close, instance.parameters.Cycle)
