...
function Init() --The strategy profile initialization
    strategy:name("Tick SAR Strategy")
...
function Prepare(nameOnly)
    ...
    local name
    Parameters["Price"] = instance.parameters.Price
        ...
        ", " ..
            instance.parameters.TF ..
                "(" ..
                    ", " ..
                        Parameters["Step"] ..
                            ", " .. Parameters["Max"] .. ", " .. Parameters["Price"] .. "," .. CustomID .. " )"
    instance:name(name)
    ...
    SAR = core.indicators:create("TICK_SAR", Source[Parameters["Price"]], Parameters["Step"], Parameters["Max"])
