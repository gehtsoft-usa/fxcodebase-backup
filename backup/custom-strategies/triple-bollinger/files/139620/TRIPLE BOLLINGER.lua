...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=70725
...
local STRATEGY_NAME = "TRIPLE BOLLINGER";
function CreateParameters() 
    strategy.parameters:addInteger("BB_Periods", "BB Periods", "BB Periods", 20)
    strategy.parameters:addDouble("BB_Deviations", "BB Deviations", "BB Deviations", 3.14)
    strategy.parameters:addInteger("BB1_Periods", "BB1 Periods", "BB1 Periods", 20)
    strategy.parameters:addDouble("BB1_Deviations", "BB1 Deviations", "BB1 Deviations", 2)
    strategy.parameters:addInteger("BB2_Periods", "BB2 Periods", "BB2 Periods", 20)
    strategy.parameters:addDouble("BB2_Deviations", "BB2 Deviations", "BB2 Deviations", 0.75)
    strategy.parameters:addInteger("BB3_Periods", "BB3 Periods", "BB3 Periods", 20)
    strategy.parameters:addDouble("BB3_Deviations", "BB3 Deviations", "BB3 Deviations", 0.75)
end

local BB, BB1, BB2, BB3;
function CreateEntryIndicators(source)
    BB = core.indicators:create("BB", source.close, instance.parameters["BB_Periods"], instance.parameters["BB_Deviations"])
    BB1 = core.indicators:create("BB", source.close, instance.parameters["BB1_Periods"], instance.parameters["BB1_Deviations"])
    BB2 = core.indicators:create("BB", source.close, instance.parameters["BB2_Periods"], instance.parameters["BB2_Deviations"])
    BB3 = core.indicators:create("BB", source.close, instance.parameters["BB3_Periods"], instance.parameters["BB3_Deviations"])
end
...
function IsEntryLong(source, period)
    return core.crossesOver(source.close, BB3.BL, period) 
        or core.crossesOver(source.close, BB2.BL, period) 
        or core.crossesOver(source.close, BB1.BL, period) 
        or core.crossesOver(source.close, BB.AL, period) 
        or core.crossesOver(source.close, BB1.TL, period);
end
function IsEntryShort(source, period)
    return core.crossesUnder(source.close, BB3.TL, period) 
        or core.crossesUnder(source.close, BB2.TL, period) 
        or core.crossesUnder(source.close, BB1.TL, period) 
        or core.crossesUnder(source.close, BB.AL, period) 
        or core.crossesUnder(source.close, BB1.BL, period);
end
function IsExitLong(source, period)
    return core.crossesOver(source.close, BB3.TL, period) 
        or core.crossesUnder(source.close, BB2.TL, period);
end
function IsExitShort(source, period)
    return core.crossesUnder(source.close, BB3.BL, period) 
        or core.crossesOver(source.close, BB2.BL, period);
end
