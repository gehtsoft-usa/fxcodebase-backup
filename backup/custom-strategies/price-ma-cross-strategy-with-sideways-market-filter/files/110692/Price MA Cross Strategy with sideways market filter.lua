...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=64331
...
function Init() --The strategy profile initialization
    strategy:name("Price MA Cross Strategy with sideways market filter");
    ...
    strategy.parameters:addStringAlternative("Method", "WMA", "WMA" , "WMA");
	 ...
	 strategy.parameters:addGroup("Sideways market filter Calculation");
	 strategy.parameters:addInteger("Period1", "1. MA Period", "", 1);
	 strategy.parameters:addInteger("Period2", "2. MA Period", "", 50);
	 strategy.parameters:addInteger("Period3", "3. MA Period", "", 100);
	 strategy.parameters:addInteger("Period4", "4. MA Period", "", 200);
	 strategy.parameters:addInteger("Period5", "5. MA Period", "", 500);
      strategy.parameters:addDouble("TL", "Top Level", "", 1.001);
	 strategy.parameters:addDouble("BL", "Bottom Level", "", 0.999);
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "PMCSWSMF");
...
local SMF, Period1, Period2,Period3,Period4,Period5, TL,BL;
...
function Prepare( nameOnly)
    ...
    if nameOnly then
	 ...
	 assert(core.indicators:findIndicator("SIDEWAYS MARKET FILTER") ~= nil, "Please, download and install SIDEWAYS MARKET FILTER.LUA indicator");          
    ...
    SMF = core.indicators:create("SIDEWAYS MARKET FILTER", Source, Period1, Period2,Period3,Period4,Period5 );
    assert(core.indicators:findIndicator(Method) ~= nil, Method .. " indicator must be installed");
	 MA = core.indicators:create(Method, Source.close, Period );
	first=math.max(SMF.DATA:first(), MA.DATA:first()); 
...
function EntryFunction(period,now)
	...
	and  (SMF.DATA[period]> TL or  SMF.DATA[period]< BL)
