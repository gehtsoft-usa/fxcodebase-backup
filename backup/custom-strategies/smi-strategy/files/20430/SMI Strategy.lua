...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=9510
...
function Prepare(nameOnly)
    ...
    name = name .. ", " .. Period_Q .. ", " .. Period_R .. ", " .. Period_S .. ", " .. Period_Signal
    instance:name(name)
    ...
    Indicator = core.indicators:create("SMI", Source, Period_R, Period_S, Period_Signal)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if not InRange(now, OpenTime, CloseTime) or not Short[1]:hasData(period - 1) or not Short[2]:hasData(period - 1) then
        return
    end
