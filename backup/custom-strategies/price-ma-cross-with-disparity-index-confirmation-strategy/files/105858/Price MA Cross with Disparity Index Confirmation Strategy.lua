...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=63393
...
function Init() --The strategy profile initialization
    strategy:name("Price MA Cross with Disparity Index Confirmation Strategy");
    ...
    strategy.parameters:addGroup("Disparity Index Calculation"); 
    strategy.parameters:addInteger("Period2", "Disparity period", "", 28);
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "PMCDICS");
...
local first;
local MA1, MA2, Period1, Period2, Method1, Method2;
local Direction;
local CustomID;
local Exit;
...
function ExtUpdate(id, source, period)  -- The method called every time when a new bid or ask price appears.
   ...
   -- get only time
	...
	if Exit then
		            if    Source.close[period]< MA2.DATA[period]
					then 			
								if   Direction then
