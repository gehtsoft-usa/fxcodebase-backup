...
--http://fxcodebase.com/code/viewtopic.php?f=31&t=70850
...
local STRATEGY_NAME = "TITI Strategy";
function CreateParameters() 
    strategy.parameters:addString("indi", "Indicator", "", "TITI");
    strategy.parameters:setFlag("indi", core.FLAG_INDICATOR);
    strategy.parameters:addInteger("buy_index", "Buy Stream Index", "", 1);
    strategy.parameters:addInteger("sell_index", "Sell Stream Index", "", 2);
end

local indi;
function CreateEntryIndicators(source)
    indi = core.indicators:create(instance.parameters.indi, source, instance.parameters:getCustomParameters("indi"));
end
...
function IsEntryLong(source, period)
    return indi:getTextOutput(instance.parameters.buy_index - 1):hasData(period);
end
function IsEntryShort(source, period)
    return indi:getTextOutput(instance.parameters.sell_index - 1):hasData(period);
end
