...
function ExtUpdate(id, source, period)  -- The method called every time when a new bid or ask price appears.
	...
	if CCI.DATA:colorI(period) ==  core.rgb(0, 255, 0) then
	CountNow= CountNow+1;
	elseif CCI.DATA:colorI(period) ==  core.rgb(255, 0, 0) then
	CountNow= CountNow-1;
	end 
	
	
	if CCI.DATA:colorI(period-1) ==  core.rgb(0, 255, 0) then
	CountPrevious= CountPrevious+1;
	elseif CCI.DATA:colorI(period-1) ==  core.rgb(255, 0, 0) then
	CountPrevious= CountPrevious-1;
	end 
	
	
	--Gann
    if Gann.DATA:colorI(period) ==  core.rgb(0, 255, 0) then
	CountNow= CountNow+1;
	elseif Gann.DATA:colorI(period) ==  core.rgb(255, 0, 0) then
	CountNow= CountNow-1;
	end 
	
	
	if Gann.DATA:colorI(period-1) ==  core.rgb(0, 255, 0) then
	CountPrevious= CountPrevious+1;
	elseif Gann.DATA:colorI(period-1) ==  core.rgb(255, 0, 0) then
	CountPrevious= CountPrevious-1;
	end 
	
	--TVI
    if TVI.DATA:colorI(period) ==  core.rgb(0, 255, 0) then
	CountNow= CountNow+1;
	elseif TVI.DATA:colorI(period) ==  core.rgb(255, 0, 0) then
	CountNow= CountNow-1;
	end 
	
	
	if TVI.DATA:colorI(period-1) ==  core.rgb(0, 255, 0) then
	CountPrevious= CountPrevious+1;
	elseif TVI.DATA:colorI(period-1) ==  core.rgb(255, 0, 0) then
	CountPrevious= CountPrevious-1;
	end 
	
	--T3
    if T3.DATA:colorI(period) ==  core.rgb(0, 255, 0) then
	CountNow= CountNow+1;
	elseif T3.DATA:colorI(period) ==  core.rgb(255, 0, 0) then
	CountNow= CountNow-1;
	end 
	
	
	if T3.DATA:colorI(period-1) ==  core.rgb(0, 255, 0) then
	CountPrevious= CountPrevious+1;
	elseif T3.DATA:colorI(period-1) ==  core.rgb(255, 0, 0) then
	CountPrevious= CountPrevious-1;
	end 
