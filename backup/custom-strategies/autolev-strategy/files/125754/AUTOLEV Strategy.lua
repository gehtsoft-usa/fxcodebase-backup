    ...
    for i = 1, 18 do
        ...
        if i % 2 == 1 then
            action1.IsPass = function (source, period, periodFromLast, data) 
                ...
                return core.crossesOver(source.close, GetLevelPrice(source, period, data), period); 
            end
        else
            action1.IsPass = function (source, period, periodFromLast, data) 
                if period < N + 1 then
                ...
                return core.crossesUnder(source.close, GetLevelPrice(source, period, data), period); 
            end
        end
        if isEntry1 then
