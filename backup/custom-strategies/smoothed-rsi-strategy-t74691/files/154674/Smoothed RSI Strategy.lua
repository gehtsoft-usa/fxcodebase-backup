...
function Prepare( nameOnly)
	...
	assert(core.indicators:findIndicator("SMOOTHED RSI") ~= nil, "Please, download and install SMOOTHED RSI.LUA indicator");          
    ...
    Indicator = core.indicators:create("SMOOTHED RSI", Source.close ,RSIFrame, MAFrame, Method, 70, 30);
