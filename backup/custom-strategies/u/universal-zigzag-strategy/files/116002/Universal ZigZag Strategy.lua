...
--http://fxcodebase.com/code/viewtopic.php?f=31&t=65356
...
function Init() --The strategy profile initialization
    strategy:name("Universal ZigZag Strategy")
    ...
    strategy.parameters:addString("UpBandPrice", "Upper band price", "", "2")
    strategy.parameters:addStringAlternative("UpBandPrice", "close", "", "0")
    strategy.parameters:addStringAlternative("UpBandPrice", "open", "", "1")
    strategy.parameters:addStringAlternative("UpBandPrice", "high", "", "2")
    strategy.parameters:addStringAlternative("UpBandPrice", "low", "", "3")
    strategy.parameters:addStringAlternative("UpBandPrice", "median", "", "4")
    strategy.parameters:addStringAlternative("UpBandPrice", "typical", "", "5")
    strategy.parameters:addStringAlternative("UpBandPrice", "weighted close", "", "6")
    strategy.parameters:addStringAlternative("UpBandPrice", "HA close", "", "7")
    strategy.parameters:addStringAlternative("UpBandPrice", "HA open", "", "8")
    strategy.parameters:addStringAlternative("UpBandPrice", "HA high", "", "9")
    strategy.parameters:addStringAlternative("UpBandPrice", "HA low", "", "10")
    strategy.parameters:addStringAlternative("UpBandPrice", "HA median", "", "11")
    strategy.parameters:addStringAlternative("UpBandPrice", "HA typical", "", "12")
    strategy.parameters:addStringAlternative("UpBandPrice", "HA weighted", "", "13")

    strategy.parameters:addString("LoBandPrice", "Lower band price", "", "3")
    strategy.parameters:addStringAlternative("LoBandPrice", "close", "", "0")
    strategy.parameters:addStringAlternative("LoBandPrice", "open", "", "1")
    strategy.parameters:addStringAlternative("LoBandPrice", "high", "", "2")
    strategy.parameters:addStringAlternative("LoBandPrice", "low", "", "3")
    strategy.parameters:addStringAlternative("LoBandPrice", "median", "", "4")
    strategy.parameters:addStringAlternative("LoBandPrice", "typical", "", "5")
    strategy.parameters:addStringAlternative("LoBandPrice", "weighted close", "", "6")
    strategy.parameters:addStringAlternative("LoBandPrice", "HA close", "", "7")
    strategy.parameters:addStringAlternative("LoBandPrice", "HA open", "", "8")
    strategy.parameters:addStringAlternative("LoBandPrice", "HA high", "", "9")
    strategy.parameters:addStringAlternative("LoBandPrice", "HA low", "", "10")
    strategy.parameters:addStringAlternative("LoBandPrice", "HA median", "", "11")
    strategy.parameters:addStringAlternative("LoBandPrice", "HA typical", "", "12")
    strategy.parameters:addStringAlternative("LoBandPrice", "HA weighted", "", "13")

    strategy.parameters:addString("BreakOutMode", "Breakout mode", "", "0")
    strategy.parameters:addStringAlternative("BreakOutMode", "close", "", "0")
    strategy.parameters:addStringAlternative("BreakOutMode", "Up/Lo band price", "", "1")

    strategy.parameters:addDouble("ReversalValue", "Reversal Value", "", 12)

    strategy.parameters:addString("RetraceMethod", "Retrace Method", "", "0")
    strategy.parameters:addStringAlternative("RetraceMethod", "Price channel", "", "0")
    strategy.parameters:addStringAlternative("RetraceMethod", "% of price", "", "1")
    strategy.parameters:addStringAlternative("RetraceMethod", "Price change in pips", "", "2")
    strategy.parameters:addStringAlternative("RetraceMethod", "ATR multiplier", "", "3")

    strategy.parameters:addInteger("ATRPeriod", "ATR Period", "", 50)
    --  strategy.parameters:addBoolean("ShowZigZag", "Show Zigzag", "", true);
    --  strategy.parameters:addBoolean("ShowSignals", "Show signals", "", true);
    --  strategy.parameters:addBoolean("ShowPriceChannel", "Show price channel", "", true);

    strategy.parameters:addString("ZigZagChannelMode", "ZigZag Channel Mode", "", "1")
    strategy.parameters:addStringAlternative("ZigZagChannelMode", "Off", "", "0")
    strategy.parameters:addStringAlternative("ZigZagChannelMode", "High/Low channel", "", "1")
    strategy.parameters:addStringAlternative("ZigZagChannelMode", "Chaos bands", "", "2")
...
local Indicator
--local UpBandPrice,LoBandPrice, BreakOutMode, ReversalValue,RetraceMethod, ATRPeriod, true, true, true, ZigZagChannelMode, true;
local UpBandPrice, LoBandPrice, BreakOutMode, ReversalValue, RetraceMethod, ATRPeriod, ZigZagChannelMode
function Prepare(nameOnly)
    ...
    assert(
        core.indicators:findIndicator("UNIZIGZAGCHANNEL") ~= nil,
        "Please, download and install UNIZIGZAGCHANNEL.LUA indicator"
    )
...
function EntryFunction(now, period)
    ...
    if Indicator.Signal[period] == -1 then
        if Direction then
            BUY()
        else
            SELL()
        ...
        Return = true
    elseif Indicator.Signal[period] == 1 then
        if Direction then
            SELL()
        else
            BUY()
