...
function Init() --The strategy profile initialization
    strategy:name("Unusual Volume Price Movement Strategy")
    ...
    strategy.parameters:addInteger("Average_Period", "Volume Average Period", "Period", 25, 0, 100)
    ...
    strategy.parameters:addInteger("Price_Period", "Price Period", "Period", 25, 0, 100)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    elseif Source.close[period] < Bottom then
        if Direction then
            SELL()
        else
            BUY()
