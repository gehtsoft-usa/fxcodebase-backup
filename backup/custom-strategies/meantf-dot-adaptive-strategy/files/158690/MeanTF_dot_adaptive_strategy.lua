-- Available @ https://fxcodebase.com/code/viewtopic.php?f=31&t=75735
...
local STRATEGY_NAME = "MeadTF Dot Adaptive Strategy";
function CreateParameters() 
    AddAction(1, "Up Cross Over");
    AddAction(2, "Up Cross Under");
    AddAction(3, "Down Cross Over");
    AddAction(4, "Down Cross Under");
    AddAction(5, "Prev Cross Over");
    AddAction(6, "Prev Cross Under");
...
function CreateEntryIndicators(source)
    ...
    indicatorParams:setString("TF", instance.parameters.TF);
    indi = core.indicators:create("MEANTF_DOT", source, indicatorParams)
    actions[1] = 
    {
        IsPass = function (period)
            return core.crossesOver(source.close, indi.MeanUP, period);
        end
    };
    actions[2] = 
    {
        IsPass = function (period)
            return core.crossesUnder(source.close, indi.MeanUP, period);
        end
    };
    actions[3] = 
    {
        IsPass = function (period)
            return core.crossesOver(source.close, indi.MeanDN, period);
        end
    };
    actions[4] = 
    {
        IsPass = function (period)
            return core.crossesUnder(source.close, indi.MeanDN, period);
        end
    };
    actions[5] = 
    {
        IsPass = function (period)
            return core.crossesOver(source.close, indi.Prev, period);
        end
    };
    actions[6] = 
    {
        IsPass = function (period)
            return core.crossesUnder(source.close, indi.Prev, period);
        end
    };
end
