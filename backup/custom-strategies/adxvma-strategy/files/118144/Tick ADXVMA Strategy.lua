...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=65824
...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addInteger("ChandeEMA", "Chande EMA", "", 14, 2, 2000);	
	strategy.parameters:addInteger("WeightDM", "Weight DM", "", 14, 2, 2000);
	strategy.parameters:addInteger("WeightDI", "WeightDI", "", 14, 2, 2000);
	strategy.parameters:addInteger("Length", "Length", "", 14, 2, 2000);
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "ADXVMAS");
...
local Indicator;
local ChandeEMA, WeightDM, WeightDI, Length;
...
function Prepare( nameOnly)
   ...
   -- assert(TF ~= "t1", "The time frame must not be tick");
    ...
    PrepareTrading();
	 ...
	 assert(core.indicators:findIndicator("ADXVMA") ~= nil, "Please, download and install ADXVMA.LUA indicator");          
    ...
    Source = ExtSubscribe(2, nil, TF, instance.parameters.Type == "Bid", "close");
   Indicator = core.indicators:create("ADXVMA", Source, ChandeEMA, WeightDM, WeightDI, Length,  core.rgb(0, 255, 0),  core.rgb(255, 0, 0), core.rgb(128, 128, 128)  );
