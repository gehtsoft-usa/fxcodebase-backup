...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=64926&p=113575#p113575
...
function Init() --The strategy profile initialization
    strategy:name("Difference Strategy")
...
function Prepare(nameOnly)
    ...
    assert(core.indicators:findIndicator("DIFFERENCE") ~= nil, "Please, download and install DIFFERENCE.LUA indicator")
    ...
    Indicator = core.indicators:create("DIFFERENCE", Source.close, Period, false)
