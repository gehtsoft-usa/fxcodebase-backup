...
local STRATEGY_NAME = "Engulfing with BB Strategy";
...
function CreateParameters()
	...
	strategy.parameters:addBoolean("bb_filter", "BB Filter", "", false)
    ...
    strategy.parameters:addBoolean("use_ma_filter", "Use MA Filter", "", true);
    strategy.parameters:addInteger("ma_filter_period", "MA Filter Period", "", 14);
    AddAverages("ma_filter_method", "MA Filter Method", "MVA");
end

local indi, ma_filter;
function CreateEntryIndicators(source) 
    local profile = core.indicators:findIndicator("ENGULFING WITH BB");
    assert(profile ~= nil, "Please, download and install " .. "ENGULFING WITH BB" .. ".LUA indicator");
    ...
    indicatorParams:setBoolean("bb_filter", instance.parameters.bb_filter);
    indicatorParams:setBoolean("use_ma_filter", instance.parameters.use_ma_filter);
    indicatorParams:setInteger("Period", instance.parameters.Period);
    indicatorParams:setInteger("bb_period", instance.parameters.bb_period);
    indicatorParams:setInteger("ma_filter_period", instance.parameters.ma_filter_period);
    indicatorParams:setDouble("bb_deviations", instance.parameters.bb_deviations);
    indicatorParams:setString("Method", instance.parameters.Method);
    indicatorParams:setString("ma_filter_method", instance.parameters.ma_filter_method);
    indi = core.indicators:create("ENGULFING WITH BB", source, indicatorParams)
end
