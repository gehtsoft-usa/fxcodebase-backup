...
function Init() --The strategy profile initialization
    strategy:name("Modified ANN Strategy Indicator Strategy");
	...
	strategy.parameters:addDouble("threshold", "Threshold", "Threshold", 0.0014);
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "MANNSIS");
...
function Prepare( nameOnly)
    ...
    PrepareTrading();
	 ...
	 assert(core.indicators:findIndicator("MODIFIED ANN STRATEGY INDICATOR") ~= nil, "Please, download and install MODIFIED ANN STRATEGY INDICATOR.LUA indicator");          
    ...
    Indicator  = core.indicators:create("MODIFIED ANN STRATEGY INDICATOR", Source,  threshold,core.rgb(0, 255, 0),core.rgb(255, 0, 0)   );
