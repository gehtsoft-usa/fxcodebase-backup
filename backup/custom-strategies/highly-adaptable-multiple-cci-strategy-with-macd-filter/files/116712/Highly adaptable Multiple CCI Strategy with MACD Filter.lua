...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=65500
...
function Init() --The strategy profile initialization
    strategy:name("Highly adaptable Multiple CCI Strategy with MACD Filter")
    ...
    strategy.parameters:addBoolean("UseFilter", "Use MACD Filter", "", true)
...
function ACTION(Flag, Label, period)
    ...
    elseif Action[Flag] == "BUY" then
        if UseFilter and MACD.MACD[period] < MACD.SIGNAL[period] then
            return
        end
