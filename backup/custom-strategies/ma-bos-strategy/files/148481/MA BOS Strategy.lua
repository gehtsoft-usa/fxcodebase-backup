...
-- https://fxcodebase.com/code/viewtopic.php?f=31&t=72980
...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addInteger("Period1", "Period", "", 50);  
    strategy.parameters:addInteger("Period2", "Period", "", 200);  	
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "MABS");
...
function Prepare( nameOnly)
    ...
    MA1 = core.indicators:create(instance.parameters.Method , Source[instance.parameters.Price], instance.parameters.Period1 );
    MA2 = core.indicators:create(instance.parameters.Method , Source[instance.parameters.Price], instance.parameters.Period2 );
...
function EntryFunction( id, now,period)
	...
	and  Source.close[period-2] > MA1.DATA[period-2] 	
	then	
          if Direction then
                BUY();
            else
