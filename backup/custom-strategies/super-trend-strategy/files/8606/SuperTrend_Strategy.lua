...
function Init() --The strategy profile initialization
    ...
    strategy:description("Super trend strategy")
    strategy:setTag(
    ...
    strategy.parameters:addGroup("Super trend indicator parameters")
...
function Prepare(nameOnly)
            ...
            instance.bid:name() ..
                "." ..
                    instance.parameters.TF ..
                        "," .. "ST(" .. instance.parameters.N .. ", " .. instance.parameters.M .. "))"
    instance:name(name)
    if nameOnly then
        return;
    end
    ...
    assert(core.indicators:findIndicator("SUPERTREND_DOT") ~= nil, "SUPERTREND_DOT indicator must be installed");
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if ST.DN[period - 1] > ST.UP[period - 1] and ST.UP[period] > ST.DN[period] then
