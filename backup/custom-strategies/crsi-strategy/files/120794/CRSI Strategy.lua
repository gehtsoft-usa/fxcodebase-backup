...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=66603
...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addInteger("LenRSI", "RSI Closes Length", "RSI Closes Length", 3);
    strategy.parameters:addInteger("LenUD", "RSI UpClose Length", "RSI UpClose Length", 2);
    strategy.parameters:addInteger("LenRank", "PerecentRank Length", "PerecentRank Length", 100);
	strategy.parameters:addDouble("Level", "Level", "Level", 3);
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "CRSIS");
...
local Indicator;
local LenRSI,LenUD,LenRank,Level;
...
function Prepare( nameOnly)
	...
	assert(core.indicators:findIndicator("CRSI SIGNAL") ~= nil, "Please, download and install CRSI SIGNAL.LUA indicator");          
    ...
    Indicator = core.indicators:create("CRSI SIGNAL", Source,LenRSI,LenUD,LenRank,Level  );
