...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=60817
...
function Init() --The strategy profile initialization
    strategy:name("Candle Direction Strategy")
...
function Prepare(nameOnly)
    ...
    first = math.max(Source.close:first() + 1, MA.DATA:first())
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if
        Source.close[period] > Source.open[period] and
            ((Source.close[period - 1] < Source.open[period - 1] and Change) or (not Change)) and
