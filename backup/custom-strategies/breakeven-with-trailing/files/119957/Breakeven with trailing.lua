...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=66271
-- Id: 
...
function Init()
    ...
    strategy.parameters:addInteger("breakeven_level", "Move stop when profit reach, pips", "", 10);
    strategy.parameters:addInteger("breakeven_target", "Move to, pips", "", 5);
    strategy.parameters:addString("trailing", "Trailing stop order", "", "no");
    strategy.parameters:addStringAlternative("trailing", "No trailing", "", "no");
    strategy.parameters:addStringAlternative("trailing", "Dynamic", "", "dynamic");
    strategy.parameters:addStringAlternative("trailing", "Fixed", "", "fixed");
    strategy.parameters:addInteger("trailing_value", "Fixed trailing in pips", "10 or greater", 10, 10, 10000);
end
...
function Prepare(nameOnly)
    ...
    local name = profile:id() .. "(" .. instance.bid:instrument()  .. "[" .. instance.parameters.Trade   .. "], " 
        .. instance.parameters.breakeven_level .. "," .. instance.parameters.breakeven_target .. ")";
    ...
    source = ExtSubscribe(1, nil, "t1", true);

    local controller = breakeven:CreateController()
        :SetWhen(instance.parameters.breakeven_level)
        :SetTo(instance.parameters.breakeven_target)
        :SetTrade(trade);
    if instance.parameters.trailing == "dynamic" then
        controller:SetTrailing(1);
    elseif instance.parameters.trailing == "fixed" then
        controller:SetTrailing(instance.parameters.trailing_value);
    end
end
