...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=24045
...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addInteger("CP", "Period", "Period", 30)
    ...
    strategy.parameters:addInteger("MP", "Period", "Period", 30)
...
function Prepare(nameOnly)
    ...
    Indicator[1] = core.indicators:create(Method, Source[Price], MP)
