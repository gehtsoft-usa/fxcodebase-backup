...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=61543
...
function Init() --The strategy profile initialization
    strategy:name("TrendLord with Higher Time Frame Confirmation Strategy")
    ...
    strategy.parameters:addString("Method1", "MA Method", "Method", "LWMA")
    ...
    strategy.parameters:addGroup("Confirmation Filter  Calculation")
    strategy.parameters:addBoolean("UseFilter", "Use MA Filter", "", true)
    TF = {"Chart", "m1", "m5", "m15", "m30", "H1", "H2", "H3", "H4", "H6", "H8", "D1", "W1", "M1"}
    strategy.parameters:addString("BS", "Filter MA Time Frame", "", "D1")
    for i = 1, 14, 1 do
        strategy.parameters:addStringAlternative("BS", TF[i], TF[i], TF[i])
    end
    ...
    strategy.parameters:addInteger("FilterPeriod", "Period", "Period", 50)
    strategy.parameters:addString("Method2", "MA Method", "Method", "LWMA")
    ...
    strategy.parameters:addBoolean("Exit", "Exit on Neutral", "", false)
...
function Prepare(nameOnly)
    ...
    assert(
        core.indicators:findIndicator("TRENDLORD WITH HIGHER TIME FRAME CONFIRMATION") ~= nil,
        "Please, download and install TRENDLORD WITH HIGHER TIME FRAME CONFIRMATION.LUA indicator"
    )
    ...
    Indicator =
        ...
        "TRENDLORD WITH HIGHER TIME FRAME CONFIRMATION",
        Source,
        Price1,
        Period,
        Method1,
