...
-- https://fxcodebase.com/code/viewtopic.php?f=31&t=71617
...
function Init() --The strategy profile initialization
    strategy:name("Two MA Engulfing Strategy")
...
function CreateTradingParameters()
    ...
    strategy.parameters:addInteger("Amount", "Trade Amount as Balance percangege", "", 5,1 , 100)
...
local Price1, Method1, Period1, MA1
local Price2, Method2, Period2, MA2
...
function MarketOrder(BuySell, hCount)
    ...
    local Quantity=  (Amount* (Balance/100))/(BaseSize*1000); 
