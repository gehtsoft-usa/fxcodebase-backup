...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=59818
...
function Init() --The strategy profile initialization
    strategy:name("T3 moving average Strategy")
    ...
    strategy.parameters:addString("Method", "Trade Method", "Method", "Price/MA")
    strategy.parameters:addStringAlternative("Method", "Price/MA", "Price/MA", "Price/MA")
    strategy.parameters:addStringAlternative("Method", "MASlope", "MASlope", "MASlope")
...
function Prepare(nameOnly)
    ...
    Indicator[1] = core.indicators:create("T3_MA", Source[Price], Period, b)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if Method == "Price/MA" then
        ...
        if Short[1][period - 1] < Short[1][period - 2] and Short[1][period - 1] < Short[1][period] then
            if Direction then
                BUY()
            else
                SELL()
            end
        elseif Short[1][period - 1] > Short[1][period - 2] and Short[1][period - 1] > Short[1][period] then
            if Direction then
                SELL()
            else
                BUY()
