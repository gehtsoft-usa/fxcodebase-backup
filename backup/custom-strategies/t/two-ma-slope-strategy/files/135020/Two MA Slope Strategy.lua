...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=70028 
...
function Init() --The strategy profile initialization
    strategy:name("Two MA Slope Strategy");
	...
	strategy.parameters:addInteger("Period1", "Short MA Period", "", 5);
	...
	strategy.parameters:addInteger("Period2", "Long MA Period", "", 20);
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "TMSS");
