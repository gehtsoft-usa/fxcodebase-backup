...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=6516
...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addString("Mode", "Signal Type", "", "Slope")
...
function Prepare(nameOnly)
    ...
    name =
        profile:id() ..
        "(" .. instance.bid:name() .. "." .. instance.parameters.TF .. ", " .. VF .. ", " .. F .. "," .. ")"
    instance:name(name)
    ...
    GD1 = core.indicators:create("GD", Source[Price], VF, F)
    GD2 = core.indicators:create("GD", GD1.DATA, VF, F)
    GD3 = core.indicators:create("GD", GD2.DATA, VF, F)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if Mode ~= "Slope" then
        if core.crossesOver(Source[Price], GD3.DATA, period) then
            if Direction == "direct" then
                BUY()
            else
                SELL()
            end
        elseif core.crossesUnder(Source[Price], GD3.DATA, period) then
            if Direction == "direct" then
                SELL()
            else
                BUY()
