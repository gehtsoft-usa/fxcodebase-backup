...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=70586
...
function Init() --The strategy profile initialization
    strategy:name("Two Time Frame MA Crossover Strategy");
	...
	strategy.parameters:addString("TF1", "1. Time Frame", "", "m1");
    strategy.parameters:setFlag("TF1", core.FLAG_PERIODS);
	
	
	strategy.parameters:addString("Price1", "1. MA Price Source", "", "close");
    ...
    strategy.parameters:addInteger("Period1", "1. MA Period", "Period" , 7);
	...
	strategy.parameters:addString("Price2", "2. MA Price Source", "", "close");
    ...
    strategy.parameters:addInteger("Period2", "2. MA Period", "Period" , 14);
    ...
    strategy.parameters:addGroup("2. Time Frame (Higher Time Frame)");	
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "TTFMACS");
...
function Prepare( nameOnly)
    ...
    Indicator1 = core.indicators:create(instance.parameters.Method1, Source1[instance.parameters.Price1], instance.parameters.Period1 );
    Indicator2 = core.indicators:create(instance.parameters.Method2, Source1[instance.parameters.Price2], instance.parameters.Period2 );
...
function ExitFunction(id, now,period)
	...
	or  not Indicator2.DATA:hasData(period1)
	then
	return;
	end
	 
	--/////////////////////////////////////////////////////////////////  
	if  LastExit == Source1:serial(period1)
	...
	--/////////////////////////////////////////////////////////////////////
		            ...
		            if  (Indicator1.DATA[period1]< Indicator2.DATA[period1]
					and  Indicator1.DATA[period1-1]>= Indicator2.DATA[period1-1])
					or Source2.close[period2]< Source2.open[period2]
					then
...
function EntryFunction( id, now,period)
    ...
    if  Indicator1.DATA[period1]> Indicator2.DATA[period1]
	and  Indicator1.DATA[period1-1]<= Indicator2.DATA[period1-1]
	and Source2.close[period2]> Source2.open[period2]
	then	
          if Direction then
                BUY();
            else
		...
		Return=true;
    elseif  Indicator1.DATA[period1]< Indicator2.DATA[period1]
	and  Indicator1.DATA[period1-1]>= Indicator2.DATA[period1-1]
	and Source2.close[period2]< Source2.open[period2]
		then
            if Direction then
