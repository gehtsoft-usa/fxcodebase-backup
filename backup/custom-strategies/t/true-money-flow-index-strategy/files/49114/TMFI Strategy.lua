...
function Init() --The strategy profile initialization
    strategy:name("True Money Flow Index Strategy")
...
function Prepare(nameOnly)
    ...
    assert(core.indicators:findIndicator("TMFI") ~= nil, "Please, download and install TMFI.LUA indicator")
    ...
    Indicator[1] = core.indicators:create("TMFI", Source, N, Method, Period)
