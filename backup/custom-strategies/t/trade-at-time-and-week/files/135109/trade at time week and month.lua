...
function Init()
    ...
    strategy.parameters:addInteger("month", "Month", "", 1);
    strategy.parameters:addIntegerAlternative("month", "January", "", 1);
    strategy.parameters:addIntegerAlternative("month", "Febuary", "", 2);
    strategy.parameters:addIntegerAlternative("month", "March", "", 3);
    strategy.parameters:addIntegerAlternative("month", "April", "", 4);
    strategy.parameters:addIntegerAlternative("month", "May", "", 5);
    strategy.parameters:addIntegerAlternative("month", "June", "", 6);
    strategy.parameters:addIntegerAlternative("month", "July", "", 7);
    strategy.parameters:addIntegerAlternative("month", "August", "", 8);
    strategy.parameters:addIntegerAlternative("month", "Spetember", "", 9);
    strategy.parameters:addIntegerAlternative("month", "October", "", 10);
    strategy.parameters:addIntegerAlternative("month", "November", "", 11);
    strategy.parameters:addIntegerAlternative("month", "December", "", 12);
...
local base_size, offer_id, Account, Amount, amount_type, AllowTrade, close_on_opposite, custom_id, AllowedSide, dayOfWeek, month;
...
function Prepare(nameOnly)
    ...
    month = instance.parameters.month;
...
function ExtAsyncOperationFinished(cookie, success, message, message1, message2)
    if cookie == MANDATORY_CLOSE_TIMER_ID then
        ...
        if (date == nil or date < serverDate + OpenTime + interval) and InRange(now, OpenTime, OpenTime + interval) and dateTable.wday == dayOfWeek and dateTable.month == month then
