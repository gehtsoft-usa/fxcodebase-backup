...
function Init() --The strategy profile initialization
    strategy:name("DMI ADX strategy")
    strategy:description("DMI ADX strategy")
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if
        DMI_ADX.BuffADX[period] > instance.parameters.ADXLevel and DMI_ADX.BuffDMI[period - 1] < 0 and
            DMI_ADX.BuffDMI[period] > 0
     then
