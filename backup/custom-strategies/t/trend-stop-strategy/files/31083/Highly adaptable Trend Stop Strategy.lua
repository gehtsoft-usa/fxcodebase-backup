...
function Init() --The strategy profile initialization
    strategy:name("Highly adaptable Trend Stop Strategy")
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("Action" .. 1, "Price Trend Stop Line Cross Over", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 2, "Price Trend Stop Line CrossInder", "", "NO")
...
function Prepare(nameOnly)
    ...
    Indicator = core.indicators:create("TRENDSTOP", Source, Period, Mode)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if Short[period - 1] > Source.close[period - 1] and Short[period] < Source.close[period] then
        ACTION(1, 1, "Over")

        ONE = Source:serial(period)
    elseif Short[period - 1] < Source.close[period - 1] and Short[period] > Source.close[period] then
        ACTION(2, 1, "Under")
