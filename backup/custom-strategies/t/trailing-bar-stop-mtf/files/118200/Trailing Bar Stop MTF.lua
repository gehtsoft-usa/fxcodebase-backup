...
function Init()
    ...
    strategy.parameters:addInteger("buffer_zone", "Buffer Zone, bars", "", 1);
...
function breakeven:CreateController()
    ...
    function controller:DoAfterBreakeven(source, period)
        ...
        if period - self._period < buffer_zone then
            return;
        end
