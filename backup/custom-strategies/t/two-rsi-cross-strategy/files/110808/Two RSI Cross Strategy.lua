...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=64370&p
...
function Init() --The strategy profile initialization
    strategy:name("Two RSI Cross Strategy")
    ...
    strategy.parameters:addGroup("1. RSI Calculation")
    ...
    strategy.parameters:addInteger("RP1", "RSI Period", "", 14)

    strategy.parameters:addInteger("MP1", "Moving Average Period", "", 1, 1, 1000)
    strategy.parameters:addString("Method1", "Moving Average Method", "Method", "MVA")
    ...
    strategy.parameters:addGroup("2. RSI Calculation")
    ...
    strategy.parameters:addInteger("RP2", "RSI Period", "", 28)

    strategy.parameters:addInteger("MP2", "Moving Average Period", "", 1, 1, 1000)
    strategy.parameters:addString("Method2", "Moving Average Method", "Method", "MVA")
...
local Method1, Price1, RP1, MP1, Indicator1, MA1
local Method2, Price2, RP2, MP2, Indicator2, MA2
local Data1, Data2
function Prepare(nameOnly)
    ...
    RP1 = instance.parameters.RP1
    MP1 = instance.parameters.MP1

    Method2 = instance.parameters.Method2
    Price2 = instance.parameters.Price2
    RP2 = instance.parameters.RP2
    MP2 = instance.parameters.MP2
    ...
    Indicator1 = core.indicators:create("RSI", Source[Price1], RP1)
    Indicator2 = core.indicators:create("RSI", Source[Price2], RP2)

    if MP1 ~= 1 then
        MA1 = core.indicators:create(Method1, Indicator1.DATA, MP1)
        Data1 = MA1.DATA
    else
        Data1 = Indicator1.DATA
    end

    if MP2 ~= 1 then
        MA2 = core.indicators:create(Method2, Indicator2.DATA, MP2)
        Data2 = MA2.DATA
    else
        Data2 = Indicator2.DATA
    end

    first = math.max(Data1:first(), Data2:first())
...
function EntryFunction(period, now)
    ...
    if Data1[period] > Data2[period] and Data1[period - 1] <= Data2[period - 1] then
        if Direction then
            BUY()
        else
            SELL()
        ...
        Return = true
    elseif Data1[period] < Data2[period] and Data1[period - 1] >= Data2[period - 1] then
        if Direction then
            SELL()
        else
            BUY()
