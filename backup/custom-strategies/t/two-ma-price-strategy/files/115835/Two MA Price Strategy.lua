...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=65329
...
function Init() --The strategy profile initialization
    strategy:name("Two MA Price Strategy")
...
function EntryFunction(now, period)
    ...
    if
        MA1.DATA[period] > MA2.DATA[period] and Source.close[period] > MA1.DATA[period] and
