...
function Prepare( nameOnly)
    ...
    TSV = core.indicators:create("TSV", Source, instance.parameters.Period  ); 
    XRSIOMA = core.indicators:create("X-RSIOMA", Source, instance.parameters.RSIOMA,instance.parameters.Ma_RSIOMA, instance.parameters.rsi_use_obos, instance.parameters.rsi_os, instance.parameters.rsi_ob  ); 	
...
function EntryFunction( id, now,period)
    ...
    if   TSV.DATA[period]> 0 
    and XRSIOMA.b[period]> 0 	
	and (TSV.DATA[period-1]<= 0 
	or XRSIOMA.b[period-1]<= 0 )	
	then	
          if Direction then
                BUY();
            else
