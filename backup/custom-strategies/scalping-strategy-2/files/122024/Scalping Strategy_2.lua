...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=66904
...
function Init()
    ...
    strategy.parameters:addInteger("LIN", "LIN", "", 29, 1, 2000);
    strategy.parameters:addInteger("WHB", "WHB", "", 6, 1, 2000);
    strategy.parameters:addInteger("WHS", "WHS", "", 6, 1, 2000);
    strategy.parameters:addInteger("BIB", "BIB", "", 6, 1, 2000);
    strategy.parameters:addDouble("BIS", "BIS", "", 6, 1, 2000);
    strategy.parameters:addDouble("PPKKS", "PPKKS", "", 0.994);
    strategy.parameters:addDouble("PPKKB", "PPKKB", "", 0.994);
    strategy.parameters:addDouble("RES", "RES", "", 3);
    strategy.parameters:addDouble("SUP", "SUP", "", 3); 
...
function Prepare(name_only)
    ...
    assert(core.indicators:findIndicator("SCALPING INDICATOR") ~= nil, "Please, download and install SCALPING INDICATOR");
    ...
    indi = core.indicators:create("SCALPING INDICATOR", trading_logic.MainSource,
        instance.parameters.LIN, instance.parameters.WHB, instance.parameters.WHS,
        instance.parameters.BIB, instance.parameters.BIS, instance.parameters.PPKKS,
        instance.parameters.PPKKB, instance.parameters.RES, instance.parameters.SUP);
