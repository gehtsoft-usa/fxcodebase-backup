...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=70876
...
function Init() --The strategy profile initialization
    strategy:name("Just Long Strategy");
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "JLS");
    ...
    strategy.parameters:addString("ALLOWEDSIDE", "Allowed side", "Allowed side for trading or signaling, can be Sell, Buy or Both", "Buy");
