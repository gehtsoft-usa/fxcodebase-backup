...
function CreateIndicators(source)
    ...
    indi = core.indicators:create("IVFT", source, instance.parameters.Period);
...
function CreateCustomActions()
    ...
    action1.IsPass = function (source, period, periodFromLast, data) 
        ...
        return core.crossesOver(indi.DATA, level_1_val, period); 
    end
    if isEntry1 then
    ...
    action1.IsPass = function (source, period, periodFromLast, data) 
        ...
        return core.crossesUnder(indi.DATA, level_1_val, period);
    end
    if isEntry1 then
        EntryActions[#EntryActions + 1] = action1;
    else
    ...
    action1.IsPass = function (source, period, periodFromLast, data) 
        ...
        return core.crossesOver(indi.DATA, level_2_val, period); 
    end
    if isEntry1 then
        EntryActions[#EntryActions + 1] = action1;
    else
    ...
    action1.IsPass = function (source, period, periodFromLast, data) 
        ...
        return core.crossesUnder(indi.DATA, level_2_val, period); 
    end
    if isEntry1 then
        EntryActions[#EntryActions + 1] = action1;
    else
    ...
    action1.IsPass = function (source, period, periodFromLast, data) 
        ...
        return core.crossesOver(indi.DATA, level_3_val, period);
    end
    if isEntry1 then
        EntryActions[#EntryActions + 1] = action1;
    else
    ...
    action1.IsPass = function (source, period, periodFromLast, data) 
        ...
        return core.crossesUnder(indi.DATA, level_3_val, period);
    end
    if isEntry1 then
        EntryActions[#EntryActions + 1] = action1;
    else
