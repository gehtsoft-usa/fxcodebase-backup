...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=66276
...
function Init() --The strategy profile initialization
	...
	strategy.parameters:addInteger("Period1", "MA Period", "Period" , 20);
...
function Prepare( nameOnly)
    ...
    Indicator1 = core.indicators:create( instance.parameters.Method1, Source.close,  instance.parameters.Period1  );
	...
	Indicator2 = core.indicators:create( instance.parameters.Method2, Source.close,  instance.parameters.Period2  );
...
function EntryFunction( now,period)
	...
	and (
	(Source.low[period]<Indicator1.DATA[period]
	and Source.open[period]>Indicator1.DATA[period]
	and Source.close[period]>Indicator1.DATA[period]
	)
	or
	(Source.low[period]<Indicator2.DATA[period]
	and Source.open[period]>Indicator2.DATA[period]
	...
	and (
	(Source.high[period]>Indicator1.DATA[period]
	and Source.open[period]<Indicator1.DATA[period]
	and Source.close[period]<Indicator1.DATA[period]
	)
	or
	(Source.high[period]>Indicator2.DATA[period]
	and Source.open[period]<Indicator2.DATA[period]
	and Source.close[period]<Indicator2.DATA[period]
	)
	)
