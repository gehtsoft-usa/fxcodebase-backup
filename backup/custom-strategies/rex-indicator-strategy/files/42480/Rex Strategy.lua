...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=24705
...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addInteger("SP", "Smoothing Period", "Smoothing Period", 14);
    strategy.parameters:addInteger("SS", "Signal Period", "Signal Period", 14);
...
function Prepare(nameOnly)
    ...
    Indicator[1] = core.indicators:create("REX", Source,SP, SS  );
