...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=7918
...
function Init() --The strategy profile initialization
    strategy:name("Forex Freedom Bars Strategy")
    ...
    strategy.parameters:addInteger("OpenLevel", "Open Level", "", 4, 3, 4)
    strategy.parameters:addInteger("CloseLevel", "Close Level", "", 2, 2, 4)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    for i = 1, 4, 1 do
        if Short[i][Short[i]:size() - 1] > 0 then
            Buy = Buy + 1
        elseif Short[i][Short[i]:size() - 1] < 0 then
            Sell = Sell + 1
        end
    end
