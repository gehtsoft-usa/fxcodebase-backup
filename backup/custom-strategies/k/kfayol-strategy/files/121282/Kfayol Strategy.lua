...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=66676
...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addInteger("PeriodA", "Short Period", "", 12);
	strategy.parameters:addInteger("PeriodB", "Long Period", "", 26);
	strategy.parameters:addInteger("PeriodC", "Signal", "", 9);
...
--	strategy.parameters:addStringAlternative("ExitExecutionType", "Live", "", "Live");
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "Kfayol");
...
local MA1, Method1, Period1;
local MA2, Method2, Period2;
local MACD, PeriodA, PeriodB, PeriodC; 
local SAR, Step, Max;
function Prepare( nameOnly)
	...
	MACD= core.indicators:create("MACD", Source.close, PeriodA,  PeriodB,PeriodC ); 
	SAR	=    core.indicators:create("SAR", Source, Step,  Max );
	first=math.max(RSI.DATA:first(), MA1.DATA:first(), MA2.DATA:first(), MACD.SIGNAL:first()); 
