...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=60754
...
function Init() --The strategy profile initialization
    strategy:name("Kalman Filter Strategy ")
    ...
    strategy.parameters:addGroup("Kalman Filter Calculation")
    strategy.parameters:addDouble("K", "K", "", 1)
    strategy.parameters:addDouble("S", "Sharpness", "", 1)

    strategy.parameters:addGroup("Smoothing Calculation")
    ...
    strategy.parameters:addInteger("Period", "Smoothing Period", "", 20)
...
local first
local K, S, Kalman, MA, Method, Period
local CustomID
local Price
...
function Prepare(nameOnly)
    ...
    assert(
        core.indicators:findIndicator("KALMAN_FILTER") ~= nil,
        "Please, download and install KALMAN_FILTER.LUA indicator"
    )
