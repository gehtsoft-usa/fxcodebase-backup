...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=65823
...
function Init() --The strategy profile initialization
    strategy:name("Key Reversal Streategy");
	...
	strategy.parameters:addInteger("Period", "Trend Period", "", 2);
...
--	strategy.parameters:addStringAlternative("ExitExecutionType", "Live", "", "Live");
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "KRS");
...
function Prepare( nameOnly)
    ...
    PrepareTrading();
	 ...
	 assert(core.indicators:findIndicator("KEY REVERSAL SIGNAL") ~= nil, "Please, download and install KEY REVERSAL SIGNAL.LUA indicator");          
   ...
   Indicator = core.indicators:create("KEY REVERSAL SIGNAL", Source, Trend,Period );
