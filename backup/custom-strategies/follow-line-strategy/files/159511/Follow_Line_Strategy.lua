-- Available @ https://fxcodebase.com/code/viewtopic.php?f=31&t=76010&p=159511#p159511
...
local STRATEGY_NAME = "Follow Line trategy";
function CreateParameters() 
    strategy.parameters:addInteger("param1", "ATR Period", "", 5, 1);
    strategy.parameters:addInteger("param2", "Bollinger Bands Period", "", 21, 1);
    strategy.parameters:addDouble("param3", "Bollinger Bands Deviation", "", 1.00, 0.1);
end

local indi;
function CreateEntryIndicators(source)
    local profile = core.indicators:findIndicator("FOLLOW LINE");
    assert(profile ~= nil, "Please, download and install " .. "FOLLOW LINE" .. ".LUA indicator");
    ...
    indi = core.indicators:create("FOLLOW LINE", source, indicatorParams)
end
