...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=27805
...
function Init() --The strategy profile initialization
    strategy:name("Zero Point Force Strategy")
    ...
    strategy.parameters:addInteger("Short", "Short Period", "Short Period", 12)
    ...
    strategy.parameters:addInteger("Long", "Long Period", "Long Period", 24)
    ...
    strategy.parameters:addInteger("Volume", "Volume Period", "Volume Period", 12)
    ...
    strategy.parameters:addString("Entry", "Entry Type", "", "Cross")
    strategy.parameters:addStringAlternative("Entry", "Cross", "", "Cross")
    strategy.parameters:addStringAlternative("Entry", "Fractal", "", "Fractal")
    strategy.parameters:addBoolean("ON", "Use Optional Exit", "", true)
    strategy.parameters:addString("Exit", "Exit Type", "", "Cross")
    strategy.parameters:addStringAlternative("Exit", "Cross", "", "Cross")
    strategy.parameters:addStringAlternative("Exit", "Fractal", "", "Fractal")
    strategy.parameters:addStringAlternative("Exit", "Any", "", "Any")
...
function Prepare(nameOnly)
    ...
    S = instance.parameters.Short
    L = instance.parameters.Long
    ...
    assert(core.indicators:findIndicator("ZPF") ~= nil, "Please, download and install ZPF.LUA indicator")
    ...
    Indicator[1] = core.indicators:create("ZPF", Source, S, Method1, L, Method2, Volume, Method3)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if
        (core.crossesOver(Short[1], Short[2], period) and Entry == "Cross") or
            (Short[1][period - 2] > Short[1][period - 1] and Short[1][period - 1] < Short[1][period] and
                Entry == "Fractal")
     then
        if Direction then
            BUY()
    ...
    elseif
        (core.crossesUnder(Short[1], Short[2], period) and Entry == "Cross") or
            (Short[1][period - 2] < Short[1][period - 1] and Short[1][period - 1] > Short[1][period] and
                Entry == "Fractal")
     then
        if Direction then
    ...
    if ON then
        if
            (core.crossesUnder(Short[1], Short[2], period) and Exit ~= "Fractal") or
                (Short[1][period - 2] < Short[1][period - 1] and Short[1][period - 1] > Short[1][period] and
                    Entry ~= "Cross")
         then
            if Direction then
        ...
        if
            (core.crossesOver(Short[1], Short[2], period) and Exit ~= "Fractal") or
                (Short[1][period - 2] > Short[1][period - 1] and Short[1][period - 1] < Short[1][period] and
                    Entry ~= "Cross")
         then
            if Direction then
