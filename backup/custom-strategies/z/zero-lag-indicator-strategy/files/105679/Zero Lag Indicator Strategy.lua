...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=63350
...
function Init() --The strategy profile initialization
    strategy:name("Zero Lag Indicator Strategy")
    ...
    strategy.parameters:addInteger("N", "Lenth", "Inernal EMA length", 20)
    strategy.parameters:addInteger("GainLimit", "GainLimit", "Limit of gain term", 50)
...
function Prepare(nameOnly)
    ...
    GainLimit = instance.parameters.GainLimit
    ...
    assert(
        core.indicators:findIndicator("ZERO LAG INDICATOR") ~= nil,
        "Please, download and install ZERO LAG INDICATOR.LUA indicator"
    )
    ...
    Indicator =
        core.indicators:create("ZERO LAG INDICATOR", Source, N, GainLimit, core.rgb(0, 255, 0), core.rgb(255, 0, 0))
