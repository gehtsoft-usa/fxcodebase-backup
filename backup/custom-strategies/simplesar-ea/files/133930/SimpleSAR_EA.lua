...
local OpenTime, CloseTime, _ToTime;
    ...
    if TicketB ~= nil then
        ...
        if New_Level - Old_Level >= TrailingStep then
            ...
            if TicketSS == nil then
                local command = trading:EntryOrder(instance.ask:instrument())
                ...
                if instance.parameters.use_limit then
                    command:SetPipLimit(nil, instance.parameters.limit_pips);
                end
                command:Execute();
            else
    ...
    if TicketB == nil and TicketS == nil then
        if TicketBS_command == nil or TicketBS_command.Finished then
            ...
            if TicketBS == nil then
                ...
                TicketBS_command = command:Execute();
        ...
        if TicketSS_command == nil or TicketSS_command.Finished then
            ...
            if TicketSS == nil then
                ...
                TicketSS_command = command:Execute();
