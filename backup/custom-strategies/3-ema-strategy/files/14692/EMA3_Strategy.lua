...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=6398
...
function Init() --The strategy profile initialization
    strategy:name("EMA3 Strategy")
    strategy:description("EMA3 strategy")
    strategy:setTag("Version", "2")
    strategy:setTag("NonOptimizableParameters", "Email,SendEmail,SoundFile,RecurrentSound,PlaySound, ShowAlert")

    strategy.parameters:addGroup("Parameters")
    strategy.parameters:addInteger("EMA1_Period", "EMA1_Period", "", 7)
    strategy.parameters:addInteger("EMA2_Period", "EMA2_Period", "", 14)
    strategy.parameters:addInteger("EMA3_Period", "EMA3_Period", "", 21)
...
function Prepare(nameOnly)
                                ...
                                instance.parameters.EMA1_Period ..
                                    "), EMA2(" ..
                                        instance.parameters.EMA2_Period ..
                                            "), EMA3(" .. instance.parameters.EMA3_Period .. "))"
    instance:name(name)
    if nameOnly then
        return
    end
    ...
    Source2 = ExtSubscribe(3, nil, "t1", true, "close")
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if LastOpen ~= nil then
        Shift = source.close[period] - LastOpen
    end

    if
        EMA1.DATA[period] > EMA2.DATA[period] and EMA1.DATA[period] > EMA3.DATA[period] and
            EMA2.DATA[period] > EMA3.DATA[period] - Shift
     then
    ...
    if
        EMA3.DATA[period] > EMA1.DATA[period] and EMA3.DATA[period] > EMA2.DATA[period] and
            EMA2.DATA[period] > EMA1.DATA[period] - Shift
     then
        if instance.parameters.TypeSignal == "direct" then
            MustS = true
        else
