...
-- https://fxcodebase.com/code/viewtopic.php?f=31&t=72455
...
function Prepare( nameOnly)
    ...
    Indicator = core.indicators:create("TSF SIGNAL", Source , 
	instance.parameters.Price_slow,
	instance.parameters.PERIOD_slow,
	instance.parameters.lookback_slow,
	instance.parameters.LWMA_slow,
	instance.parameters.MA_slow,
	instance.parameters.Method_slow,
	instance.parameters.Price_fast,
	instance.parameters.PERIOD_fast, 
	instance.parameters.lookback_fast,
	instance.parameters.LWMA_fast,
	instance.parameters.MA_fast, 
	instance.parameters.Method_fast); 
