...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=15783
...
function Init() --The strategy profile initialization
    strategy:name("OB OS RSI Strategy");
    ...
    strategy.parameters:addInteger("N", "Number of periods", "", 4);
	strategy.parameters:addDouble("OB", "Overbought Level", "", 75);
	strategy.parameters:addDouble("OS", "Oversold Level", "", 25);
	    strategy.parameters:addString("Cross", "Type of signal", "", "Cross");
    strategy.parameters:addStringAlternative("Cross", "Cross out OB/OS Zone", "", "Cross");
    strategy.parameters:addStringAlternative("Cross", "In OB/OS Zone", "", "Zone");

	
	 strategy.parameters:addGroup("MA Parameters");
	  strategy.parameters:addBoolean("Use", "Use MA Filter", "", false);
...
function Prepare(nameOnly)
    ...
    Indicator[1] = core.indicators:create("RSI", Source[Price], N );
...
function ExtUpdate(id, source, period)  -- The method called every time when a new bid or ask price appears.
   ...
   -- get only time
    ...
    if period < first +1 then
        ...
        if    Source.close[period] > Short[2][period] or  not Use and 	
		(
		(       Short[1][period] < OS   and  Cross  == "Zone" )
        or    (core.crossesOver(Short[1], OS, period) and  Cross == "Cross" )
		)
		...
		elseif  Source.close[period] < Short[2][period] or  not Use and 
        (		
		(  Short[1][period] > OB  and  Cross == "Zone" )
		or  (core.crossesUnder(Short[1], OB, period) and Cross == "Cross" )
		)
		 then
            if Direction then
                SELL();
