...
function CreateParameters() 
    ...
    strategy.parameters:addInteger("sl", "Stop level, pips", "", 10);
    strategy.parameters:addInteger("tp", "Limit level, pips", "", 10);
end
                ...
                elseif closed_trade.OQTXT == custom_id .. "2" then
                    ...
                    while row ~= nil do
                        if row.QTXT == custom_id .. "3" then
                            if row.BS == "B" then
                                trading:MoveStop(row, row.Open + tp * main_source:pipSize())
                            else
                                trading:MoveStop(row, row.Open - tp * main_source:pipSize())
                            end
                        end
