...
function AddPrice(id, name)
    strategy.parameters:addString("Price" .. id, name .. " Price Source", "", "close")
...
function CreateEntryIndicators(source)
    ...
    indicatorParams:setString("Price1", instance.parameters.Price1);
    indicatorParams:setString("Price2", instance.parameters.Price2);
