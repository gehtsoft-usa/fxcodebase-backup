-- Available @ https://fxcodebase.com/code/viewtopic.php?f=31&t=74363
...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addDouble("Bandwidth", "Bandwidth", "", 8);  
	
    strategy.parameters:addString("Price", "Source", "", "close");
...
function Prepare( nameOnly)
    ...
    Indicator = core.indicators:create("NADARAYA-WATSON_SMOOTHERS", Source , Bandwidth, Price,    false , core.colors().Teal, core.colors().Red); 
...
function EntryFunction( id, now,period)
    ...
    if   Indicator.DATA:colorI(period) == core.colors().Teal
	and  Indicator.DATA:colorI(period-1) ~= core.colors().Teal
	then	
          if Direction then
                BUY();
            else
