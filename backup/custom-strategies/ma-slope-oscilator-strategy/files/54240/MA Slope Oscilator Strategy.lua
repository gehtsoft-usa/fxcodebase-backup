...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=31812
...
function Init() --The strategy profile initialization
    strategy:name("MA Slope Oscilator Strategy")
    ...
    strategy.parameters:addGroup("First MA Slope Parameters ")
    ...
    strategy.parameters:addInteger("First_Period", " First MA Period", "", 25)
    strategy.parameters:addString("First_Method", "Method of First MA", "", "EMA")
    strategy.parameters:addStringAlternative("First_Method", "EMA", "", "EMA")
    strategy.parameters:addStringAlternative("First_Method", "KAMA", "", "KAMA")
    strategy.parameters:addStringAlternative("First_Method", "LWMA", "", "LWMA")
    strategy.parameters:addStringAlternative("First_Method", "MVA", "", "MVA")
    strategy.parameters:addStringAlternative("First_Method", "TMA", "", "TMA")
    strategy.parameters:addStringAlternative("First_Method", "HMA", "", "HMA")
    ...
    strategy.parameters:addDouble("First_Slope", "Slope", "pip/minute", 0)
    strategy.parameters:addInteger("First_Bars", "Bars", "", 1)

    strategy.parameters:addGroup("Second MA Slope Parameters ")
    ...
    strategy.parameters:addInteger("Second_Period", " Second MA Period", "", 50)
    strategy.parameters:addString("Second_Method", "Method of Second MA", "", "EMA")
    strategy.parameters:addStringAlternative("Second_Method", "EMA", "", "EMA")
    strategy.parameters:addStringAlternative("Second_Method", "KAMA", "", "KAMA")
    strategy.parameters:addStringAlternative("Second_Method", "LWMA", "", "LWMA")
    strategy.parameters:addStringAlternative("Second_Method", "MVA", "", "MVA")
    strategy.parameters:addStringAlternative("Second_Method", "TMA", "", "TMA")
    strategy.parameters:addStringAlternative("Second_Method", "HMA", "", "HMA")
    ...
    strategy.parameters:addDouble("Second_Slope", "Slope", "pip/minute", 0)
    strategy.parameters:addInteger("Second_Bars", "Bars", "", 1)
...
function Prepare(nameOnly)
    ...
    assert(core.indicators:findIndicator("MA_SLOPE") ~= nil, "Please, download and install MA_SLOPE.lua")
...
function ExitFunction(period, now)
    ...
    if indicator1.DATA:colorI(period) == core.rgb(255, 0, 0) or indicator2.DATA:colorI(period) == core.rgb(255, 0, 0) then
        if Direction then
    ...
    if indicator1.DATA:colorI(period) == core.rgb(0, 255, 0) or indicator2.DATA:colorI(period) == core.rgb(0, 255, 0) then
        if Direction then
            if haveTrades("S") then
                exitSpecific("S")
                Signal("Close Short")
...
function EntryFunction(period, now)
    ...
    if
        indicator1.DATA:colorI(period) == core.rgb(0, 255, 0) and indicator2.DATA:colorI(period) == core.rgb(0, 255, 0) and
            (indicator1.DATA:colorI(period - 1) ~= core.rgb(0, 255, 0) or
                indicator2.DATA:colorI(period - 1) ~= core.rgb(0, 255, 0))
     then
        if Direction then
            BUY()
        else
        ...
        Return = true
    elseif
        indicator1.DATA:colorI(period) == core.rgb(255, 0, 0) and indicator2.DATA:colorI(period) == core.rgb(255, 0, 0) and
            (indicator1.DATA:colorI(period - 1) ~= core.rgb(255, 0, 0) or
                indicator2.DATA:colorI(period - 1) ~= core.rgb(255, 0, 0))
     then
        if Direction then
            SELL()
        else
