...
-- http://fxcodebase.com/code/viewtopic.php?f=27&t=70790
...
local main_source, stop, limit, mult, martingale_stop, use_trailing, trailing, use_breakeven, breakeven_when, breakeven_to;
...
function Open(side)
    ...
    local command = trading:MarketOrder(instance.bid:instrument())
        ...
        :SetSide(side)
        :SetPipStop(nil, stop, use_trailing and trailing or nil)
