...
function Init() --The strategy profile initialization
    strategy:name("ChandelierExit Close Strategy")
...
function CreateTradingParameters()
    ...
    strategy.parameters:addBoolean("Afterwards", "Close Strategy Afterwards", "", false)
...
function Prepare(nameOnly)
    ...
    Afterwards = instance.parameters.Afterwards
