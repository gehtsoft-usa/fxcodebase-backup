...
function Init() --The strategy profile initialization
    strategy:name("Highly adaptable Centred moving average Channel Strategy");
	...
	strategy.parameters:addString("Mode", "Calculation Mode", "", "Static");
    strategy.parameters:addStringAlternative("Mode", "Dynamic", "", "Dynamic");
    strategy.parameters:addStringAlternative("Mode", "Static", "", "Static");
	
	strategy.parameters:addInteger("Calculation", "Calculation Type", "" , 2); 
    strategy.parameters:addIntegerAlternative("Calculation", "Pips", "Pips" ,1);
    strategy.parameters:addIntegerAlternative("Calculation", "Percentage", "Percentage" , 2);
   
    strategy.parameters:addDouble("Percentage", "Percentage Range", "Percentage Range", 0.5);
	strategy.parameters:addDouble("Pip", "Pip Range", "Pip Range", 100); 
	...
	strategy.parameters:addString("Action".. 4, "Central Line Cross Under", "", "NO");
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "HACMACS");
...
local Indicator;
local Period, Mode, Calculation, Percentage, Pip;
...
function Prepare( nameOnly)
	...
	assert(core.indicators:findIndicator("CMAC") ~= nil, "Please, download and install CMAC.LUA indicator");
	...
	Indicator = core.indicators:create("CMAC", Source.close, Period, Mode, Calculation, Percentage, Pip  ); 
	first=Indicator.Central:first(); 
