...
local source, ich1, ich2, ich3, sr;
function Prepare(nameOnly)
    ...
    sr = instance:addStream("SR", core.Line, "Support/Resistance", "Support/Resistance", instance.parameters.sr_color, 0, 0);
    sr:setWidth(instance.parameters.sr_width);
    sr:setStyle(instance.parameters.sr_style);
end
...
function Update(period, mode)
    ...
    if ich1.SB[index1] == ich2.SB[index2] and ich1.SB[index1] == ich3.SB[index3] 
        and ich1.TL[index1] == ich1.TL[index1 - 1]
        and ich2.TL[index2] == ich2.TL[index2 - 1]
        and ich3.TL[index3] == ich3.TL[index3 - 1]
    then
        sr[period] = ich1.SB[index1];
    end
end
