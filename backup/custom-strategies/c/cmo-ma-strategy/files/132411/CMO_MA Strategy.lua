...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=69599
...
local STRATEGY_NAME = "CMO MA Strategy";
...
function CreateEntryIndicators(source)
    indi = core.indicators:create("CMO_MA", source, instance.parameters.Period, instance.parameters.Method);
end
...
function Prepare(nameOnly)
    ...
    CreateEntryIndicators(main_source.close);
