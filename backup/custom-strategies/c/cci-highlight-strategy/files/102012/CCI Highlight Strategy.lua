...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=62588
...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addInteger("Period", "TMA period", "", 17)
    strategy.parameters:addInteger("Overbought", "Overbought level", "", 100)
    strategy.parameters:addInteger("Oversold", "Oversold level", "", -100)
...
function Prepare(nameOnly)
    ...
    assert(
        core.indicators:findIndicator("CCI HIGHLIGHT") ~= nil,
        "Please, download and install CCI HIGHLIGHT.LUA indicator"
    )
