...
function Prepare(nameOnly)
    ...
    Indicator = core.indicators:create("QQE", Source[Price], RF, RSP, AP, F, S, true)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if period < first or not Short[1]:hasData(period - 1) or not Short[2]:hasData(period - 1) then
        return
    end
