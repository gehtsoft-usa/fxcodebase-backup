...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=66110
...
function Init() --The strategy profile initialization
    strategy:name("MA RSI ADX Strategy");
	...
	strategy.parameters:addInteger("Period1", "MA Period", "",5 );
	...
	strategy.parameters:addInteger("Period2", "MA Period", "",10 );
...
--	strategy.parameters:addStringAlternative("ExitExecutionType", "Live", "", "Live");
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "MARSIADXS");
...
local RSI_Period, RSI, MA1, MA2, Period1,Period2, Method1, Method2, Price1, Price2;
...
function Prepare( nameOnly)
	...
	first=math.max(ADX.DATA:first(), RSI.DATA:first(), MA1.DATA:first(), MA2.DATA:first()); 
