...
function Init() --The strategy profile initialization
    strategy:name("Cross MA strategy")
    strategy:description("Cross MA strategy")
    strategy:setTag("NonOptimizableParameters", "Email,SendEmail,SoundFile,RecurrentSound,PlaySound, ShowAlert")

    strategy.parameters:addGroup("Parameters")
    strategy.parameters:addString("Type", "CLOSE", "", "C")
    strategy.parameters:addStringAlternative("Type", "OPEN", "", "O")
    strategy.parameters:addStringAlternative("Type", "HIGH", "", "H")
    strategy.parameters:addStringAlternative("Type", "LOW", "", "L")
    strategy.parameters:addStringAlternative("Type", "CLOSE", "", "C")
    strategy.parameters:addStringAlternative("Type", "MEDIAN", "", "M")
    strategy.parameters:addStringAlternative("Type", "TYPICAL", "", "T")
    strategy.parameters:addStringAlternative("Type", "WEIGHTED", "", "W")
...
function Prepare()
    ...
    assert(core.indicators:findIndicator("CROSS_VAMA") ~= nil, "Please, download and install CROSS_VAMA.LUA indicator")
