...
-- https://fxcodebase.com/code/viewtopic.php?f=31&t=71225
...
function Init() --The strategy profile initialization
    strategy:name("Averages Price Cross Strategy");
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "MPCS");
...
function Prepare( nameOnly)
    ...
    Indicator = core.indicators:create("AVERAGES", Source.close,instance.parameters.Method, instance.parameters.Period ); 
