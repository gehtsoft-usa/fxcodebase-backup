...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=19904
...
function Init() --The strategy profile initialization
    strategy:name("Fibonacci Bollinger Bands Strategy with Filters")
    ...
    strategy.parameters:addInteger("MF", "Fibonacci Bollinger Bands Period", "", 20)
    strategy.parameters:addInteger("AF", "ATR Period", "", 20)
    local i, j

    i = 1
    strategy.parameters:addDouble("F" .. i, "1. Fibonacci Level", " ", 1.6180)
    i = 2
    strategy.parameters:addDouble("F" .. i, "2. Fibonacci Level", " ", 2.6180)
    i = 3
    strategy.parameters:addDouble("F" .. i, "3. Fibonacci Level", " ", 4.2360)

    strategy.parameters:addGroup("Fibonacci Bollinger Bands Selector")

    strategy.parameters:addString("Action" .. 1, "Central Line Cross Over", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 2, "Central Line Cross Under", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 3, "1. Top Line Cross Over", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 4, "1. Top Line Cross Under", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 5, "2. Top Line Cross Over", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 6, "2. Top Line Cross Under", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 7, "3. Top Line Cross Over", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 8, "3. Top Line Cross Under", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 9, "1. Botoom Line Cross Over", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 10, "1. Botoom Line Cross Under", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 11, "2. Botoom Line Cross Over", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 12, "2. Botoom Line Cross Under", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 13, "3. Botoom Line Cross Over", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 14, "3. Botoom Line Cross Under", "", "NO")
    ...
    strategy.parameters:addGroup("Filter Selector")

    strategy.parameters:addBoolean("Filter1", "Use MA Filter", "", false)
    strategy.parameters:addBoolean("Filter2", "Use MACD Filter", "", false)
    strategy.parameters:addBoolean("Filter3", "Use ROC Filter", "", false)
    strategy.parameters:addBoolean("Filter4", "Use RSI Filter", "", false)

    strategy.parameters:addGroup("1. MA Parameters")
    strategy.parameters:addInteger("MA_P1", "1. MA Period", "Period", 10)
    strategy.parameters:addString("Method1", "1. MA Method", "Method", "MVA")
    ...
    strategy.parameters:addInteger("MA_P2", "2. MA Period", "Period", 20)
    strategy.parameters:addString("Method2", "2. MA Method", "Method", "MVA")
    ...
    strategy.parameters:addGroup("2. MA Parameters")

    strategy.parameters:addInteger("MA_P3", "3. MA Period", "Period", 12)

    strategy.parameters:addString("Method3", "3. MA Method", "Method", "EMA")
    ...
    strategy.parameters:addInteger("MA_P4", "4. MA Period", "Period", 26)

    strategy.parameters:addString("Method4", "4. MA Method", "Method", "EMA")
    strategy.parameters:addStringAlternative("Method4", "MVA", "MVA", "MVA")
    strategy.parameters:addStringAlternative("Method4", "EMA", "EMA", "EMA")
    strategy.parameters:addStringAlternative("Method4", "LWMA", "LWMA", "LWMA")
    strategy.parameters:addStringAlternative("Method4", "TMA", "TMA", "TMA")
    strategy.parameters:addStringAlternative("Method4", "SMMA", "SMMA", "SMMA")
    strategy.parameters:addStringAlternative("Method4", "KAMA", "KAMA", "KAMA")
    strategy.parameters:addStringAlternative("Method4", "VIDYA", "VIDYA", "VIDYA")
    strategy.parameters:addStringAlternative("Method4", "WMA", "WMA", "WMA")

    strategy.parameters:addGroup("ROC Parameters")
    strategy.parameters:addInteger("ROC_P", "ROC Period", "Period", 14)

    strategy.parameters:addGroup("RSI Parameters")
    strategy.parameters:addInteger("RSI_P", "RSI Period", "Period", 14)
    strategy.parameters:addDouble("OB", "OB Level", "Level", 70)
    strategy.parameters:addDouble("OS", "OS Level", "Level", 30)
...
local OB, OS, RSI_P, MA_P1, MA_P2, MA_P3, MA_P4, ROC_P, Method1, Method2, Method3, Method4
...
function Prepare(nameOnly)
    ...
    RSI_P = instance.parameters.RSI_P
    MA_P1 = instance.parameters.MA_P1
    MA_P2 = instance.parameters.MA_P2
    MA_P3 = instance.parameters.MA_P3
    MA_P4 = instance.parameters.MA_P4
    ROC_P = instance.parameters.ROC_P
    ...
    for i = 1, 4, 1 do
        Filter[i] = instance.parameters:getBoolean("Filter" .. i)
    end

    assert(core.indicators:findIndicator("FIBB") ~= nil, "Please, download and install FIBB.LUA indicator")
    ...
    Indicators[1] = core.indicators:create("FIBB", Source, MD, AF, F[1], F[2], F[3])

    RSI = core.indicators:create("RSI", Source.close, RSI_P)
    assert(core.indicators:findIndicator(Method1) ~= nil, Method1 .. " indicator must be installed");
    MA1 = core.indicators:create(Method1, Source.close, MA_P1)
    assert(core.indicators:findIndicator(Method2) ~= nil, Method2 .. " indicator must be installed");
    MA2 = core.indicators:create(Method2, Source.close, MA_P2)
    assert(core.indicators:findIndicator(Method3) ~= nil, Method3 .. " indicator must be installed");
    MA3 = core.indicators:create(Method3, Source.close, MA_P3)
    assert(core.indicators:findIndicator(Method4) ~= nil, Method4 .. " indicator must be installed");
    MA4 = core.indicators:create(Method4, Source.close, MA_P4)
    ROC = core.indicators:create("ROC", Source.close, ROC_P)

    Indicators["Central"] = Indicators[1]:getStream(0)
    Indicators["T1"] = Indicators[1]:getStream(1)
    Indicators["T2"] = Indicators[1]:getStream(3)
    Indicators["T3"] = Indicators[1]:getStream(5)
    Indicators["B1"] = Indicators[1]:getStream(2)
    Indicators["B2"] = Indicators[1]:getStream(4)
    Indicators["B3"] = Indicators[1]:getStream(6)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    for i = 1, 4, 1 do
        ...
        elseif i == 2 then
            ...
            if MA3.DATA[period] > MA4.DATA[period] then
                FilterSignal[i] = 1
            elseif MA3.DATA[period] < MA3.DATA[period] then
                FilterSignal[i] = -1
            end
        elseif i == 3 then
            ROC:update(core.UpdateLast)
            if Source.close[period] < Source.open[period] and ROC.DATA[period] > ROC.DATA[period - 1] then
                FilterSignal[i] = 1
            elseif Source.close[period] > Source.open[period] and ROC.DATA[period] < ROC.DATA[period - 1] then
                FilterSignal[i] = -1
            end
        elseif i == 4 then
            RSI:update(core.UpdateLast)
            if RSI.DATA[period] < OS then
                FilterSignal[i] = 1
            elseif RSI.DATA[period] > OB then
                FilterSignal[i] = -1
            end
        end
    end
    ...
    if core.crossesOver(Source.close, Indicators["Central"], period) then
        ACTION(1)
    end
    if core.crossesUnder(Source.close, Indicators["Central"], period) then
        ACTION(2)
    end

    if core.crossesOver(Source.close, Indicators["T1"], period) then
        ACTION(3)
    end
    if core.crossesUnder(Source.close, Indicators["T1"], period) then
        ACTION(4)
    end
    if core.crossesOver(Source.close, Indicators["T2"], period) then
        ACTION(5)
    end
    if core.crossesUnder(Source.close, Indicators["T2"], period) then
        ACTION(6)
    end
    if core.crossesOver(Source.close, Indicators["T3"], period) then
        ACTION(7)
    end
    if core.crossesUnder(Source.close, Indicators["T3"], period) then
        ACTION(8)
    end

    if core.crossesOver(Source.close, Indicators["B1"], period) then
        ACTION(9)
    end
    if core.crossesUnder(Source.close, Indicators["B1"], period) then
        ACTION(10)
    end

    if core.crossesOver(Source.close, Indicators["B2"], period) then
        ACTION(11)
    end
    if core.crossesUnder(Source.close, Indicators["B2"], period) then
        ACTION(12)
    end

    if core.crossesOver(Source.close, Indicators["B3"], period) then
        ACTION(13)
    end
    if core.crossesUnder(Source.close, Indicators["B3"], period) then
        ACTION(14)
    end
end
...
function BUY()
    for i = 1, 4, 1 do
        if Filter[i] and FilterSignal[i] ~= 1 then
            return
        end
    end
