...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=66910
...
function Init()
    strategy:name("Pullback Strategy on specific MA");
    strategy:description("v1 2018-11-09");

    AddAverages("method_1", "MA 1 Method", "MVA");
    strategy.parameters:addInteger("length_1", "MA 1 Period", "", 20);
    AddAverages("method_2", "MA 2 Method", "MVA");
    strategy.parameters:addInteger("length_2", "MA 2 Period", "", 50);
    strategy.parameters:addInteger("distance", "Distance price-ma, pips", "", 5);
...
function Prepare(name_only)
    ...
    ma1 = core.indicators:create("AVERAGES", trading_logic.MainSource.close, instance.parameters.method_1, instance.parameters.length_1);
    ma2 = core.indicators:create("AVERAGES", trading_logic.MainSource.close, instance.parameters.method_2, instance.parameters.length_2);
...
function IsBuyCondition(source, period)
    ...
    return core.crossesOver(ma1.DATA, ma2.DATA, period) and (source.low[period] - ma1.DATA[period]) / source:pipSize() >= distance;
end
...
function IsSellCondition(source, period)
    ...
    return core.crossesUnder(ma1.DATA, ma2.DATA, period) and (ma1.DATA[period] - source.high[period]) / source:pipSize() >= distance;
end
