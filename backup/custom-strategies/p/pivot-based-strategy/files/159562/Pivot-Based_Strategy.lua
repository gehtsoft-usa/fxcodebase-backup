-- Available @ https://fxcodebase.com/code/viewtopic.php?f=31&p=159518#p159518
...
function CreateParameters() 
    ...
    strategy.parameters:setFlag("pivot_tf", core.FLAG_PERIODS);
    strategy.parameters:addString("pivot_type", "Pivot", "", "pivot");
    strategy.parameters:addStringAlternative("pivot_type", "Pivot", "", "pivot");
    strategy.parameters:addStringAlternative("pivot_type", "R1", "", "R1");
    strategy.parameters:addStringAlternative("pivot_type", "R2", "", "R2");
    strategy.parameters:addStringAlternative("pivot_type", "R3", "", "R3");
    strategy.parameters:addStringAlternative("pivot_type", "R4", "", "R4");
    strategy.parameters:addStringAlternative("pivot_type", "S1", "", "S1");
    strategy.parameters:addStringAlternative("pivot_type", "S2", "", "S2");
    strategy.parameters:addStringAlternative("pivot_type", "S3", "", "S3");
    strategy.parameters:addStringAlternative("pivot_type", "S4", "", "S4");
end

local indi, tradingWeekOffset, tradingDayOffset;
function CreateEntryIndicators(source)
    ...
    indi = core.indicators:create("PIVOT", source, instance.parameters.pivot_tf, "Pivot", "HIST");
end
...
function GetValue(period)
    if instance.parameters.pivot_type == "pivot" then
        return indi.P[period];
    elseif instance.parameters.pivot_type == "S1" then
        return indi.S1[period];
    elseif instance.parameters.pivot_type == "S2" then
        return indi.S2[period];
    elseif instance.parameters.pivot_type == "S3" then
        return indi.S3[period];
    elseif instance.parameters.pivot_type == "S4" then
        return indi.S4[period];
    elseif instance.parameters.pivot_type == "R1" then
        return indi.R1[period];
    elseif instance.parameters.pivot_type == "R2" then
        return indi.R2[period];
    elseif instance.parameters.pivot_type == "R3" then
        return indi.R3[period];
    elseif instance.parameters.pivot_type == "R4" then
        return indi.R4[period];
    end
end

function IsEntryLong(source, period)
    local s = core.getcandle(instance.parameters.pivot_tf, source:date(period), tradingDayOffset, tradingWeekOffset);
    local index = core.findDate(source, s, false);
    local current = GetValue(index);
    local prev = GetValue(index - 1);
    return current > prev, s;
end
