...
local STRATEGY_NAME = "BSP Strategy";
...
function CreateParameters() 
	...
	strategy.parameters:addString("Type1", "Show", "", "Both");
    strategy.parameters:addStringAlternative("Type1", "Both", "", "Both");
    strategy.parameters:addStringAlternative("Type1", "Buying", "", "Buying");
	strategy.parameters:addStringAlternative("Type1", "Selling", "", "Selling");
	strategy.parameters:addStringAlternative("Type1", "Prevailing", "", "Prevailing");
...
function CreateIndicators(source) 
    local profile = core.indicators:findIndicator("BSP");
    assert(profile ~= nil, "Please, download and install " .. "BSP" .. ".LUA indicator");
    local indicatorParams = profile:parameters();
    indicatorParams:setString("Method", instance.parameters.Method);
    indicatorParams:setString("Type1", instance.parameters.Type1);
    indicatorParams:setString("Type2", instance.parameters.Type2);
    indicatorParams:setInteger("Period", instance.parameters.Period);
    indi = core.indicators:create("BSP", source, indicatorParams);
end
...
function CreateCustomActions()
    ...
    exitLongAction.IsPass = function (source, period, periodFromLast, data)
        return indi:getStream(0)[period] < indi:getStream(1)[period];
    end
