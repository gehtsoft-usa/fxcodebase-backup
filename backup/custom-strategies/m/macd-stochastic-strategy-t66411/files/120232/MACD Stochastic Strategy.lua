...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=66411
...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addString("SM", "Smoothing method for %K", "", "MVA");
    strategy.parameters:addStringAlternative("SM", "MVA", "", "MVA");
    strategy.parameters:addStringAlternative("SM", "EMA", "", "EMA");
    strategy.parameters:addStringAlternative("SM", "Fast Smoothed", "", "FS");
...
function CreateTradingParameters()
  ...
  --  strategy.parameters:addStringAlternative("ExitExecutionType", "End of Turn", "", "EndOfTurn");
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "MACDSS");
...
function Prepare( nameOnly)
	...
	Stochastic = core.indicators:create("STOCHASTIC", Source , K, SD, D, SM ); 
	first=math.max(MACD.HISTOGRAM:first(), Stochastic.D:first()); 
