...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=6681
...
function Init() --The strategy profile initialization
    strategy:name("Magic Trend Strategy");
    ...
    strategy.parameters:addInteger("CCIF", "CCI period", "No description", 50, 2, 2000);
    strategy.parameters:addInteger("ATRF", "ATR Period", "No description", 5, 2, 2000);
...
function Prepare( nameOnly)
	...
	MT = core.indicators:create("MAGIC TREND", Source,  CCIF, ATRF );
	
	
	first = MT.DATA:first() + 1;
    ...
    now = now - math.floor(now);		
      ...
      return ;
					 ...
					 MT:update(core.UpdateLast);
							...
							if core.crossesOver(  Source.close, MT.DATA , period) then
							...
							elseif core.crossesUnder(  Source.close,  MT.DATA , period) then
