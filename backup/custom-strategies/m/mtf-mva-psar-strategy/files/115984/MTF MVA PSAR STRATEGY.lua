...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=65352
...
function Init() --The strategy profile initialization
    strategy:name("MTF MVA PSAR STRATEGY")
    ...
    strategy.parameters:addInteger("Period11", "1. MA Period", "Period", 5)
    strategy.parameters:addString("Method11", "1. MA Method", "Method", "EMA")
    strategy.parameters:addStringAlternative("Method11", "MVA", "MVA", "MVA")
    strategy.parameters:addStringAlternative("Method11", "EMA", "EMA", "EMA")
    strategy.parameters:addStringAlternative("Method11", "LWMA", "LWMA", "LWMA")
    strategy.parameters:addStringAlternative("Method11", "TMA", "TMA", "TMA")
    strategy.parameters:addStringAlternative("Method11", "SMMA", "SMMA", "SMMA")
    strategy.parameters:addStringAlternative("Method11", "KAMA", "KAMA", "KAMA")
    strategy.parameters:addStringAlternative("Method11", "VIDYA", "VIDYA", "VIDYA")
    strategy.parameters:addStringAlternative("Method11", "WMA", "WMA", "WMA")

    strategy.parameters:addInteger("Period12", "2. MA Period", "Period", 11)
    strategy.parameters:addString("Method12", "2. MA Method", "Method", "EMA")
    strategy.parameters:addStringAlternative("Method12", "MVA", "MVA", "MVA")
    strategy.parameters:addStringAlternative("Method12", "EMA", "EMA", "EMA")
    strategy.parameters:addStringAlternative("Method12", "LWMA", "LWMA", "LWMA")
    strategy.parameters:addStringAlternative("Method12", "TMA", "TMA", "TMA")
    strategy.parameters:addStringAlternative("Method12", "SMMA", "SMMA", "SMMA")
    strategy.parameters:addStringAlternative("Method12", "KAMA", "KAMA", "KAMA")
    strategy.parameters:addStringAlternative("Method12", "VIDYA", "VIDYA", "VIDYA")
    strategy.parameters:addStringAlternative("Method12", "WMA", "WMA", "WMA")

    strategy.parameters:addDouble("Step", "SAR Step", "The sensitivity of SAR.", 0.01, 0.001, 1)
    strategy.parameters:addDouble("Max", "SAR Max", "The maximum value of Step.", 0.1, 0.001, 10)
    ...
    strategy.parameters:addInteger("Period21", "1. MA Period", "Period", 50)
    strategy.parameters:addString("Method21", "1. MA Method", "Method", "EMA")
    strategy.parameters:addStringAlternative("Method21", "MVA", "MVA", "MVA")
    strategy.parameters:addStringAlternative("Method21", "EMA", "EMA", "EMA")
    strategy.parameters:addStringAlternative("Method21", "LWMA", "LWMA", "LWMA")
    strategy.parameters:addStringAlternative("Method21", "TMA", "TMA", "TMA")
    strategy.parameters:addStringAlternative("Method21", "SMMA", "SMMA", "SMMA")
    strategy.parameters:addStringAlternative("Method21", "KAMA", "KAMA", "KAMA")
    strategy.parameters:addStringAlternative("Method21", "VIDYA", "VIDYA", "VIDYA")
    strategy.parameters:addStringAlternative("Method21", "WMA", "WMA", "WMA")

    strategy.parameters:addInteger("Period22", "2. MA Period", "Period", 200)
    strategy.parameters:addString("Method22", "2. MA Method", "Method", "EMA")
    strategy.parameters:addStringAlternative("Method22", "MVA", "MVA", "MVA")
    strategy.parameters:addStringAlternative("Method22", "EMA", "EMA", "EMA")
    strategy.parameters:addStringAlternative("Method22", "LWMA", "LWMA", "LWMA")
    strategy.parameters:addStringAlternative("Method22", "TMA", "TMA", "TMA")
    strategy.parameters:addStringAlternative("Method22", "SMMA", "SMMA", "SMMA")
    strategy.parameters:addStringAlternative("Method22", "KAMA", "KAMA", "KAMA")
    strategy.parameters:addStringAlternative("Method22", "VIDYA", "VIDYA", "VIDYA")
    strategy.parameters:addStringAlternative("Method22", "WMA", "WMA", "WMA")
...
local MA11, MA12, MA21, MA22
local Period11, Period12, Period21, Period22
local Method11, Method12, Method21, Method22
local SAR, Step, Max
...
function Prepare(nameOnly)
    ...
    MA11 = core.indicators:create(Method11, Source1.close, Period11)
    assert(core.indicators:findIndicator(Method12) ~= nil, Method12 .. " indicator must be installed");
    MA12 = core.indicators:create(Method12, Source1.close, Period12)
    assert(core.indicators:findIndicator(Method21) ~= nil, Method21 .. " indicator must be installed");
    MA21 = core.indicators:create(Method21, Source2.close, Period21)
    assert(core.indicators:findIndicator(Method22) ~= nil, Method22 .. " indicator must be installed");
    MA22 = core.indicators:create(Method22, Source2.close, Period22)

    SAR = core.indicators:create("SAR", Source1, Step, Max)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if EntryExecutionType == "Live" then
        ...
        period1 = core.findDate(Source1, Source1:date(period), false)
    ...
    -- update indicators.
    MA11:update(core.UpdateLast)
    MA12:update(core.UpdateLast)
    MA21:update(core.UpdateLast)
    MA22:update(core.UpdateLast)
    SAR:update(core.UpdateLast)

    if
        period1 < MA11.DATA:first() + 1 or period1 < MA12.DATA:first() + 1 or
            period1 < math.max(SAR.UP:first(), SAR.DN:first()) + 1 or
            period2 < MA21.DATA:first() + 1 or
            period2 < MA22.DATA:first() + 1
     then
        return
    end

    if EntryExecutionType == "Live" and id == 1 or EntryExecutionType ~= "Live" and id == 2 then
...
function EntryFunction(now, period1, period2)
    ...
    if
        MA11.DATA[period1] > MA12.DATA[period1] and MA21.DATA[period2] > MA22.DATA[period2] and
            Source1.close[period1] > MA11.DATA[period1] and
            Source1.close[period1 - 1] <= MA11.DATA[period1 - 1] and
            SAR:getStream(1):hasData(period1)
     then
        if Direction then
            BUY()
        else
    ...
    elseif
        MA11.DATA[period1] < MA12.DATA[period1] and MA21.DATA[period2] < MA22.DATA[period2] and
            Source1.close[period1] < MA11.DATA[period1] and
            Source1.close[period1 - 1] >= MA11.DATA[period1 - 1] and
            SAR:getStream(0):hasData(period1)
     then
        if Direction then
            SELL()
        else
...
function Signal(Label)
    ...
    --source
    if Email ~= nil then
        terminal:alertEmail(Email, profile:id() .. " : " .. Label, FormatEmail(Source1, NOW, Label))
    end
end
