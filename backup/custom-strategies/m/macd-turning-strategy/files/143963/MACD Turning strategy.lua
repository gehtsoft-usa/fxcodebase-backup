...
-- https://fxcodebase.com/code/viewtopic.php?f=31&t=71578
...
function Init() --The strategy profile initialization
    strategy:name("MACD Turning strategy");
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "MACDTS");
...
function Prepare( nameOnly)
    ...
    MACD = core.indicators:create("MACD", Source.close,  instance.parameters.Short,  instance.parameters.Long,  instance.parameters.Signal ); 
...
function EntryFunction( id, now,period)
    ...
    if   MACD.SIGNAL[period]<0 
	and MACD.SIGNAL[period] > MACD.SIGNAL[period-1]
	and MACD.SIGNAL[period-1] < MACD.SIGNAL[period-2]	
	then	
          if Direction then
                BUY();
            else
