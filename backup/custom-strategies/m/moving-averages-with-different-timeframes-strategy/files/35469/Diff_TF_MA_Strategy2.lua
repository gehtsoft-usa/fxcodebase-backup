...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addInteger("SecondaryPeriod", "Secondary Period", "", 20)
    ...
    strategy.parameters:addInteger("MasterPeriod", "Master Period", "", 50)
...
function Prepare()
    ...
    if Price == "close" then
        Master_MA =
            ...
            instance.parameters.MasterPeriod,
            false
        )
        Secondary_MA =
            core.indicators:create(
            ...
            Source2.close,
            instance.parameters.Method,
            instance.parameters.SecondaryPeriod,
            false
        )
