...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=15809
...
function Init() --The strategy profile initialization
    strategy:name("Multiple Day Up_Down  Strategy");
	...
	strategy.parameters:addInteger("Period1", "Number of periods", "Number of periods", 5);
	...
	strategy.parameters:addInteger("Period2", "Number of periods", "Number of periods", 200);
	strategy.parameters:addString("Method2", "Average Method", "" , "MVA");
	...
	strategy.parameters:addInteger("Period", "Max Number of candles", "Number of periods", 5);
	strategy.parameters:addInteger("Triger", "Min number of candles in counter trend To qualify ", "Number of periods", 4);
...
local Triger, Period, Period1, Period2;
...
function Prepare(nameOnly)
	...
	Triger = instance.parameters.Triger;
    ...
    Indicator[1] = core.indicators:create(Method1, Source[Price], Period1   );
	Short[1] = Indicator[1]:getStream(0);
	
    assert(core.indicators:findIndicator(Method2) ~= nil, Method2 .. " indicator must be installed");
	 Indicator[2] = core.indicators:create(Method2, Source[Price], Period2   );
...
function ExtUpdate(id, source, period)  -- The method called every time when a new bid or ask price appears.
   ...
   -- get only time
	...
	UP,DOWN= Check (period) ;
        ...
        if Source.close[period] >  Short[2] [period]
		and  Source.close[period] <  Short[1][period]
		and UP
		then
		...
		elseif  Source.close[period] <  Short[2][period] 
		and  Source.close[period] >  Short[1][period]
		and DOWN
		 then
            if Direction then
                ...
                BUY();
		            ...
		            if    Source.close[period] >  Short[1][period]
					then 			
								if   Direction then
