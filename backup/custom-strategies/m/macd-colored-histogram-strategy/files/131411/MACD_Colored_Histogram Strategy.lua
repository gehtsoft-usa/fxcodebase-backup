...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=69428
...
function CreateParameters() 
    strategy.parameters:addInteger("Period1", "Fast Period", "", 12, 1, 2000);
	strategy.parameters:addInteger("Period2", "Slow Period", "", 26, 1, 2000);
    strategy.parameters:addInteger("Period3", "Signal Period", "", 9, 1, 2000);
    strategy.parameters:addString("method1", "Up Signal", "", "buy");
    strategy.parameters:addStringAlternative("method1", "No Action", "", "no");
    strategy.parameters:addStringAlternative("method1", "Buy", "", "buy");
    strategy.parameters:addStringAlternative("method1", "Sell", "", "sell");
    strategy.parameters:addStringAlternative("method1", "Close", "", "close");
    strategy.parameters:addString("method2", "Down Signal", "", "sell");
    strategy.parameters:addStringAlternative("method2", "No Action", "", "no");
    strategy.parameters:addStringAlternative("method2", "Buy", "", "buy");
    strategy.parameters:addStringAlternative("method2", "Sell", "", "sell");
    strategy.parameters:addStringAlternative("method2", "Close", "", "close");
    strategy.parameters:addString("method3", "No Signal", "", "close");
    strategy.parameters:addStringAlternative("method3", "No Action", "", "no");
    strategy.parameters:addStringAlternative("method3", "Buy", "", "buy");
    strategy.parameters:addStringAlternative("method3", "Sell", "", "sell");
    strategy.parameters:addStringAlternative("method3", "Close", "", "close");
end

local indi, method1, method2, method3;
function CreateEntryIndicators(source)
    method1 = instance.parameters.method1;
    method2 = instance.parameters.method2;
    method3 = instance.parameters.method3;
    indi = core.indicators:create("MACD", source, Period1, Period2, Period3);
end
...
function IsEntryLong(source, period)
    local signal_up = ((indi.MACD[period] > 0 and indi.MACD[period] > indi.SIGNAL[period])
        and (indi.MACD[period-1] < 0 or indi.MACD[period-1] < indi.SIGNAL[period-1]));
    local signal_down = ((indi.MACD[period] < 0 and indi.MACD[period] < indi.SIGNAL[period])
        and (indi.MACD[period-1] > 0 or indi.MACD[period-1] > indi.SIGNAL[period-1]));
    if method1 == "buy" then
        return signal_up;
    elseif method2 == "buy" then
        return signal_down;
    elseif method3 == "buy" then
        return not signal_up and not signal_down;
    end
    return false;
end
function IsEntryShort(source, period)
    ...
    local signal_down = ((indi.MACD[period] < 0 and indi.MACD[period] < indi.SIGNAL[period])
        and (indi.MACD[period-1] > 0 or indi.MACD[period-1] > indi.SIGNAL[period-1]));
    if method1 == "sell" then
        return signal_up;
    elseif method2 == "sell" then
        return signal_down;
    elseif method3 == "sell" then
        return not signal_up and not signal_down;
    end
    return false;
end
function IsExitLong(source, period)
    ...
    local signal_down = ((indi.MACD[period] < 0 and indi.MACD[period] < indi.SIGNAL[period])
        and (indi.MACD[period-1] > 0 or indi.MACD[period-1] > indi.SIGNAL[period-1]));
    if method1 == "close" then
        return signal_up;
    elseif method2 == "close" then
        return signal_down;
    elseif method3 == "close" then
        return not signal_up and not signal_down;
    end
    return false;
end
