...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=65741
...
function Init() --The strategy profile initialization
    strategy:name("MACD AO Strategy");
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "MACDAOS");
