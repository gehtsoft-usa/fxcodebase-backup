-- Available @ https://fxcodebase.com/code/viewtopic.php?f=31&t=75760
...
function Init() --The strategy profile initialization
    strategy:name("MACD Slope Strategy");
    ...
    strategy.parameters:addInteger("Period", "Slope Period", "Period", 1,1,2000);
	strategy.parameters:addInteger("Period1", "Short Period", "Period", 12,1,2000);
	strategy.parameters:addInteger("Period2", "Long Period", "Period", 26,1,2000);
	strategy.parameters:addInteger("Period3", "Signal Period", "Period", 9,1,2000);
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "MSS");
...
function Prepare( nameOnly)
    ...
    Indicator = core.indicators:create("MACD SLOPE", Source.close,  Period, Period1, Period2, Period3  );
...
function ExitFunction( now,period)
	 ...
	 return;
		            ...
		            if    Indicator.DATA[period]< 0  then
