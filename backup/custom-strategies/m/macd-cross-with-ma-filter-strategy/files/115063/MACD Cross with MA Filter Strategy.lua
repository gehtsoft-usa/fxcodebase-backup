...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=65112
...
function Init() --The strategy profile initialization
    strategy:name("MACD Cross with MA Filter Strategy")
    ...
    strategy.parameters:addString("Smooth_Method", "Smooth method", "", "MVA")
    strategy.parameters:addStringAlternative("Smooth_Method", "MVA", "", "MVA")
    strategy.parameters:addStringAlternative("Smooth_Method", "EMA", "", "EMA")
    strategy.parameters:addStringAlternative("Smooth_Method", "KAMA", "", "KAMA")
    strategy.parameters:addStringAlternative("Smooth_Method", "Wilder", "", "Wilder")
    strategy.parameters:addStringAlternative("Smooth_Method", "LWMA", "", "LWMA")
    strategy.parameters:addStringAlternative("Smooth_Method", "SineWMA", "", "SineWMA")
    strategy.parameters:addStringAlternative("Smooth_Method", "TriMA", "", "TriMA")
    strategy.parameters:addStringAlternative("Smooth_Method", "LSMA", "", "LSMA")
    strategy.parameters:addStringAlternative("Smooth_Method", "SMMA", "", "SMMA")
    strategy.parameters:addStringAlternative("Smooth_Method", "HMA", "", "HMA")
    strategy.parameters:addStringAlternative("Smooth_Method", "ZeroLagEMA", "", "ZeroLagEMA")
    strategy.parameters:addStringAlternative("Smooth_Method", "DEMA", "", "DEMA")
    strategy.parameters:addStringAlternative("Smooth_Method", "T3", "", "T3")
    strategy.parameters:addStringAlternative("Smooth_Method", "ITrend", "", "ITrend")
    strategy.parameters:addStringAlternative("Smooth_Method", "Median", "", "Median")
    strategy.parameters:addStringAlternative("Smooth_Method", "GeoMean", "", "GeoMean")
    strategy.parameters:addStringAlternative("Smooth_Method", "REMA", "", "REMA")
    strategy.parameters:addStringAlternative("Smooth_Method", "ILRS", "", "ILRS")
    strategy.parameters:addStringAlternative("Smooth_Method", "IE/2", "", "IE/2")
    strategy.parameters:addStringAlternative("Smooth_Method", "TriMAgen", "", "TriMAgen")
    strategy.parameters:addStringAlternative("Smooth_Method", "JSmooth", "", "JSmooth")
    strategy.parameters:addInteger("Fast_Period", "Fast MA period", "", 12)
    strategy.parameters:addInteger("Slow_Period", "Slow MA period", "", 26)
    strategy.parameters:addString("Signal_Method", "Signal method", "", "MVA")
    strategy.parameters:addStringAlternative("Signal_Method", "MVA", "", "MVA")
    strategy.parameters:addStringAlternative("Signal_Method", "EMA", "", "EMA")
    strategy.parameters:addStringAlternative("Signal_Method", "KAMA", "", "KAMA")
    strategy.parameters:addStringAlternative("Signal_Method", "Wilder", "", "Wilder")
    strategy.parameters:addStringAlternative("Signal_Method", "LWMA", "", "LWMA")
    strategy.parameters:addStringAlternative("Signal_Method", "SineWMA", "", "SineWMA")
    strategy.parameters:addStringAlternative("Signal_Method", "TriMA", "", "TriMA")
    strategy.parameters:addStringAlternative("Signal_Method", "LSMA", "", "LSMA")
    strategy.parameters:addStringAlternative("Signal_Method", "SMMA", "", "SMMA")
    strategy.parameters:addStringAlternative("Signal_Method", "HMA", "", "HMA")
    strategy.parameters:addStringAlternative("Signal_Method", "ZeroLagEMA", "", "ZeroLagEMA")
    strategy.parameters:addStringAlternative("Signal_Method", "DEMA", "", "DEMA")
    strategy.parameters:addStringAlternative("Signal_Method", "T3", "", "T3")
    strategy.parameters:addStringAlternative("Signal_Method", "ITrend", "", "ITrend")
    strategy.parameters:addStringAlternative("Signal_Method", "Median", "", "Median")
    strategy.parameters:addStringAlternative("Signal_Method", "GeoMean", "", "GeoMean")
    strategy.parameters:addStringAlternative("Signal_Method", "REMA", "", "REMA")
    strategy.parameters:addStringAlternative("Signal_Method", "ILRS", "", "ILRS")
    strategy.parameters:addStringAlternative("Signal_Method", "IE/2", "", "IE/2")
    strategy.parameters:addStringAlternative("Signal_Method", "TriMAgen", "", "TriMAgen")
    strategy.parameters:addStringAlternative("Signal_Method", "JSmooth", "", "JSmooth")
    strategy.parameters:addInteger("Signal_Period", "Signal period", "", 9)

    strategy.parameters:addBoolean("Filter", "Use Filter", "", true)
    strategy.parameters:addString("MA_Method", "Filter Signal method", "", "MVA")
    ...
    strategy.parameters:addInteger("MA_Period", "Signal period", "", 9)
...
function Prepare(nameOnly)
    ...
    local profile = core.indicators:findIndicator("MACD_AVERAGES")
    assert(profile ~= nil, "Please, download and install " .. "MACD_AVERAGES" .. ".LUA indicator")
    local indicatorParams = profile:parameters()
    indicatorParams:setInteger("Signal_Period", Signal_Period)
    indicatorParams:setInteger("Fast_Period", Fast_Period)
    indicatorParams:setInteger("Slow_Period", Slow_Period)
    indicatorParams:setString("Signal_Method", Signal_Method)
    indicatorParams:setString("Smooth_Method1", Smooth_Method)
    indicatorParams:setString("Smooth_Method2", Smooth_Method)
    MACD_AVERAGES = core.indicators:create("MACD_AVERAGES", Source[Price], indicatorParams)

    MA = core.indicators:create("AVERAGES", Source[Price], MA_Method, MA_Period, false)
    first = math.max(MACD_AVERAGES.DATA:first(), MA.DATA:first())
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    -- update indicators.
    MACD_AVERAGES:update(core.UpdateLast)
...
function EntryFunction(now, period)
    ...
    --  Fast_MA:update(core.UpdateLast);
    -- Slow_MA:update(core.UpdateLast);
    -- MA:update(core.UpdateLast);

    -- only buy if we have a fast cross over slow and the price is above the moving averages.
    if
        (Source[Price][period] > MA.DATA[period] or not Filter) and
            MACD_AVERAGES.MACD[period] > MACD_AVERAGES.SIGNAL[period] and
            MACD_AVERAGES.MACD[period - 1] <= MACD_AVERAGES.SIGNAL[period - 1]
     then
        if Direction then
            BUY()
        else
