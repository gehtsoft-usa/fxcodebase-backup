...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=61739
...
function Init() --The strategy profile initialization
    strategy:name("MA position Overlay Position Strategy")
    ...
    strategy.parameters:addInteger("Period1", "1. MA Period ", "", 7, 1, 2000)
    ...
    strategy.parameters:addInteger("Period2", "2. MA Period", "", 14, 1, 2000)
    ...
    strategy.parameters:addInteger("Period3", "3. MA Period", "", 21, 1, 2000)
...
function CreateTradingParameters()
    ...
    strategy.parameters:addBoolean("Exit", "Exit on Neutral", "Use Optional Exit", false)
...
function Prepare(nameOnly)
    ...
    assert(
        core.indicators:findIndicator("MA POSITION OVERLAY POSITION") ~= nil,
        "Please, download and install MA POSITION OVERLAY POSITION.LUA indicator"
    )
    Indicator =
        core.indicators:create(
        "MA POSITION OVERLAY POSITION",
        Source,
        Price[1],
        Period[1],
        Method[1],
