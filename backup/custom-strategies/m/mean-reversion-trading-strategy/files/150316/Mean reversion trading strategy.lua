-- Available @ https://fxcodebase.com/code/viewtopic.php?f=31&t=73571
...
function Init() --The strategy profile initialization
    strategy:name("Mean reversion trading strategy");
    ...
    strategy.parameters:addDouble("LongLevel", "Long Entry Level", "", 30);  
    strategy.parameters:addDouble("ShortLevel", "Short Entry Level", "", 70);  	
	
    strategy.parameters:addDouble("LE", "Long Exit Level", "", 40);  
    strategy.parameters:addDouble("SE", "Short Exit Level", "", 60);  	
    ...
    strategy.parameters:addInteger("RSI_Period", "Period", "", 10);  	
	
     strategy.parameters:addString("RSI_Price", "Price Source", "", "median");
...
function Prepare( nameOnly)
	...
	LE = instance.parameters.LE;
	SE = instance.parameters.SE;
	
	LongLevel= instance.parameters.LongLevel;
	ShortLevel= instance.parameters.ShortLevel
...
function EntryFunction( id, now,period)
	...
	and RSI.DATA[period]> ShortLevel
	then
            if Direction then
                SELL();
            else
