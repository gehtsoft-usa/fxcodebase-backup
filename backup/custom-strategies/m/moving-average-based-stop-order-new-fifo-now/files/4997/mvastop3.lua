...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=2339
...
function Init()
    strategy:name("Set stop by Moving Average")
    strategy:description("Strategy changes stop equal to the chosen moving average value")
...
function ExtAsyncOperationFinished(id, success, message)
    ...
    if id == 100 and tradeExist and not (executing) then
        local period
