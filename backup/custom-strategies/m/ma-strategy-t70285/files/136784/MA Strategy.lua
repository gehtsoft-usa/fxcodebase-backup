...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=70285
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "MAS");
...
function Prepare( nameOnly)
    ...
    MA1 = core.indicators:create("MVA", Source.close, Period  ); 
...
function ExitFunction(id, now,period)
	...
	--/////////////////////////////////////////////////////////////////////
		            ...
		            if  MA1.DATA[period]<MA1.DATA[period-1]
