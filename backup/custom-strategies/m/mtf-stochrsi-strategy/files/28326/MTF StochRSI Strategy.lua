...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=14949
...
function Init() --The strategy profile initialization
    strategy:name("MTF StochRSI Strategy");
...
function TIMEFRAME(id, FRAME)
    ...
    strategy.parameters:addInteger(tostring(id*100  +2), "Number of periods for RSI", "", 14, 1, 200);
    strategy.parameters:addInteger(tostring(id*100  +3), "%K Stochastic Periods", "", 14, 1, 200);
    strategy.parameters:addInteger(tostring(id*100  +4), "%K Slowing Periods", "", 5, 1, 200);
    strategy.parameters:addInteger(tostring(id*100  +5), "%D Slowing Stochastic Periods", "", 3, 1, 200);
...
function Prepare(nameOnly)
   ...
   OS = instance.parameters.OS;
    ...
    Indicator[tostring(i*100 + 10)] = core.indicators:create("STOCHRSI", Source[i][Price], Parameters[tostring(i*100 + 2)], Parameters[tostring(i*100 + 3)], Parameters[tostring(i*100 + 4)], Parameters[tostring(i*100 + 5)]);
...
function ExtUpdate(id, source, period)  -- The method called every time when a new bid or ask price appears.
   ...
   Indicator[tostring(i*100 + 10)]:update(core.UpdateLast); 
	...
	return;
						   ...
						   if core.crossesOver(Indicator[tostring(1*100 + 10)].K, Indicator[tostring(1*100 + 10)].D,Indicator[tostring(1*100 + 10)].K:size()-2 , Indicator[tostring(1*100 + 10)].D:size()-2)
						   and Indicator[tostring(1*100 + 10)].K[  Indicator[tostring(1*100 + 10)].K:size()-2] < OS 
						   and
						   (
						    Indicator[tostring(2*100 + 10)].K[  Indicator[tostring(2*100 + 10)].K:size()-2] < OS
							or
							Indicator[tostring(2*100 + 10)].K[  Indicator[tostring(2*100 + 10)].K:size()-2] > Indicator[tostring(2*100 + 10)].D[  Indicator[tostring(2*100 + 10)].D:size()-2]
						   )
						   and Indicator[tostring(2*100 + 10)].K[  Indicator[tostring(2*100 + 10)].K:size()-2] < OB
						   then
						  ...
						  elseif core.crossesUnder(Indicator[tostring(1*100 + 10)].K, Indicator[tostring(1*100 + 10)].D, Indicator[tostring(1*100 + 10)].K:size()-2 , Indicator[tostring(1*100 + 10)].D:size()-2)
						  and Indicator[tostring(1*100 + 10)].K[  Indicator[tostring(1*100 + 10)].K:size()-2] > OB 
						 and
						 (
						 Indicator[tostring(2*100 + 10)].K[  Indicator[tostring(2*100 + 10)].K:size()-2] > OB
						 or
							Indicator[tostring(2*100 + 10)].K[  Indicator[tostring(2*100 + 10)].K:size()-2] < Indicator[tostring(2*100 + 10)].D[  Indicator[tostring(2*100 + 10)].D:size()-2]
						 )
						  and Indicator[tostring(2*100 + 10)].K[  Indicator[tostring(2*100 + 10)].K:size()-2] > OS
						 then
							if Direction then
								SELL();
							else
			...
			return;
					  ...
					  if   core.crossesUnder(Indicator[tostring(1*100 + 10)].K, Indicator[tostring(1*100 + 10)].D,Indicator[tostring(1*100 + 10)].K:size()-2 , Indicator[tostring(1*100 + 10)].D:size()-2)
					   then 			
										if   Direction then
						...
						elseif  core.crossesOver(Indicator[tostring(1*100 + 10)].K, Indicator[tostring(1*100 + 10)].D,Indicator[tostring(1*100 + 10)].K:size()-2 , Indicator[tostring(1*100 + 10)].D:size()-2)
						then
									 if   Direction then    
												if haveTrades("S") then
												   exit("S");
