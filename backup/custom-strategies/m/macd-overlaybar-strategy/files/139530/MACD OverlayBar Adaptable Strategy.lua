...
function CreateParameters() 
    AddAction(1, "Up in Up Trend");
    AddAction(2, "Down in Down Trend");
    AddAction(3, "Down in Up Trend");
    AddAction(4, "Up in Down Trend");
...
function CreateEntryIndicators(source)
    ...
    Indicator = core.indicators:create("MACD OVERLAY", source, Method,
        SN,
        LN,
        IN,
        Price,
    ...
    actions[1] = 
    {
        IsPass = function (period)
            local up = Indicator.DATA:colorI(period) == core.rgb(0, 200, 0);
            local rise = Indicator.DATA[period] > Indicator.DATA[period - 1];
            local prev_rise = Indicator.DATA[period - 1] > Indicator.DATA[period - 2];
            return up and rise and not prev_rise;
        end
    };
    actions[2] = 
    {
        IsPass = function (period)
            ...
            local rise = Indicator.DATA[period] > Indicator.DATA[period - 1];
            local prev_rise = Indicator.DATA[period - 1] > Indicator.DATA[period - 2];
            return not up and not rise and prev_rise;
        end
    };
    actions[3] = 
    {
        IsPass = function (period)
            ...
            local rise = Indicator.DATA[period] > Indicator.DATA[period - 1];
            local prev_rise = Indicator.DATA[period - 1] > Indicator.DATA[period - 2];
            return up and not rise and prev_rise;
        end
    };
    actions[4] = 
    {
        IsPass = function (period)
            ...
            local rise = Indicator.DATA[period] > Indicator.DATA[period - 1];
            local prev_rise = Indicator.DATA[period - 1] > Indicator.DATA[period - 2];
            return not up and rise and not prev_rise;
        end
    };
end
