...
function CreateParameters() 
    AddAction(1, "Red to Green");
    AddAction(2, "Green to Red");
...
function CreateEntryIndicators(source)
    ...
    actions[1] = 
    {
        IsPass = function (period)
            return Indicator.DATA:colorI(period) == core.rgb(0, 200, 0) and Indicator.DATA:colorI(period - 1) ~= core.rgb(0, 200, 0)
        end
    };
    actions[2] = 
    {
        IsPass = function (period)
            return Indicator.DATA:colorI(period) == core.rgb(200, 0, 0) and Indicator.DATA:colorI(period - 1) ~= core.rgb(200, 0, 0)
        end
    };
end
