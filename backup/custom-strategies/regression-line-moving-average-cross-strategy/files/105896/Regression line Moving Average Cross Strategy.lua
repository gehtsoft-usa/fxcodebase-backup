...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=63397
...
function Init() --The strategy profile initialization
    strategy:name("Regression line Moving Average Cross Strategy");
    ...
    strategy.parameters:addGroup("Regression Line Calculation");
    strategy.parameters:addInteger("rPeriod", "Period", "Period",20);
	strategy.parameters:addString("rMethod", "MA Method", "Method" , "LSMA");
    strategy.parameters:addStringAlternative("rMethod", "MVA", "MVA" , "MVA");
    strategy.parameters:addStringAlternative("rMethod", "EMA", "EMA" , "EMA");
    strategy.parameters:addStringAlternative("rMethod", "LWMA", "LWMA" , "LWMA");
    strategy.parameters:addStringAlternative("rMethod", "TMA", "TMA" , "TMA");
    strategy.parameters:addStringAlternative("rMethod", "SMMA", "SMMA" , "SMMA");
    strategy.parameters:addStringAlternative("rMethod", "KAMA", "KAMA" , "KAMA");
    strategy.parameters:addStringAlternative("rMethod", "VIDYA", "VIDYA" , "VIDYA");
    strategy.parameters:addStringAlternative("rMethod", "WMA", "WMA" , "WMA");
	strategy.parameters:addStringAlternative("rMethod", "LSMA", "LSMA" , "LSMA");
	
	strategy.parameters:addGroup("Moving Average Line Calculation");
    strategy.parameters:addInteger("mPeriod", "Period", "Period",20); 
	strategy.parameters:addString("mMethod", "MA Method", "Method" , "MVA");
    strategy.parameters:addStringAlternative("mMethod", "MVA", "MVA" , "MVA");
    strategy.parameters:addStringAlternative("mMethod", "EMA", "EMA" , "EMA");
    strategy.parameters:addStringAlternative("mMethod", "LWMA", "LWMA" , "LWMA");
    strategy.parameters:addStringAlternative("mMethod", "TMA", "TMA" , "TMA");
    strategy.parameters:addStringAlternative("mMethod", "SMMA", "SMMA" , "SMMA");
    strategy.parameters:addStringAlternative("mMethod", "KAMA", "KAMA" , "KAMA");
    strategy.parameters:addStringAlternative("mMethod", "VIDYA", "VIDYA" , "VIDYA");
    strategy.parameters:addStringAlternative("mMethod", "WMA", "WMA" , "WMA");
	strategy.parameters:addStringAlternative("mMethod", "LSMA", "LSMA" , "LSMA");
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "RLMACS");
...
local first;
local MA1, MA2, rMethod, rPeriod, mMethod, mPeriod;
local Direction;
local CustomID;
...
function Prepare( nameOnly)
    ...
    assert(core.indicators:findIndicator(rMethod) ~= nil, rMethod .. " indicator must be installed");
    MA1 = core.indicators:create(rMethod, Source.close, rPeriod  );
    assert(core.indicators:findIndicator(mMethod) ~= nil, mMethod .. " indicator must be installed");
	MA2 = core.indicators:create(mMethod, Source.close, mPeriod  );	
