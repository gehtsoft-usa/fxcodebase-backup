...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=2567&p
...
function Init() --The strategy profile initialization
    strategy:name("ZONE_TRADE_STRATEGY");
    strategy:description("The strategy trades using AO or AC or BW Zone Trade Rules");
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "ZTS");
...
function Prepare( nameOnly)
	...
	if TYPE == "ZONE" then
	 ...
	 name = profile:id() .. "(" .. "ZONE(" .. instance.bid:name() .. "." .. instance.parameters.TF .. "," ..
                                   instance.parameters.ACFM .. ","  .. instance.parameters.ACSM   .. ","  .. instance.parameters.ACM.. "," ..
                                   instance.parameters.AOFM .. ","  .. instance.parameters.AOSM .. ")";
	
	elseif  TYPE == "AO" then

	 name = profile:id() .. "(" .. "AO(" .. instance.bid:name() .. "." .. instance.parameters.TF .. "," ..
                                   instance.parameters.AOFM .. ","  .. instance.parameters.AOSM .. ")";
	elseif TYPE == "AC" then
	
	 name = profile:id() .. "(" .. "AC(" .. instance.bid:name() .. "." .. instance.parameters.TF .. "," ..
                                   instance.parameters.ACFM .. ","  .. instance.parameters.ACSM   .. ","  .. instance.parameters.ACM.. ")";
	end
	...
	elseif TYPE == "ZONE" then
     ...
     indicator[1] = core.indicators:create("AO",Source, instance.parameters:getInteger("AOFM"), instance.parameters:getInteger("AOSM")  );	
	 indicator[2] = core.indicators:create("AC",Source,  instance.parameters:getInteger("ACFM"),  instance.parameters:getInteger("ACSM"),instance.parameters:getInteger("ACM")  );	
	 first=math.max(first, indicator[1].DATA:first(), indicator[2].DATA:first());
	end    
        ...
        return;
		   ...
		   if  TYPE == "AO" then
		    ...
		    indicator[1]:update(core.UpdateLast);
			   ...
			   if   indicator[1].DATA[period] >  indicator[1].DATA[period-1] and FLAGAO ~= "Buy" then
			   FLAGAO = "Buy";
						if Direction then
						BUY();
					else
			   ...
			   elseif   indicator[1].DATA[period] <  indicator[1].DATA[period-1] and FLAGAO ~= "Sell" then
			   FLAGAO = "Sell";
							if Direction then
						SELL();
					else
		   ...
		   indicator[2]:update(core.UpdateLast);
			 ...
			 if   FLAGAO == "Buy"  and FLAGAC == "Buy" and FLAG ~= "Buy" then			   
			  FLAG = "Buy";
				  if Direction then
						BUY();
					else
				...
				ONE= Source:serial(period);
			  elseif  FLAGAO == "Sell"  and FLAGAC == "Sell" and FLAG ~= "Sell" then
			  FLAG = "Sell";
			      if Direction then
						SELL();
					else
				...
				ONE= Source:serial(period)
			   elseif  FLAGAO == "Sell" and FLAGAC == "Buy" and FLAG ~= "Neutral" or FLAGAO == "Buy" and FLAGAC == "Sell" and FLAG ~= "Neutral" then
			  FLAG = "Neutral";			  
			   TRADE("Neutral");
			   end
		   end      
