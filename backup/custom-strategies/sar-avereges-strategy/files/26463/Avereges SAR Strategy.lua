...
function Init() --The strategy profile initialization
    strategy:name("Avereges SAR Strategy");
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "ASAS");
