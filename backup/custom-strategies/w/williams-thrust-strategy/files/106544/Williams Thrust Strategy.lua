...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=63545
...
function Init() --The strategy profile initialization
    strategy:name("Williams Thrust Strategy")
    ...
    strategy.parameters:addInteger("LWO", "First Larry Williams Period", "", 250, 2, 1000)
    strategy.parameters:addInteger("MAO", "First Moving Average Period", "", 50, 2, 1000)
    strategy.parameters:addInteger("LWT", "Second Larry Williams Period", "", 50, 2, 1000)
    strategy.parameters:addInteger("MAT", "Second Moving Average Period", "", 10, 2, 1000)

    strategy.parameters:addString("Method", "MA Type", "MA Type", "EMA")
...
function Prepare(nameOnly)
    ...
    assert(
        core.indicators:findIndicator("WILLIAMS THRUST") ~= nil,
        "Please, download and install WILLIAMS THRUST.LUA indicator"
    )
