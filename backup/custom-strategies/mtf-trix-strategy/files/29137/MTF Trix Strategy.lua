...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=15474
...
function Init() --The strategy profile initialization
    strategy:name("MTF Trix Strategy")
    ...
    strategy.parameters:addStringAlternative("ExitType", "First", "", "First")
    strategy.parameters:addStringAlternative("ExitType", "Second", "", "Second")
    strategy.parameters:addStringAlternative("ExitType", "Third", "", "Third")
    strategy.parameters:addStringAlternative("ExitType", "Fourth", "", "Fourth")
...
function TIMEFRAME(id, FRAME)
    ...
    strategy.parameters:addInteger(tostring(id * 100 + 2), "TRIX Periods", "", 14)
    ...
    strategy.parameters:addStringAlternative(tostring(id * 100 + 5), "LWMA", "", "LWMA")
    strategy.parameters:addStringAlternative(tostring(id * 100 + 5), "TMA", "", "TMA")
    strategy.parameters:addStringAlternative(tostring(id * 100 + 5), "SMMA*", "", "SMMA")
    strategy.parameters:addStringAlternative(tostring(id * 100 + 5), "Vidya (1995)", "", "VIDYA")
    strategy.parameters:addStringAlternative(tostring(id * 100 + 5), "Vidya (1992)*", "", "VIDYA92")
    strategy.parameters:addStringAlternative(tostring(id * 100 + 5), "Wilders", "", "WMA")
    strategy.parameters:addInteger(tostring(id * 100 + 6), "Signal Periods", "", 9)
    strategy.parameters:addString(
        tostring(id * 100 + 7),
    ...
    strategy.parameters:addStringAlternative(tostring(id * 100 + 7), "MVA", "", "MVA")
    strategy.parameters:addStringAlternative(tostring(id * 100 + 7), "EMA", "", "EMA")
    strategy.parameters:addStringAlternative(tostring(id * 100 + 7), "LWMA", "", "LWMA")
    strategy.parameters:addStringAlternative(tostring(id * 100 + 7), "TMA", "", "TMA")
    strategy.parameters:addStringAlternative(tostring(id * 100 + 7), "SMMA*", "", "SMMA")
    strategy.parameters:addStringAlternative(tostring(id * 100 + 7), "Vidya (1995)", "", "VIDYA")
    strategy.parameters:addStringAlternative(tostring(id * 100 + 7), "Vidya (1992)*", "", "VIDYA92")
    strategy.parameters:addStringAlternative(tostring(id * 100 + 7), "Wilders", "", "WMA")
end
...
function Prepare(nameOnly)
    ...
    for i = 1, TfNumber, 1 do
        ...
        Parameters[tostring(i * 100 + 7)] = instance.parameters:getString(tostring(i * 100 + 7))
        ...
        name =
            name ..
            "(" ..
                Parameters[tostring(i * 100 + 1)] ..
                    ", " ..
                        Parameters[tostring(i * 100 + 2)] ..
                            ", " ..
                                Parameters[tostring(i * 100 + 3)] ..
                                    ", " ..
                                        Parameters[tostring(i * 100 + 4)] ..
                                            ", " ..
                                                Parameters[tostring(i * 100 + 5)] ..
                                                    ", " ..
                                                        Parameters[tostring(i * 100 + 6)] ..
                                                            ", " .. Parameters[tostring(i * 100 + 7)] .. ") "
        ...
        if not nameOnly then
            ...
            Trix[i] = Indicator[i]:getStream(0)
            SignalLine[i] = Indicator[i]:getStream(1)
            Histogram[i] = Indicator[i]:getStream(2)
        end
    end
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    for i = 1, TfNumber, 1 do
        if SignalLine[i]:size() <= SignalLine[i]:first() + 2 then
            FLAG = false
        end
    end
    ...
    if
        core.crossesOver(Trix[1], SignalLine[1], Trix[1]:size() - 2, SignalLine[1]:size() - 2) and
            (Histogram[2][Histogram[2]:size() - 2] > 0 or not ON[2]) and
            (Histogram[3][Histogram[3]:size() - 2] > 0 or not ON[3]) and
            (Histogram[4][Histogram[4]:size() - 2] > 0 or not ON[4])
     then
        if Direction then
            BUY()
        else
    ...
    elseif
        core.crossesUnder(Trix[1], SignalLine[1], Trix[1]:size() - 2, SignalLine[1]:size() - 2) and
            (Histogram[2][Histogram[2]:size() - 2] < 0 or not ON[2]) and
            (Histogram[3][Histogram[3]:size() - 2] < 0 or not ON[3]) and
            (Histogram[4][Histogram[4]:size() - 2] < 0 or not ON[4])
     then
    ...
    if Exit then
        if
            (core.crossesUnder(Trix[1], SignalLine[1], Trix[1]:size() - 2, SignalLine[1]:size() - 2) and
                (ExitType == "First" or ExitType == "Any")) or
                (Histogram[2][Histogram[2]:size() - 2] < 0 and (ExitType == "Second" or ExitType == "Any")) or
                (Histogram[3][Histogram[3]:size() - 2] < 0 and (ExitType == "Third" or ExitType == "Any")) or
                (Histogram[4][Histogram[4]:size() - 2] < 0 and (ExitType == "Fourth" or ExitType == "Any"))
         then
            if Direction then
