...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=71021
...
function Init() --The strategy profile initialization
    strategy:name("Simultaneous MA Cross Strategy");
    ...
    strategy.parameters:addInteger("Period1", "1. MA Period", "", 14, 2, 2000);
    ...
    strategy.parameters:addInteger("Period2", "2. MA Period", "", 14, 2, 2000);	
    ...
    strategy.parameters:addInteger("Period3", "3. MA Period", "", 28, 1, 2000);
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "SMACS");
...
function EntryFunction( id, now,period)
    ...
    and   MA1.DATA[period-1] <= MA3.DATA[period-1]
