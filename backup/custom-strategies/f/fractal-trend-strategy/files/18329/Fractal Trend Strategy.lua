...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=8283
...
function Init() --The strategy profile initialization
    strategy:name("Fractal Trend Strategy")
...
function Prepare(nameOnly)
    ...
    assert(
        core.indicators:findIndicator("ADVANCED FRACTAL TREND OVERLAY") ~= nil,
        "Please, download and install ADVANCED FRACTAL TREND OVERLAY.LUA indicator"
    )
