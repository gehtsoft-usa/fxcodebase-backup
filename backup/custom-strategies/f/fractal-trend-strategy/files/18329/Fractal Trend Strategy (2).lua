...
local STRATEGY_NAME = "Fractal Trend Strategy";
...
function CreateEntryIndicators(source)
    local profile = core.indicators:findIndicator("ADVANCED FRACTAL TREND OVERLAY");
    assert(profile ~= nil, "Please, download and install " .. "ADVANCED FRACTAL TREND OVERLAY" .. ".LUA indicator");
    indi = core.indicators:create("ADVANCED FRACTAL TREND OVERLAY", source, core.rgb(0, 255, 0),
        core.rgb(255, 0, 0),
        core.rgb(0, 255, 0),
        core.rgb(255, 0, 0),
        frame,
...
function IsEntryLong(source, period)
    return indi.DATA:colorI(period) == core.rgb(0, 255, 0);
end
function IsEntryShort(source, period)
    return indi.DATA:colorI(period) == core.rgb(255, 0, 0);
end
