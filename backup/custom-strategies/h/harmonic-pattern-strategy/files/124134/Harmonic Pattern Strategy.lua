...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=67393
...
local STRATEGY_NAME = "Harmonic Pattern Strategy";
...
function CreateParameters()
	strategy.parameters:addBoolean("Bat", "Bat", "", true)
	strategy.parameters:addBoolean("Gartley", "Gartley", "", true)
	strategy.parameters:addBoolean("Crab", "Crab", "", true)
	strategy.parameters:addBoolean("Butterfly", "Butterfly", "", true)
	strategy.parameters:addBoolean("ABCD", "AB=CD", "", true)
	strategy.parameters:addBoolean("Drives", "Three Drives", "", true)

	strategy.parameters:addDouble("Correction", "correction", "", 25, 0, 33)

	strategy.parameters:addGroup("Zig Zag Calculation")
	strategy.parameters:addInteger("Depth", "Depth", "", 12, 1, 10000)
	strategy.parameters:addInteger("Deviation", "Deviation", "", 5, 1, 1000)
	strategy.parameters:addInteger("Backstep", "Backstep", "", 3, 1, 10000)
end

local indi;
function CreateIndicators(source)
    local profile = EnsureIndicatorInstalled("HARMONIC PATTERN_WITH ALERT");
	...
	p:setBoolean("ChartAlert", false);
	p:setBoolean("PlaySound", false)
	p:setBoolean("RecurrentSound", false)
    p:setBoolean("SendEmail", false)
    
    p:setBoolean("ShowOutput", true);
    indi = core.indicators:create("HARMONIC PATTERN_WITH ALERT", source, p)
end
