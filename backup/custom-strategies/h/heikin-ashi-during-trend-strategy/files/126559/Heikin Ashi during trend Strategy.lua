...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=68511
...
function Init() --The strategy profile initialization
    strategy:name("Heikin Ashi during trend");
    ...
    strategy.parameters:addGroup("1. MA Calculate");
	
    strategy.parameters:addBoolean("Use_HA_1", "Use HA as source", "", false);   
	...
	strategy.parameters:addInteger("Period1", "Period", "", 25);
    ...
    strategy.parameters:addStringAlternative("Method1", "WMA", "WMA" , "WMA");
	 ...
	 strategy.parameters:addGroup("2. MA Calculate");
	 strategy.parameters:addBoolean("Use_HA_2", "Use HA as source", "", false);
	...
	strategy.parameters:addInteger("Period2", "Period", "", 50);
    ...
    strategy.parameters:addStringAlternative("Method2", "WMA", "WMA" , "WMA");
	 ...
	 strategy.parameters:addGroup("3. MA Calculate");
	 strategy.parameters:addBoolean("Use_HA_3", "Use HA as source", "", false);
	...
	strategy.parameters:addInteger("Period3", "Period", "", 100);
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "HADT");
...
local Use_HA_1, Use_HA_2, Use_HA_3;
function Prepare( nameOnly)
	...
	Use_HA_1= instance.parameters.Use_HA_1;
	Use_HA_2= instance.parameters.Use_HA_2;
	Use_HA_3= instance.parameters.Use_HA_3;
	...
	MA1 = core.indicators:create(Method1, HA[Price1], Period1   );
	else
	...
	MA2 = core.indicators:create(Method2, HA[Price2], Period2  );
	else	
	...
	MA3 = core.indicators:create(Method3, HA[Price3], Period3    );
	else
