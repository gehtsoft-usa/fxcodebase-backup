...
-- Available @ https://fxcodebase.com/code/viewtopic.php?f=31&t=74324
...
local STRATEGY_NAME = "Highly Adaptable ATR Channels Strategy";
function CreateParameters() 
    AddAction(1, "Central Line Cross Over");
    AddAction(2, "Central Line Cross Under");
    AddAction(3, "1. Upper Band Cross Over");
    AddAction(4, "1. Upper Band Cross Under");
    AddAction(5, "1. Lower Band Cross Over");
    AddAction(6, "1. Lower Band Cross Under");
    AddAction(7, "2. Upper Band Cross Over");
    AddAction(8, "2. Upper Band Cross Under");
    AddAction(9, "2. Lower Band Cross Over");
    AddAction(10, "2. Lower Band Cross Under");
    AddAction(11, "3. Upper Band Cross Over");
    AddAction(12, "3. Upper Band Cross Under");
    AddAction(13, "3. Lower Band Cross Over");
    AddAction(14, "3. Lower Band Cross Under");
    ...
    strategy.parameters:addDouble("Mult_Factor2", "Mult_Factor2", "", 3.2);
...
function CreateEntryIndicators(source)
    ...
    local profile = core.indicators:findIndicator("ATR_CHANNELS");
    assert(profile ~= nil, "Please, download and install " .. "ATR_CHANNELS" .. ".LUA indicator");
    local indicatorParams = profile:parameters();
    indicatorParams:setInteger("ATR_Period", instance.parameters.ATR_Period);
    indicatorParams:setInteger("MA_Period", instance.parameters.MA_Period);
    indicatorParams:setString("MA_Method", instance.parameters.MA_Method);
    indicatorParams:setString("MA_Price", instance.parameters.MA_Price);
    indicatorParams:setDouble("Mult_Factor1", instance.parameters.Mult_Factor1);
    indicatorParams:setDouble("Mult_Factor2", instance.parameters.Mult_Factor2);
    indicatorParams:setDouble("Mult_Factor3", instance.parameters.Mult_Factor3);
    indi = core.indicators:create("ATR_CHANNELS", source, indicatorParams)
    actions[1] = 
    {
        IsPass = function (period)
            return core.crossesOver(main_source, indi.Main, period) 
        end
    };
    actions[2] = 
    {
        IsPass = function (period)
            return core.crossesUnder(main_source, indi.Main, period) 
        end
    };
    actions[3] = 
    {
        IsPass = function (period)
            return core.crossesOver(main_source, indi.UpperBand1, period) 
        end
    };
    actions[4] = 
    {
        IsPass = function (period)
            return core.crossesUnder(main_source, indi.UpperBand1, period) 
        end
    };
    actions[5] = 
    {
        IsPass = function (period)
            return core.crossesOver(main_source, indi.LowerBand1, period) 
        end
    };
    actions[6] = 
    {
        IsPass = function (period)
            return core.crossesUnder(main_source, indi.LowerBand1, period) 
        end
    };
    actions[7] = 
    {
        IsPass = function (period)
            return core.crossesOver(main_source, indi.UpperBand2, period) 
        end
    };
    actions[8] = 
    {
        IsPass = function (period)
            return core.crossesUnder(main_source, indi.UpperBand2, period) 
        end
    };
    actions[9] = 
    {
        IsPass = function (period)
            return core.crossesOver(main_source, indi.LowerBand2, period) 
        end
    };
    actions[10] = 
    {
        IsPass = function (period)
            return core.crossesUnder(main_source, indi.LowerBand2, period) 
        end
    };
    actions[11] = 
    {
        IsPass = function (period)
            return core.crossesOver(main_source, indi.UpperBand3, period) 
        end
    };
    actions[12] = 
    {
        IsPass = function (period)
            return core.crossesUnder(main_source, indi.UpperBand3, period) 
        end
    };
    actions[13] = 
    {
        IsPass = function (period)
            return core.crossesOver(main_source, indi.LowerBand3, period) 
        end
    };
    actions[14] = 
    {
        IsPass = function (period)
            return core.crossesUnder(main_source, indi.LowerBand3, period) 
        end
    };
end
