...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=62883
...
function Init() --The strategy profile initialization
    strategy:name("HIGH VOLUME INSIDE BAR STRATEGY");
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "HVIBS");
...
function ExtUpdate(id, source, period)  -- The method called every time when a new bid or ask price appears.
   ...
   -- get only time
	...
	--[[
	1. SOURCE (HIGH)(PERIOD)<SOURCE(HIGH)(PERIOD-1)
	AND SOURCE(LOW)(PERIOD)>SOURCE(LOW)(PERIOD-1)

	2. PVA(PERIOD)>PVA (PERIOD -1)

	3.SOURCE (CLOSE)(PERIOD-1)>SOURCE (OPEN)(PERIOD-1)
	...
	and Source.low[period]>Source.low[period-1]
	and Source.volume[period]> Source.volume[period-1]
