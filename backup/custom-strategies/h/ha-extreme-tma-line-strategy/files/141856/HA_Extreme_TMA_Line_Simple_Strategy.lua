...
local STRATEGY_NAME = "HA Extreme TMA Line Simple Strategy";
...
function CreateEntryIndicators(source) 
    ...
    indi = core.indicators:create("EXTREME_TMA_LINE", source, instance.parameters.TMA_Period,
    instance.parameters.ATR_Period,
    instance.parameters.ATR_Mult,
    instance.parameters.TrendThreshold,
        true,
        instance.parameters.Redraw,
...
function CreateCustomActions()
    ...
    enterLongAction.IsPass = function (source, period, periodFromLast, data)
        return source.close[period] < indi.Lower[period];
    end
    ...
    enterShortAction.IsPass = function (source, period, periodFromLast, data)
        return source.close[period] > indi.Upper[period];
    end
...
function trading:EntryOrder(instrument)
    ...
    function builder:BuildValueMap()
        core.host:trace(self.valuemap.GTC);
...
function trading:MarketOrder(instrument)
    ...
    function builder:Execute()
        core.host:trace(tostring(self.valuemap.GTC));
