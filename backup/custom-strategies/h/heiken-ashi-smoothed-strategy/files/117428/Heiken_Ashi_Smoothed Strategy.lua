...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=65692
...
function Init() --The strategy profile initialization
    strategy:name("Heiken_Ashi_Smoothed Strategy");
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "HAS");
...
function Prepare( nameOnly)
    ...
    PrepareTrading();
	 ...
	 assert(core.indicators:findIndicator("HEIKEN_ASHI_SMOOTHED") ~= nil, "Please, download and install HEIKEN_ASHI_SMOOTHED.LUA indicator");          
    ...
    Source = ExtSubscribe(2, nil, TF, instance.parameters.Type == "Bid", "bar");
     Indicator = core.indicators:create("HEIKEN_ASHI_SMOOTHED", Source, Period,Method , core.rgb(0, 255, 0),  core.rgb(255, 0, 0),core.rgb(128,128,128)  );
