...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=9809
...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addBoolean("Previous", "Close Previous Order ", "", true)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if HA.open[period] < HA.close[period] then
        ...
        elseif HA.open[period] < HA.close[period] and HA.low[period] == HA.open[period] then
            if Direction then
                BUY()
            else
                SELL()
    ...
    elseif HA.open[period] > HA.close[period] then
        ...
        elseif HA.open[period] > HA.close[period] and HA.high[period] == HA.open[period] then
            if Direction then
                SELL()
            else
                BUY()
