...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=7702
...
function Init() --The strategy profile initialization
    strategy:name("Highly adaptable Laguerre RSI Strategy")
    ...
    strategy.parameters:addGroup("Laguerre RSI Parameter")
    strategy.parameters:addDouble("Parameters1", "Gamma", "", 0.7, -0.5, 1.05)

    strategy.parameters:addGroup("Levels")
    strategy.parameters:addDouble("Parameters2", "Overbought Level", "", 0.85)
    strategy.parameters:addDouble("Parameters3", " Oversold Level", "", 0.15)
    strategy.parameters:addDouble("Parameters4", " Central Line Level", "", 0.45)
    ...
    strategy.parameters:addString("Action" .. 3, "Central Line CrossOver Action", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 4, "Central Line CrossUnder Action", "", "NO")
...
function Prepare(nameOnly)
    ...
    assert(
        core.indicators:findIndicator("LAGUERRE_RSI") ~= nil,
        "Please, download and install LAGUERRE_RSI.LUA indicator"
    )
    ...
    Indicators[1] = core.indicators:create("LAGUERRE_RSI", Source[Price], Parameters[1])
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if core.crossesOver(Indicators[1].DATA, Parameters[2], period) then
        ACTION(1)
    elseif core.crossesUnder(Indicators[1].DATA, Parameters[2], period) then
        ACTION(2)
    elseif core.crossesOver(Indicators[1].DATA, Parameters[4], period) then
        ACTION(3)
    elseif core.crossesUnder(Indicators[1].DATA, Parameters[4], period) then
        ACTION(4)
    elseif core.crossesOver(Indicators[1].DATA, Parameters[3], period) then
        ACTION(5)
    elseif core.crossesUnder(Indicators[1].DATA, Parameters[3], period) then
        ACTION(6)
    end
end
