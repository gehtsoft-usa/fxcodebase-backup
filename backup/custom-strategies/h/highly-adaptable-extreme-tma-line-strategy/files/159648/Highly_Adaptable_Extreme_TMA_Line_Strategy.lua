-- Available @ https://fxcodebase.com/code/viewtopic.php?f=31&t=76047
...
local STRATEGY_NAME = "Extreme TMA Line Strategy";
function CreateParameters() 
    AddAction(1, "Cross Over TMA");
    AddAction(2, "Cross Under TMA");
    AddAction(3, "Cross Over Upper TMA");
    AddAction(4, "Cross Under Upper TMA");
    AddAction(5, "Cross Over Lower TMA");
    AddAction(6, "Cross Under Lower TMA");
