...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=15734
...
function Init() --The strategy profile initialization
    strategy:name("Highly adaptable SMI BB Strategy")
    ...
    strategy.parameters:addInteger("BP", "Period", "", 20)
    strategy.parameters:addDouble("BD", "Standard Deviation", "", 2)
    strategy.parameters:addInteger("DATA", "Type of BB Source", "", 1)
    strategy.parameters:addIntegerAlternative("DATA", "SMI Line", "", 1)
    strategy.parameters:addIntegerAlternative("DATA", "SMI Signal Line", "", 2)

    strategy.parameters:addGroup("SMI Calculation")
    ...
    strategy.parameters:addString("Action" .. 1, "SMI Top BB Line CrossOver Action", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 2, "SMI Central BB Line CrossOver Action", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 3, "SMI Bottom BB Line CrossOver Action", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 4, "SMI Top BB Line CrossUnder Action", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 5, "SMI Central BB Line CrossUnder Action", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 6, "SMI Bottom BB Line CrossUnder Action", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 7, "SMI / Signal Line CrossOver Action", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 8, "SMI / Signal Line CrossUnder Action", "", "NO")
...
function Prepare(nameOnly)
    ...
    name =
        ...
        ", " ..
            DATA ..
                ", " ..
                    BP ..
                        ", " .. BD .. ", " .. Period_Q .. ", " .. Period_R .. ", " .. Period_S .. ", " .. Period_Signal
    ...
    Indicator[1] = core.indicators:create("SMI", Source, Period_Q, Period_R, Period_S, Period_Signal)
    Short["L"] = Indicator[1]:getStream(0)
    Short["S"] = Indicator[1]:getStream(1)

    Indicator[2] = core.indicators:create("BB", Indicator[1]:getStream(DATA - 1), BP, BD)
    Short["T"] = Indicator[2]:getStream(0)
    Short["B"] = Indicator[2]:getStream(1)
    Short["C"] = Indicator[2]:getStream(2)

    first = math.max(Short["L"]:first(), Short["S"]:first(), Short["T"]:first(), Short["C"]:first())
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if core.crossesOver(Short["L"], Short["T"], period) then
        ACTION(1)
    elseif core.crossesOver(Short["L"], Short["C"], period) then
        ACTION(2)
    elseif core.crossesOver(Short["L"], Short["B"], period) then
        ACTION(3)
    elseif core.crossesUnder(Short["L"], Short["T"], period) then
        ACTION(4)
    elseif core.crossesUnder(Short["L"], Short["C"], period) then
        ACTION(5)
    elseif core.crossesUnder(Short["L"], Short["B"], period) then
        ACTION(6)
    elseif core.crossesUnder(Short["L"], Short["C"], period) then
        ACTION(7)
    elseif core.crossesUnder(Short["L"], Short["B"], period) then
