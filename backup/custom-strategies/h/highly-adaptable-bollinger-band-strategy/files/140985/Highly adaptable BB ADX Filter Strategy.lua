...
function CreateTradingParameters()
    ...
    strategy.parameters:addDouble("total_stop", "Total Stop", "", 50);
    strategy.parameters:addDouble("total_limit", "Total Limit", "", 50);
...
local ToTime
local adx, adx_level, total_stop, total_limit;
--
function Prepare(nameOnly)
    ...
    total_stop = instance.parameters.total_stop;
    total_limit = instance.parameters.total_limit;
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    local total_profit = account_row.Equity - account_row.Balance;
    if total_profit <= -total_stop or total_profit >= total_limit then
        exitSpecific("B");
        exitSpecific("S");
