...
-- https://fxcodebase.com/code/viewtopic.php?f=31&t=71810
...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addInteger("Period", "Period", "", 15, 1, 2000); 
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "HBH");
...
function Prepare( nameOnly)
	...
	assert(core.indicators:findIndicator("HBH") ~= nil, "Please, download and install HBH.LUA indicator");          
    ...
    Indicator = core.indicators:create("HBH", Source, Period, Method,     core.rgb(0, 255, 0),  core.rgb(255, 0, 0)  ); 
