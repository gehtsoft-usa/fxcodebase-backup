 -- Available @ https://fxcodebase.com/code/viewtopic.php?f=31&t=75138
...
function Init() --The strategy profile initialization
    strategy:name("Highly adaptable  Super Trend Strategy.")
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("Action" .. 1, "Color of UP", "", "NO")
    ...
    strategy.parameters:addStringAlternative("Action" .. 1, "Close Long Position", "", "CLOSELONG")
    strategy.parameters:addStringAlternative("Action" .. 1, "Close Short Position", "", "CLOSESHORT")
    strategy.parameters:addStringAlternative("Action" .. 1, "Close All Position", "", "CLOSEALL")
    strategy.parameters:addStringAlternative("Action" .. 1, "Alert", "", "Alert")

    strategy.parameters:addString("Action" .. 2, "Color of DOWN", "", "NO")
    ...
    strategy.parameters:addStringAlternative("Action" .. 2, "Close Long Position", "", "CLOSELONG")
    strategy.parameters:addStringAlternative("Action" .. 2, "Close Short Position", "", "CLOSESHORT")
    strategy.parameters:addStringAlternative("Action" .. 2, "Close All Position", "", "CLOSEALL")
    strategy.parameters:addStringAlternative("Action" .. 2, "Alert", "", "Alert")
	
    strategy.parameters:addString("Action" .. 3, "Color Change", "", "NO")
    ...
    strategy.parameters:addStringAlternative("Action" .. 3, "Close Long Position", "", "CLOSELONG")
    strategy.parameters:addStringAlternative("Action" .. 3, "Close Short Position", "", "CLOSESHORT")
    strategy.parameters:addStringAlternative("Action" .. 3, "Close All Position", "", "CLOSEALL")
    strategy.parameters:addStringAlternative("Action" .. 3, "Alert", "", "Alert")	
	
	
    strategy.parameters:addString("Action" .. 4, "Value is Rising", "", "NO")
    ...
    strategy.parameters:addStringAlternative("Action" .. 4, "Close Long Position", "", "CLOSELONG")
    strategy.parameters:addStringAlternative("Action" .. 4, "Close Short Position", "", "CLOSESHORT")
    strategy.parameters:addStringAlternative("Action" .. 4, "Close All Position", "", "CLOSEALL")
    strategy.parameters:addStringAlternative("Action" .. 4, "Alert", "", "Alert")		
	
    strategy.parameters:addString("Action" .. 5, "Value is Falling", "", "NO")
    ...
    strategy.parameters:addStringAlternative("Action" .. 5, "Close Long Position", "", "CLOSELONG")
    strategy.parameters:addStringAlternative("Action" .. 5, "Close Short Position", "", "CLOSESHORT")
    strategy.parameters:addStringAlternative("Action" .. 5, "Close All Position", "", "CLOSEALL")
    strategy.parameters:addStringAlternative("Action" .. 5, "Alert", "", "Alert")		
	
    strategy.parameters:addString("Action" .. 6, "No Change in Value", "", "NO")
    ...
    strategy.parameters:addStringAlternative("Action" .. 6, "Close Long Position", "", "CLOSELONG")
    strategy.parameters:addStringAlternative("Action" .. 6, "Close Short Position", "", "CLOSESHORT")
    strategy.parameters:addStringAlternative("Action" .. 6, "Close All Position", "", "CLOSEALL")
    ...
    strategy.parameters:addInteger("MaxNumberOfPosition", "Max Number Of Position In One Direction", "", 1, 1, 1000000)
...
function Prepare(nameOnly)
    ...
    Indicator = core.indicators:create("ST", Source, Period, Mode, core.rgb(0, 255, 0), core.rgb(255, 0, 0))
    Short = Indicator:getStream(0)
    first = Short:first() + 1
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if Short:colorI(period) ==  core.rgb(0, 255, 0)  then
        ACTION(1, "Up Trend")

        ONE = Source:serial(period)
    elseif Short:colorI(period) ==  core.rgb(255, 0, 0)  then
        ACTION(2,  "Down Trend")

        ONE = Source:serial(period)
    elseif Short:colorI(period)~= Short:colorI(period-1) then
        ACTION(3,  "Color Change")

        ONE = Source:serial(period)
    elseif Short[period] > Short[period-1] then
        ACTION(4, "Value is Rising")

        ONE = Source:serial(period)
    elseif Short[period] < Short[period-1]  then
        ACTION(5,  "Value is Falling")

        ONE = Source:serial(period)
    elseif Short[period] == Short[period-1] then
        ACTION(6,  "No Change in Value")
...
function ACTION(Flag, Label)
    ...
    elseif Action[Flag] == "CLOSELONG" then
        if AllowTrade then
            if Direction then
    ...
    elseif Action[Flag] == "CLOSESHORT" then
        if AllowTrade then
            if Direction then
                if haveTrades("S") then
                    exitSpecific("S")
    ...
    elseif Action[Flag] == "CLOSEALL" then
        if AllowTrade then
            if haveTrades("B") then
                exitSpecific("B")
                Signal("Close Long")
