...
-- https://fxcodebase.com/code/viewtopic.php?f=31&t=72939
...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addInteger("Period1", "1. MA Period", "", 25);  
    strategy.parameters:addInteger("Period2", "2. MA Period", "", 50);  
    strategy.parameters:addInteger("Period3", "3. MA Period", "", 270);  	
...
function CreateTradingParameters()
   ...
   -- strategy.parameters:addStringAlternative("ExitExecutionType", "End of Turn", "", "EndOfTurn");
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "HADTS");
...
function Prepare( nameOnly)
    ...
    MA3 = core.indicators:create(instance.parameters.Method, Source.close, instance.parameters.Period3 );	 
