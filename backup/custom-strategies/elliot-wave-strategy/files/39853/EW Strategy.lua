...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=23132
...
function Init() --The strategy profile initialization
    strategy:name("Elliot Wave Strategy")
    ...
    strategy.parameters:addInteger("Trigger", "Trigger value (%)", "", 70, 2, 1000)
    strategy.parameters:addInteger("NPeriod", "Number of periods", "", 20, 2, 1000)
...
function Prepare(nameOnly)
    ...
    name =
        ...
        ", " ..
            instance.parameters.Trigger ..
                ", " ..
                    instance.parameters.NPeriod ..
                        ", " .. instance.parameters.FastN .. ", " .. instance.parameters.SlowN
    ...
    EW =
        ...
        instance.parameters.Trigger,
        instance.parameters.NPeriod,
        instance.parameters.FastN,
        instance.parameters.SlowN
    )
    first = EW.DATA:first()
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if core.crossesOver(EW.DATA, 0, period) then
        if Direction then
            BUY()
        else
            SELL()
        end
    elseif core.crossesUnder(EW.DATA, 0, period) then
        if Direction then
            SELL()
        else
            BUY()
