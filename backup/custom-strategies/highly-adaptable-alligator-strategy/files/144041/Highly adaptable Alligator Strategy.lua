...
-- https://fxcodebase.com/code/viewtopic.php?f=31&t=71592
...
function Init() --The strategy profile initialization
    strategy:name("Highly adaptable Alligator Strategy");
    ...
    strategy.parameters:addStringAlternative("MTH", "REGRESSION", "", "REGRESSION")
    strategy.parameters:addStringAlternative("MTH", "SMMA", "", "SMMA")
    strategy.parameters:addStringAlternative("MTH", "VIDYA", "", "VIDYA")
    strategy.parameters:addStringAlternative("MTH", "VIDYA92", "", "VIDYA92")
    strategy.parameters:addStringAlternative("MTH", "WMA", "", "WMA")


	strategy.parameters:addGroup("Selector");
	
	strategy.parameters:addString("Action".. 1, "Price Jaw Cross Over", "", "NO");
	...
	strategy.parameters:addString("Action".. 2, "Price Jaw Cross Under", "", "NO");
	...
	strategy.parameters:addString("Action".. 3, "Price Teeth Cross Over", "", "NO");
	...
	strategy.parameters:addString("Action".. 4, "Price Teeth Cross Under", "", "NO");
	...
	strategy.parameters:addString("Action".. 5, "Price Lips Cross Over", "", "NO");
	...
	strategy.parameters:addString("Action".. 6, "Price Lips Cross Under", "", "NO");
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "KBMS");
	
	strategy.parameters:addBoolean("PositionCap", "Use Position Cap", "", false);
	
	strategy.parameters:addInteger("MaxNumberOfPositionInAnyDirection", "Max Number Of Open Position In Any Direction", "", 10, 1, 10000);
	strategy.parameters:addInteger("MaxNumberOfPosition", "Max Number Of Position In One Direction", "",5, 1, 100000);
...
local JawN, JawS, TeethN, TeethS, LipsN, LipsS, MTH
...
function Prepare( nameOnly)
    ...
    Indicator = core.indicators:create("ALLIGATOR", Source, JawN, JawS, TeethN, TeethS, LipsN, LipsS, MTH)
    first = math.max(Indicator.Jaw:first(), Indicator.Teeth:first(), Indicator.Lips:first())
   ...
   -- get only time
	...
	then
        return;
								...
								if core.crossesOver(Source.close, Indicator:getStream(0), period)then									
									ACTION(1,1 ,"Over", period);								
								end
								if core.crossesUnder(Source.close, Indicator:getStream(0), period)then		
                                    ACTION(2,1 ,"Under", period);	  
                                end									
					            if core.crossesOver(Source.close, Indicator:getStream(1), period) then	
								     ACTION(3,2 ,"Over", period);	
								end	  
								if core.crossesUnder(Source.close, Indicator:getStream(1), period) then	
								     ACTION(4,2 ,"Under", period);	
								end	  
								if core.crossesOver(Source.close, Indicator:getStream(2), period) then	
								     ACTION(5,3 ,"Over", period);
                                end									 
								if core.crossesUnder(Source.close, Indicator:getStream(2), period) then	
