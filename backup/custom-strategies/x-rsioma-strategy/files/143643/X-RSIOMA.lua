...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=70738
...
local MABuffer1, RSIBuffer1, marsioma1, rsi_os, rsi_ob, rsi_use_obos;
local indi_alerts = {};
...
{ 
    {
        ...
        UpCondition = function (period)
            ...
            return core.crossesOver(RSIBuffer1.DATA, rsi_os, period) and RSIBuffer1.DATA[period] > marsioma[period];
        end,
        DownCondition = function (period)
            ...
            return core.crossesUnder(RSIBuffer1.DATA, rsi_ob, period) and RSIBuffer1.DATA[period] < marsioma[period];
        end,
...
function Init()
    ...
    indicator.parameters:addColor("marsioma_color", "Marsioma Color", "Color", core.colors().Red);
...
function Prepare(nameOnly)
    ...
    marsioma = instance:addStream("marsioma", core.Line, "marsioma", "marsioma", instance.parameters.marsioma_color, 0, 0);
	...
	marsioma:addLevel(instance.parameters.Level1, instance.parameters.level_overboughtsold_style, instance.parameters.level_overboughtsold_width, instance.parameters.level_overboughtsold_color);
	marsioma:addLevel(instance.parameters.Level2, instance.parameters.level_overboughtsold_style, instance.parameters.level_overboughtsold_width, instance.parameters.level_overboughtsold_color);
	marsioma:addLevel(instance.parameters.Level3, instance.parameters.level_overboughtsold_style, instance.parameters.level_overboughtsold_width, instance.parameters.level_overboughtsold_color);
end
...
function Draw(stage, context) 
    ...
    if rsi[NOW] <= marsioma[NOW] and rsi[NOW] < 50 then
        ...
        context:drawText(FONT, "SELLS ONLY", core.colors().Red, 0, context:left(), context:top(), context:left() + w, context:top() + h, context.LEFT);
    elseif rsi[NOW] >= marsioma[NOW] and rsi[NOW] > 50 then
        local w, h = context:measureText(FONT, "BUYS ONLY", context.LEFT);
        context:drawText(FONT, "BUYS ONLY", core.colors().Blue, 0, context:left(), context:top(), context:left() + w, context:top() + h, context.LEFT);
    end
end
