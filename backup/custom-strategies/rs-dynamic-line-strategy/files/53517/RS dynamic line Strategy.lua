...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=31385
...
function Prepare(nameOnly)
    ...
    local i;
	   ...
	   name = name .. ", " ..  Period;
	 	...
	 	assert(core.indicators:findIndicator("RSDYNAMIC_LINE") ~= nil, "Please, download and install RSDYNAMIC_LINE.LUA indicator");          
		...
		if Exit then
		       ...
		       if    core.crossesOver(Source.close, Short[2],period) 
					then 			
					  ...
					  if core.crossesUnder(Source.close, Short[1],period) 
		               then
								   if   Direction then    
										if haveTrades("S") then
										   exit("S");
