...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=3698
...
function Init() --The strategy profile initialization
    strategy:name("MA & MACD strategy")
    strategy:description("MA & MACD strategy")
    strategy:setTag("Version", "2");
    strategy:setTag("NonOptimizableParameters", "Email,SendEmail,SoundFile,RecurrentSound,PlaySound, ShowAlert")

    strategy.parameters:addGroup("MA1 indicator parameters")
    strategy.parameters:addInteger("Period1", "Period1", "Period1", 80, 1, 1000)
    strategy.parameters:addString("Method1", "Method1", "", "MVA")
    ...
    strategy.parameters:addGroup("MA2 indicator parameters")
    strategy.parameters:addInteger("Period2", "Period2", "Period2", 20, 1, 1000)
    strategy.parameters:addString("Method2", "Method2", "", "MVA")
    ...
    strategy.parameters:addInteger("FastPeriod_MACD", "FastPeriod_MACD", "FastPeriod_MACD", 12, 1, 1000)
    strategy.parameters:addInteger("SlowPeriod_MACD", "SlowPeriod_MACD", "SlowPeriod_MACD", 26, 1, 1000)
    strategy.parameters:addInteger("SignalPeriod_MACD", "SignalPeriod_MACD", "SignalPeriod_MACD", 9, 1, 1000)
                                ...
                                instance.parameters.Period1 ..
                                    ") MA2(" ..
                                        instance.parameters.Period2 ..
                                            ") MACD(" ..
                                                instance.parameters.FastPeriod_MACD ..
                                                    ", " ..
                                                        instance.parameters.SlowPeriod_MACD ..
                                                            ", " .. instance.parameters.SignalPeriod_MACD .. "))"
    instance:name(name)
    if nameOnly then
        return;
    end
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if MACD.HISTOGRAM[period] > 0 then
        if MA2.DATA[period - 1] < MA1.DATA[period - 1] and MA2.DATA[period] >= MA1.DATA[period] then
