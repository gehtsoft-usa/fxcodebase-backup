...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=62150
...
function Init() --The strategy profile initialization
    strategy:name("2MA cloud Strategy")
    ...
    strategy.parameters:addString("Method1", "Method 1", "", "EMA")
    ...
    strategy.parameters:addInteger("Period1", "Period 1", "", 10)
    strategy.parameters:addString("Method2", "Method 2", "", "EMA")
    ...
    strategy.parameters:addInteger("Period2", "Period 2", "", 15)
...
function Prepare(nameOnly)
    ...
    Method1 = instance.parameters.Method2
    ...
    MA1 = core.indicators:create("AVERAGES", Source[Price], Method1, Period1, false)
