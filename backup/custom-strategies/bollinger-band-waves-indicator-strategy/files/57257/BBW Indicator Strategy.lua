...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=33740
...
function Init() --The strategy profile initialization
    strategy:name("Bollinger Band Waves  Indicator Strategy")
    ...
    strategy.parameters:addInteger("N", "Number of periods", "Number of periods", 20)
    strategy.parameters:addInteger("Dev", "Number of standard deviations", "Number of standard deviations", 2)
...
function Prepare(nameOnly)
    ...
    name = name .. ", " .. Method .. ", " .. Dev .. ", " .. N

    assert(core.indicators:findIndicator("BBW") ~= nil, "Please, download and install BBW.LUA indicator")
    assert(
    ...
    Indicator[1] = core.indicators:create("BBW", Source[Price], N, Dev, Method)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if Short[1][period] > Short[1][period - 1] and Short[1][period - 1] < Short[1][period - 2] then
        if Direction then
            BUY()
        else
            SELL()
        end
    elseif Short[1][period] < Short[1][period - 1] and Short[1][period - 1] > Short[1][period - 2] then
        if Direction then
            SELL()
        else
            BUY()
