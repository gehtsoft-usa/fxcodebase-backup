...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=12168
...
function Init() --The strategy profile initialization
    ...
    strategy:description("SMI strategy")
...
function Prepare(nameOnly)
    ...
    SMI =
        ...
        "SMI",
        Source,
        instance.parameters.Period_Q,
        instance.parameters.Period_R,
        instance.parameters.Period_S,
        instance.parameters.Period_Signal
    )
