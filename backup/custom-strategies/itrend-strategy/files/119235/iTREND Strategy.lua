...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=66124
...
function Init() --The strategy profile initialization
	...
	strategy.parameters:addString("Price_Mode", "Price Type", "", "close");
	strategy.parameters:addStringAlternative("Price_Mode","CLOSE", "", "close");
    strategy.parameters:addStringAlternative("Price_Mode", "OPEN", "", "open");
    strategy.parameters:addStringAlternative("Price_Mode", "HIGH", "", "high");
    strategy.parameters:addStringAlternative("Price_Mode", "LOW", "", "low");    
    strategy.parameters:addStringAlternative("Price_Mode", "MEDIAN", "", "median");
    strategy.parameters:addStringAlternative("Price_Mode", "TYPICAL", "", "typical");
    strategy.parameters:addStringAlternative("Price_Mode", "WEIGHTED", "", "weighted");
	
	
	strategy.parameters:addGroup("Bollinger  Component Parameters");	
	strategy.parameters:addString("Bollinger_Mode", "Bollinger Mode", "", "CL");
	strategy.parameters:addStringAlternative("Bollinger_Mode", "Central Band Line", "", "CL");
	strategy.parameters:addStringAlternative("Bollinger_Mode","Top Band Line", "", "TL");
	strategy.parameters:addStringAlternative("Bollinger_Mode","Bottom Band Line", "", "BL");

	
	
	strategy.parameters:addString("Bollinger_Price", "Power Price", "", "close");
	strategy.parameters:addStringAlternative("Bollinger_Price","CLOSE", "", "close");
    strategy.parameters:addStringAlternative("Bollinger_Price", "OPEN", "", "open");
    strategy.parameters:addStringAlternative("Bollinger_Price", "HIGH", "", "high");
    strategy.parameters:addStringAlternative("Bollinger_Price", "LOW", "", "low");    
    strategy.parameters:addStringAlternative("Bollinger_Price", "MEDIAN", "", "median");
    strategy.parameters:addStringAlternative("Bollinger_Price", "TYPICAL", "", "typical");
    strategy.parameters:addStringAlternative("Bollinger_Price", "WEIGHTED", "", "weighted");
	strategy.parameters:addInteger("Bollinger_Period", "Bands Period", "", 20);
	strategy.parameters:addDouble("Bollinger_Deviation", "Bands Deviation", "", 2);
	 
	
	strategy.parameters:addGroup("Power Component Parameters");	
	strategy.parameters:addString("Power_Price", "Power Price", "", "close");
	strategy.parameters:addStringAlternative("Power_Price","CLOSE", "", "close");
    strategy.parameters:addStringAlternative("Power_Price", "OPEN", "", "open");
    strategy.parameters:addStringAlternative("Power_Price", "HIGH", "", "high");
    strategy.parameters:addStringAlternative("Power_Price", "LOW", "", "low");    
    strategy.parameters:addStringAlternative("Power_Price", "MEDIAN", "", "median");
    strategy.parameters:addStringAlternative("Power_Price", "TYPICAL", "", "typical");
    strategy.parameters:addStringAlternative("Power_Price", "WEIGHTED", "", "weighted");

    strategy.parameters:addInteger("Power_Period", "Power Period", "", 13);
	strategy.parameters:addString("Power_Mode", "Power MA Mode", "", "EMA");
	 strategy.parameters:addStringAlternative("Power_Mode", "(EMA) Exponential Moving Average", "", "EMA");
    strategy.parameters:addStringAlternative("Power_Mode", "(SMA) Simple Moving Average", "", "MVA");   
    strategy.parameters:addStringAlternative("Power_Mode", "(LWMA) Linear-weighted Moving Average", "", "LWMA");
    strategy.parameters:addStringAlternative("Power_Mode", "(LSMA) Least Square Moving Average (Regression)", "", "REGRESSION");
    strategy.parameters:addStringAlternative("Power_Mode", "(SMMA) Smoothed Moving Average", "", "SMMA");
    strategy.parameters:addStringAlternative("Power_Mode", "(WMA) Wilders Smooth", "", "WMA"); 
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "ITS");
...
local Indicator;
local Price_Mode, Bollinger_Mode, Bollinger_Price, Bollinger_Period, Bollinger_Deviation,Power_Price,Power_Period,Power_Mode ;
...
function Prepare( nameOnly)
	...
	assert(core.indicators:findIndicator("ITREND") ~= nil, "Please, download and install ITREND.LUA indicator");          
    ...
    Indicator = core.indicators:create("ITREND", Source, Price_Mode, Bollinger_Mode, Bollinger_Price, Bollinger_Period, Bollinger_Deviation,Power_Price,Power_Period,Power_Mode  );	 
...
function EntryFunction( now,period)
    ...
    if   Indicator.Bollinger[period]> Indicator.Power[period]
	and  Indicator.Bollinger[period-1]<= Indicator.Power[period-1]
	then	
          if Direction then
                BUY();
            else
		...
		Return=true;
    elseif Indicator.Bollinger[period]< Indicator.Power[period]
	and  Indicator.Bollinger[period-1]>= Indicator.Power[period-1]
	then
            if Direction then
                SELL();
