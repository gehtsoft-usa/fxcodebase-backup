...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=63510
...
function Init() --The strategy profile initialization
    strategy:name("Shadow TSI Strategy")
    ...
    strategy.parameters:addInteger("Period1", "1. Period", "", 13, 2, 5000)
    strategy.parameters:addInteger("Period2", "2. Period", "", 7, 2, 5000)

    strategy.parameters:addGroup("1. MA Calculation")
    strategy.parameters:addInteger("Period3", "Period", "", 2, 2, 5000)
    ...
    strategy.parameters:addInteger("Period4", "Period", "", 6, 2, 5000)
    strategy.parameters:addString("Method4", "MA Method", "Method", "EMA")
...
function Prepare(nameOnly)
    ...
    tsi = core.indicators:create("TSI", Source.close, Period1, Period2)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if
        tsi.DATA[period] > ma2.DATA[period] and ma1.DATA[period] > ma2.DATA[period] and
            (tsi.DATA[period - 1] <= ma2.DATA[period - 1] or ma1.DATA[period - 1] <= ma2.DATA[period - 1])
     then
        if Direction then
            BUY()
        else
