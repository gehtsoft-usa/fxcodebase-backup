...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=61580
...
function Init() --The strategy profile initialization
    strategy:name("MA position Overlay Strategy")
...
function Prepare(nameOnly)
    ...
    assert(
        core.indicators:findIndicator("MA POSITION OVERLAY") ~= nil,
        "Please, download and install MA POSITION OVERLAY.LUA indicator"
    )
