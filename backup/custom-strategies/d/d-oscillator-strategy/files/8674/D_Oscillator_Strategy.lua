...
function Init() --The strategy profile initialization
    strategy:name("D oscillator strategy")
    strategy:description("D oscillator strategy")
    strategy:setTag(
    ...
    strategy.parameters:addInteger("RSI_Period", "RSI_Period", "", 13)
    strategy.parameters:addInteger("D_Period", "D_Period", "", 8)
    strategy.parameters:addInteger("CCI_Period", "CCI_Period", "", 8)
    strategy.parameters:addDouble("CCI_Coeff", "CCI_Coeff", "", 0.4)
    strategy.parameters:addInteger("Smooth", "Smooth", "", 4)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if DO.Buff1[period - 1] < DO.Buff2[period - 1] and DO.Buff1[period] > DO.Buff2[period] then
    ...
    if DO.Buff2[period - 1] < DO.Buff1[period - 1] and DO.Buff2[period] > DO.Buff1[period] then
        if instance.parameters.TypeSignal == "direct" then
            MustS = true
        else
            MustB = true
