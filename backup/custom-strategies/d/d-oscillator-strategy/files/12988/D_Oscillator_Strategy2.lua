...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=3609
-- Id: 4345
--+------------------------------------------------------------------+
...
function Init() --The strategy profile initialization
    strategy:name("D oscillator 2 strategy")
    strategy:setTag("NonOptimizableParameters", "Email,SendEmail,SoundFile,RecurrentSound,PlaySound,ShowAlert")
    strategy:description("D oscillator 2 strategy")
    ...
    strategy.parameters:addGroup("D oscillator 2 parameters")
    strategy.parameters:addInteger("RSI_Period2", "RSI_Period2", "", 21)
    strategy.parameters:addInteger("D_Period2", "D_Period2", "", 15)
    strategy.parameters:addInteger("CCI_Period2", "CCI_Period2", "", 21)
    strategy.parameters:addDouble("CCI_Coeff2", "CCI_Coeff2", "", 0.4)
    strategy.parameters:addInteger("Smooth2", "Smooth2", "", 3)
...
function Prepare()
                                                        ...
                                                        instance.parameters.CCI_Coeff ..
                                                            ", " ..
                                                                instance.parameters.Smooth ..
                                                                    ")) " ..
                                                                        "DO2(" ..
                                                                            instance.parameters.RSI_Period2 ..
                                                                                ", " ..
                                                                                    instance.parameters.D_Period2 ..
                                                                                        ", " ..
                                                                                            instance.parameters.CCI_Period2 ..
                                                                                                ", " ..
                                                                                                    instance.parameters.CCI_Coeff2 ..
                                                                                                        ", " ..
                                                                                                            instance.parameters.Smooth2 ..
                                                                                                                "))"
    instance:name(name)
    ...
    assert(
        core.indicators:findIndicator("D_OSCILLATOR") ~= nil,
        "Please, download and install D_OSCILLATOR.LUA indicator"
    )
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    DO2:update(core.UpdateLast)

    -- Check that we have enough data
    if (DO.DATA:first() > (period - 1)) then
        return
    end
    if (DO2.DATA:first() > (period - 1)) then
        return
    end
    ...
    if (DO.Buff1[period - 1] - DO.Buff2[period - 1]) * (DO.Buff1[period] - DO.Buff2[period]) < 0 then
        if DO2.Buff1[period] > DO2.Buff2[period] then
