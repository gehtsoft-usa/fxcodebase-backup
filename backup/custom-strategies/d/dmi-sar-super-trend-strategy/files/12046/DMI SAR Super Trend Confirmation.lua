...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=4855
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if
        DMI.DIP[period - 1] < DMI.DIM[period - 1] and DMI.DIP[period] > DMI.DIM[period] and
            not SAR.DN:hasData(period - 1) and
            SAR.DN:hasData(period) and
            SuperTrend.DATA[period] < Source.close[period]
     then
    ...
    elseif
        DMI.DIP[period - 1] > DMI.DIM[period - 1] and DMI.DIP[period] < DMI.DIM[period] and
            not SAR.UP:hasData(period - 1) and
            SAR.UP:hasData(period) and
            SuperTrend.DATA[period] > Source.close[period]
     then
        if Direction == "direct" then
            SELL()
