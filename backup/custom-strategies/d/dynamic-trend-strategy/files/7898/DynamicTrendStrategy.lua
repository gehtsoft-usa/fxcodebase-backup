...
function Init()
    strategy:name("DynamicTrend strategy")
    strategy:description("DynamicTrend strategy")
...
function Prepare(nameOnly)
    ...
    indicator = core.indicators:create("DYNAMICTREND", gSource, Percent, MaxPeriod, false)
...
function ExtUpdate(id, source, period)
    ...
    if core.crossesOver(gSource.close, indicator.DATA, period) then
        BUY()
    elseif core.crossesUnder(gSource.close, indicator.DATA, period) then
        SELL()
    end
end
