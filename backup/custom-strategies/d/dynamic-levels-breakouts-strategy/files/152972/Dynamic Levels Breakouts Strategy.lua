-- https://fxcodebase.com/code/viewtopic.php?f=31&t=74261
...
function Init() --The strategy profile initialization
    strategy:name("Dynamic Levels Breakouts Strategy");
    ...
    strategy.parameters:addBoolean("Consecutive", "Show Consecutive Signals", "", false); 	
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "DBS");
...
function Prepare( nameOnly)
	...
	assert(core.indicators:findIndicator("DYNAMIC LEVELS BREAKOUTS") ~= nil, "Please, download and install DYNAMIC LEVELS BREAKOUTS.LUA indicator");          
    ...
    Indicator = core.indicators:create("DYNAMIC LEVELS BREAKOUTS", Source , instance.parameters.Period, instance.parameters.Consecutive, true); 	
