...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=68575&start=10
...
local STRATEGY_NAME = "Donchian Channel Middle line Strategy (yolerap)";
...
function CreateParameters()
    ...
    strategy.parameters:addBoolean("close_on_neutral", "Close on neutral", "", false);
end

local indi, close_on_neutral;
function CreateIndicators(source)
    ...
    close_on_neutral = instance.parameters.close_on_neutral;
end
...
function CreateCustomActions()
    ...
    exitLongAction.IsPass = function (source, period, periodFromLast, data)
        return close_on_neutral and indi.DM[period] == indi.DM[period - 1];
    end
    ...
    enterLongAction.IsPass = function (source, period, periodFromLast, data)
        return indi.DM[period] > indi.DM[period - 1];
    end
