...
function CreateParameters() 
    ...
    strategy.parameters:addDouble("max_drawdown", "Max Drawdown %", "", 5);
end

local indi, max_drawdown;
function CreateEntryIndicators(source)
    max_drawdown = instance.parameters.max_drawdown / 100.0;
...
function IsExitLong(source, period)
    ...
    return (account_row.Balance - account_row.Equity) / account_row.Balance >= max_drawdown;
end
...
local main_source;
local base_size, offer_id, Amount, amount_type, AllowTrade, close_on_opposite, custom_id, AllowedSide;
