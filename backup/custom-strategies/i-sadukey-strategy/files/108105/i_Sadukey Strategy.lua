...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=63870
...
function Prepare(nameOnly)
    ...
    assert(
        core.indicators:findIndicator("I_SADUKEY OVERLAY") ~= nil,
        "Please, download and install I_SADUKEY OVERLAY.LUA indicator"
    )
    ...
    Indicator = core.indicators:create("I_SADUKEY OVERLAY", Source, core.rgb(0, 255, 0), core.rgb(255, 0, 0))
