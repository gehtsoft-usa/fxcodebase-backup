...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addBoolean("OpenLong", "Open Long", "", false);
	strategy.parameters:addBoolean("OpenShort", "Open Short", "", false);
	strategy.parameters:addBoolean("CloseLong", "Close Long", "", false);
	strategy.parameters:addBoolean("CloseShort", "Close Short", "", false);  
    strategy.parameters:addBoolean("HedgeLong", "Hedge your Long exposure", "", false);  
	strategy.parameters:addBoolean("HedgeShort", "Hedge your Short exposure", "", false);  
