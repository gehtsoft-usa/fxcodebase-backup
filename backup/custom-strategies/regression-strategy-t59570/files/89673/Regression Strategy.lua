...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=59570
...
function Init() --The strategy profile initialization
    strategy:name("Regression Strategy");
	...
	strategy.parameters:addGroup("Short Line Calculation");
    ...
    strategy.parameters:addInteger("SP", "Short Line Period", "Perios",20);
	
	strategy.parameters:addString("Method1", "MA Method", "Method" , "REGRESSION");
	 strategy.parameters:addStringAlternative("Method1", "REGRESSION", "REGRESSION" , "REGRESSION");
 ...
 strategy.parameters:addStringAlternative("Method1", "LWMA", "LWMA" , "LWMA");
	...
	strategy.parameters:addGroup("Long Line Calculation");
	...
	strategy.parameters:addInteger("LP", "Long Line Period", "Perios",50);
	strategy.parameters:addString("Method2", "MA Method", "Method" , "REGRESSION");
	 strategy.parameters:addStringAlternative("Method2", "REGRESSION", "REGRESSION" , "REGRESSION");
 ...
 strategy.parameters:addStringAlternative("Method2", "LWMA", "LWMA" , "LWMA");
	...
	strategy.parameters:addGroup("Exit Calculation");
	...
	strategy.parameters:addInteger("EP", "Exit Line Period", "Perios",50);
	strategy.parameters:addString("Method3", "MA Method", "Method" , "REGRESSION");
	 strategy.parameters:addStringAlternative("Method3", "REGRESSION", "REGRESSION" , "REGRESSION");
	...
	strategy.parameters:addString("EntryType", "Entry Type", "", "ShortMA/LongMA");
    strategy.parameters:addStringAlternative("EntryType", "Price/Short MA", "", "Price/ShortMA");
	strategy.parameters:addStringAlternative("EntryType", "Price/Long MA", "", "Price/LongMA");
    strategy.parameters:addStringAlternative("EntryType", "Short MA/Long MA", "", "ShortMA/LongMA");
	
	
   strategy.parameters:addBoolean("Exit", "Use Optinal Exit", "", false);
   
   strategy.parameters:addString("ExitType", "Entry Type", "", "Price/ExitMA");
    strategy.parameters:addStringAlternative("ExitType", "Price/Short MA", "", "Price/ShortMA");
	strategy.parameters:addStringAlternative("ExitType", "Price/Long MA", "", "Price/LongMA");
    strategy.parameters:addStringAlternative("ExitType", "Price/Exit MA", "", "Price/ExitMA");
...
function Prepare(nameOnly)
    ...
    local i;
	   ...
	   name = name .. ", " .. EntryType .. ", " ..  Price1.. ", " ..  SP.. ", " ..  Method1.. ", " ..  Price2.. ", " .. LP.. ", " ..  Method2.. ", " ..  Price3.. ", " .. EP.. ", " ..  Method3;
    ...
    Indicator[1] = core.indicators:create("REGRESSION", Source[Price1], SP  );
	Indicator[2] = core.indicators:create("REGRESSION", Source[Price2], LP  );
	Short[1] = Indicator[1]:getStream(0);
	Short[2] = Indicator[2]:getStream(0);
	
	Indicator[3] = core.indicators:create("REGRESSION", Source[Price3], EP  ); 
...
function ExtUpdate(id, source, period)  -- The method called every time when a new bid or ask price appears.
   ...
   -- get only time
	...
	if EntryType=="ShortMA/LongMA" then 
	...
	elseif EntryType== "Price/ShortMA" then
	
	   if   core.crossesOver(Source.close, Short[1] ,period) 
	   then
	    Flag= true;
	   elseif   core.crossesUnder(Source.close, Short[1] ,period) 
	   then
	    Flag= false;
	   end	  
	elseif EntryType== "Price/LongMA" then
	
	   if   core.crossesOver(Source.close, Short[2] ,period) 
	   then
	    Flag= true;
	   elseif   core.crossesUnder(Source.close, Short[2] ,period) 
	   then
	    Flag= false;
	   end	 
	end
		...
		Flag= nil;
				...
				if ExitType=="Price/ExitMA" then 
			
			   if   core.crossesOver(Source.close, Short[3],period) 
			   then
			    Flag= false;
			   elseif   core.crossesUnder(Source.close, Short[3],period) 
			   then
			    Flag= true;
			   end	
				
			elseif ExitType== "Price/ShortMA" then
			...
			elseif ExitType== "Price/LongMA" then
