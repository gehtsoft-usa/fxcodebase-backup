...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=62314
...
function Init() --The strategy profile initialization
    strategy:name("Non-Lag Moving Average Strategy");
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "NLMAS");
...
local first;
local Length, Filter, Deviation,Price; 
local Indicator; 
local Direction;
local CustomID;
...
function Prepare( nameOnly)
    ...
    Indicator = core.indicators:create("SSNONLAGMA", Source[Price],   Length, Filter, 0, Deviation ,  core.rgb(0, 255, 0),  core.rgb(255, 0, 0)  );
