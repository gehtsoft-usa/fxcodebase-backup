...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=24018
...
function Init() --The strategy profile initialization
    strategy:name("NHNL Divergence strategy")
...
function Prepare(nameOnly)
    ...
    assert(core.indicators:findIndicator("NHNL_DIVERGENCE") ~= nil, "Please, download and install VQZI.LUA indicator")
    ...
    Indicator[1] = core.indicators:create("NHNL_DIVERGENCE", Source, instance.parameters.Period, false)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    local UP = Indicator[1].UP[period - 2]
    if UP == nil then
        UP = 0
    end
    local DN = Indicator[1].DN[period - 2]
    if DN == nil then
        DN = 0
    end
