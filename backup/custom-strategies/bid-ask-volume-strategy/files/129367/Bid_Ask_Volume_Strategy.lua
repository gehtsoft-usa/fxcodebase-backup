...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=69042
...
local STRATEGY_NAME = "Bid Ask Volume";
...
function CreateEntryIndicators(source)
    local profile = core.indicators:findIndicator("BID_ASK_VOLUME");
    assert(profile ~= nil, "Please, download and install " .. "BID_ASK_VOLUME" .. ".LUA indicator");
    ...
    indi = core.indicators:create("BID_ASK_VOLUME", source, indicatorParams);
end
...
function CreateCustomActions()
    ...
    enterLongAction.IsPass = function (source, period, periodFromLast, data)
        return indi.Bid[period] > indi.Ask[period];
    end
