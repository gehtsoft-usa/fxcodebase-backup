...
function CreateParameters() 
    ...
    strategy.parameters:addString("Type", "Selector", "Selector", "Both")
    strategy.parameters:addStringAlternative("Type", "Both", "Both", "Both")
    strategy.parameters:addStringAlternative("Type", "Investors", "Investors", "Investors")
    strategy.parameters:addStringAlternative("Type", "Speculators", "Speculators", "Speculators")
...
function CreateEntryIndicators(source) 
    ...
    indicatorParams:setString("Type", instance.parameters:getString("Type"));
