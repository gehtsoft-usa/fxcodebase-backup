...
function Init() --The strategy profile initialization
    strategy:name("Stochastic Divergence and DMI strategy")
    strategy:description("Stochastic Divergence and DMI strategy")
    ...
    strategy.parameters:addInteger("Period", "Period", "DMI period", 14)
...
function Prepare()
                        ...
                        "," ..
                            "Stochastic(" ..
                                instance.parameters.K ..
                                    ", " .. instance.parameters.SD .. ", " .. instance.parameters.D .. "))"
    instance:name(name)
    ...
    assert(
        core.indicators:findIndicator("STOCHASTIC_DIVERGENCE") ~= nil,
        "Please, download and install STOCHASTIC_DIVERGENCE.LUA indicator"
    )
    Stochastic =
    ...
    DMI = core.indicators:create("DMI", Source, instance.parameters.Period)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if (Stochastic.DATA:first() > (period - 1)) then
        return
    end
    ...
    if Stochastic:getStream(1):hasData(period - 2) then
        ...
        if v ~= 0 and DMI.DIP[period] < DMI.DIM[period] then
