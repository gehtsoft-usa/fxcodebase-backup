...
function Init() --The strategy profile initialization
    strategy:name("Two VARMA Lines Cross Strategy");
    ...
    strategy.parameters:addInteger("Period1", "Period", "", 12, 2, 2000);
	strategy.parameters:addInteger("Smoothing1", "Smoothing", "", 6, 1, 200);
	...
	strategy.parameters:addInteger("Period2", "Period", "", 24, 2, 2000);
	strategy.parameters:addInteger("Smoothing2", "Smoothing", "", 12, 1, 200);
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "TVARMALS");
...
function Prepare( nameOnly)
    ...
    Indicator1 = core.indicators:create("VARMA", Source[instance.parameters.Price1],instance.parameters.Period1,instance.parameters.Smoothing1 );
	Indicator2 = core.indicators:create("VARMA", Source[instance.parameters.Price2],instance.parameters.Period2,instance.parameters.Smoothing2 );
