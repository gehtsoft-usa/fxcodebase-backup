...
function Init() --The strategy profile initialization
    strategy:name("Stoc_BB_RSI Strategy")
...
function EntryFunction(now, period1)
    local Return = false
    ...
    if
        (Indicator.STO_Signal[period1] > B_Level and Indicator.RSI[period1] > B_Level and
            Indicator.STO[period1] > Indicator.Minus2Sigma[period1] and
            Indicator.STO[period1 - 1] <= Indicator.Minus2Sigma[period1 - 1])
     then
        if Direction then
            BUY()
        else
        ...
        Return = true
    elseif
        (Indicator.STO_Signal[period1] < S_Level and Indicator.RSI[period1] < S_Level and
            Indicator.STO[period1] < Indicator.Plus2Sigma[period1] and
            Indicator.STO[period1 - 1] >= Indicator.Plus2Sigma[period1 - 1])
     then
        if Direction then
            SELL()
        else
