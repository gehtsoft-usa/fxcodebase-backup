...
-- https://fxcodebase.com/code/viewtopic.php?f=31&t=71599
...
function Init() --The strategy profile initialization
    strategy:name("Snake Force Strategy");
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "SFS");
...
function Prepare( nameOnly)
    ...
    Indicator = core.indicators:create("SF", Source.close,  instance.parameters.Period  ); 
...
--	period3= core.findDate (Source3, TickSource:date(period), false);
	...
	--/////////////////////////////////////////////////////////////////////
		            ...
		            if    Indicator.ResistanceUp[period]>0
					and  Indicator.ResistanceUp[period-1]==0
					and  Indicator.ForceUp[period-1]>0	 
					then
					  ...
					  if  Indicator.ResistanceDn[period]<0
					  and Indicator.ResistanceDn[period-1]==0
				      and  Indicator.ForceDn[period-1]<0	 					  
					  then
...
function EntryFunction( id, now,period)
	...
	then	
		...
		Return=true;
    elseif   Indicator.ForceDn[period]< 0 
	and  Indicator.ForceDn[period-1]==0 
	then
            if Direction then
                SELL();
