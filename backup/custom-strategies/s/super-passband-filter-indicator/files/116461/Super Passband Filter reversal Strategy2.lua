...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "SPFRS");
...
function ExtUpdate(id, source, period)  -- The method called every time when a new bid or ask price appears.
   ...
   -- get only time
	...
	and Indicator.PB[period] > Indicator.PB[period-1]
	and Indicator.PB[period-1] <= Indicator.PB[period-2]
	then	
          if Direction then
                BUY();
            else
