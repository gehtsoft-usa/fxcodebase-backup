...
-- https://fxcodebase.com/code/viewtopic.php?f=31&t=73634
...
local Historical,ShowLabel,SignalMode;
local Lookback;
function Prepare(nameOnly)   
	...
	if SignalMode then
	position = instance:addStream("position", core.Bar, name, "position", core.rgb(0, 255, 0), 0 );
    position:setPrecision(math.max(2, instance.source:getPrecision()));
	else	
