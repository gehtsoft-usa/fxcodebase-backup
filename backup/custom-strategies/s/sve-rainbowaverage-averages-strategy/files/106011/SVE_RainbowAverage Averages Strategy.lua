...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=63429
...
function Init() --The strategy profile initialization
    strategy:name("SVE_RainbowAverage Averages Strategy");
    ...
    strategy.parameters:addInteger("Period", "Number of periods", "", 2, 2, 1000);
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "SRAS");
...
function Prepare( nameOnly)
    ...
    Indicator = core.indicators:create("SVE_RAINBOWAVERAGE AVERAGES", Source.close, Period,  Method);
