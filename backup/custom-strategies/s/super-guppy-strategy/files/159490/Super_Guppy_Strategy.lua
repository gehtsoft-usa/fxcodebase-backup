-- Available @ https://fxcodebase.com/code/viewtopic.php?f=31&t=76004
...
local STRATEGY_NAME = "Super Guppy Strategy";
function CreateParameters() 
    strategy.parameters:addBoolean("param1", "Test w/Shorts?", "", true);
    strategy.parameters:addBoolean("param2", "Use Early Signals?", "", true);
    strategy.parameters:addBoolean("param3", "Show 200 EMA?", "", false);
    strategy.parameters:addInteger("param4", "Max Days Back to Test", "", 100000, 0);
    strategy.parameters:addInteger("param5", "Min Days Back to Test", "", 0, 0);
    strategy.parameters:addInteger("param6", "Fast EMA 1", "", 3, 1);
    strategy.parameters:addInteger("param7", "Fast EMA 2", "", 6, 1);
    strategy.parameters:addInteger("param8", "Fast EMA 3", "", 9, 1);
    strategy.parameters:addInteger("param9", "Fast EMA 4", "", 12, 1);
    strategy.parameters:addInteger("param10", "Fast EMA 5", "", 15, 1);
    strategy.parameters:addInteger("param11", "Fast EMA 6", "", 18, 1);
    strategy.parameters:addInteger("param12", "Fast EMA 7", "", 21, 1);
    strategy.parameters:addInteger("param13", "Slow EMA 8", "", 24, 1);
    strategy.parameters:addInteger("param14", "Slow EMA 9", "", 27, 1);
    strategy.parameters:addInteger("param15", "Slow EMA 10", "", 30, 1);
    strategy.parameters:addInteger("param16", "Slow EMA 11", "", 33, 1);
    strategy.parameters:addInteger("param17", "Slow EMA 12", "", 36, 1);
    strategy.parameters:addInteger("param18", "Slow EMA 13", "", 39, 1);
    strategy.parameters:addInteger("param19", "Slow EMA 14", "", 42, 1);
    strategy.parameters:addInteger("param20", "Slow EMA 15", "", 45, 1);
    strategy.parameters:addInteger("param21", "Slow EMA 16", "", 48, 1);
    strategy.parameters:addInteger("param22", "Slow EMA 17", "", 51, 1);
    strategy.parameters:addInteger("param23", "Slow EMA 18", "", 54, 1);
    strategy.parameters:addInteger("param24", "Slow EMA 19", "", 57, 1);
    strategy.parameters:addInteger("param25", "Slow EMA 20", "", 60, 1);
    strategy.parameters:addInteger("param26", "Slow EMA 21", "", 63, 1);
    strategy.parameters:addInteger("param27", "Slow EMA 22", "", 66, 1);
    strategy.parameters:addInteger("param28", "EMA 200", "", 200, 1);
end

local indi; 
function CreateEntryIndicators(source)
    local profile = core.indicators:findIndicator("SUPER_GUPPY_SIGNAL");
    assert(profile ~= nil, "Please, download and install " .. "SUPER GUPPY SIGNAL" .. ".LUA indicator");
    local indicatorParams = profile:parameters();
    indicatorParams:setBoolean("param1", instance.parameters.param1);
    indicatorParams:setBoolean("param2", instance.parameters.param2);
    indicatorParams:setBoolean("param3", instance.parameters.param3);
    indicatorParams:setInteger("param4", instance.parameters.param4);
    indicatorParams:setInteger("param5", instance.parameters.param5);
    indicatorParams:setInteger("param6", instance.parameters.param6);
    indicatorParams:setInteger("param7", instance.parameters.param7);
    ...
    indicatorParams:setInteger("param15", instance.parameters.param15);
    indicatorParams:setInteger("param16", instance.parameters.param16);
    indicatorParams:setInteger("param17", instance.parameters.param17);
    indicatorParams:setInteger("param18", instance.parameters.param18);
    ...
    indicatorParams:setInteger("param21", instance.parameters.param21);
    indicatorParams:setInteger("param22", instance.parameters.param22);
    indicatorParams:setInteger("param23", instance.parameters.param23);
    indicatorParams:setInteger("param24", instance.parameters.param24);
    indicatorParams:setInteger("param25", instance.parameters.param25);
    indicatorParams:setInteger("param26", instance.parameters.param26);
    indicatorParams:setInteger("param27", instance.parameters.param27);
    indicatorParams:setInteger("param28", instance.parameters.param28);
    indi = core.indicators:create("SUPER_GUPPY_SIGNAL", source, indicatorParams)
end
...
function IsEntryLong(source, period)
    return indi.entry_signalLONG[period] == 1;
end
function IsEntryShort(source, period)
    return indi.entry_signalshort[period] == -1;
end
function IsExitLong(source, period)
    return indi.close_signalLONG:hasData(period);
end
function IsExitShort(source, period)
    return indi.close_signalshort:hasData(period);
end
