...
function Prepare(nameOnly)
	...
	Source1 = ExtSubscribe(3, nil, instance.parameters.TF1, instance.parameters.Type == "Bid", "bar")
    ...
    adx = core.indicators:create("ADX", Source1, ADXPeriod)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
	...
	elseif ExecutionType ~= "Live" and id == 2 then 
    ...
    if period < first or (ADX and adx.DATA[period1] < ADXLevel) then
        return
    end
