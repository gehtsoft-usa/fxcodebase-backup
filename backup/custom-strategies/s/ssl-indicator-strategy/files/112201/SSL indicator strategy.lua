...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=64626
...
function Init() --The strategy profile initialization
    strategy:name("SSL indicator strategy")
    ...
    strategy.parameters:addInteger("N", "Number of periods", "The number of periods.", 10, 2, 1000)
...
function Prepare(nameOnly)
    ...
    Indicator = core.indicators:create("SSL", Source, N)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if not Indicator.DATA:hasData(period) or period < first then
        return
    end
