...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=68878
...
function Init() --The strategy profile initialization
    strategy:name("Dynamic Trend following algorithm Strategy");
	...
	strategy.parameters:addInteger("RSI_Period", "RSI Period", "Period" , 14);
	strategy.parameters:addInteger("MA_Period", "MA of RSI Period", "Period" , 14);
    strategy.parameters:addString("MA_Method", "MA of RSI Method", "Method" , "EMA");
...
function CreateTradingParameters()
   ...
   --strategy.parameters:addStringAlternative("ExitExecutionType", "End of Turn", "", "EndOfTurn");
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "DTFAS");
...
function Prepare( nameOnly)
	...
	MA = core.indicators:create(instance.parameters.MA_Method, RSI.DATA, instance.parameters.MA_Period   );
	first=MA.DATA:first(); 
...
function EntryFunction( id, now,period)
	...
	and RSI.DATA[period]> MA.DATA[period]
	and ( MA.DATA[period] < 40 or MA.DATA[period] >  60)
	...
	then	
		...
		Return=true;
    elseif Source.close[period]<  Source.close[period-1]
	and RSI.DATA[period]< MA.DATA[period]
	and ( MA.DATA[period] < 40 or MA.DATA[period] >  60)
