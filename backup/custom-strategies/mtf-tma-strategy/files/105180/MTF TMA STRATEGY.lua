...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=63228
...
function Init() --The strategy profile initialization
    strategy:name("MTF TMA STRATEGY");
    ...
    strategy.parameters:addInteger("TMA_Period1", "TMA period", "", 56);
    strategy.parameters:addInteger("ATR_Period1", "ATR period", "", 100);
    strategy.parameters:addDouble("ATR_Mult1", "ATR multiplier", "", 2);
    strategy.parameters:addDouble("TrendThreshold1", "TrendThreshold", "", 0.5);   
    strategy.parameters:addBoolean("Redraw1", "Redraw", "", false);
	
	strategy.parameters:addDouble("BL1", "Buy Level", "", 0.1);
    strategy.parameters:addDouble("SL1", "Sell Level", "", -0.1);
    ...
    strategy.parameters:addInteger("TMA_Period2", "TMA period", "", 56);
    strategy.parameters:addInteger("ATR_Period2", "ATR period", "", 100);
    strategy.parameters:addDouble("ATR_Mult2", "ATR multiplier", "", 2);
    strategy.parameters:addDouble("TrendThreshold2", "TrendThreshold", "", 0.5);   
    strategy.parameters:addBoolean("Redraw2", "Redraw", "", false);
	strategy.parameters:addDouble("BL2", "Buy Level", "", 0.3);
    strategy.parameters:addDouble("SL2", "Sell Level", "", -0.3);
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "MTFTMA");
...
local first;
local TMA_Period1, ATR_Period1, ATR_Mult1, TrendThreshold1,Redraw1;
local TMA_Period2, ATR_Period2, ATR_Mult2, TrendThreshold2,Redraw2;
--local Exit;
local TMA1,TMA2,BL1,BL2,SL1,SL2;
local Direction;
local CustomID;
...
function Prepare(nameOnly)
	...
	TMA_Period1 = instance.parameters.TMA_Period1;
	ATR_Period1 = instance.parameters.ATR_Period1;
	ATR_Mult1 = instance.parameters.ATR_Mult1;
	TrendThreshold1 = instance.parameters.TrendThreshold1;
	Redraw1 = instance.parameters.Redraw1;
    
	TMA_Period2 = instance.parameters.TMA_Period2;
	ATR_Period2 = instance.parameters.ATR_Period2;
	ATR_Mult2 = instance.parameters.ATR_Mult2;
	TrendThreshold2 = instance.parameters.TrendThreshold2;
	Redraw2 = instance.parameters.Redraw2;
    ...
    TMA1 = core.indicators:create("EXTREME_TMA_LINE", Source1, TMA_Period1, ATR_Period1, ATR_Mult1, TrendThreshold1, true,Redraw1,  core.rgb(128, 128, 128),  core.rgb(0, 255, 0),  core.rgb(255, 0, 0)  );
    TMA2 = core.indicators:create("EXTREME_TMA_LINE", Source2, TMA_Period2, ATR_Period2, ATR_Mult2, TrendThreshold2, true,Redraw2,  core.rgb(128, 128, 128),  core.rgb(0, 255, 0),  core.rgb(255, 0, 0)  );
...
function ExtUpdate(id, source, period)  -- The method called every time when a new bid or ask price appears.
 ...
 now = core.host:execute("getServerTime");
   ...
   -- get only time
    ...
    -- update indicators.
    TMA1:update(core.UpdateLast);
	TMA2:update(core.UpdateLast);
	...
	EXTREME TMA SLOPE IN M15 > BUY LEVEL(M15)
	EXTREME TMA SLOPE IN H4 > BUY LEVEL(H4)
	EXTREME TMA SLOPE IN H4 (PERIOD)>EXTREME TMA SLOPE IN H4( PERIOD-1)
	PRICE IN M 15 CROSS OVER LOWER BAND OF EXTREME TMA LINE


	SELL:

	EXTREME TMA SLOPE IN M15 < SELL LEVEL(M15)
	EXTREME TMA SLOPE IN H4 < SELL LEVEL(H4)
	EXTREME TMA SLOPE IN H4 (PERIOD)<EXTREME TMA SLOPE IN H4( PERIOD-1)
	PRICE IN M15 CROSS UNDER UPPER BAND OF EXREME TMA LINE
	]]

	 if TMA1.DATA:size() <= TMA1.DATA:first() + 2 
	or TMA2.DATA:size() <= TMA2.DATA:first() + 2 
	then
        return ;
    end
    ...
    if   ((TMA1.DATA[period1] - TMA1.DATA[period1-1])/Source1:pipSize())  > BL1
	and Source1.close[period1]> TMA1.Lower[period1]
	and Source1.close[period1-1]<= TMA1.Lower[period1-1]
	and ((TMA2.DATA[period2] - TMA2.DATA[period2-1])/Source2:pipSize()) > BL2
	and TMA2.DATA[period2]> TMA2.DATA[period2-1]
	then	
          if Direction then
                BUY();
            else
    ...
    elseif   ((TMA1.DATA[period1] - TMA1.DATA[period1-1])/Source1:pipSize())  < SL1
	and Source1.close[period1]< TMA1.Upper[period1]
	and Source1.close[period1-1]>= TMA1.Upper[period1-1]
	and ((TMA2.DATA[period2] - TMA2.DATA[period2-1])/Source2:pipSize()) < SL2
	and TMA2.DATA[period2]< TMA2.DATA[period2-1]
	then
            if Direction then
                SELL();
