-- Available @ https://fxcodebase.com/code/viewtopic.php?f=31&t=73634
...
function Init() --The strategy profile initialization
    strategy:name("SAR Price Targets Strategy");
    ...
    strategy.parameters:addDouble("Step", "Step", "", 0.02 );
    strategy.parameters:addDouble("Max", "Max", "", 0.2 );
    strategy.parameters:addDouble("Level1", "1. Target Ratio", "", 1 );
    strategy.parameters:addDouble("Level2", "2. Target Ratio", "", 1.5 );
    strategy.parameters:addDouble("Level3", "3. Target Ratio", "", 2 );
    strategy.parameters:addDouble("Level4", "Trigger Line (in pips)", "", 0 );
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "STS");
...
function Prepare( nameOnly)
	...
	assert(core.indicators:findIndicator("SAR PRICE TARGETS") ~= nil, "Please, download and install SAR PRICE TARGETS.LUA indicator");          
    ...
    Indicator = core.indicators:create("SAR PRICE TARGETS", Source, Step, Max, Level1, Level2, Level3, Level4, true, true ); 
