-- Available @ https://fxcodebase.com/code/viewtopic.php?f=31&t=73830
...
function Init() --The strategy profile initialization
    strategy:name("MA RSI STOCH Strategy");
    ...
    strategy.parameters:addInteger("Period", "Period", "", 144);	
    ...
    strategy.parameters:addInteger("RSI_Period", "Period", "", 8);	
	
	
    strategy.parameters:addGroup("Stochastic Calculation");
    strategy.parameters:addInteger("S1", "K Period", "", 5);  	
    strategy.parameters:addInteger("S2", "D Period", "", 3);  	
    strategy.parameters:addInteger("S3", "D MA Period", "", 3);  	 
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "MRSS");
...
function Prepare( nameOnly)
    ...
    Stochastic = core.indicators:create("STOCHASTIC", Source , S1,S2,S3,M1,M2 );	
	first=math.max(MA.DATA:first(),RSI.DATA:first(), Stochastic.D:first())+1; 
