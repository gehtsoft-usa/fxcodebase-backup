...
local ma, ssd, atr_stop, atr_limit, stop_mult, limit_mult, confirmation_source1, confirmation_source2;
local confirmation_ssd1, confirmation_ssd2;
function CreateEntryIndicators(source)
    ...
    confirmation_ssd1 = core.indicators:create("SSD", confirmation_source1, instance.parameters.stoch_k, instance.parameters.stoch_sd, instance.parameters.stoch_d);
    confirmation_ssd2 = core.indicators:create("SSD", confirmation_source2, instance.parameters.stoch_k, instance.parameters.stoch_sd, instance.parameters.stoch_d);
end

function UpdateIndicators()
    confirmation_ssd1:update(core.UpdateLast);
    confirmation_ssd2:update(core.UpdateLast);
...
function IsEntryLong(source, period)
    ...
    return source.close[period] > ma.DATA[period]
        ...
        and confirmation_ssd1.D[NOW] < ssd.K[period] 
        and confirmation_ssd2.D[NOW] < ssd.K[period] 
end
