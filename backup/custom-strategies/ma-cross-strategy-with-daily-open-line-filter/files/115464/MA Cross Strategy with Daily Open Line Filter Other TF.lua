...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addString("TF2", "Time frame for open price", "", "D1")
...
local AccountType
local Source, TickSource, Source2
...
local Method1, Method2, Period1, Period2, MA1, MA2
...
function EntryFunction(now, period)
    ...
    local OpenTF2 = Source2.open[Source2:size() - 1]
