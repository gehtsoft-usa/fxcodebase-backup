...
function Init() --The strategy profile initialization
    strategy:name("Quantum  Strategy");
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "QS");
...
function ExitFunction( now,period)
	 ...
	 return;
		            ...
		            if Source.close[period] >  DNC.DM[period]
					then
