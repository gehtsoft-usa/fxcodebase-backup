...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=61201
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if
        (Source.close[period - 2] < Source.open[period - 2] and Source.close[period - 1] < Source.open[period - 1] and
            Source.close[period] > Source.open[period] and
            Source.close[period] > math.max(Source.close[period - 1], Source.open[period - 1])) or
            (Source.close[period - 3] < Source.open[period - 3] and Source.close[period - 2] < Source.open[period - 2] and
                Source.close[period] > Source.open[period] and
                Source.close[period] > math.max(Source.close[period - 2], Source.open[period - 2]))
     then
        BUY()
    ...
    elseif
        (Source.close[period - 2] > Source.open[period - 2] and Source.close[period - 1] > Source.open[period - 1] and
            Source.close[period] < Source.open[period] and
            Source.close[period] < math.min(Source.close[period - 1], Source.open[period - 1])) or
            (Source.close[period - 3] > Source.open[period - 3] and Source.close[period - 2] > Source.open[period - 2] and
                Source.close[period] < Source.open[period] and
                Source.close[period] < math.min(Source.close[period - 2], Source.open[period - 2]))
     then
        SELL()
        ONE = Source:serial(period)
    end
