-- Available @ https://fxcodebase.com/code/viewtopic.php?f=31&t=73461
...
function Init() --The strategy profile initialization
    strategy:name("doubleGrid Trade Indicator Strategy");
	...
	strategy.parameters:addDouble("gsz", "Grid Pip Size", "", 100, 1, 10000)
...
function CreateTradingParameters()
   ...
   -- strategy.parameters:addStringAlternative("ExitExecutionType", "End of Turn", "", "EndOfTurn");
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "DGTIS");
	...
	strategy.parameters:addInteger("MaxNumberOfPosition", "Max Number Of Position In One Direction", "", 2);
...
function Prepare( nameOnly)
	...
	assert(core.indicators:findIndicator("DOUBLEGRID TRADE INDICATOR") ~= nil, "Please, download and install DOUBLEGRID TRADE INDICATOR.LUA indicator");          
    ...
    Indicator = core.indicators:create("DOUBLEGRID TRADE INDICATOR", Source.close , gsz ); 
