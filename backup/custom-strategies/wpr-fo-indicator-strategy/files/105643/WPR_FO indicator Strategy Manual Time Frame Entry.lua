...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=63335
...
function Init() --The strategy profile initialization
    strategy:name("WPR_FO indicator Strategy")
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if
        Exit and Indicator.DATA:colorI(period) == core.rgb(0, 0, 255) and
            Indicator.DATA:colorI(period - 1) ~= core.rgb(0, 0, 255)
     then
