...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=3517
...
function Init() --The strategy profile initialization
    ...
    strategy:description("MACD strategy")
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    local MustS = false
    if
        MACD.MACD[period - 1] > MACD.SIGNAL[period - 1] and MACD.MACD[period] < MACD.SIGNAL[period] and
            MACD.SIGNAL[period] > 0
     then
