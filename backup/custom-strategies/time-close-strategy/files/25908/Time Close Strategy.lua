...
-- http://fxcodebase.com/code//viewtopic.php?f=31&t=13319
...
function Init() --The strategy profile initialization
    strategy:name("Time Close Strategy")
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("SIDE", "Allowed Open/Entry/Both", "", "Both")
    strategy.parameters:addStringAlternative("SIDE", "Both", "", "Both")
    strategy.parameters:addStringAlternative("SIDE", "Buy", "", "Entry")
    strategy.parameters:addStringAlternative("SIDE", "Sell", "", "Open")
