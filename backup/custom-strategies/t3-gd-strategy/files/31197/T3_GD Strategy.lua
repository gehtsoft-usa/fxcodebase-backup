...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=16943
...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addDouble("VF1", "Volume Factor", "Volume Factor", 0.7, 0, 1)
    strategy.parameters:addInteger("F1", "Period", "Period", 20, 2, 2000)

    strategy.parameters:addGroup("GD Calculation")
    ...
    strategy.parameters:addDouble("VF2", "Volume Factor", "Volume Factor", 0.7, 0, 1)
    strategy.parameters:addInteger("F2", "Period", "Period", 20, 2, 2000)
...
function Prepare(nameOnly)
    ...
    name = name .. ", " .. Price1 .. ", " .. VF1 .. ", " .. F1 .. ", " .. Price2 .. ", " .. VF2 .. ", " .. F2
    ...
    Indicator[1] = core.indicators:create("T3", Source[Price1], VF1, F1)
    Short[1] = Indicator[1]:getStream(0)

    Indicator[2] = core.indicators:create("GD", Source[Price1], VF2, F2)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if core.crossesOver(Short[2], Short[1], period) then
        if Direction then
            BUY()
        else
            SELL()
        end
    elseif core.crossesUnder(Short[2], Short[1], period) then
        if Direction then
            SELL()
        else
            BUY()
