-- Available @ https://fxcodebase.com/code/viewtopic.php?f=31&t=74837
...
function Init() --The strategy profile initialization
    strategy:name("Long-Short Strategy");
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "LSS");
...
function EntryFunction( id, now,period)
	...
	--/////////////////////////////////////////////////////////////////    
     if LongEntry == Source:serial(period)   
	 and ShortEntry == Source:serial(period)   
	 then
	 return;
	 end	
	 --/////////////////////////////////////////////////////////////////  
	...
	then	
		...
		LongEntry= Source:serial(period); 
   end
   
   if  ShortEntry ~= Source:serial(period) 
	then
            if Direction then
                SELL();
            else
		...
		ShortEntry= Source:serial(period); 
    end
