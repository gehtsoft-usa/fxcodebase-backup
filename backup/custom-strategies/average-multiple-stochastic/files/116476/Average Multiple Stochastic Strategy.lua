...
-- http://fxcodebase.com/code/viewtopic.php?f=28&t=2712
...
function Init() --The strategy profile initialization
    strategy:name("Average Multiple Stochastic Strategy")
...
function Add(id, K, SD, D, MVAT_K, MVAT_D)
    strategy.parameters:addGroup(id .. ". Line")

    strategy.parameters:addInteger("K" .. id, "Stochastic Period", "Stochastic Period", K, 2, 100000)
    strategy.parameters:addInteger("SD" .. id, "Smoothing period for %K", "Smoothing period for %K", SD, 1, 100000)
    strategy.parameters:addInteger("D" .. id, "Smoothing period for %D", "Smoothing period for %D", D, 2, 100000)
    ...
    strategy.parameters:addStringAlternative("MVAT_K" .. id, "MVA", "MVA", "MVA")
    strategy.parameters:addStringAlternative("MVAT_K" .. id, "EMA", "EMA", "EMA")
    strategy.parameters:addStringAlternative("MVAT_K" .. id, "MetaTrader", "The MetaTrader algorithm.", "MT")
    ...
    strategy.parameters:addStringAlternative("MVAT_D" .. id, "MVA", "MVA", "MVA")
    strategy.parameters:addStringAlternative("MVAT_D" .. id, "EMA", "EMA", "EMA")
end
...
function Prepare(nameOnly)
    ...
    assert(
        core.indicators:findIndicator("AVERAGE MULTIPLE STOCHASTIC") ~= nil,
        "Please, download and install AVERAGE MULTIPLE STOCHASTIC.LUA indicator"
    )
    ...
    Indicator =
        ...
        true,
        true,
        instance.parameters:getInteger("K" .. 1),
        instance.parameters:getInteger("SD" .. 1),
        instance.parameters:getInteger("D" .. 1),
        instance.parameters:getString("MVAT_K" .. 1),
        instance.parameters:getString("MVAT_D" .. 1),
        instance.parameters:getInteger("K" .. 2),
        instance.parameters:getInteger("SD" .. 2),
        instance.parameters:getInteger("D" .. 2),
        instance.parameters:getString("MVAT_K" .. 2),
        instance.parameters:getString("MVAT_D" .. 2),
        instance.parameters:getInteger("K" .. 3),
        instance.parameters:getInteger("SD" .. 3),
        instance.parameters:getInteger("D" .. 3),
        instance.parameters:getString("MVAT_K" .. 3),
        instance.parameters:getString("MVAT_D" .. 3),
        instance.parameters:getInteger("K" .. 4),
        instance.parameters:getInteger("SD" .. 4),
        instance.parameters:getInteger("D" .. 4),
        instance.parameters:getString("MVAT_K" .. 4),
        instance.parameters:getString("MVAT_D" .. 4),
        instance.parameters:getInteger("K" .. 5),
        instance.parameters:getInteger("SD" .. 5),
        instance.parameters:getInteger("D" .. 5),
        instance.parameters:getString("MVAT_K" .. 5),
        instance.parameters:getString("MVAT_D" .. 5)
    )
    first = Indicator.Average_D:first()
...
function EntryFunction(now, period)
    ...
    if
        Indicator.Average_K[period] > Indicator.Average_D[period] and
            Indicator.Average_K[period - 1] <= Indicator.Average_D[period - 1]
     then
        if Direction then
            BUY()
        else
