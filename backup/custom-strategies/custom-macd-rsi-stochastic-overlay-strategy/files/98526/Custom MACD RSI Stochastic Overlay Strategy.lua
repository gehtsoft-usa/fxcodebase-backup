...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=61792
...
function Init() --The strategy profile initialization
    strategy:name("Custom MACD RSI Stochastic Overlay Strategy")
    ...
    strategy.parameters:addString("Price1", "Data Source", "", "close")
    ...
    strategy.parameters:addDouble("MB", "Buy Level", "", 0.0001)
    strategy.parameters:addDouble("MS", "Sell Level", "", -0.0001)

    strategy.parameters:addGroup("RSI Calculation")
    strategy.parameters:addString("Price2", "Data Source", "", "close")
    ...
    strategy.parameters:addInteger("RP", "Period", "", 14, 2, 1000)

    strategy.parameters:addDouble("RB", "Buy Level", "", 70)
    strategy.parameters:addDouble("RS", "Sell Level", "", 30)
    ...
    strategy.parameters:addDouble("SB", "Buy Level", "", 50)
    strategy.parameters:addDouble("SS", "Sell Level", "", 50)

    strategy.parameters:addGroup("Selector")
    strategy.parameters:addBoolean("One", "Use MACD Filter", "", true)
    strategy.parameters:addBoolean("Two", "Use RSI Filter", "", true)
    strategy.parameters:addBoolean("Three", "Use Stochastic Filter", "", true)
...
local first
local Price1, SN, LN, IN, MB, MS, Price2, RB, RS, K, SD, D, MVAT_K, MVAT_D, SB, SS, One, Two, Three, RP
local Indicator
...
function Prepare(nameOnly)
    ...
    assert(
        core.indicators:findIndicator("CUSTOM MACD RSI STOCHASTIC OVERLAY") ~= nil,
        "Please, download and install CUSTOM MACD RSI STOCHASTIC OVERLAY.LUA indicator"
    )
    ...
    Indicator =
        ...
        "CUSTOM MACD RSI STOCHASTIC OVERLAY",
        Source,
        Price1,
        SN,
        LN,
