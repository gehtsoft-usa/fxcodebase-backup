...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=62331
...
function Init() --The strategy profile initialization
    strategy:name("Laguerre_Filter Strategy")
    ...
    strategy.parameters:addString("TradeType", "Slope/Cross ", "", "Cross")
    strategy.parameters:addStringAlternative("TradeType", "Cross", "", "Cross")
    strategy.parameters:addStringAlternative("TradeType", "Slope", "", "Slope")
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if
        (Source.close[period] > Indicator.DATA[period] and Source.close[period - 1] <= Indicator.DATA[period - 1] and
            TradeType == "Cross") or
            (Indicator.DATA[period] > Indicator.DATA[period - 1] and
                Indicator.DATA[period - 1] <= Indicator.DATA[period - 2] and
                TradeType == "Slope")
     then
        if Direction then
            BUY()
