...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=22664
...
function Init() --The strategy profile initialization
    strategy:name("Linear Regression Slope Cross Strategy")
    ...
    strategy.parameters:addInteger("Period1", "1. Period", "Period", 10)
    strategy.parameters:addInteger("Period2", "2. Period", "Period", 20)
...
function Prepare(nameOnly)
    ...
    Indicator[1] = core.indicators:create("LRS", Source[Price], Period1)
    Short[1] = Indicator[1]:getStream(0)

    Indicator[2] = core.indicators:create("LRS", Source[Price], Period2)
