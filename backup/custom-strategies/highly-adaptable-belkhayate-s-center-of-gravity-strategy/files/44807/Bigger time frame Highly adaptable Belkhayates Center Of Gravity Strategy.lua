...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addString("TF1", "1. Time frame", "", "m5")
    strategy.parameters:setFlag("TF1", core.FLAG_PERIODS)

    strategy.parameters:addString("TF2", "2. Time frame", "", "H1")
    strategy.parameters:setFlag("TF2", core.FLAG_PERIODS)

    strategy.parameters:addString("PriceSource", "Price Source Time Frame", "", "1")
    strategy.parameters:addStringAlternative("PriceSource", "1. Time Frame", "", "1")
    strategy.parameters:addStringAlternative("PriceSource", "2. Time Frame", "", "2")

    strategy.parameters:addString("IndicatorSource", "Indicator Source Time Frame", "", "2")
    strategy.parameters:addStringAlternative("IndicatorSource", "1. Time Frame", "", "1")
    strategy.parameters:addStringAlternative("IndicatorSource", "2. Time Frame", "", "2")
    ...
    strategy.parameters:addString("Action" .. 1, "L1 Line Cross Over", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 2, "L1 Line Cross Under", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 3, "L2 Line Cross Over", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 4, "L2 Cross Under", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 5, "L3 Line  Cross Over", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 6, "L3 Line Cross Under", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 7, "L4 Line Cross Over", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 8, "L4 Line Cross  Under", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 9, "L5 Line Cross Over", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 10, "L5 Line Cross Under", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 11, "L6 Line Cross Over", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 12, "L6 Line Cross  Under", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 13, "L7 Line Cross Over", "", "NO")
    ...
    strategy.parameters:addString("Action" .. 14, "L7 Line Cross Under", "", "NO")
...
local IndicatorSource, PriceSource
...
function Prepare(nameOnly)
    ...
    IndicatorSource = instance.parameters.IndicatorSource
    ...
    Source1 = ExtSubscribe(1, nil, instance.parameters.TF1, instance.parameters.Type == "Bid", "bar")
    Source2 = ExtSubscribe(2, nil, instance.parameters.TF2, instance.parameters.Type == "Bid", "bar")

    if IndicatorSource == "1" then
        Indicators[1] = core.indicators:create("BELCOG", Source1, N, O, E)
    else
        Indicators[1] = core.indicators:create("BELCOG", Source2, N, O, E)
    end
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if PriceSource == "1" then
        p1 = period
    else
        p1 = core.findDate(Source2.close, Source1:date(period), false)
    end

    if IndicatorSource == "1" then
        p2 = period
    else
        p2 = core.findDate(Source2.close, Source1:date(period), false)
    end
    ...
    if
        not Indicators[1].DATA:hasData(p2) or (not Source1.close:hasData(p1) and PriceSource == "1") or
            (not Source2.close:hasData(p1) and PriceSource == "2") or
            not Indicators[1].DATA:hasData(p2 - 1) or
            (not Source1.close:hasData(p1 - 1) and PriceSource == "1") or
            (not Source2.close:hasData(p1 - 1) and PriceSource == "2")
     then
        return
    end
    ...
    if PriceSource == "1" then
        if
            Source1.close[p1] > Indicators[1]:getStream(0)[p2] and
                Source1.close[p1 - 1] <= Indicators[1]:getStream(0)[p2 - 1]
         then
            ACTION(1, 1, "Over")
        end
        if
        ...
        if
            Source1.close[p1] > Indicators[1]:getStream(1)[p2] and
                Source1.close[p1 - 1] <= Indicators[1]:getStream(1)[p2 - 1]
         then
            ACTION(3, 2, "Over")
        end
        if
        ...
        if
            Source1.close[p1] > Indicators[1]:getStream(2)[p2] and
                Source1.close[p1 - 1] <= Indicators[1]:getStream(2)[p2 - 1]
         then
            ACTION(5, 3, "Over")
        end
        if
        ...
        if
            Source1.close[p1] > Indicators[1]:getStream(3)[p2] and
                Source1.close[p1 - 1] <= Indicators[1]:getStream(3)[p2 - 1]
         then
            ACTION(7, 4, "Over")
        end
        if
        ...
        if
            Source1.close[p1] > Indicators[1]:getStream(4)[p2] and
                Source1.close[p1 - 1] <= Indicators[1]:getStream(4)[p2 - 1]
         then
            ACTION(9, 5, "Over")
        end
        if
        ...
        if
            Source1.close[p1] > Indicators[1]:getStream(5)[p2] and
                Source1.close[p1 - 1] <= Indicators[1]:getStream(5)[p2 - 1]
         then
            ACTION(11, 6, "Over")
        end
        if
        ...
        if
            Source1.close[p1] > Indicators[1]:getStream(6)[p2] and
                Source1.close[p1 - 1] <= Indicators[1]:getStream(6)[p2 - 1]
         then
            ACTION(13, 7, "Over")
        end
        if
        ...
        if
            Source2.close[p1] > Indicators[1]:getStream(0)[p2] and
                Source2.close[p1 - 1] <= Indicators[1]:getStream(0)[p2 - 1]
         then
            ACTION(1, 1, "Over")
        end
        if
        ...
        if
            Source2.close[p1] > Indicators[1]:getStream(1)[p2] and
                Source2.close[p1 - 1] <= Indicators[1]:getStream(1)[p2 - 1]
         then
            ACTION(3, 2, "Over")
        end
        if
        ...
        if
            Source2.close[p1] > Indicators[1]:getStream(2)[p2] and
                Source2.close[p1 - 1] <= Indicators[1]:getStream(2)[p2 - 1]
         then
            ACTION(5, 3, "Over")
        end
        if
        ...
        if
            Source2.close[p1] > Indicators[1]:getStream(3)[p2] and
                Source2.close[p1 - 1] <= Indicators[1]:getStream(3)[p2 - 1]
         then
            ACTION(7, 4, "Over")
        end
        if
        ...
        if
            Source2.close[p1] > Indicators[1]:getStream(4)[p2] and
                Source2.close[p1 - 1] <= Indicators[1]:getStream(4)[p2 - 1]
         then
            ACTION(9, 5, "Over")
        end
        if
        ...
        if
            Source2.close[p1] > Indicators[1]:getStream(5)[p2] and
                Source2.close[p1 - 1] <= Indicators[1]:getStream(5)[p2 - 1]
         then
            ACTION(11, 6, "Over")
        end
        if
        ...
        if
            Source2.close[p1] > Indicators[1]:getStream(6)[p2] and
                Source2.close[p1 - 1] <= Indicators[1]:getStream(6)[p2 - 1]
         then
            ACTION(13, 7, "Over")
        end
        if
