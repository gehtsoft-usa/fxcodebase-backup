...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "QDCS");
...
function EntryFunction( now,period)
	...
	then	
		...
		Return=true;
    elseif Source.close[period] >  DNC.DM[period]
	and Quantum.Signal[period]==1			
		then
            if Direction then
                SELL();
