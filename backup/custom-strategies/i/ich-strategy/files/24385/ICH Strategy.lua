...
function Prepare(nameOnly)
    ...
    Indicator[1] = core.indicators:create("ICH", Source, instance.parameters.TenkanSenPeriod,instance.parameters.KijunSenPeriod,instance.parameters.SenkouSpanPeriod  );
...
function ExtUpdate(id, source, period)  -- The method called every time when a new bid or ask price appears.
   ...
   -- get only time
    ...
    if period < first +1  then
		...
		and Short["A"][period]  > Short["B"][period]
		then
