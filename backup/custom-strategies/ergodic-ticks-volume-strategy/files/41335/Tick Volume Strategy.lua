...
function Init() --The strategy profile initialization
    strategy:name("Tick Volume Strategy")
    ...
    strategy.parameters:addInteger("u", "Ergodic Signal Period", "", 5)
...
function Prepare(nameOnly)
    ...
    name = name .. ", " .. tostring(r) .. ", " .. tostring(s) .. ", " .. tostring(u)
    ...
    Indicator[1] = core.indicators:create("TVI", Source, r, s, u)
