...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=7766
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if
        Open[1][Open[1]:size() - 2] < Close[1][Open[1]:size() - 2] and
            Open[2][Open[2]:size() - 2] < Close[2][Open[2]:size() - 2] and
            Open[3][Open[3]:size() - 2] < Close[3][Open[3]:size() - 2] and
            Open[4][Open[4]:size() - 2] < Close[4][Open[4]:size() - 2] and
            Open[5][Open[5]:size() - 2] < Close[5][Open[5]:size() - 2]
     then
        if Direction then
            BUY()
        else
