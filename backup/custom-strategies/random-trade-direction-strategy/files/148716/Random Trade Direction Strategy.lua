...
-- https://fxcodebase.com/code/viewtopic.php?f=31&t=73057
...
function Init() --The strategy profile initialization
    strategy:name("Random Trade Direction Strategy");
    ...
    strategy.parameters:addInteger("Percentage", "Percentage of accepted results", "", 10, 1, 50);  
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "RTDS");
...
local LastEntry, LastExit, LastSignal;
local ToTime;
...
function EntryFunction( id, now,period)
	...
	--/////////////////////////////////////////////////////////////////    
	 ...
	 or LastSignal  == Source:serial(period)   
	 then
	 return;
	 end	
	 --/////////////////////////////////////////////////////////////////  
    ...
    local TradeDirection;


    if  rand() > 1 - Percentage  then
	TradeDirection=1;
	...
	LastSignal= Source:serial(period);
