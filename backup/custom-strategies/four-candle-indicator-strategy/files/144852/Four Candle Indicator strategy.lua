...
-- https://fxcodebase.com/code/viewtopic.php?f=31&t=71821
...
function Init() --The strategy profile initialization
    strategy:name("Four Candle Indicator strategy");
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "FCIS");
...
function Prepare( nameOnly)
	...
	assert(core.indicators:findIndicator("FOUR CANDLE INDICATOR") ~= nil, "Please, download and install FOUR CANDLE INDICATOR.LUA indicator");          
    ...
    Indicator = core.indicators:create("FOUR CANDLE INDICATOR", Source, true  );
