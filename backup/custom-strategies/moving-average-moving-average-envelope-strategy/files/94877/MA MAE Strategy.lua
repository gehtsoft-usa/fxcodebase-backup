...
function Init() --The strategy profile initialization
    strategy:name("Moving Average, Moving Average Envelope Strategy")
    ...
    strategy.parameters:addString("Method1", "Method", "", "Wilder")
    ...
    strategy.parameters:addGroup("MAE Calculation")
    ...
    strategy.parameters:addString("Method2", "Method", "", "SineWMA")
    ...
    strategy.parameters:addDouble("B", "Band Width", "", 25)
...
local first
local MA1, Method1, Period1, Price1
local BWU, B, MA2, Method2, Period2, Price2
local CustomID
local Direction
...
function Prepare(nameOnly)
    ...
    MA1 = core.indicators:create("AVERAGES", Source[Price1], Method1, Period1, false)
    MA2 = core.indicators:create("AVERAGES", Source[Price2], Method2, Period2, false)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    local d1 = MA2.DATA[period]
    local d2 = MA2.DATA[period - 1]
    local s1, s2
    ...
    if MA1.DATA[period] > Top1 and MA1.DATA[period - 1] <= Top2 then
        if Direction then
            BUY()
        else
            SELL()
    ...
    elseif MA1.DATA[period] < Bottom1 and MA1.DATA[period - 1] <= Bottom2 then
        if Direction then
            SELL()
        else
            BUY()
