...
{ 
    {
        ...
        UpCondition = function (period)
            return ((MS and Indicator.MACD[period]>Indicator.SIGNAL[period] and Indicator.MACD[period-1]<=Indicator.SIGNAL[period-1])
...
function Init()
	...
	indicator.parameters:addInteger("P3", "Signal Perios", "", 9);
	
	indicator.parameters:addBoolean("MS", "MACD/Signal Cross Signal", "", true);   
    indicator.parameters:addBoolean("MZ", "MACD/Zero Cross Signal ", "", true); 
	
    indicator.parameters:addBoolean("MSC", "MACD/Signal Confirmation", "", true);   
    indicator.parameters:addBoolean("MZC", "MACD/Zero Confirmation ", "", true); 
