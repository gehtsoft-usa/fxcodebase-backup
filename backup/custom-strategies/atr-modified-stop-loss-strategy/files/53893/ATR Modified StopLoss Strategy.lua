...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=31596
...
function Init() --The strategy profile initialization
    strategy:name("ATR Modified Stop/Loss Strategy")
    ...
    strategy.parameters:addInteger("N", "Number of periods to smooth ATR", "No description", 5)
    strategy.parameters:addDouble("Factor", "The factor to calculate stop/loss", "No description", 3.5)
...
function Prepare(nameOnly)
    ...
    assert(core.indicators:findIndicator("ATRMSL") ~= nil, "Please, download and install ATRMSL.LUA indicator")
    ...
    Indicator[1] = core.indicators:create("ATRMSL", Source, N, Factor)
