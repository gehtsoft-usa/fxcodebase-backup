...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addInteger("PERIOD", "Periods", "", 0, 0, 1000)
...
function Prepare(nameOnly)
    ...
    local name
    name = profile:id() .. "(" .. instance.bid:name() .. "." .. instance.parameters.TF .. ", " .. PERIOD .. "," .. ")"
    instance:name(name)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    min, max = mathex.minmax(Source["Bar"], period - 1 - PERIOD + 1 - 1, period - 1)
