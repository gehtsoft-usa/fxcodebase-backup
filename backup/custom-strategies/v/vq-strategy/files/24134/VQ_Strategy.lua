...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=12173
...
function Init() --The strategy profile initialization
    strategy:name("VQ strategy")
    strategy:description("VQ strategy")
    strategy:setTag("Version", "1.1")
    strategy:setTag("NonOptimizableParameters", "Email,SendEmail,SoundFile,RecurrentSound,PlaySound, ShowAlert")

    strategy.parameters:addGroup("Parameters")
    strategy.parameters:addInteger("Length", "Length", "", 5)
    ...
    strategy.parameters:addString("MainPrice", "Main price", "", "close")
    strategy.parameters:addStringAlternative("MainPrice", "close", "", "close")
    strategy.parameters:addStringAlternative("MainPrice", "median", "", "median")
...
function Prepare(nameOnly)
    ...
    assert(core.indicators:findIndicator("VQ_TRIGGER") ~= nil, "Please, download and install VQ_TRIGGER.lua indicator")
    ...
    VQ =
        ...
        "VQ_TRIGGER",
        Source,
        instance.parameters.Length,
        instance.parameters.Method,
        instance.parameters.Smoothing,
        instance.parameters.Filter,
        instance.parameters.MainPrice
    )
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    VQ:update(core.UpdateLast)

    -- Check that we have enough data
    if (VQ.DATA:first() > (period - 3)) then
        return
    end
