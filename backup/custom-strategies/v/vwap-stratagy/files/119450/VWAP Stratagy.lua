...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "VWAPS");
...
function EntryFunction( now,period)
	...
	and Source.close[period-1] <= Indicator.DATA[period-1]
	then	
          if Direction then
                BUY(period);
            else
