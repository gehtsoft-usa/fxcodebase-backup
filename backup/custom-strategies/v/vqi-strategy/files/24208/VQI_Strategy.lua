...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=12221
...
function Init() --The strategy profile initialization
    strategy:name("VQI strategy")
    strategy:description("VQI strategy")
    strategy:setTag("Version", "1.1")
    strategy:setTag("NonOptimizableParameters", "Email,SendEmail,SoundFile,RecurrentSound,PlaySound, ShowAlert")

    strategy.parameters:addGroup("Parameters")
    strategy.parameters:addInteger("P1", "Short Smoothing Period", "", 9)
    strategy.parameters:addInteger("P2", "Long Smoothing Period", "", 200)
    strategy.parameters:addString("Type", "Algorithm Selection", "", "One")
    strategy.parameters:addStringAlternative("Type", "One", "", "One")
    strategy.parameters:addStringAlternative("Type", "Two", "", "Two")
...
function Prepare(nameOnly)
    ...
    VQI =
        core.indicators:create("VQI", Source, instance.parameters.P1, instance.parameters.P2, instance.parameters.Type)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if (VQI.DATA:first() > (period - 1)) then
        return
    end
    ...
    if VQI.S2[period - 1] < VQI.S3[period - 1] and VQI.S2[period] > VQI.S3[period] then
