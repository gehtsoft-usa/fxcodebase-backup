-- Available @ https://fxcodebase.com/code/viewtopic.php?f=31&t=73322
...
function Init() --The strategy profile initialization
    strategy:name("Vulkan Profit Strategy");
    ...
    strategy.parameters:addGroup("Tunnel Caclculation");
    strategy.parameters:addInteger("Period1", "1. Period", "", 18);  
    strategy.parameters:addInteger("Period2", "2. Period", "", 28);
    ...
    strategy.parameters:addGroup("Signal Caclculation");
    strategy.parameters:addInteger("Period3", "1. Period", "", 5);  
    strategy.parameters:addInteger("Period4", "2. Period", "", 8);
	
    strategy.parameters:addString("PriceSignal", "Price Source", "", "close");
    strategy.parameters:addStringAlternative("PriceSignal", "OPEN", "", "open");
    strategy.parameters:addStringAlternative("PriceSignal", "HIGH", "", "high");
    strategy.parameters:addStringAlternative("PriceSignal", "LOW", "", "low");
    strategy.parameters:addStringAlternative("PriceSignal","CLOSE", "", "close");
    strategy.parameters:addStringAlternative("PriceSignal", "MEDIAN", "", "median");
    strategy.parameters:addStringAlternative("PriceSignal", "TYPICAL", "", "typical");
    strategy.parameters:addStringAlternative("PriceSignal", "WEIGHTED", "", "weighted");	

	strategy.parameters:addString("MethodSignal", "MA Method", "Method" , "WMA");
    strategy.parameters:addStringAlternative("MethodSignal", "MVA", "MVA" , "MVA");
    strategy.parameters:addStringAlternative("MethodSignal", "EMA", "EMA" , "EMA");
    strategy.parameters:addStringAlternative("MethodSignal", "LWMA", "LWMA" , "LWMA");
    strategy.parameters:addStringAlternative("MethodSignal", "TMA", "TMA" , "TMA");
    strategy.parameters:addStringAlternative("MethodSignal", "SMMA", "SMMA" , "SMMA");
    strategy.parameters:addStringAlternative("MethodSignal", "KAMA", "KAMA" , "KAMA");
    strategy.parameters:addStringAlternative("MethodSignal", "VIDYA", "VIDYA" , "VIDYA");
    strategy.parameters:addStringAlternative("MethodSignal", "WMA", "WMA" , "WMA");	 	
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "VPS");
