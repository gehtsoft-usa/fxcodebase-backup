...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=65666
...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addInteger("Period", "Number of periods", "", 14, 1, 1000);
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "VTDMIS");
...
function Prepare( nameOnly)
    ...
    Indicator = core.indicators:create("VTDMI", Source, Period  );
