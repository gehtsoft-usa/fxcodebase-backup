...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=61854&p
...
function Init() --The strategy profile initialization
    strategy:name("Volume Moving Average Strategy")
    ...
    strategy.parameters:addGroup("1. VOLMA Calculation")
    strategy.parameters:addInteger("RSIVolumePeriod1", "Volume RSI Period", "", 100)
    ...
    strategy.parameters:addGroup("2. VOLMA Calculation")
    strategy.parameters:addInteger("RSIVolumePeriod2", "Volume RSI Period", "", 200)
...
local Direction
local CustomID
local RSIVolumePeriod1, RSIVolumePeriod2, Price2, Price1, Period2, Period1
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if core.crossesOver(MA1.DATA, MA2.DATA, period) then
        if Direction then
            BUY()
        else
            SELL()
    ...
    elseif core.crossesUnder(MA1.DATA, MA2.DATA, period) then
        if Direction then
            SELL()
        else
            BUY()
