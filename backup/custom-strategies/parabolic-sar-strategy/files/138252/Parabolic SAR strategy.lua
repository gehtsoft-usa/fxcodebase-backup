...
local STRATEGY_NAME = "Parabolic SAR strategy";
...
function CreateEntryIndicators(source)
    ...
    ma_source = ExtSubscribe(4, nil, instance.parameters.ma_tf, instance.parameters.type, "bar");
