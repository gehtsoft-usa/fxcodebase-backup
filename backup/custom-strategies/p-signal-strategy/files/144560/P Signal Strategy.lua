...
-- https://fxcodebase.com/code/viewtopic.php?f=31&t=71743
...
function Init() --The strategy profile initialization
    strategy:name("P Signal Strategy");
...
function Prepare( nameOnly)
	...
	assert(core.indicators:findIndicator("P SIGNAL") ~= nil, "Please, download and install P SIGNAL.LUA indicator");          
    ...
    Indicator = core.indicators:create("P SIGNAL", Source, Period  );
...
--	period3= core.findDate (Source3, TickSource:date(period), false);
	...
	--/////////////////////////////////////////////////////////////////////
					...
					and (Indicator.DATA[period]-Indicator.DATA[period-1]) <0 	
					then
