...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=64808
...
function Init() --The strategy profile initialization
    strategy:name("QQE oscillator Strategy")
    ...
    strategy.parameters:addInteger("SF", "SF", "", 5)
    strategy.parameters:addDouble("DarFactor", "DarFactor", "", 4.236)
...
local RSI_Period, SF, DarFactor, Method, Indicator
