...
-- https://fxcodebase.com/code/viewtopic.php?f=31&t=71650
...
function Init() --The strategy profile initialization
    strategy:name("QQE Super Trend Strategy");
	...
	strategy.parameters:addInteger("Period", "MA Period", "Period" , 100);	
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "QSTS");
...
function Prepare( nameOnly)
    ...
    QQE = core.indicators:create("QQE", Source.close, instance.parameters.RF , instance.parameters.RSP );	 
    SUPERTREND = core.indicators:create("SUPERTREND", Source , instance.parameters.N , instance.parameters.M );	 	
	
	
	first=math.max(MA.DATA:first(),QQE.DATA:first(),SUPERTREND.DATA:first()); 
...
--	period3= core.findDate (Source3, TickSource:date(period), false);
	...
	--/////////////////////////////////////////////////////////////////////
		            ...
		            if  Source.close[period]< SUPERTREND.DATA[period]	
					then
...
function EntryFunction( id, now,period)
	...
	and QQE.DATA[period]>50
	and Source.close[period]> SUPERTREND.DATA[period]	
	then	
          if Direction then
                BUY();
            else
