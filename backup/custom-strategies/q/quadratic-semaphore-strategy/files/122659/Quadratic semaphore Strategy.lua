...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=67128
...
function Init() --The strategy profile initialization
    strategy:name("Quadratic semaphore Strategy");
    ...
    strategy.parameters:addInteger("length", "length", "", 30, 1, 2000);
    strategy.parameters:addInteger("p", "p", "", 6, 1, 2000);
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "QSS");
...
function Prepare( nameOnly)
	...
	assert(core.indicators:findIndicator("QUADRATIC SEMAPHORE") ~= nil, "Please, download and install QUADRATIC SEMAPHORE.LUA indicator");
    ...
    Indicator = core.indicators:create("QUADRATIC SEMAPHORE", Source, length, p, true,   core.rgb(0, 255, 0),  core.rgb(255, 0, 0) , core.rgb(128, 128, 128));	 
