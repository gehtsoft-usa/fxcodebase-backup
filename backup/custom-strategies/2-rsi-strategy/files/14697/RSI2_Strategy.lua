...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=6401
...
function Init() --The strategy profile initialization
    strategy:name("RSI2 strategy")
    strategy:description("RSI2 strategy")
    strategy:setTag("NonOptimizableParameters", "Email,SendEmail,SoundFile,RecurrentSound,PlaySound, ShowAlert")
    strategy:setTag("Version", "1.1")

    strategy.parameters:addGroup("Parameters")
    strategy.parameters:addInteger("RSI1_Period", "RSI1_Period", "", 10)
    strategy.parameters:addInteger("RSI2_Period", "RSI2_Period", "", 20)
    ...
    strategy.parameters:addDouble("Level1_B", "Level1 BUY", "Level1 BUY", 20)
    strategy.parameters:addDouble("Level1_S", "Level1 SELL", "Level1 SELL", 20)
    strategy.parameters:addDouble("Level2_B", "Level2 BUY", "Level2 BUY", 80)
    strategy.parameters:addDouble("Level2_S", "Level2 SELL", "Level2 SELL", 20)
...
function Prepare(nameOnly)
            ...
            instance.bid:name() ..
                "." ..
                    instance.parameters.TF ..
                        "," ..
                            "RSI1(" ..
                                instance.parameters.RSI1_Period .. "), RSI2(" .. instance.parameters.RSI2_Period .. "))"
    instance:name(name)
    if nameOnly then
        return;
    end
    ...
    RSI1 = core.indicators:create("RSI", Source, instance.parameters.RSI1_Period)
    RSI2 = core.indicators:create("RSI", Source, instance.parameters.RSI2_Period)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if (RSI1.DATA:first() > (period - 1)) then
        return
    end
    if (RSI2.DATA:first() > (period - 1)) then
        return
    end
    ...
    if RSI1.DATA[period] > instance.parameters.Level1_B and RSI2.DATA[period] > instance.parameters.Level2_B then
    ...
    if RSI1.DATA[period] < instance.parameters.Level1_S and RSI2.DATA[period] < instance.parameters.Level2_S then
        if instance.parameters.TypeSignal == "direct" then
            MustS = true
        else
            MustB = true
