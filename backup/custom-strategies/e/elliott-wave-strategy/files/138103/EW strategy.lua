...
--http://fxcodebase.com/code/viewtopic.php?f=31&t=3326
...
local STRATEGY_NAME = "Elliot Wave Strategy";
...
function CreateEntryIndicators(source)
    EW = core.indicators:create("EW", source, instance.parameters.Trigger, 
        instance.parameters.NPeriod, instance.parameters.FastN, instance.parameters.SlowN);
end
...
function IsEntryLong(source, period)
    return EW.DATA[period] == -1 and EW.DATA[period - 1] ~= -1;
end
