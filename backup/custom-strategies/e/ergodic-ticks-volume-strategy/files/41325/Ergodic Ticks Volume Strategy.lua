...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=24026
...
function Init() --The strategy profile initialization
    strategy:name("Ergodic Ticks Volume Strategy")
    ...
    strategy.parameters:addInteger("r", "TVI First Smoothing Period", "", 12)
    strategy.parameters:addInteger("s", "TVI Second Smoothing Period", "", 12)

    strategy.parameters:addInteger("er", "Ergodic TVI First Smoothing", "", 5)
    strategy.parameters:addInteger("es", "Ergodic TVI Second Smoothing", "", 5)
    strategy.parameters:addInteger("eu", "Ergodic Signal Period", "", 5)
...
function Prepare(nameOnly)
    ...
    name =
        name ..
        ", " ..
            tostring(r) .. ", " .. tostring(s) .. ", " .. tostring(er) .. ", " .. tostring(es) .. ", " .. tostring(eu)

    assert(core.indicators:findIndicator("TVI") ~= nil, "Please, download and install TVI.LUA indicator")
    assert(
        core.indicators:findIndicator("ERGODIC TVI") ~= nil,
        "Please, download and install ERGODIC TVI.LUA indicator"
    )
    ...
    Indicator[1] = core.indicators:create("ERGODIC TVI", Source, r, s, er, es, eu)
