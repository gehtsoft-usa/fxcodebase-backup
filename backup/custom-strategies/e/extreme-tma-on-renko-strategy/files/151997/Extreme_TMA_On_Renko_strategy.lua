...
function CreateParameters() 
    ...
    strategy.parameters:addInteger("ATR_period", "ATR period", "", 24);
    strategy.parameters:addString("atr_frame", "ATR period", "", "H1");
	
	strategy.parameters:addString("atr_Method", "ATR MA Method", "Method" , "MVA");
    strategy.parameters:addStringAlternative("atr_Method", "MVA", "MVA" , "MVA");
    strategy.parameters:addStringAlternative("atr_Method", "EMA", "EMA" , "EMA");
    strategy.parameters:addStringAlternative("atr_Method", "LWMA", "LWMA" , "LWMA");
    strategy.parameters:addStringAlternative("atr_Method", "TMA", "TMA" , "TMA");
    strategy.parameters:addStringAlternative("atr_Method", "SMMA", "SMMA" , "SMMA");
    strategy.parameters:addStringAlternative("atr_Method", "KAMA", "KAMA" , "KAMA");
    strategy.parameters:addStringAlternative("atr_Method", "VIDYA", "VIDYA" , "VIDYA");
    strategy.parameters:addStringAlternative("atr_Method", "WMA", "WMA" , "WMA");
	
    strategy.parameters:addBoolean("smooth_ATR", "Use smoothing for ATR", "", false);
    strategy.parameters:addString("smooth_method", "Method to smooth", "", "HMA");
    ...
    strategy.parameters:addInteger("smooth_period", "Smoothing period", "", 120);

    strategy.parameters:addInteger("TMA_Period", "TMA period", "", 56);
    strategy.parameters:addDouble("ATR_Mult", "ATR multiplier", "", 2);
    strategy.parameters:addDouble("TrendThreshold", "TrendThreshold", "", 0.5);
end

local renko, tma, ATR;
function CreateEntryIndicators(source)
    --create your indicators here
    assert(core.indicators:findIndicator("RENKO_CANDLES_TICK_ATR") ~= nil, "Please, download and install RENKO_CANDLES_TICK_ATR.LUA indicator");
    renko = core.indicators:create("RENKO_CANDLES_TICK_ATR", source, source:instrument(),
        instance.parameters.timeframe,
        instance.parameters.type,
        instance.parameters.ATR_period,
        instance.parameters.atr_frame,
        instance.parameters.atr_Method,
        instance.parameters.smooth_ATR,
        instance.parameters.smooth_method,
        instance.parameters.smooth_period
    );
    assert(core.indicators:findIndicator("TICK_EXTREME_TMA_LINE") ~= nil, "Please, download and install TICK_EXTREME_TMA_LINE.LUA indicator");
    tma = core.indicators:create("TICK_EXTREME_TMA_LINE", renko:getCandleOutput(0), instance.parameters.TMA_Period,
        instance.parameters.ATR_period,
    ...
    ATR = core.indicators:create("TATR", renko:getCandleOutput(0), instance.parameters.ATR_Period);
end

function UpdateIndicators()
    --update your indicators here
    renko:update(core.UpdateLast);
    tma:update(core.UpdateLast);
...
function GetSlope(shift)
    return (tma.DATA[NOW - shift] - tma.DATA[NOW - 1 - shift]) / (0.1 * ATR.DATA[NOW - shift]);
end

function IsEntryLong(source, period)
    return GetSlope(0) > instance.parameters.TrendThreshold and GetSlope(1) <= instance.parameters.TrendThreshold;
end
