...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=66246
...
function Init() --The strategy profile initialization
    strategy:name("Equilibrium price Strategy");
	...
	strategy.parameters:addString("Price1", "MA Price", "", "close");
...
local Period1, Method1, Price1,Indicator;
...
function Prepare( nameOnly)
	...
	assert(core.indicators:findIndicator("EQUILIBRIUM PRICE") ~= nil, "Please, download and install EQUILIBRIUM PRICE.LUA indicator");          
    ...
    Indicator = core.indicators:create("EQUILIBRIUM PRICE", Source,  Period1, Price1, Method1  );
