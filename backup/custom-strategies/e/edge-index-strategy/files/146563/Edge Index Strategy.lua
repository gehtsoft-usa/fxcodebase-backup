...
-- https://fxcodebase.com/code/viewtopic.php?f=31&t=72447
...
function Init() --The strategy profile initialization
    strategy:name("Edge Index Strategy");
    ...
    strategy.parameters:addInteger("P1", "1. Signal Period", "", 10, 1, 2000); 	
    strategy.parameters:addInteger("P2", "2. Signal Period", "", 14, 1, 2000); 
 	strategy.parameters:addGroup("Stochastic Calculation");	
    strategy.parameters:addInteger("P3", "Fast Period", "", 5, 1, 2000);
    strategy.parameters:addInteger("P4", "Mid Period", "", 21, 1, 2000);
    strategy.parameters:addInteger("P5", "Slow Period", "", 50, 1, 2000);	
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "EIS");
...
function Prepare( nameOnly)
	...
	assert(core.indicators:findIndicator("EDGE INDEX") ~= nil, "Please, download and install EDGE INDEX.LUA indicator");          
    ...
    Indicator = core.indicators:create("EDGE INDEX", Source, instance.parameters.P1, instance.parameters.P2, instance.parameters.P3, instance.parameters.P4, instance.parameters.P5  );
    MA = core.indicators:create("MVA", Source.close,  instance.parameters.P5  );    
	first=math.max(Indicator.SIGNAL2:first(),MA.DATA:first()); 
...
function EntryFunction( id, now,period)
    ...
    if   Indicator.SIGNAL1[period]>  Indicator.SIGNAL2[period]
	and  Indicator.SIGNAL1[period-1]<=  Indicator.SIGNAL2[period-1]
	...
	then	
		...
		Return=true;
    elseif Indicator.SIGNAL1[period]<  Indicator.SIGNAL2[period]
	and  Indicator.SIGNAL1[period-1]>=  Indicator.SIGNAL2[period-1]
	and  Source.close[period] <MA.DATA[period]  
		then
            if Direction then
