...
function Init() --The strategy profile initialization
	...
	strategy.parameters:addDouble("RBL", "RSI Buy Level", "", 50);
	strategy.parameters:addDouble("RSL", "RSI Sell Level", "", 50);
	
	strategy.parameters:addGroup("CCI Calculation");
	 strategy.parameters:addInteger("CP", "CCI Period", "", 14);	 
	 strategy.parameters:addDouble("CBL", "RSI Buy Level", "", -100);
	 strategy.parameters:addDouble("CSL", "RSI Sell Level", "", 100);
