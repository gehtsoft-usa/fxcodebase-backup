-- Available @ https://fxcodebase.com/code/viewtopic.php?f=31&t=75474
...
function Init() --The strategy profile initialization
	...
	strategy.parameters:addGroup("3 Down Calculation");
	strategy.parameters:addInteger("parameters1", "Down Days", "Required number of down days to trigger signal", 3, 1, 10);
	strategy.parameters:addBoolean("parameters2", "Use Trend Filter", "Trade if upwards filter slope", false);
	strategy.parameters:addInteger("parameters3", "Trend Filter Length", "", 200, 2, 300);
	strategy.parameters:addInteger("parameters4", "Exit Filter Length", "Trade to close at or above exit filter", 4, 2, 20);
	strategy.parameters:addInteger("parameters5", "Wick Percentage", "Low wick as a percentage of High-Low", 10, 1, 200);
	strategy.parameters:addInteger("parameters6", "Body Percentage", "Body as a percentage of High-Low", 20, 1, 200);
...
function Prepare( nameOnly)
	...
	parameters4 = instance.parameters.parameters4;
	parameters5 = instance.parameters.parameters5;
	parameters6 = instance.parameters.parameters6;
	...
	assert(core.indicators:findIndicator("3DOWN") ~= nil, "Please, download and install 3DOWN.LUA indicator");          
    ...
    Indicator = core.indicators:create("3DOWN", Source, parameters1,parameter2, parameters3, parameters4, parameters5, parameters6  );  
...
function ExitFunction( now,period)
	 ...
	 return;
		            ...
		            if     Indicator.DATA[period]== -1 then
