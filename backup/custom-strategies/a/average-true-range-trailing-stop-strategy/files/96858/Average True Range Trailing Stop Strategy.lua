...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=61404
...
function Init() --The strategy profile initialization
    strategy:name("Average True Range Trailing Stop Strategy")
    ...
    strategy.parameters:addInteger("P1", "Period", "", 5)
    strategy.parameters:addDouble("P2", "Coeff", "", 3.5)
...
function Prepare(nameOnly)
    ...
    assert(
        core.indicators:findIndicator("WILDERS_TRAILING_STOP") ~= nil,
        "Please, download and install WILDERS_TRAILING_STOP.LUA indicator"
    )
    ...
    Indicator[1] =
        core.indicators:create("WILDERS_TRAILING_STOP", Source, P1, P2, core.rgb(0, 255, 0), core.rgb(255, 0, 0))
