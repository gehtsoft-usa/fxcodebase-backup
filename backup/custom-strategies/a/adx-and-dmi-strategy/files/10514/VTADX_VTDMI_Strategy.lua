...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=4107
--+------------------------------------------------------------------+
...
function Init() --The strategy profile initialization
    strategy:name("VTADX and VTDMI strategy")
    strategy:description("VTADX and VTDMI strategy")
    strategy:setTag("NonOptimizableParameters", "Email,SendEmail,SoundFile,RecurrentSound,PlaySound, ShowAlert")

    strategy.parameters:addGroup("VTADX indicator parameters")
    strategy.parameters:addInteger("VTADX_SM1", "Smoothing periods 1", "", 14, 1, 100)
    strategy.parameters:addInteger("VTADX_SM2", "Smoothing periods 2", "", 14, 1, 100)
    strategy.parameters:addInteger("VTADX_Level", "Level", "Level", 20, 1, 100)

    strategy.parameters:addGroup("VTDMI indicator parameters")
    strategy.parameters:addInteger("VTDMI_N", "Period of VTDMI", "Period of VTDMI", 14, 1, 1000)
    ...
    strategy.parameters:addDouble("DMI_M_Level_BUY", "DMI_M_Level_BUY", "DMI_M_Level_BUY", 20)
    strategy.parameters:addDouble("DMI_P_Level_SELL", "DMI_P_Level_SELL", "DMI_P_Level_SELL", 20)
...
function Prepare()
            ...
            instance.bid:name() ..
                "." ..
                    instance.parameters.TF ..
                        "," ..
                            "VTADX(" ..
                                instance.parameters.VTADX_SM1 ..
                                    ", " ..
                                        instance.parameters.VTADX_SM2 ..
                                            ", " ..
                                                instance.parameters.VTADX_Level ..
                                                    ")" .. "VTDMI(" .. instance.parameters.VTDMI_N .. "))"
    instance:name(name)
    ...
    DMI = core.indicators:create("VTDMI", Source, instance.parameters.VTDMI_N)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if
        (ADX.DATA[period] >= instance.parameters.ADX_Level and DMI.DIP[period] >= instance.parameters.DMI_P_Level_BUY and
            DMI.DIM[period] < instance.parameters.DMI_M_Level_BUY)
     then
    ...
    if
        (ADX.DATA[period] >= instance.parameters.ADX_Level and DMI.DIP[period] < instance.parameters.DMI_P_Level_SELL and
