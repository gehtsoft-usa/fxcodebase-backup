...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=14955
...
function Init() --The strategy profile initialization
    ...
    strategy:description("Aroon strategy")
...
function Prepare(nameOnly)
    ...
    Aroon = core.indicators:create("AROON", Source, instance.parameters.Period)
...
function ExtUpdate(id, source, period) -- The method called every time when a new bid or ask price appears.
    ...
    if (Aroon.DATA:first() > (period - 1)) then
        return
    end
    ...
    if Aroon.UP[period - 1] < Aroon.DOWN[period - 1] and Aroon.UP[period] > Aroon.DOWN[period] then
