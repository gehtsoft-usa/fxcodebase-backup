...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=66618
...
function Init() --The strategy profile initialization
    strategy:name("AltrTrend Overlay Strategy");
    ...
    strategy.parameters:addInteger("K", "K", "", 30);
    strategy.parameters:addDouble("KStop", "KStop", "", 0.5);
    strategy.parameters:addInteger("Kperiod", "Kperiod", "", 150);
    strategy.parameters:addInteger("PerADX", "PerADX", "", 14);
...
function CreateTradingParameters()
   ...
   -- strategy.parameters:addStringAlternative("ExitExecutionType", "End of Turn", "", "EndOfTurn");
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "ATS");
...
function Prepare( nameOnly)
	...
	assert(core.indicators:findIndicator("ALTRTREND OVERLAY") ~= nil, "Please, download and install ALTRTREND OVERLAY.LUA indicator");          
   ...
   Indicator = core.indicators:create("ALTRTREND OVERLAY", Source, K,KStop,Kperiod,PerADX, core.rgb(0, 255, 0),  core.rgb(255, 0, 0),  core.rgb(0, 0, 255)  );
