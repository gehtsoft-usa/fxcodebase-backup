...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=10457
...
function Init() --The strategy profile initialization
    strategy:name("Arm's Ease of Movement Value Strategy")
...
function Prepare(nameOnly)
    ...
    assert(core.indicators:findIndicator("EMV") ~= nil, "EMV indicator must be installed");
    Indicator[1] = core.indicators:create("EMV", Source, Period, Method)
