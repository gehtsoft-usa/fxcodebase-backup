...
-- http://fxcodebase.com/code/viewtopic.php?f=31&t=2893
...
function CreateTradingParameters()
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "DCBS");
   ...
   -- get only time
	...
	if  ExecutionType ==  "Live"  then
		...
		if CROSS then
		    ...
		    if core.crossesOver( Source.close, mid , period) and
			(not Filter  
			or (Source.close[period]> MA1.DATA[period] and FilterType =="Price/MA1") 
			or ( MA1.DATA[period]> MA2.DATA[period] and FilterType =="MA1/MA2") 
			or ( MA1.DATA[period]> MA1.DATA[period-1] and FilterType =="Slope") 			
			) then 
		   ...
		   elseif core.crossesUnder( Source.close, mid , period) and
		   	(not Filter  
			or (Source.close[period]< MA1.DATA[period] and FilterType =="Price/MA1") 
			or ( MA1.DATA[period]< MA2.DATA[period] and FilterType =="MA1/MA2") 
			or ( MA1.DATA[period]< MA1.DATA[period-1] and FilterType =="Slope") 			
		...
		if BREAK then
			...
			if core.crossesOver( Source.close, max , period) and
			(not Filter  
			or (Source.close[period]> MA1.DATA[period] and FilterType =="Price/MA1") 
			or ( MA1.DATA[period]> MA2.DATA[period] and FilterType =="MA1/MA2") 
			or ( MA1.DATA[period]> MA1.DATA[period-1] and FilterType =="Slope") 			
           ...
           ONE= Source:serial(period);
		   elseif core.crossesUnder( Source.close, min , period)  and 
		   	(not Filter  
			or (Source.close[period]< MA1.DATA[period] and FilterType =="Price/MA1") 
			or ( MA1.DATA[period]< MA2.DATA[period] and FilterType =="MA1/MA2") 
			or ( MA1.DATA[period]< MA1.DATA[period-1] and FilterType =="Slope") 			
