...
string file_custom_indicator = "TradeZones.ex5";
...
class BUYcondition1 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    buyZone.highPrice = ObjectGetDouble(0, "BuyZone", OBJPROP_PRICE, 1);
    buyZone.lowPrice  = ObjectGetDouble(0, "BuyZone", OBJPROP_PRICE, 0);
...
class SELLcondition1 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    sellZone.highPrice = ObjectGetDouble(0, "SellZone", OBJPROP_PRICE, 1);
    sellZone.lowPrice  = ObjectGetDouble(0, "SellZone", OBJPROP_PRICE, 0);
