...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=65431
// Id: 19893

//+------------------------------------------------------------------+
//|                               EMA_Cross_Dashboard_With_Alert.mq4 |
...
enum MA_Method_Type_1{ SMA1=MODE_SMA,  EMA1=MODE_EMA,  SMMA1=MODE_SMMA,  LWMA1=MODE_LWMA }; 
extern  MA_Method_Type_1  MA_Method_1        =  EMA1;


enum MA_Method_Type_2{ SMA2=MODE_SMA,  EMA2=MODE_EMA,  SMMA2=MODE_SMMA,  LWMA2=MODE_LWMA }; 
extern  MA_Method_Type_2  MA_Method_2        =  EMA2;
...
private:
    ...
    int GetDirection()
    {
        double ema_1_current = iMA(_symbol, _timeframe, MA1_period, 0, MA_Method_1, PRICE_CLOSE, 0);
        double ema_1_previous = iMA(_symbol, _timeframe, MA1_period, 0, MA_Method_1, PRICE_CLOSE, 1);
        double ema_2_current = iMA(_symbol, _timeframe, MA2_period, 0, MA_Method_2, PRICE_CLOSE, 0);
        double ema_2_previous = iMA(_symbol, _timeframe, MA2_period, 0, MA_Method_2, PRICE_CLOSE, 1);
        if (ema_1_current > ema_2_current && ema_1_previous <= ema_2_previous)
        {
            return 1;
        }
        if (ema_1_current < ema_2_current && ema_1_previous >= ema_2_previous)
