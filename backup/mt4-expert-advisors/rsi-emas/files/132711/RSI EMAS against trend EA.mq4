...
input int ob_level = 70; // RSI overbought level
input int os_level = 30; // RSI oversold level
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double maValue = iMA(_symbol, _timeframe, ma200_period, 0, MODE_EMA, PRICE_CLOSE, period);
