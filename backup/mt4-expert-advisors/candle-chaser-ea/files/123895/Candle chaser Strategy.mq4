...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=67350
...
extern bool Change = false; // Only on Sequence Change
...
public:
   ...
   {
      return iClose(_instrument.GetSymbol(), _timeframe, period) > iOpen(_instrument.GetSymbol(), _timeframe, period)
         && ((iClose(_instrument.GetSymbol(), _timeframe, period + 1) < iOpen(_instrument.GetSymbol(), _timeframe, period + 1) && Change) || !Change);
   }
};
