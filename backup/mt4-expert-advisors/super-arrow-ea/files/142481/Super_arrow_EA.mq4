...
//https://fxcodebase.com/code/viewtopic.php?f=38&t=71267
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double value = iCustom(_symbol, _timeframe, "Super_arrow", FasterMovingAverage, SlowerMovingAverage, RSIPeriod, 
         MagicFilterPeriod, BollingerbandsPeriod, BollingerbandsShift, BollingerbandsDeviation, BullsPowerPeriod, BearsPowerPeriod, false, Utstup, 0, period);
...
public:
   ...
   {
      double value = iCustom(_symbol, _timeframe, "Super_arrow", FasterMovingAverage, SlowerMovingAverage, RSIPeriod, 
         MagicFilterPeriod, BollingerbandsPeriod, BollingerbandsShift, BollingerbandsDeviation, BullsPowerPeriod, BearsPowerPeriod, false, Utstup, 1, period);
      return value != 0 && value != EMPTY_VALUE;
   }
};
...
int OnInit()
{
   double temp = iCustom(NULL, 0, "Super_arrow", 0, 0);
   if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
   {
      Alert("Please, install the 'Super_arrow' indicator");
      return INIT_FAILED;
   }
