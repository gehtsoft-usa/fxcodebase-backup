...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=73496
...
class Grid
{
 ...
 public:
  Grid(string Symbol, string Side, double LastPrice, double Gap, double Multiplier, int MaxQnt, double MaxLot, double InitialLot, int magic, bool simbolFilterOn = true, bool magicFilterOn = true, double tp=0, double sl=0)
  {
    _symbol     = Symbol;
    _side       = Side;
...
class BUYcondition2 : public iConditions
{
 ...
 public:
  bool evaluate()
  {
	...
	int count()
	{		
		if(_count < candlesTest) { _count++; } else { _count = 0; }
