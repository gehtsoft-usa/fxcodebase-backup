...
class AimeUpCondition : public ACondition
{
public:
   AimeUpCondition(const string symbol, ENUM_TIMEFRAMES timeframe)
      :ACondition(symbol, timeframe)
   {
   }
   ...
   virtual bool IsPass(const int period, const datetime date)
   {
      double value = iCustom(_symbol, _timeframe, "aime-5820-crossover-alert", false, false, 0, period + 1);
      return value != EMPTY_VALUE && value != 0;
   }
};

class AimeDownCondition : public ACondition
{
public:
   AimeDownCondition(const string symbol, ENUM_TIMEFRAMES timeframe)
      :ACondition(symbol, timeframe)
   {
   }
   ...
   virtual bool IsPass(const int period, const datetime date)
   {
      double value = iCustom(_symbol, _timeframe, "aime-5820-crossover-alert", false, false, 1, period + 1);
      return value != EMPTY_VALUE && value != 0;
   }
};
...
public:
   ...
   virtual bool IsPass(const int period, const datetime date)
   {
      double value = iCustom(_symbol, _timeframe, "5-stochasti", _timeframe, StochKPeriod, StochDPeriod, StochSlowing, StochMAMethod, StochPriceField, true, 2, period);
      return value != EMPTY_VALUE && value != 0;
   }
};
...
public:
   ...
   virtual bool IsPass(const int period, const datetime date)
   {
      double value = iCustom(_symbol, _timeframe, "5-stochasti", _timeframe, StochKPeriod, StochDPeriod, StochSlowing, StochMAMethod, StochPriceField, true, 3, period);
      return value != EMPTY_VALUE && value != 0;
   }
};
...
ICondition* CreateUpCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   {
      return new AimeUpCondition(_Symbol, timeframe);
   }
...
ICondition* CreateDownCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   {
      return new AimeDownCondition(_Symbol, timeframe);
   }
...
int init()
{
   ...
   temp = iCustom(NULL, 0, "aime-5820-crossover-alert", 0, 0);
   if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
   {
      Alert("Please, install the aime-5820-crossover-alert indicator");
      return INIT_FAILED;
   }
   ...
   temp = iCustom(NULL, 0, "5-stochasti", 0, 5, 3, 3, 0, 0, true, 0, 0);
   if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
   {
      Alert("Please, install the '5-stochasti' indicator");
      return INIT_FAILED;
   }
