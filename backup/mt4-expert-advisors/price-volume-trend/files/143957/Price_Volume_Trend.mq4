...
//https://fxcodebase.com/code/viewtopic.php?f=38&t=71575
...
input string signalType = "SMA"; // Signal Smoothing Type
input int signalLength = 21; // Signal Smoothing Length
input int mult_factor = 10; // Multiplicative Facor
...
// Price-volume trend stream v2.0
...
int init()
{
   IndicatorObjPrefix = GenerateIndicatorPrefix("PVT");
   ...
   pvt5 = new PriceVolumeTrendStream(_Symbol, (ENUM_TIMEFRAMES)_Period);
   ema2 = new EMAOnStream(pvt5, signalLength);
   sma4 = new SmaOnStream(pvt5, signalLength);
                ...
                const int &spread[])
{
   ...
   {
      double pvt5Value;
      if (!pvt5.GetValue(pos, pvt5Value))
      {
         continue;
      }
      double ema2Value;
      ...
      double signal = ((signalType == "EMA") ? ema2Value : sma4Value);
      double hist = mult_factor * (pvt5Value - signal);
      plot1[pos] = pvt5Value;
      plot2[pos] = (showSignal ? signal : EMPTY_VALUE);
      plot3[pos] = hist;
   }
