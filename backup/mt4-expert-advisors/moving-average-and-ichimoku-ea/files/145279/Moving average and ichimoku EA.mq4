...
//https://fxcodebase.com/code/viewtopic.php?f=38&t=71949
...
// ------------------------------------------------------------------
class Ichimoku : public iIndicators
{
...
class BUYcondition2 : public iConditions
{
  public:
   bool evaluate()
   {
      // TODO: condition Buy 2 -Ichimoku cross
...
class SELLcondition2 : public iConditions
{
  public:
   bool evaluate()
   {
      // TODO: condition sell 2-Ichimoku cross dn
      if (ichimoku.Tenkansen(1) < ichimoku.Kijunsen(1) && ichimoku.Tenkansen(2) > ichimoku.Kijunsen(2))
      {
         return true;
      }
...
class ConditionToCloseBuy : public iConditions
{
  public:
   bool evaluate()
   {
      ...
      // if(close <= emaHigh.index(1) || close <= emaLow.index(1) || close <= emaClose.index(1))
