...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=73248
...
string file_custom_indicator = "SF_TL-Indicator.ex4";
 ...
 public:
  bool evaluate()
  {
    // TODO: condition Buy 1
		if(iOpen(NULL,0,0)>indi_BuyPrice() && Bid < indi_BuyPrice())
		return true;
 ...
 public:
  bool evaluate()
  {
    // TODO: condition sell 1		
		if(iOpen(NULL,0,0)<indi_SellPrice() && Bid > indi_SellPrice())
		return true;
  ...
  if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
  {
	...
	// clang-format off
     switch(Period())
     {
         ...
         case(10080): TFS="WK1"; break;
         case(43200): TFS="MN1"; break;
         default: TFS="UNKNOWN_TIMEFRAME"; break;
      }
      TL1="TL1_" + TFS;
      TL2="TL2_" + TFS;
      MIDL="MIDL_" + TFS;	
...
void OnTick()
{
  ...
  if (newsOn)
  {
	...
	iCustom(NULL, 0, file_custom_indicator, 0, 0);
...
double indi_BuyPrice()
{
  // double prevTL1 = ObjectGetValueByTime(0, TL1, iTime(NULL, 0, 5));
  double currTL1 = ObjectGetValueByTime(0, TL1, iTime(NULL, 0, 0));
  double currTL2 = ObjectGetValueByTime(0, TL2, iTime(NULL, 0, 0));
  double currMID = ObjectGetValueByTime(0, MIDL, iTime(NULL, 0, 0));

  if (currTL1 < currMID) return currTL1;
  if (currTL2 < currMID) return currTL2;

  return 0;
}

double indi_SellPrice()
{
  // double prevTL1 = ObjectGetValueByTime(0, TL1, iTime(NULL, 0, 5));
  double currTL1 = ObjectGetValueByTime(0, TL1, iTime(NULL, 0, 0));
  double currTL2 = ObjectGetValueByTime(0, TL2, iTime(NULL, 0, 0));
