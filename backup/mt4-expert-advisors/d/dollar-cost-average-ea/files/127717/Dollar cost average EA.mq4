...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=68741
...
input int ma_period_1 = 10; // MA Period #1
input ENUM_MA_METHOD ma_method_1 = MODE_SMA; // Smoothing method #1
input int ma_period_2 = 15; // MA Period #2
...
public:
   ...
   {
      double ma1_0 = iMA(_symbol, _timeframe, ma_period_1, 0, ma_method_1, PRICE_CLOSE, period);
      double ma1_1 = iMA(_symbol, _timeframe, ma_period_1, 0, ma_method_1, PRICE_CLOSE, period + 1);
      double ma2_0 = iMA(_symbol, _timeframe, ma_period_2, 0, ma_method_2, PRICE_CLOSE, period);
      double ma2_1 = iMA(_symbol, _timeframe, ma_period_2, 0, ma_method_2, PRICE_CLOSE, period + 1);
      return ma1_0 < ma1_1 && ma2_0 >= ma2_1;
   }
};
