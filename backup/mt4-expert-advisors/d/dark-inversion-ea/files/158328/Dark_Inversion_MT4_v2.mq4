...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=75475
...
input enum_opposite_types opposite_type        = dark_inversion; // Opposite Type:
...
{
    if(opposite_type == dark_inversion) {
