...
int init()
{
   ...
   IndicatorBuffers(2);
   IndicatorObjPrefix = GenerateIndicatorPrefix("drs");
   IndicatorShortName("SynResSup");

   SetIndexStyle(0, DRAW_ARROW, 0, 2);
   SetIndexBuffer(0, ExtResistanceBuffer);
   SetIndexArrow(0, 158);
   SetIndexStyle(1, DRAW_ARROW, 0, 2);
   SetIndexBuffer(1, ExtSupportBuffer);
   SetIndexArrow(1, 158);
                ...
                const int &spread[])
{
   ...
   {
      ArrayInitialize(ExtResistanceBuffer, EMPTY_VALUE);
      ArrayInitialize(ExtSupportBuffer, EMPTY_VALUE);
