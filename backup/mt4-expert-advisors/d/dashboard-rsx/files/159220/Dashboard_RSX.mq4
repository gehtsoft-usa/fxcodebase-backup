...
string file_custom_indicator = "Rsx";
...
// ------------------------------------------------------------------
input string             Irsx            = "== RSX Setup ==";  // == Moving Average Setup ==
...
class FinderPattern
{
 ...
 public:
  ...
  bool havePatternUp(int i, ENUM_TIMEFRAMES tf)
  {
    ...
    double rsx = iCustom(_symbol, tf,file_custom_indicator, tf, Length, Price, 0, 0);
    return (rsx != 0 && rsx != EMPTY_VALUE);
  }

  bool havePatternDn(int i, ENUM_TIMEFRAMES tf)
  {
    // TODO: escribir el patrón bajista
    double rsx = iCustom(_symbol, tf,file_custom_indicator, tf, Length, Price, 1, 0);
    return (rsx != 0 && rsx != EMPTY_VALUE);
  }
