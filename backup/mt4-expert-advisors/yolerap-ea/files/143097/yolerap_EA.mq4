...
// http://fxcodebase.com/code/viewtopic.php?f=27&t=70712
//+------------------------------------------------------------------------------------------------+
...
input int ma1_period = 50; // MA 1 period
input ENUM_MA_METHOD ma1_method = MODE_SMA; // Smoothing method
input int ma2_period = 100; // MA 2 period
...
ICondition* CreateLongCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   condition.Add(new MAPriceCondition(symbol, timeframe, FirstBelowSecond, ma1_method, ma1_period, PRICE_CLOSE), false);
   condition.Add(new MAPriceCondition(symbol, timeframe, FirstBelowSecond, ma2_method, ma2_period, PRICE_CLOSE), false);
...
ICondition* CreateLongFilterCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(new MAMACondition(symbol, timeframe, FirstAboveSecond, ma1_method, ma1_period, PRICE_CLOSE, ma2_method, ma2_period, PRICE_CLOSE), false);
   return condition;
}
...
ICondition* CreateShortCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(new MAPriceCondition(symbol, timeframe, FirstAboveSecond, ma1_method, ma1_period, PRICE_CLOSE), false);
   condition.Add(new MAPriceCondition(symbol, timeframe, FirstAboveSecond, ma2_method, ma2_period, PRICE_CLOSE), false);
   #ifdef ACT_ON_SWITCH_CONDITION
      ActOnSwitchCondition* switchCondition = new ActOnSwitchCondition(symbol, timeframe, (ICondition*) condition);
      condition.Release();
      return switchCondition;
...
ICondition* CreateShortFilterCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(new MAMACondition(symbol, timeframe, FirstBelowSecond, ma1_method, ma1_period, PRICE_CLOSE, ma2_method, ma2_period, PRICE_CLOSE), false);
   return condition;
}
