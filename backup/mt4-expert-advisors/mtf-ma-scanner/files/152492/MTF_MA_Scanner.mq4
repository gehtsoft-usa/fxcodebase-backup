//Available @ https://fxcodebase.com/code/viewtopic.php?f=38&t=74141
...
input int period_1 = 7;
input AveragesMethod method_1 = SMA;
input int period_2 = 14;
input AveragesMethod method_2 = SMA;
...
public:
   ...
   {
      double avg1 = iCustom(_symbol, _timeframe, "averages", period_1, 0, method_1, 0, period);
      double avg2 = iCustom(_symbol, _timeframe, "averages", period_2, 0, method_2, 0, period);
      return avg1 > avg2;
   }
};
