...
)
{
   ...
   ObjectSetText(IndicatorObjPrefix + "!Upp",DoubleToString(ld_Dist_Pips,gi_PipsDecimal),8,"Arial",gc_Upper);
   ...
   ObjectSetText(IndicatorObjPrefix + "!Low",DoubleToString(ld_Dist_Pips,gi_PipsDecimal),8,"Arial",gc_Lower);
   
   // Display the total range of the bands
   ld_Dist_Pts = MathAbs(gadblUpper[rates_total - 1] - gadblLower[rates_total - 1]);
   ld_Dist_Pips = Convert_2_Pips(ld_Dist_Pts);
   Object_Create(IndicatorObjPrefix + "!Range",5,5,"TMA Range: "+DoubleToString(ld_Dist_Pips,gi_PipsDecimal),10,"Arial",gc_Lower);
