...
// https://fxcodebase.com/code/viewtopic.php?f=38&p=147870
...
// ------------------------------------------------------------------
input string       TIndi                   = "== Setup MH Arrows indicator ==";        // == Setup MH Arrows indicator ==
input int          uBars                   = 500; // Bars
...
class BUYcondition1 : public iConditions
{
  public:
   bool evaluate()
   {
      ...
      double buffer0 = iCustom(NULL, 0, "!--MH Arrow Signals.ex4", uBars, 0, 1);
      // double buffer01 = iCustom(NULL, 0, "!--MH Arrow Signals.ex4", uBars, 0, 2);
      return buffer0 > 0 && buffer0!= EMPTY_VALUE;
   }
};
  ...
  public:
   bool evaluate()
   {
      // TODO: condition sell 1
			double buffer1 = iCustom(NULL, 0, "!--MH Arrow Signals.ex4", uBars, 1, 1);
      return buffer1 > 0 && buffer1!= EMPTY_VALUE;
   }
};
