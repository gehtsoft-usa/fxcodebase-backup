...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=71255
...
input int bars_since_last_trade = 1; // Bars since last trade
input int rsi_period = 14; // RSI Period
input int Level1 = 70; // 1st Level
input CustomActionType Level1_action_over = No_Action; // Over level action
input CustomActionType Level1_action_under = No_Action; // Under level action
input int Level2 = 30; // 2nd Level
input CustomActionType Level2_action_over = No_Action; // Over level action
input CustomActionType Level2_action_under = No_Action; // Under level action
input int Level3 = 65; // 3rd Level
input CustomActionType Level3_action_over = No_Action; // Over level action
input CustomActionType Level3_action_under = No_Action; // Under level action
input int Level4 = 35; // 4th Level
input CustomActionType Level4_action_over = No_Action; // Over level action
input CustomActionType Level4_action_under = No_Action; // Under level action
input int Level5 = 55; // 5th Level
input CustomActionType Level5_action_over = No_Action; // Over level action
input CustomActionType Level5_action_under = No_Action; // Under level action
input int Level6 = 45; // 6th Level
input CustomActionType Level6_action_over = No_Action; // Over level action
input CustomActionType Level6_action_under = No_Action; // Under level action
input int Level7 = 50; // 7th Level
input CustomActionType Level7_action_over = No_Action; // Over level action
input CustomActionType Level7_action_under = No_Action; // Under level action
...
class OverCondition : public ACondition
{
   int _level;
public:
   OverCondition(const string symbol, ENUM_TIMEFRAMES timeframe, int level)
      :ACondition(symbol, timeframe)
   {
      _level = level;
   }
   ...
   bool IsPass(const int period, const datetime date)
   {
      double rsiValue = iRSI(_symbol, _timeframe, rsi_period, PRICE_CLOSE, period);
      return _level < rsiValue;
   }
};

class UnderCondition : public ACondition
{
   int _level;
public:
   UnderCondition(const string symbol, ENUM_TIMEFRAMES timeframe, int level)
      :ACondition(symbol, timeframe)
   {
      _level = level;
   }
   ...
   ICondition* mainCondition, ICondition* tradingTimeCondition)
{
   ...
   condition.Add(new MinDistanceSinceLastTradeCondition(symbol, timeframe, bars_since_last_trade, magic_number), false);
   if (cap_by_margin)
   {
   ...
   ICondition* tradingTimeCondition)
{
   ...
   mainCondition = new OverCondition(symbol, timeframe, Level1);
   CreateAction(Level1_action_over, mainCondition, symbol, timeframe, tradingCalculator, tradingTimeCondition);
   mainCondition.Release();
   mainCondition = new UnderCondition(symbol, timeframe, Level1);
   CreateAction(Level1_action_under, mainCondition, symbol, timeframe, tradingCalculator, tradingTimeCondition);
   mainCondition.Release();

   mainCondition = new OverCondition(symbol, timeframe, Level2);
   CreateAction(Level2_action_over, mainCondition, symbol, timeframe, tradingCalculator, tradingTimeCondition);
   mainCondition.Release();
   mainCondition = new UnderCondition(symbol, timeframe, Level2);
   CreateAction(Level2_action_under, mainCondition, symbol, timeframe, tradingCalculator, tradingTimeCondition);
   mainCondition.Release();

   mainCondition = new OverCondition(symbol, timeframe, Level3);
   CreateAction(Level3_action_over, mainCondition, symbol, timeframe, tradingCalculator, tradingTimeCondition);
   mainCondition.Release();
   mainCondition = new UnderCondition(symbol, timeframe, Level3);
   CreateAction(Level3_action_under, mainCondition, symbol, timeframe, tradingCalculator, tradingTimeCondition);
   mainCondition.Release();

   mainCondition = new OverCondition(symbol, timeframe, Level4);
   CreateAction(Level4_action_over, mainCondition, symbol, timeframe, tradingCalculator, tradingTimeCondition);
   mainCondition.Release();
   mainCondition = new UnderCondition(symbol, timeframe, Level4);
   CreateAction(Level4_action_under, mainCondition, symbol, timeframe, tradingCalculator, tradingTimeCondition);
   mainCondition.Release();

   mainCondition = new OverCondition(symbol, timeframe, Level5);
   CreateAction(Level5_action_over, mainCondition, symbol, timeframe, tradingCalculator, tradingTimeCondition);
   mainCondition.Release();
   mainCondition = new UnderCondition(symbol, timeframe, Level5);
   CreateAction(Level5_action_under, mainCondition, symbol, timeframe, tradingCalculator, tradingTimeCondition);
   mainCondition.Release();

   mainCondition = new OverCondition(symbol, timeframe, Level6);
   CreateAction(Level6_action_over, mainCondition, symbol, timeframe, tradingCalculator, tradingTimeCondition);
   mainCondition.Release();
   mainCondition = new UnderCondition(symbol, timeframe, Level6);
   CreateAction(Level6_action_under, mainCondition, symbol, timeframe, tradingCalculator, tradingTimeCondition);
   mainCondition.Release();

   mainCondition = new OverCondition(symbol, timeframe, Level7);
   CreateAction(Level7_action_over, mainCondition, symbol, timeframe, tradingCalculator, tradingTimeCondition);
   mainCondition.Release();
   mainCondition = new UnderCondition(symbol, timeframe, Level7);
   CreateAction(Level7_action_under, mainCondition, symbol, timeframe, tradingCalculator, tradingTimeCondition);
   mainCondition.Release();
}
