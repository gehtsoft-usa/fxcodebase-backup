...
//https://fxcodebase.com/code/viewtopic.php?f=38&t=72124
...
#property indicator_color1 0x0ebb23
#property indicator_style1 STYLE_SOLID
#property indicator_width1 1
#property indicator_level1 0
#property indicator_levelcolor 0x989898
...
int init()
{
   IndicatorObjPrefix = GenerateIndicatorPrefix("KRI");
   IndicatorShortName("Kairi Relative Index");
   IndicatorBuffers(1);
   int id = 0;
                ...
                const int &spread[])
{
   ...
   for (int pos = MathMin(bars_limit, rates_total - 1 - MathMax(prev_calculated - 1, toSkip)); pos >= 0 && !IsStopped(); --pos)
   {
      ...
      sma1Source.SetValue(pos, srcInputstreamValue);
      double sma1Value;
      ...
      double kri = 100 * (srcInputstreamValue - sma) / sma;
      color kriColor = ((kri >= 0) ? 0x0ebb23 : Red);
      plot1[pos] = kri;
   }
