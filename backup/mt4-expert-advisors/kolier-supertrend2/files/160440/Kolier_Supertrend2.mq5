//Available @  https://fxcodebase.com/code/viewtopic.php?f=38&p=160273#p160273
...
input double atr_multi  = 3;               // ATR multiplier
...
input color  ArrowUpClr            = Lime;               // Arrow Up Color:
...
void OnInit()
{
    ...
    string short_name = "Kolier Supertrend (" + IntegerToString(atr_period) + "," + DoubleToString(atr_multi, 1) + ")";
    ...
    PlotIndexSetInteger(1, PLOT_LINE_COLOR, LightSeaGreen);
