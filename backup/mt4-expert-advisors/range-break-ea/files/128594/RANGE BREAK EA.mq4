...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=68905
...
public:
   ...
   bool IsPass(const int period)
   {
      ...
      int iBarBegin = iBarShift(_symbol, _timeframe, dtTimeBegin);
      int iBarEnd = iBarShift(_symbol, _timeframe, dtTimeEnd);
      double dPriceHigh = iHigh(_symbol, _timeframe, iHighest(_symbol, _timeframe, MODE_HIGH, iBarBegin-iBarEnd, iBarEnd));
      return iClose(_symbol, _timeframe, period) > dPriceHigh;
   }
};
...
public:
   ...
   bool IsPass(const int period)
   {
      ...
      int iBarBegin = iBarShift(_symbol, _timeframe, dtTimeBegin);
      int iBarEnd = iBarShift(_symbol, _timeframe, dtTimeEnd);
      double dPriceLow = iLow(_symbol, _timeframe, iLowest(_symbol, _timeframe, MODE_LOW , iBarBegin-iBarEnd, iBarEnd));
      return iClose(_symbol, _timeframe, period) < dPriceLow;
   }
};
