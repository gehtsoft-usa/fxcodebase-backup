...
string file_custom_indicator = "winIndi.ex4";
int bufferToBuy = 4;
int bufferToSell = 5;
...
double lastCloseBuyPrice, lastCloseSellPrice;
 ...
 public:
  bool evaluate()
  {
    // TODO: condition Buy 1
      ...
      {
          double indi = Indi(bufferToBuy, i);
          if(indi != EMPTY_VALUE && indi != lastCloseBuyPrice)
          {
              lastCloseBuyPrice = indi;
              return true;
          }
      }
    return false;
 ...
 public:
  bool evaluate()
  {
    // TODO: condition sell 3
      ...
      {
        double indi = Indi(bufferToSell, i);        
          if(indi != EMPTY_VALUE && indi != lastCloseSellPrice)
          {
              lastCloseSellPrice = indi;
              return true;
          }
      }
 ...
 public:
  bool evaluate()
  {
    if (closeAllInOpositeSignal) 
			...
			if (sellCondition3.evaluate() && sellCondition2.evaluate()) return true;
 ...
 public:
  bool evaluate()
  {
    ...
    //   if(buyCondition3.evaluate())return true;
      if(buyCondition3.evaluate() && buyCondition2.evaluate())return true;
...
int OnInit()
{
  ...
  buyCondition3 = new BUYcondition3();
  ...
  sellCondition3 = new SELLcondition3();
