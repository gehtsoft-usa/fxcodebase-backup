...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70805
...
input int ema_period_1 = 8; // EMA period #1
input int ema_period_2 = 13; // EMA period #2
...
public:
   ...
   {
      int ema10 = iMA(_symbol, _timeframe, ema_period_1, 0, MODE_EMA, PRICE_CLOSE, period);
      int ema11 = iMA(_symbol, _timeframe, ema_period_1, 0, MODE_EMA, PRICE_CLOSE, period + 1);
      int ema20 = iMA(_symbol, _timeframe, ema_period_2, 0, MODE_EMA, PRICE_CLOSE, period);
      int ema21 = iMA(_symbol, _timeframe, ema_period_2, 0, MODE_EMA, PRICE_CLOSE, period + 1);

      return ema10 > ema20 && ema11 <= ema21 && iClose(_symbol, _timeframe, period) > iOpen(_symbol, _timeframe, period);
   }
};
...
string IndicatorName = "Dashboard";
int init()
{
