...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70817
...
input double entry_long_level = 57; // Entry long level
input double entry_short_level = 43; // Entry short level
input double exit_long_level = 66; // Exit long level
input double exit_short_level = 34; // Exit short level
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      ...
      return rsiValue > entry_long_level;
   }
};
...
public:
   ...
   {
      double rsiValue = iRSI(_symbol, _timeframe, rsi_period, PRICE_CLOSE, period);
      return rsiValue < entry_short_level;
   }
};
...
public:
   ...
   {
      double rsiValue = iRSI(_symbol, _timeframe, rsi_period, PRICE_CLOSE, period);
      return rsiValue > exit_long_level;
   }
};
...
public:
   ...
   {
      double rsiValue = iRSI(_symbol, _timeframe, rsi_period, PRICE_CLOSE, period);
      return rsiValue < exit_short_level;
   }
};
