                ...
                const long &tick_volume[], const long &volume[], const int &spread[])
{
    ...
    for (int i = start; i < rates_total && !IsStopped(); i++) {
        ...
        if (havePinbarUp(i)) {
            ...
            if (SignalUp[i - 2] == EMPTY_VALUE) PinbarUp[i - 2] = low[i - 2];
        }
        ...
        if (havePinbarDown(i)) {
            ...
            if (SignalDn[i - 2] == EMPTY_VALUE) PinbarDn[i - 2] = high[i - 2];
        }
    }
...
bool havePinbarUp(int i) { return pinbar.FindPattern(i) == "p"; }
bool havePinbarDown(int i) { return pinbar.FindPattern(i) == "q"; }
