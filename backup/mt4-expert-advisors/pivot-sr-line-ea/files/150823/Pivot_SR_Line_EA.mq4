...
// ------------------------------------------------------------------
string file_custom_indicator = "^Pivot_SR_Line.ex4";
...
input ENUM_TIMEFRAMES TF_Candle = PERIOD_CURRENT;// Time Frame Candle to Entry:
...
class BUYcondition1 : public iConditions
{
    ...
    bool evaluate()
    {
        ...
        if (iClose(NULL, TF_Candle, 1) > pivot0 && iOpen(NULL, TF_Candle, 1) < pivot0) { return true; }
