...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=74109
...
string file_custom_indicator = "X2_PRICE_ZONE_mod_mtf.ex4";
int bufferToBuy = 10;
int bufferToSell = 11;
...
extern double             Deviation = 0.382;
extern int                MA_period = 2;
extern ENUM_MA_METHOD     MA_method = MODE_SMMA;
extern ENUM_APPLIED_PRICE MA_price = PRICE_WEIGHTED;
extern bool               Draw_Mainline = True;            // Main line visible?
extern bool               Draw_Bands = True;            // Bands  visible?
extern bool               Draw_Signsl = True;            // Signal line  visible?
extern bool               Draw_candles = True;            // Candles  visible?
...
extern color              Candle_UP = clrSpringGreen;      // Bullish  wick color
extern color              Candle_DOWN = clrCrimson;      // Bearish  wick color
extern bool               ShowArrows = true;            // Arrows visible?
...
input int                 UpArrowCode = 236;              // Up Arrow code
input int                 DnArrowCode = 238;              // Down arrow code
...
extern string             LabelConfig = "--Label Position Settings -- ";
extern int                XPosition = 205;
extern int                YPosition = 100;
extern int                btn_Subwindow = 0;
extern ENUM_BASE_CORNER   btn_corner = CORNER_RIGHT_LOWER;
extern bool               Interpolate = true;// Interpolate in multi time frame mode?
extern string             LabelID = "X2PZ_";
...
double Indi(int buffer, int candle)
{
    ...
    return iCustom(NULL, 0, file_custom_indicator,TimeFrame, Periods, Deviation, MA_period, MA_method, MA_price, Draw_Mainline, Draw_Bands, Draw_Signsl, Draw_candles, WickWidth, BodyWidth, UseAutoWidth, Candle_UP, Candle_DOWN, ShowArrows, ArrowOnFirst, UpArrowSize, DnArrowSize, UpArrowCode, DnArrowCode, UpArrowGap, DnArrowGap, UpArrowColor, DnArrowColor, alertsOn, alertsOnCurrent, alertsOnHighLow, alertsMessage, alertsSound, alertsNotify, alertsEmail, LabelConfig, XPosition, YPosition, btn_Subwindow, btn_corner, Interpolate, LabelID,
        buffer, candle);
}
