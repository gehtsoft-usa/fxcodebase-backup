...
Version:     
Date:        
Repository:  Available @ https://fxcodebase.com/code/viewtopic.php?f=38&t=76391
License:     GNU
*/
...
int deinit()
{
   ...
   if (bu_ob_boxes != NULL) bu_ob_boxes.Release();
   if (be_ob_boxes != NULL) be_ob_boxes.Release();
   if (bu_bb_boxes != NULL) bu_bb_boxes.Release();
   if (be_bb_boxes != NULL) be_bb_boxes.Release();
   highest1.Release();
   lowest1.Release();
                ...
                const int &spread[])
{
   ...
   for (int pos = MathMin(bars_limit, rates_total - 1 - MathMax(prev_calculated - 1, toSkip)); pos >= 0 && !IsStopped(); --pos)
   {
      ...
      if (!f_get_high_11.GetValue(pos, f_get_high_11Value1, f_get_high_11Value2)) { f_get_high_11Value1 = EMPTY_VALUE; f_get_high_11Value2 = INT_MIN; }
      ...
      if (!f_get_high_12.GetValue(pos, f_get_high_12Value1, f_get_high_12Value2)) { f_get_high_12Value1 = EMPTY_VALUE; f_get_high_12Value2 = INT_MIN; }
      double h1 = f_get_high_12Value1;
      int h1i = f_get_high_12Value2;
      double f_get_low_13Value1;
      int f_get_low_13Value2;
      if (!f_get_low_13.GetValue(pos, f_get_low_13Value1, f_get_low_13Value2)) { f_get_low_13Value1 = EMPTY_VALUE; f_get_low_13Value2 = INT_MIN; }
      ...
      if (!f_get_low_14.GetValue(pos, f_get_low_14Value1, f_get_low_14Value2)) { f_get_low_14Value1 = EMPTY_VALUE; f_get_low_14Value2 = INT_MIN; }
      ...
      if (for1_from == INT_MIN || for1_to == INT_MIN) { continue; }
      ...
      if (for2_from == INT_MIN || for2_to == INT_MIN) { continue; }
      ...
      if (for3_from == INT_MIN || for3_to == INT_MIN) { continue; }
      ...
      if (for4_from == INT_MIN || for4_to == INT_MIN) { continue; }
      ...
      for (int foreach1_index = 0; foreach1_index < Array::Size<int, ICustomTypeArray<Box*>*>(foreach1_items, INT_MIN); ++foreach1_index)
      {
         ...
         else if ((Array::Size<int, ICustomTypeArray<Box*>*>(bu_ob_boxes, INT_MIN) == 5))
         {
      ...
      for (int foreach2_index = 0; foreach2_index < Array::Size<int, ICustomTypeArray<Box*>*>(foreach2_items, INT_MIN); ++foreach2_index)
      {
         ...
         else if ((Array::Size<int, ICustomTypeArray<Box*>*>(be_ob_boxes, INT_MIN) == 5))
         {
      ...
      for (int foreach3_index = 0; foreach3_index < Array::Size<int, ICustomTypeArray<Box*>*>(foreach3_items, INT_MIN); ++foreach3_index)
      {
         ...
         else if ((Array::Size<int, ICustomTypeArray<Box*>*>(be_bb_boxes, INT_MIN) == 5))
         {
      ...
      for (int foreach4_index = 0; foreach4_index < Array::Size<int, ICustomTypeArray<Box*>*>(foreach4_items, INT_MIN); ++foreach4_index)
      {
         ...
         else if ((Array::Size<int, ICustomTypeArray<Box*>*>(bu_bb_boxes, INT_MIN) == 5))
         {
