...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=74608
...
int trend = -1;
if(Indi(bufferToBuy, 1) != EMPTY_VALUE && Indi(bufferToBuy, 1) >0 )trend = 1;
else if(Indi(bufferToSell, 1) != EMPTY_VALUE && Indi(bufferToSell, 1) >0 )trend = 0;
if(trend ==1) { 
