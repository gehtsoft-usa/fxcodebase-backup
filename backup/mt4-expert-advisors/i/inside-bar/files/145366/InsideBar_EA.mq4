...
// https://fxcodebase.com/code/viewtopic.php?f=38&p=149170#p149170
...
string file_custom_indicator = "Inside_Bar_with_contour.ex4";
...
class BUYcondition1 : public iConditions
{
 ...
 public:
  bool evaluate()
  {
    ...
    indi        = iCustom(NULL, 0, file_custom_indicator, 1, 2);

    if (indi != EMPTY_VALUE && indi != _lastSignal)
    {
      _lastSignal = indi;
      if (iClose(NULL, 0, 1) > iClose(NULL, 0, 2)) return true;
    }
    return false;
  }
};
...
class BUYcondition2 : public iConditions
{
 ...
 public:
  bool evaluate()
  {
    // TODO: condition Buy 1
    double indi = EMPTY_VALUE;
    indi        = iCustom(NULL, 0, file_custom_indicator, 2, 2);
  ...
  double _lastSignal;
   ...
   public:
    bool evaluate()
    {
      // TODO: condition Buy 1
      double indi = EMPTY_VALUE;
      indi        = iCustom(NULL, 0, file_custom_indicator, 2, 1);
