...
string file_custom_indicator = "Indicador_TV_To_MT5";
int    handle                = 0;
...
double indicator(int buffer, int shift)
{
  double value[1];
...
class BUYcondition1 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    return indicator(0, 1) != 0 &&indicator(0, 1)!=EMPTY_VALUE;
...
class SELLcondition1 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    return indicator(1, 1) != 0 &&indicator(1, 1)!=EMPTY_VALUE;
    // return iOpen(NULL, 0, 1) > iClose(NULL, 0, 1);
    // return false;
  }
};
