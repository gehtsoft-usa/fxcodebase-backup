...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=69074
...
ICondition* CreateLongCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   condition.Add(
      new PriceAboveIchimokuStreamCondition(symbol, timeframe, 
         Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, MODE_SENKOUSPANB, -Kijun_Sen_Period), 
      false
   );
   condition.Add(
      new IchimokeStreamAboveIchimokuStreamCondition(symbol, timeframe, 
         Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, MODE_TENKANSEN, MODE_KIJUNSEN), 
      false
   );
   condition.Add(
      new IchimokeStreamAboveIchimokuStreamCondition(symbol, timeframe, 
         Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, MODE_CHIKOUSPAN, MODE_SENKOUSPANB, Kijun_Sen_Period, -Kijun_Sen_Period), 
      false
   );
...
ICondition* CreateShortCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(
      new PriceBelowIchimokuStreamCondition(symbol, timeframe, 
         Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, MODE_SENKOUSPANA, -Kijun_Sen_Period), 
      false
   );
   condition.Add(
      new IchimokeStreamBelowIchimokuStreamCondition(symbol, timeframe, 
         Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, MODE_TENKANSEN, MODE_KIJUNSEN), 
      false
   );
   condition.Add(
