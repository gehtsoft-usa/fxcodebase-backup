...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=69580
...
public:
   ...
   {
      _indi = iIchimoku(_symbol, _timeframe, tenkan_sen, kijun_sen, senkou_span_b);
   }
   ...
   {
      double tenkan[1];
      if (CopyBuffer(_indi, 0, period, 1, tenkan) != 1)
      {
         return false;
      }
      double kijun[1];
      if (CopyBuffer(_indi, 1, period, 1, kijun) != 1)
      {
         return false;
      }
      double a[1];
      if (CopyBuffer(_indi, 2, period, 1, a) != 1)
      {
         return false;
      }
      double b[1];
      if (CopyBuffer(_indi, 1, period, 1, b) != 1)
      {
         return false;
      }
      return MathAbs(tenkan[0] - kijun[0]) < MathAbs(a[0] - b[0]);
   }
};
