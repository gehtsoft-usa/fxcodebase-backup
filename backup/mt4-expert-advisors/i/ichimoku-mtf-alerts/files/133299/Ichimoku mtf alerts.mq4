...
int init()
{
   ...
   directionButton.Init("show_hide_dir", "ich6", "Direction", button_x, button_y + 70 * 5, direction_button_color);
   qualityButton.Init("show_hide_qual", "ich7", "Quality", button_x, button_y + 70 * 6, quality_button_color);
   IndicatorBuffers(22);
