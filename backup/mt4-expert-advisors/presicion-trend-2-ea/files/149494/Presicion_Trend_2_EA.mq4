...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=73335
...
string file_custom_indicator = "precision_trend_2.ex4";
 ...
 public:
  bool evaluate()
  {
    // TODO: condition Buy 1
		bool dn4 = iCustom(NULL, 0, file_custom_indicator, avgPeriod, sensitivity, 0, 4) < iCustom(NULL, 0, file_custom_indicator, avgPeriod, sensitivity, 1, 4);
    bool dn3 = iCustom(NULL, 0, file_custom_indicator, avgPeriod, sensitivity, 0, 3) < iCustom(NULL, 0, file_custom_indicator, avgPeriod, sensitivity, 1, 3);

    bool up2 = iCustom(NULL, 0, file_custom_indicator, avgPeriod, sensitivity, 0, 2) > iCustom(NULL, 0, file_custom_indicator, avgPeriod, sensitivity, 1, 2);
    bool up1 = iCustom(NULL, 0, file_custom_indicator, avgPeriod, sensitivity, 0, 1) > iCustom(NULL, 0, file_custom_indicator, avgPeriod, sensitivity, 1, 1);
		

		if(dn4==true && dn3==true && up2==true && up1==true)return true;
 ...
 public:
  bool evaluate()
  {
    // TODO: condition sell 1
		bool up4 = iCustom(NULL, 0, file_custom_indicator, avgPeriod, sensitivity, 0, 4) > iCustom(NULL, 0, file_custom_indicator, avgPeriod, sensitivity, 1, 4);
    bool up3 = iCustom(NULL, 0, file_custom_indicator, avgPeriod, sensitivity, 0, 3) > iCustom(NULL, 0, file_custom_indicator, avgPeriod, sensitivity, 1, 3);

		bool dn2 = iCustom(NULL, 0, file_custom_indicator, avgPeriod, sensitivity, 0, 2) < iCustom(NULL, 0, file_custom_indicator, avgPeriod, sensitivity, 1, 2);
    bool dn1 = iCustom(NULL, 0, file_custom_indicator, avgPeriod, sensitivity, 0, 1) < iCustom(NULL, 0, file_custom_indicator, avgPeriod, sensitivity, 1, 1);
		
		if(up4==true && up3==true && dn2==true && dn1==true) return true;
