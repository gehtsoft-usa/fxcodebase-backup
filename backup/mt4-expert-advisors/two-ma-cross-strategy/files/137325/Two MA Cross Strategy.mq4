...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70380
...
input int period_1 = 14; // Period 1
input ENUM_MA_METHOD method_1 = MODE_SMA; // Method 1
input int period_2 = 21; // Period 2
input ENUM_MA_METHOD method_2 = MODE_SMA; // Method 2
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double maValue = iMA(_symbol, _timeframe, period_1, 0, method_1, PRICE_CLOSE, period);
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double maValue = iMA(_symbol, _timeframe, period_2, 0, method_2, PRICE_CLOSE, period);
      return iClose(_symbol, _timeframe, period) < maValue;
   }
};
