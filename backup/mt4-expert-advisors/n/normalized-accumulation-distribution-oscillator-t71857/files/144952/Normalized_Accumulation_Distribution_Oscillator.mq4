...
//https://fxcodebase.com/code/viewtopic.php?f=38&t=71857
...
#property indicator_label1 "Normalized Accumulation/Distribution Oscillator"
#property indicator_type1 DRAW_LINE
#property indicator_color1 Blue
#property indicator_style1 STYLE_SOLID
#property indicator_width1 1

input int length = 10; // Normalization Period
...
IStream* sum1;
SimplePriceStream* sum2Source;
IStream* sum2;
int init()
{
   IndicatorObjPrefix = GenerateIndicatorPrefix("Norm Accum/Dist");
   IndicatorShortName("Normalized Accumulation/Distribution Oscillator");
   IndicatorBuffers(1);
   int id = 0;
   SetIndexBuffer(id++, plot1);
   sum1Source = new CustomStream(_Symbol, (ENUM_TIMEFRAMES)_Period);
   sum1 = new SumOnStream(sum1Source, length);
   sum2Source = new SimplePriceStream(_Symbol, (ENUM_TIMEFRAMES)_Period, PriceVolume);
                ...
                const int &spread[])
{
   ...
   {
      int ad = ((high[pos] == low[pos]) ? 0 : (close[pos] - open[pos]) / (high[pos] - low[pos]) * tick_volume[pos]);
      sum1Source.SetValue(pos, ad);
      double sum1Value;
      ...
      double norm_ad = sum1Value / sum2Value;
      plot1[pos] = norm_ad;
   }
