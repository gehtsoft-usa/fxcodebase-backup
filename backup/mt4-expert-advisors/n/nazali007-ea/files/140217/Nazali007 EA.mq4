...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70825
...
input ENUM_MA_METHOD ma1_method = MODE_SMA; // MA 1 type
input int ma1_period = 100; // MA 1 period
input ENUM_MA_METHOD ma2_method = MODE_SMA; // MA 2 type
input int ma2_period = 200; // MA 2 period
...
input TradingMode entry_logic = TradingModeLive; // Entry logic
   ...
   TradingMode exit_logic = TradingModeOnBarClose; // Exit logic
#endif
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      ...
      return iClose(_symbol, _timeframe, period) > ma1 && iClose(_symbol, _timeframe, period) > ma2;
   }
};
