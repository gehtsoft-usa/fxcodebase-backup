...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=74392
...
string file_custom_indicator = "Nadaraya_Watson.ex5";
int handle = 0;
...
void setHandle()
{
    handle = iCustom(Symbol(), NULL, file_custom_indicator, Length, Bandwidth, Multiplayer );
}
