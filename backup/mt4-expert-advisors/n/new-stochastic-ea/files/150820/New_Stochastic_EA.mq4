...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=73715
...
#define stoch_indicator
#ifdef stoch_indicator
...
input int highLevel = 80;// Over Bougth Level:
input int lowLevel  = 20;// Over Sold Level:
 ...
 public:
  bool evaluate()
  {
    ...
    //   return iClose(NULL, 0, 1) > ma.index(1);
      return stoch.isCrossUp(1) && stoch.signal(1) <= lowLevel;
    //   return false;
  }
};
 ...
 public:
  bool evaluate()
  {
    // TODO: condition sell 1
		// return iClose(NULL, 0, 1) < ma.index(1);
        // return false;
      return stoch.isCrossDn(1) && stoch.signal(1) >= highLevel;
  }
};
