...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=69267
...
public:
   ...
   {
      double jaw0 = iAlligator(_symbol, _timeframe, jaw_period, 0, teeth_period, 0, lips_period, 0, MODE_SMA, PRICE_CLOSE, MODE_GATORJAW, period);
      double jaw1 = iAlligator(_symbol, _timeframe, jaw_period, 0, teeth_period, 0, lips_period, 0, MODE_SMA, PRICE_CLOSE, MODE_GATORJAW, period + 1);
      double teeth0 = iAlligator(_symbol, _timeframe, jaw_period, 0, teeth_period, 0, lips_period, 0, MODE_SMA, PRICE_CLOSE, MODE_GATORTEETH, period);
      double teeth1 = iAlligator(_symbol, _timeframe, jaw_period, 0, teeth_period, 0, lips_period, 0, MODE_SMA, PRICE_CLOSE, MODE_GATORTEETH, period + 1);
      double lips0 = iAlligator(_symbol, _timeframe, jaw_period, 0, teeth_period, 0, lips_period, 0, MODE_SMA, PRICE_CLOSE, MODE_GATORLIPS, period);
      double lips1 = iAlligator(_symbol, _timeframe, jaw_period, 0, teeth_period, 0, lips_period, 0, MODE_SMA, PRICE_CLOSE, MODE_GATORLIPS, period + 1);
      return jaw0 > jaw1 && lips0 > lips1 && teeth0 > teeth1;
   }
};
...
int init()
{
   ...
   IndicatorName = GenerateIndicatorName("Alligator alert");
   ...
   ICondition* upCondition2 = new ActOnSwitchCondition(_Symbol, (ENUM_TIMEFRAMES)_Period, upCondition);
   upCondition.Release();
   ICondition* downCondition2 = new ActOnSwitchCondition(_Symbol, (ENUM_TIMEFRAMES)_Period, downCondition);
   downCondition.Release();
   id = CreateAlert(id, upCondition2, downCondition2);
