...
input string TF_Comment="TF: 0-current, 1-m1, 5-m5, 15-m15, 30-m30, 60-H1, 240-H4, 1440-D1, 10080-W1, 43200-MN";
input int First_TF=60;
input int Second_TF=30;
input double First_Step=0.02;
input double Second_Step=0.02;
input double First_Max=0.2;
input double Second_Max=0.2;
...
void OnTick()
{
 ...
 double SAR1_0, SAR1_1, SAR2;
 
 SAR1_0=iSAR(NULL, First_TF, First_Step, First_Max, 1);
 SAR1_1=iSAR(NULL, First_TF, First_Step, First_Max, 2);
 SAR2=iSAR(NULL, Second_TF, Second_Step, Second_Max, 1);
 ...
 if ((Signal_Type==0 && SAR1_0<Pr && SAR1_1>Pr1 && SAR2<Pr) || (Signal_Type==1 && SAR1_0>Pr && SAR1_1<Pr1 && SAR2>Pr))
 {
  _Alert("Buy");
  CO=CalculateOrders();
  if (CO<=0)
 ...
 if ((Signal_Type==1 && SAR1_0<Pr && SAR1_1>Pr1 && SAR2<Pr) || (Signal_Type==0 && SAR1_0>Pr && SAR1_1<Pr1 && SAR2>Pr))
 {
  _Alert("Sell");
  CO=CalculateOrders();
  if (CO>=0)
