...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70023
...
int OnInit()
{
   ...
   OrderByTicketId* order = new OrderByTicketId(ticket_id);
   ...
   TrailingPipsAction* action = new TrailingPipsAction(order, (OrderOpenPrice() - OrderStopLoss()), trailing_step);
   ProfitInRangeCondition* condition = new ProfitInRangeCondition(order, trailing_start, 100000);
