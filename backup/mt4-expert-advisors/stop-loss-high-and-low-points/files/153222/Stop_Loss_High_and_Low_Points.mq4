...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=74327
...
class MACD
{
 ...
 public:
  ...
  {
    if (macd_line(shift+1)>signal_line(shift+1) && macd_line(shift+2)<signal_line(shift+2))
    {
        return true;
    }
    return false;
