...
// int                bb2_period       = 20;                   // Band 2: averaging period
// double             bb2_deviation    = 2;                    // Band 2: standard deviations
// int                      bb2_bands_shift  = 0;                    // Band 2: bands shift
// ENUM_APPLIED_PRICE bb2_AppliedPrice = PRICE_TYPICAL;        // Band 2: Applied Price
...
input int           userSLpips     = 15;                  // Pips SL
...
class BUYcondition1 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    double bb1 = iBands(NULL, 0, bb1_period, bb1_deviation, bb1_bands_shift, bb1_AppliedPrice, 2, 0);
    return Bid < bb1;
...
class BUYcondition2 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    return iCustom(NULL, 0, file_custom_indicator, bolPrd, bolDev, keltPrd, keltFactor, momPrd, 2, 0) != EMPTY_VALUE;
