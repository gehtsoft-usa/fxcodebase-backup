...
void draw()
{
      ...
      {
         int hhb1 = Highest(NULL,0,MODE_HIGH,PeriodWeakChannel,i-shift1);
         int llb1 = Lowest(NULL,0,MODE_LOW,PeriodWeakChannel,i-shift1);
         int hhb2 = Highest(NULL,0,MODE_HIGH,PeriodMainChannel,i-shift2);
         int llb2 = Lowest(NULL,0,MODE_LOW,PeriodMainChannel,i-shift2);
