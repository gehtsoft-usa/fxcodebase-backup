...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=75299&p=157236#p157236
...
input string        tMartingale                 = "== Martingale Setup =="; // == Matingale Setup ==
input bool          MartingaleON                = true;                     // Use Martingale:
...
input const string indicator_file = "Reflex.ex5";                // Indicator File:
//---
int  bufferToBuy              = 1;
int  bufferToSell             = 1;
