...
public:
   ...
   {
      _lastSignal = 0;
      _indi = iCustom(symbol, timeframe, "Renko Extreme_Spike", mode, step, NoRepaint, MinorMinExtremeHeightATRs, MajorToMinorHeightRatio, MinorMinExtremeWidth, MajorMinExtremeWidth);
   }
