...
int OnInit()
{
     double temp = iCustom(NULL, 0, "RWI", 0, 0);
   if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
   {
       Alert("Please, install the 'RWI' indicator");
       return INIT_FAILED;
   }
   LastBar=0;
...
void OnTick()
{
 ...
 double RWIH0, RWIH1, RWIL0, RWIL1;

 RWIH0=iCustom(NULL, 0, "RWI", Length, 0, 1);
 RWIH1=iCustom(NULL, 0, "RWI", Length, 0, 2);
 RWIL0=iCustom(NULL, 0, "RWI", Length, 1, 1);
 RWIL1=iCustom(NULL, 0, "RWI", Length, 1, 2);
 ...
 if ((Signal_Type==0 && RWIH0>RWIL0 && RWIH1<=RWIL1) || (Signal_Type==1 && RWIH0<RWIL0 && RWIH1>=RWIL1))
 {
  _Alert("Buy");
  CO=CalculateOrders();
  if (CO<=0)
 ...
 if ((Signal_Type==1 && RWIH0>RWIL0 && RWIH1<=RWIL1) || (Signal_Type==0 && RWIH0<RWIL0 && RWIH1>=RWIL1))
 {
  _Alert("Sell");
  CO=CalculateOrders();
  if (CO>=0)
