...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=73987
...
input string             ImaFast = "== EMA Fast Setup ==";  // ————————————
input int                maFastPeriod       = 8;                            // Period
...
input string             ImaSlow = "== EMA Slow Setup ==";  // ————————————
input int                maSlowPeriod       = 21;                            // Period
...
class BUYcondition3 : public iConditions
{
 public:
  bool evaluate()
  {
      ...
      return adx.Main(1) > AdxLevelMain;
      // return false;
  }
};
