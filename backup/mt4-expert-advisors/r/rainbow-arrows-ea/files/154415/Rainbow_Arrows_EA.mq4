...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=74626
...
string file_custom_indicator = "RainbowArrows_V1";
int    bufferToBuy           = 0;
int    bufferToSell          = 1;
...
class BUYcondition1 : public iConditions
{
  public:
    bool evaluate()
    {
        ...
        return buySignal != EMPTY_VALUE && buySignal!=0;
    }
};
...
class SELLcondition1 : public iConditions
{
  public:
    bool evaluate()
    {
        ...
        return sellSignal != EMPTY_VALUE && sellSignal!=0;
    }
};
