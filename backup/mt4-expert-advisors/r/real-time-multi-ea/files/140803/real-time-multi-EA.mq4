...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70938
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      return iSAR(NULL, _timeframe, SAR_Step, SAR_Max, period) < iClose(NULL, _timeframe, period + 1);
   }
};
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      return iMACD(NULL, _timeframe, Fast_EMA, Slow_EMA, MACD_SMA, PRICE_MEDIAN, 0, period) > iMACD(NULL, _timeframe, Fast_EMA, Slow_EMA, MACD_SMA, PRICE_MEDIAN, 1, period);
   }
};
...
class CMALongCondition : public ACondition
{
public:
   CMALongCondition(const string symbol, ENUM_TIMEFRAMES timeframe)
      :ACondition(symbol, timeframe)
   {
   ...
   bool IsPass(const int period, const datetime date)
   {
      return iMA(NULL, _timeframe, Fast_MA, 0, MODE_SMA, PRICE_MEDIAN, period) > iMA(NULL, _timeframe, Slow_MA, 0, MODE_SMA, PRICE_MEDIAN, period);
   }
};

class CMAShortCondition : public ACondition
{
public:
   CMAShortCondition(const string symbol, ENUM_TIMEFRAMES timeframe)
      :ACondition(symbol, timeframe)
   {
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      return iADX(NULL, _timeframe, ADX_Period, PRICE_MEDIAN, 1, period) > iADX(NULL, _timeframe, ADX_Period, PRICE_MEDIAN, 2, period);
   }
};
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      return iCCI(NULL, _timeframe, Period_CCI, PRICE_MEDIAN, 0) > 0;
   }
};
...
ICondition* CreateLongCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   condition.Add(new CMALongCondition(symbol, timeframe), false);
...
ICondition* CreateShortCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   condition.Add(new CMAShortCondition(symbol, timeframe), false);
