...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=70132
...
public:
   ...
   {
      double value = iCustom(_symbol, _timeframe, "Relative Strength Normilized", comparativeSymbol, length, showMA, lengthMA, Period, 0, period);
      return value > 0;
   }
};
...
string IndicatorName = "RSND";
int init()
{
   double temp = iCustom(NULL, 0, "Relative Strength Normilized", 0, 0);
   if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
   {
      Alert("Please, install the 'Relative Strength Normilized' indicator");
      return INIT_FAILED;
   }
   ...
   IndicatorObjPrefix = GenerateIndicatorPrefix("RSND");
