...
//https://fxcodebase.com/code/viewtopic.php?f=38&t=73056
...
input string           Tstoch       = "== Stochastic Setup ==";  // ————————————
...
input int                rsiCandlesDivergence = 50;            // RSI Candles Divergences
 ...
 public:
  bool evaluate()
  {
    // TODO: condition Buy 1
		return iClose(NULL, 0, 0) > ma.index(1);
...
class BUYcondition3 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    return stoch.main(1) > stoch.signal(1) && stoch.main(2) <= stoch.signal(2);
    // return false;
  }
};
