...
input const string indicator_file = "RangeDetector";                          // Indicator File:
...
//---
double Indi(int buffer, int candle = 1) { return iCustom(NULL, 0, indicator_file, 
    RangeLength, ATR_Mult, ATR_Length,
    buffer, candle); }
