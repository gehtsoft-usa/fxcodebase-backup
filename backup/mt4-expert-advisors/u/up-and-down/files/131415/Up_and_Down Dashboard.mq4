...
public:
   ...
   {
      double value0 = iCustom(_symbol, _timeframe, "Up_and_Down", period, 100, 0, 0);
      double value1 = iCustom(_symbol, _timeframe, "Up_and_Down", period, 100, 0, 1);
      return value1 > 0.0 && value0 < 0.0;
   }
};
...
int init()
{
   ...
   IndicatorName = GenerateIndicatorName("Up and Down Dashboard");
