...
void Hedging()
{
    // sumar lots en buy y en sell
    // abrir un trade en contra de la dirección neta y por el lotaje neto
    // el objetivo es que quede bloqueado el resultado actual
