            ...
            if((LastSignal=="BUY") && ((i==0 && Bid>=LastTarget)||(i>0 && ((Close[i]>=LastTarget) || (LastTarget>=Low[i] && LastTarget<=High[i])))) &&(LastTarget>0))
              {
               ...
               if((LastSignal=="BUY") && ((i==0 && Bid<=LastStop)||(i>0 && ((Close[i]<=LastStop) || (LastStop>=Low[i] && LastStop<=High[i])))) &&(LastStop>0))
                 {
                  LastTradeOpen=false;
                  ...
                  if((LastSignal=="SELL") && ((i==0 && Bid<=LastTarget)||(i>0 && ((Close[i]<=LastTarget) || (LastTarget>=Low[i] && LastTarget<=High[i])))) &&(LastTarget>0))
                    {
                     LastTradeOpen=false;
                     ...
                     if((LastSignal=="SELL") && ((i==0 && Bid>=LastStop)||(i>0 && ((Close[i]>=LastStop) || (LastStop>=Low[i] && LastStop<=High[i])))) &&(LastStop>0))
                       {
                        LastTradeOpen=false;
               ...
               if(IsTarget)
                 {
                  if(TARGET_PRICE_MODE==TARGET_POINTS)
                     ...
                     if(TARGET_PRICE_MODE==TARGET_PERCENTAGE)
               ...
               if(IsStop)
                 {
                  if(STOP_PRICE_MODE==STOP_POINTS)
                     ...
                     if(STOP_PRICE_MODE==STOP_PERCENTAGE)
