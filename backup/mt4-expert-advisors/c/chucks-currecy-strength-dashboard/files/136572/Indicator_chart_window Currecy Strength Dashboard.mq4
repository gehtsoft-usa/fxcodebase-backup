...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=70248
//+------------------------------------------------------------------+
...
class UpCondition : public ACondition
{
   ...
   double _maxValue;
public:
   UpCondition(const string symbol, ENUM_TIMEFRAMES timeframe, double minValue, double maxValue)
   ...
   {
      double range = iHigh(_symbol, _timeframe, period) - iLow(_symbol, _timeframe, period);
      double ratio = range == 0 ? 0 : (iClose(_symbol, _timeframe, period) - iLow(_symbol, _timeframe, period)) / range;
      return ratio >= _minValue && ratio < _maxValue;
   }
};
...
public:
   ...
   virtual ICell* Create(const string id, const int x, const int y, ENUM_BASE_CORNER corner, const string symbol, const ENUM_TIMEFRAMES timeframe)
   {
      ...
      {
         ICondition* upCondition = new UpCondition(symbol, timeframe, 0.97, 1.01);
         IValueFormatter* upValue = new FixedTextFormatter("9", GetTextColor(Green), GetBackgroundColor(Green));
         cell.AddCondition(upCondition, upValue, NULL, upValue);
         upCondition.Release();
         upValue.Release();
      }
      {
         ICondition* upCondition = new UpCondition(symbol, timeframe, 0.9, 0.97);
         IValueFormatter* upValue = new FixedTextFormatter("8", GetTextColor(Green), GetBackgroundColor(Green));
         cell.AddCondition(upCondition, upValue, NULL, upValue);
         upCondition.Release();
         upValue.Release();
      }
      {
         ICondition* upCondition = new UpCondition(symbol, timeframe, 0.75, 0.9);
         IValueFormatter* upValue = new FixedTextFormatter("7", GetTextColor(Green), GetBackgroundColor(Green));
         cell.AddCondition(upCondition, upValue, NULL, upValue);
         upCondition.Release();
         upValue.Release();
      }
      {
         ICondition* upCondition = new UpCondition(symbol, timeframe, 0.6, 0.75);
         IValueFormatter* upValue = new FixedTextFormatter("6", GetTextColor(Gray), GetBackgroundColor(Gray));
         cell.AddCondition(upCondition, upValue, NULL, NULL);
         upCondition.Release();
         upValue.Release();
      }
      {
         ICondition* upCondition = new UpCondition(symbol, timeframe, 0.5, 0.6);
         IValueFormatter* upValue = new FixedTextFormatter("5", GetTextColor(Gray), GetBackgroundColor(Gray));
         cell.AddCondition(upCondition, upValue, NULL, NULL);
         upCondition.Release();
         upValue.Release();
      }
      {
         ICondition* upCondition = new UpCondition(symbol, timeframe, 0.4, 0.5);
         IValueFormatter* upValue = new FixedTextFormatter("4", GetTextColor(Gray), GetBackgroundColor(Gray));
         cell.AddCondition(upCondition, upValue, NULL, NULL);
         upCondition.Release();
         upValue.Release();
      }
      {
         ICondition* upCondition = new UpCondition(symbol, timeframe, 0.25, 0.4);
         IValueFormatter* upValue = new FixedTextFormatter("3", GetTextColor(Gray), GetBackgroundColor(Gray));
         cell.AddCondition(upCondition, upValue, NULL, NULL);
         upCondition.Release();
         upValue.Release();
      }
      {
         ICondition* upCondition = new UpCondition(symbol, timeframe, 0.1, 0.25);
         IValueFormatter* upValue = new FixedTextFormatter("2", GetTextColor(Gray), GetBackgroundColor(Gray));
         cell.AddCondition(upCondition, upValue, NULL, NULL);
         upCondition.Release();
         upValue.Release();
      }
      {
         ICondition* upCondition = new UpCondition(symbol, timeframe, 0.03, 0.1);
         IValueFormatter* upValue = new FixedTextFormatter("1", GetTextColor(Red), GetBackgroundColor(Red));
         cell.AddCondition(upCondition, upValue, NULL, upValue);
         upCondition.Release();
         upValue.Release();
      }
      {
         ICondition* upCondition = new UpCondition(symbol, timeframe, 0.00, 0.03);
         IValueFormatter* upValue = new FixedTextFormatter("0", GetTextColor(Red), GetBackgroundColor(Red));
         cell.AddCondition(upCondition, upValue, NULL, upValue);
         upCondition.Release();
         upValue.Release();
      }
...
string IndicatorName = "Chucks Currecy Strength Dashboard";
int init()
{
   ...
   IndicatorObjPrefix = GenerateIndicatorPrefix("ccsd");
