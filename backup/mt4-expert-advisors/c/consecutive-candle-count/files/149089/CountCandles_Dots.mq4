...
// https://fxcodebase.com/code/viewtopic.php?f=38&p=148833
...
int OnInit()
{
  ...
  SetIndexStyle(2, DRAW_ARROW, EMPTY, dotSize, LineUpSuperClr);
  SetIndexStyle(1, DRAW_ARROW, EMPTY, dotSize, LineDnClr);
  SetIndexStyle(3, DRAW_ARROW, EMPTY, dotSize, LineDnSuperClr);
