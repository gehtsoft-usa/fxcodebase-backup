...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=73938 
...
// #include <FrameWork/RecoverySystems/MartingaleFibo.mqh>
...
class MartingaleFibo
{
    ...
    public:
    MartingaleFibo(int magic, string symbol, double iniLot)
    {
    ...
    double Lot()
    {
        ...
        double next = NormalizeDouble(_iniLot * fibo(pos), 2);
    ...
    int fibo(int p)
    {
        ...
        int fiboSec[16] = { 0, 1, 2, 3, 5, 8, 13, 21, 46, 67, 113, 180, 293, 473, 766 };

        return fiboSec[p];
    }
};
MartingaleFibo fiboLots(magico, _Symbol, uIniLot);
 ...
 public:
  bool evaluate()
  {
    ...
    //   return Indi(bufferToBuy, 1) > 0;
      ...
      return iClose(NULL, 0, 1) < iLow(NULL, 0, 2);
  }
};
 ...
 public:
  bool evaluate()
  {
    ...
    // return false;
      ...
      return iClose(NULL, 0, 1) > iHigh(NULL, 0, 2);
  }
};
