...
int start()
{
 ...
 while(pos>=0)
 {
  O=iCCI(NULL, 0, Length, PRICE_OPEN, pos);
  H=iCCI(NULL, 0, Length, PRICE_HIGH, pos);
  L=iCCI(NULL, 0, Length, PRICE_LOW, pos);
  C=iCCI(NULL, 0, Length, PRICE_CLOSE, pos);
