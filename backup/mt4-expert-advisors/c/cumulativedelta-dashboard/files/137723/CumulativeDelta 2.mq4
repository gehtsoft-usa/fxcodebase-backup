...
int init()
{
   ...
   IndicatorBuffers(17);
   SetIndexBuffer(0, closed);
   SetIndexEmptyValue(0, 0);
   SetIndexStyle(0, DRAW_NONE);
   SetIndexBuffer(1, opened);
   SetIndexEmptyValue(1, 0);
   SetIndexStyle(1, DRAW_NONE);
   SetIndexBuffer(2, highed);
   SetIndexEmptyValue(2, 0);
   SetIndexStyle(2, DRAW_NONE);
   SetIndexBuffer(3, lowed);
   SetIndexEmptyValue(3, 0);
   SetIndexStyle(3, DRAW_NONE);
   SetIndexBuffer(4, Up_Body_Green);
   SetIndexEmptyValue(4, 0);
   SetIndexStyle(4, DRAW_HISTOGRAM, STYLE_SOLID, 3, upColor);
   SetIndexBuffer(5, Dn_Body_Red);
   SetIndexEmptyValue(5, 0);
   SetIndexStyle(5, DRAW_HISTOGRAM, STYLE_SOLID, 3, dnColor);
   SetIndexBuffer(6, EqBodyBuffer);
   SetIndexEmptyValue(6, 0);
   SetIndexStyle(6, DRAW_HISTOGRAM, STYLE_SOLID, 3, White);
   SetIndexBuffer(7, Bg_Body_Black);
   SetIndexEmptyValue(7, 0);
   SetIndexStyle(7, DRAW_HISTOGRAM, STYLE_SOLID, 3, 0);
   SetIndexBuffer(8, Up_Wick_Green);
   SetIndexEmptyValue(8, 0);
   SetIndexStyle(8, DRAW_HISTOGRAM, STYLE_SOLID, 1, upColor);
   SetIndexBuffer(9, Dn_Wick_Red);
   SetIndexEmptyValue(9, 0);
   SetIndexStyle(9, DRAW_HISTOGRAM, STYLE_SOLID, 1, dnColor);
   SetIndexBuffer(10, EqShadowBuffer);
   SetIndexEmptyValue(10, 0);
   SetIndexStyle(10, DRAW_HISTOGRAM, STYLE_SOLID, 1, White);
   SetIndexBuffer(11, Bg_Wick_Black);
   SetIndexEmptyValue(11, 0);
   SetIndexStyle(11, DRAW_HISTOGRAM, STYLE_SOLID, 1, 0);
   SetIndexBuffer(12, Dn_Body_Green);
   SetIndexEmptyValue(12, 0);
   SetIndexStyle(12, DRAW_HISTOGRAM, STYLE_SOLID, 3, upColor);
   SetIndexBuffer(13, Up_Body_Red);
   SetIndexEmptyValue(13, 0);
   SetIndexStyle(13, DRAW_HISTOGRAM, STYLE_SOLID, 3, dnColor);
   SetIndexBuffer(14, Dn_Wick_Green);
   SetIndexEmptyValue(14, 0);
   SetIndexStyle(14, DRAW_HISTOGRAM, STYLE_SOLID, 1, upColor);
   SetIndexBuffer(15, Up_Wick_Red);
   SetIndexEmptyValue(15, 0);
   SetIndexStyle(15, DRAW_HISTOGRAM, STYLE_SOLID, 1, dnColor);
   SetIndexBuffer(16, correlation);
   SetIndexEmptyValue(16, 0);
   SetIndexStyle(16, DRAW_LINE, STYLE_SOLID, 2, Yellow);
...
int start()
{
   ...
   SetIndexStyle(7, DRAW_HISTOGRAM, STYLE_SOLID, 3, 0);
   SetIndexStyle(11, DRAW_HISTOGRAM, STYLE_SOLID, 3, 0);
