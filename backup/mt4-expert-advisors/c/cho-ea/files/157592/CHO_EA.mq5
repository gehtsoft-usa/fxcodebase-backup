...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=75439
...
input const string indicator_file = "CHO Smoothed Arrow";        // Indicator File:
//---
int  bufferToBuy              = 0;
int  bufferToSell             = 1;
...
{
  public:
    bool evaluate() { return iClose(NULL, 0, 1) > MA(1); }
};
ConditionEMA_Filter_Buy cd_close_up_ema;
...
ConditionEMA_Filter_Sell cd_close_dn_ema;
