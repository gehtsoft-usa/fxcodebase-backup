...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70102
...
input double cci_buy_level = -110; // CCI buy level
input double cci_sell_level = 110; // CCI sell level
input int Lb = 10;
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double cciValue = iCCI(_symbol, _timeframe, cci_period, PRICE_CLOSE, period);
      return cciValue < cci_buy_level;
   }
};
...
public:
   ...
   {
      double cciValue = iCCI(_symbol, _timeframe, cci_period, PRICE_CLOSE, period);
      return cciValue > cci_sell_level;
   }
};
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double value0 = iCustom(_symbol, _timeframe, "ssl-channel-chart-alert-indicator", Lb, 0, period);
      double value1 = iCustom(_symbol, _timeframe, "ssl-channel-chart-alert-indicator", Lb, 1, period);
...
int OnInit()
{
   double temp = iCustom(NULL, 0, "ssl-channel-chart-alert-indicator", Lb, 0, 0);
