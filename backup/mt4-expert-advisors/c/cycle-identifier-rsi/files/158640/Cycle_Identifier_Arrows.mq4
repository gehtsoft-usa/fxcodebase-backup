...
string file = "Cycle identifier rsi.ex4";
double indi_up(int candle = 0) { return iCustom(NULL, 0, file, 1, candle); }
double indi_dn(int candle = 0) { return iCustom(NULL, 0, file, 2, candle); }
