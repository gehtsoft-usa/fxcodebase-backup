...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70848
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      int highestIndex = iHighest(_symbol, _timeframe, MODE_HIGH, ma_period, period);
      return highestIndex == period;
   }
};
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      return iMA(_symbol, _timeframe, ma_period, 0, ma_method, PRICE_LOW, period) > iMA(_symbol, _timeframe, ma_period, 0, ma_method, PRICE_HIGH, period);
   }
};
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      int highestIndex = iLowest(_symbol, _timeframe, MODE_LOW, ma_period, period);
      return highestIndex == period;
   }
};
