 ...
 //Available @  https://fxcodebase.com/code/viewtopic.php?f=38&t=74130
...
extern bool   ShowAllArrows    = true;
   ...
   if(alertsOn)
     {
      if(alertsOnCurrent)
         ...
         whichBar = 1;
      if(arrup[whichBar] != EMPTY_VALUE && arrdwn[whichBar + 1] != EMPTY_VALUE)
         doAlert(whichBar, "up");
      if(arrdwn[whichBar] != EMPTY_VALUE && arrup[whichBar + 1] != EMPTY_VALUE)
