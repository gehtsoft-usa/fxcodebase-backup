...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70582
...
int DistanceLv, DistanceL, DistanceHv, DistanceH, Distance6Mv, Distance6M, DistanceMv, DistanceM, DistanceYv, DistanceY, DistanceADRv, DistanceADR;
...
//ArraySetAsSeries(TodayOpenBuffer,1);
...
int OnCalculate(const int rates_total,     // grandezza delle timeseries input
                ...
                const int &spread[])       // array Spread
  {
   ...
   if(counted_bars > 0)
      ...
      counted_bars = 1;
   DailyOpen(rates_total - counted_bars, rates_total - counted_bars, open, time);
   double bid = SymbolInfoDouble(_Symbol, SYMBOL_BID);
//
   double sum_day_val[1];
   sum_day_val[0] = iATR(_Symbol, tf, NumOfDays_D, 1);
   double sum_m_val[1];
   sum_m_val[0] = iATR(_Symbol, tf, NumOfDays_M, 1);
   double sum_6m_val[1];
   sum_6m_val[0] = iATR(_Symbol, tf, NumOfDays_6M, 1);
   double sum_6m_add_val[1];
   sum_6m_add_val[0] = iATR(_Symbol, tf, Recent_Days_Weighting, 1);
//
...
if(Daily_ADR_Line_ON)
{
  ...
  {
  //  double _m6[1];
   double _m6 = iATR(_Symbol, tf, NumOfDays_6M, i+1);
  
   double _hi = iHigh(NULL, tf, i);
   double _lo = iLow(NULL, tf, i);


          ObjectCreate(0, objname    +"_ADR_Histo_"+i+ "ADR high line", OBJ_TREND, 0, 0, _hi - _m6);
         ObjectSetInteger(0, objname +"_ADR_Histo_"+i+ "ADR high line", OBJPROP_TIME, 0, iTime(_Symbol, PERIOD_D1, i) + TimeZoneOfData * 3600);
         ObjectSetInteger(0, objname +"_ADR_Histo_"+i+ "ADR high line", OBJPROP_TIME, 1, iTime(_Symbol, PERIOD_D1, i-1));
         ObjectSetDouble(0, objname  +"_ADR_Histo_"+i+ "ADR high line", OBJPROP_PRICE, 0, _hi - _m6);
         ObjectSetDouble(0, objname  +"_ADR_Histo_"+i+ "ADR high line", OBJPROP_PRICE, 1, _hi - _m6);
         ObjectSetInteger(0, objname +"_ADR_Histo_"+i+ "ADR high line", OBJPROP_COLOR, ADR_Line_Colour);
         ObjectSetInteger(0, objname +"_ADR_Histo_"+i+ "ADR high line", OBJPROP_STYLE, ADR_linestyle);
         ObjectSetInteger(0, objname +"_ADR_Histo_"+i+ "ADR high line", OBJPROP_WIDTH, 1);         
         ObjectSetInteger(0, objname +"_ADR_Histo_"+i+ "ADR high line", OBJPROP_RAY, false);

         ObjectCreate(0, objname     +"_ADR_Histo_"+i+ "ADR low line", OBJ_TREND, 0, 0, _lo + _m6);
         ObjectSetInteger(0, objname +"_ADR_Histo_"+i+ "ADR low line", OBJPROP_TIME, 0, iTime(_Symbol, PERIOD_D1, i) + TimeZoneOfData * 3600);
         ObjectSetInteger(0, objname +"_ADR_Histo_"+i+ "ADR low line", OBJPROP_TIME, 1, iTime(_Symbol, PERIOD_D1, i-1));
         ObjectSetDouble(0, objname  +"_ADR_Histo_"+i+ "ADR low line", OBJPROP_PRICE, 0, _lo + _m6);
         ObjectSetDouble(0, objname  +"_ADR_Histo_"+i+ "ADR low line", OBJPROP_PRICE, 1, _lo + _m6);
         ObjectSetInteger(0, objname +"_ADR_Histo_"+i+ "ADR low line", OBJPROP_COLOR, ADR_Line_Colour);
         ObjectSetInteger(0, objname +"_ADR_Histo_"+i+ "ADR low line", OBJPROP_STYLE, ADR_linestyle);
         ObjectSetInteger(0, objname +"_ADR_Histo_"+i+ "ADR low line", OBJPROP_WIDTH, 1);
         ObjectSetInteger(0, objname +"_ADR_Histo_"+i+ "ADR low line", OBJPROP_RAY, false);  
  }
}
      ...
      if(ADR_Line)
        {
         ...
         ObjectSetInteger(0, objname + "ADR high line", OBJPROP_TIME, 0, iTime(_Symbol, tf, 0) + TimeZoneOfData * 3600);
         ...
         ObjectSetInteger(0, objname + "ADR low line", OBJPROP_TIME, 0, iTime(_Symbol, tf, 0) + TimeZoneOfData * 3600);
      ...
      if(Daily_Open_Line)
        {
         ...
         if(ShowDailyOpenLevel)
           {
            if(iBarShift(Symbol(), PERIOD_D1, (time[shift] - tzdiffsec)) != iBarShift(Symbol(), PERIOD_D1, (time[shift + 1] - tzdiffsec))) // day change
              {
               TodayOpenBuffer[shift] = open[shift];
               TodayOpenBuffer[shift + 1] = EMPTY_VALUE; // avoid stairs in the line
               dayC++;
              }
            else 
              {
