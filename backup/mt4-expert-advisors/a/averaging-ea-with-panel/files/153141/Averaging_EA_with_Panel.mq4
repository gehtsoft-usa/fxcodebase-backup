...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=74308
...
// #include <FrameWork/Actions/ActionCloseByProfit.mqh>
interface iActions
{
    bool doAction();
};
...
class GUI : public CAppDialog
{
    ...
    bool Create(const long chart, const string name, const int subwin, const int x1, const int y1, const int x2, const int y2)
    {
        ...
        if(!Create_button("BUY", Col(0), Row(0), _high, _width, btBuy)) return false;
        if(!Create_button("SELL", Col(0), Row(1), _high, _width, btSell)) return false;
        ...
        if(!Create_button("Close Win", Col(0), Row(3), _high, _width, bt1)) return false;
        if(!Create_button("Close Loss", Col(0), Row(4), _high, _width, bt2)) return false;
        if(!Create_button("Close All", Col(0), Row(5), _high, _width, bt3)) return false;
        // if (!Create_label("win" ,       Col(1), Row(0), _high, _width, lb1)) return false;
    ...
    // void OnClick_button_Buy()  { btnBuyAction.doAction(); }
    // void OnClick_button_Sell() { btnSellAction.doAction(); }
...
int OnInit()
{
    ...
    {
        gui.Create(0, "Av Pannel", 0, 200, 0, 450, 150);
        gui.Run();
    }
