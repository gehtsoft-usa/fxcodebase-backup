...
int init()
{
   IndicatorShortName("Simple Arithmetic Mean");
   ...
   if (On1)
   {
      ...
      items[size] = new Instrument(Select1, Weight1, Inverse1);
   }
   if (On2)
   {
      int size = ArraySize(items);
      ArrayResize(items, size + 1);
      items[size] = new Instrument(Select2, Weight2, Inverse2);
   }
   if (On3)
   {
      int size = ArraySize(items);
      ArrayResize(items, size + 1);
      items[size] = new Instrument(Select3, Weight3, Inverse3);
   }
   if (On4)
   {
      int size = ArraySize(items);
      ArrayResize(items, size + 1);
      items[size] = new Instrument(Select4, Weight4, Inverse4);
   }
   if (On5)
   {
      int size = ArraySize(items);
      ArrayResize(items, size + 1);
      items[size] = new Instrument(Select5, Weight5, Inverse5);
   }
   if (On6)
   {
      int size = ArraySize(items);
      ArrayResize(items, size + 1);
      items[size] = new Instrument(Select6, Weight6, Inverse6);
   }
   if (On7)
   {
      int size = ArraySize(items);
      ArrayResize(items, size + 1);
      items[size] = new Instrument(Select7, Weight7, Inverse7);
   }
