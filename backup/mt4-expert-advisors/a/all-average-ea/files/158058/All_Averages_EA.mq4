...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double fast = iCustom(_symbol, _timeframe, "All Averages 4.9", FPrice, FMA_Period, FMA_Shift, FMA_Method, 0, period);
      double slow = iCustom(_symbol, _timeframe, "All Averages 4.9", SPrice, SMA_Period, SMA_Shift, SMA_Method, 0, period);
      return fast > slow;
   }
};
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double fast = iCustom(_symbol, _timeframe, "All Averages 4.9", 0, FPrice, FMA_Period, FMA_Shift, FMA_Method, 0, period);
      double slow = iCustom(_symbol, _timeframe, "All Averages 4.9", 0, SPrice, SMA_Period, SMA_Shift, SMA_Method, 0, period);
      return fast < slow;
   }
};
...
{
public:
   LongADXFilterCondition(const string symbol, ENUM_TIMEFRAMES timeframe)
      :ACondition(symbol, timeframe)
   {
   }
   ...
   bool IsPass(const int period, const datetime date)
   {
      double adxValue = iADX(_symbol, _timeframe, 14, PRICE_CLOSE, MODE_MAIN, period);
...
{
public:
   LongRSIFilterCondition(const string symbol, ENUM_TIMEFRAMES timeframe)
      :ACondition(symbol, timeframe)
   {
   }
   ...
   bool IsPass(const int period, const datetime date)
   {
      double rsiValue = iRSI(_symbol, _timeframe, 14, PRICE_CLOSE, period);
...
{
public:
   ShortADXFilterCondition(const string symbol, ENUM_TIMEFRAMES timeframe)
      :ACondition(symbol, timeframe)
   {
   }
...
{
public:
   ShortRSIFilterCondition(const string symbol, ENUM_TIMEFRAMES timeframe)
      :ACondition(symbol, timeframe)
   {
   }
...
ICondition* CreateLongFilterCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(new LongADXFilterCondition(symbol, timeframe), false);
   condition.Add(new LongRSIFilterCondition(symbol, timeframe), false);
   return condition;
}
...
ICondition* CreateShortFilterCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(new ShortADXFilterCondition(symbol, timeframe), false);
   condition.Add(new ShortRSIFilterCondition(symbol, timeframe), false);
   return condition;
}
...
int OnInit()
{
   ...
   #endif
   double temp = iCustom(NULL, 0, "All Averages 4.9", 0, 0);
   if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
   {
      Alert("Please, install the 'All Averages 4.9' indicator");
      return INIT_FAILED;
   }
