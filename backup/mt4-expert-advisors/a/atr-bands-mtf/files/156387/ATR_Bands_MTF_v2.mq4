...
input string             Iema                  = "== Center MA Setup ==";  // ==  Center MA Setup ==
...
input string             upIema                  = "== Upper MA Setup ==";  // ==  Upper MA Setup ==
input int                upmaPeriod              = 49;                            // Period
int                      upmaShift               = 0;                             // Ma Shift
input ENUM_MA_METHOD     upmaMethod              = MODE_EMA;                      // Method
input ENUM_APPLIED_PRICE upmaAppliedPrice        = PRICE_CLOSE;                   // Applied Price
input string             dnIema                  = "== Lower MA Setup ==";  // ==  Lower MA Setup ==
input int                dnmaPeriod              = 49;                            // Period
int                      dnmaShift               = 0;                             // Ma Shift
input ENUM_MA_METHOD     dnmaMethod              = MODE_EMA;                      // Method
input ENUM_APPLIED_PRICE dnmaAppliedPrice        = PRICE_CLOSE;                   // Applied Price
                ...
                const int&      spread[])
{
  ...
  for (i = start; i >= 0; i--)
  {
    ...
    double upma   = iMA(NULL, tf, upmaPeriod, 0, upmaMethod, upmaAppliedPrice, isup);
    double dnma   = iMA(NULL, tf, dnmaPeriod, 0, dnmaMethod, dnmaAppliedPrice, isup);
