...
int init()
{
   IndicatorShortName("ANN Strategy Indicator");
...
{
   double yesterday=(Open[x_period+1]+Close[x_period+1]+High[x_period+1]+ Low[x_period+1])/4;
   double today=(Open[x_period]+Close[x_period]+High[x_period]+ Low[x_period])/4;
