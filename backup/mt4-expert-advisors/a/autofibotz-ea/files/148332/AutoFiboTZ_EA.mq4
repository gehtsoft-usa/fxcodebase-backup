...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=72944
...
ModeEntry modeEntry         = PendingLimit;                           // Mode Entry:
...
#ifdef CLOSE_ALL_ON
input string       TtpOposite              = "== Close Oposite ==";  // == Close in Oposite Signal ==
