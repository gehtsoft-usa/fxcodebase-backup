...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70716
...
input ENUM_MA_METHOD fast_method = MODE_SMA; // Fast method
input int fast_period = 7; // Fast period
input ENUM_MA_METHOD slow_method = MODE_SMA; // Slow method
input int slow_period = 14; // Slow period
input ENUM_MA_METHOD long_method = MODE_SMA; // Long method
input int long_period = 21; // Long period
...
ICondition* CreateLongCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   condition.Add(new MAMACondition(symbol, timeframe, FirstCrossOverSecond, fast_method, fast_period, PRICE_CLOSE, slow_method, slow_period, PRICE_CLOSE), false);
...
ICondition* CreateLongFilterCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(new MAPriceCondition(symbol, timeframe, FirstBelowSecond, fast_method, fast_period, PRICE_CLOSE), false);
   condition.Add(new MAPriceCondition(symbol, timeframe, FirstBelowSecond, slow_method, slow_period, PRICE_CLOSE), false);
   condition.Add(new MAPriceCondition(symbol, timeframe, FirstBelowSecond, long_method, long_period, PRICE_CLOSE), false);
   return condition;
}
...
ICondition* CreateShortCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(new MAMACondition(symbol, timeframe, FirstCrossUnderSecond, fast_method, fast_period, PRICE_CLOSE, slow_method, slow_period, PRICE_CLOSE), false);
   #ifdef ACT_ON_SWITCH_CONDITION
      ActOnSwitchCondition* switchCondition = new ActOnSwitchCondition(symbol, timeframe, (ICondition*) condition);
      condition.Release();
      return switchCondition;
...
ICondition* CreateShortFilterCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(new MAPriceCondition(symbol, timeframe, FirstAboveSecond, fast_method, fast_period, PRICE_CLOSE), false);
   condition.Add(new MAPriceCondition(symbol, timeframe, FirstAboveSecond, slow_method, slow_period, PRICE_CLOSE), false);
   condition.Add(new MAPriceCondition(symbol, timeframe, FirstAboveSecond, long_method, long_period, PRICE_CLOSE), false);
   return condition;
}
