...
public:
   ...
   void Update(int pos)
   {
      double adxpValue = iADX(_symbol, _Period, period, PRICE_CLOSE, MODE_PLUSDI, pos);
      double adxmValue = iADX(_symbol, _Period, period, PRICE_CLOSE, MODE_MINUSDI, pos);
      out[pos] = adxmValue == 0 ? 0 : adxpValue / adxmValue;
   }
...
int init()
{
   IndicatorName = GenerateIndicatorName("DMI Strength Meter Oscillator");
