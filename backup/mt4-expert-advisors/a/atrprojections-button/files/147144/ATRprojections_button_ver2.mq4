...
int start()
{
   ...
   double ATRnumber1 = iATR(NULL, tf, ATRperiod, 0) * ATRmultiplier1;
   double ATRnumber2 = iATR(NULL, tf, ATRperiod, 0) * ATRmultiplier2;
   ...
   double LowOfPrice = iLow(NULL, tf, 0) + ATRnumber2;
   double HighOfPrice = iHigh(NULL, tf, 0) - ATRnumber2;
