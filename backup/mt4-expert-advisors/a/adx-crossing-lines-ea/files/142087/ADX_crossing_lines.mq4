...
input double adx_level = 14; // ADX level
input int fast_ema_period = 12; // Fast MA period
input int slow_ema_period = 26; // Slow MA period
input int signal_period = 9; // Signal period
input bool use_exit = true; // Use exit rule
...
class ADXCondition : public ACondition
{
public:
   ADXCondition(const string symbol, ENUM_TIMEFRAMES timeframe)
      :ACondition(symbol, timeframe)
   {
   ...
   bool IsPass(const int period, const datetime date)
   {
      return iADX(_symbol, _timeframe, adx_period, PRICE_CLOSE, MODE_MAIN, period) > adx_level;
   }
};
class ADXSlopeCondition : public ACondition
{
public:
   ADXSlopeCondition(const string symbol, ENUM_TIMEFRAMES timeframe)
      :ACondition(symbol, timeframe)
   {
   ...
   bool IsPass(const int period, const datetime date)
   {
      return iADX(_symbol, _timeframe, adx_period, PRICE_CLOSE, MODE_MAIN, period) > iADX(_symbol, _timeframe, adx_period, PRICE_CLOSE, MODE_MAIN, period + 1);
   }
};
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      return iMACD(_symbol, _timeframe, fast_ema_period, slow_ema_period, signal_period, PRICE_CLOSE, MODE_MAIN, period) > 0;
   }
};
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      return iMACD(_symbol, _timeframe, fast_ema_period, slow_ema_period, signal_period, PRICE_CLOSE, MODE_MAIN, period) < iMACD(_symbol, _timeframe, fast_ema_period, slow_ema_period, signal_period, PRICE_CLOSE, MODE_MAIN, period + 1);
   }
};
...
ICondition* CreateLongCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   condition.Add(new ADXCondition(symbol, timeframe), false);
   condition.Add(new ADXSlopeCondition(symbol, timeframe), false);
