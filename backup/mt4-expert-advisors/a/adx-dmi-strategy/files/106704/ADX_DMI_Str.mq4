...
void OnTick()
{
 ...
 double DMIP0, DMIP1, DMIM0, DMIM1, ADX0, ADX1;
 ...
 ADX1=iADX(NULL, 0, ADX_Length, Price, 0, 2);
 ...
 if ((Signal_Type==0 && ((ADX0>ADX_Level && ADX1<=ADX_Level && DMIP0>DMIM0) || (ADX0>ADX_Level && DMIP0>DMIM0 && DMIP1<=DMIM1))) || (Signal_Type==1 && ((ADX0>ADX_Level && ADX1<=ADX_Level && DMIP0<DMIM0) || (ADX0>ADX_Level && DMIP0<DMIM0 && DMIP1>=DMIM1))))
 {
  _Alert("Buy");
  CO=CalculateOrders();
  if (CO<=0)
 ...
 if ((Signal_Type==1 && ((ADX0>ADX_Level && ADX1<=ADX_Level && DMIP0>DMIM0) || (ADX0>ADX_Level && DMIP0>DMIM0 && DMIP1<=DMIM1))) || (Signal_Type==0 && ((ADX0>ADX_Level && ADX1<=ADX_Level && DMIP0<DMIM0) || (ADX0>ADX_Level && DMIP0<DMIM0 && DMIP1>=DMIM1))))
 {
  _Alert("Sell");
  CO=CalculateOrders();
  if (CO>=0)
