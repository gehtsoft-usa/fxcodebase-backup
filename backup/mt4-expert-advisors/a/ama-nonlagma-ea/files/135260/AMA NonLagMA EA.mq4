...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double ama = iCustom(_symbol, _timeframe, "AMA", inpPeriod, inpFastPeriod, inpSlowPeriod, inpPrice, 0, period);
      double nonlagma = iCustom(_symbol, _timeframe, "nonlagma-indicator", Price, Length, Displace, Filter, Color, ColorBarBack, Deviation, 0, period);
      return ama > nonlagma;
   }
};
