...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=68978
...
public:
   ...
   {
      return iHighest(_symbol, _timeframe, MODE_HIGH, dist, period - dist / 2) == period;
   }
};
...
public:
   ...
   bool IsPass(const int period)
   {
      return iLowest(_symbol, _timeframe, MODE_LOW, dist, period - dist / 2) == period;
   }
};
