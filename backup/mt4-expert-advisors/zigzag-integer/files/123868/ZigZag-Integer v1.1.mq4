...
extern ENUM_BASE_CORNER DisplayLocation = CORNER_RIGHT_LOWER; //Display location
extern int x_shift = 5; // X shift
extern int y_shift = 5; // Y shift
...
int init()
{
   IndicatorName = GenerateIndicatorName("ZigZag-Integer");
