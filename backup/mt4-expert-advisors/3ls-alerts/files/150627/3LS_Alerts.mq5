...
{
  // TODO: signal up
	int sh = iBars(_Symbol, Period()) - i;

  double op  = iOpen(NULL, 0, sh);
  double cl  = iClose(NULL, 0, sh);
  double op1 = iOpen(NULL, 0, sh + 1);
  double cl1 = iClose(NULL, 0, sh + 1);
	double op2 = iOpen(NULL, 0, sh + 2);
  double cl2 = iClose(NULL, 0, sh + 2);
  double op3 = iOpen(NULL, 0, sh + 3);
  double cl3 = iClose(NULL, 0, sh + 3);

  if (op1 > cl1 && cl > op && cl > op1 && cl2<op2 && cl3<op3) return true;
