...
// https://fxcodebase.com/code/viewtopic.php?f=38&p=155697#p155697
...
string file_custom_indicator = "2x ma(+ keltner)";
int    bufferToBuy           = 9;
int    bufferToSell          = 10;

input string          Tindi      = "== Indicator Setup =="; // ————————————
input ENUM_TIMEFRAMES TimeFrame  = 0;
input int             colorOn    = 2;   // Color Change on:
input int             MAPeriod1  = 10;  // MA period 1:
input int             MAPeriod2  = 200; // MA Period 2:
input int             MAPeriodch = 50;  // MA period Channel:
input int             MAType     = 11;  // MA type:
input int             MAPrice    = 0;   // MA Applied:
input int             AtrPeriod  = 51;  // ATR period:
input double          KATR       = 1.0; // ATR desviation:
...
double Indi(int buffer, int candle)
{
    ...
    TimeFrame, colorOn, MAPeriod1, MAPeriod2, MAPeriodch, MAType, MAPrice, AtrPeriod, KATR, 
    buffer, candle);
}
#endif
