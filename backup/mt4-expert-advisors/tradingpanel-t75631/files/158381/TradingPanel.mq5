...
class GUI : public CAppDialog
{
    ...
    CButton btBuy, btSell, btBuyPending, btSellPending, btCloseAll, btTSL;
    CEdit   eAsk, eBid;
    CEdit   ePendingPrice,  eTP,  eSL,  eLots,  eRisk; 
    ...
    bool Create(const long chart, const string name, const int subwin, const int x1, const int y1, const int x2, const int y2)
    {
        ...
        if(!Create_button("TSL",              Col(0), Row(12), _high, _width2, btTSL)) return false;
