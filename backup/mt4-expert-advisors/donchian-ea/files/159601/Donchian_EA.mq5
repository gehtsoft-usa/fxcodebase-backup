//Available @  https://fxcodebase.com/code/viewtopic.php?f=27&p=159565#p159565
...
input const string indicator_file = "Donchian_Channel_5";                          // Indicator File:
  ...
  public:
    bool evaluate()
    {
        for (int i = 1; i <= candles_back_for_signals; i++) {
            ...
            if (cl > indi && indi != EMPTY_VALUE && indi != lastSignal) {
                lastSignal = cl;
                return true;
            }
        }
