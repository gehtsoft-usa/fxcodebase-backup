...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=72825
...
bool ControlNewsTime()
{
  ...
  // if (HayProximas > 0)
  // {
  //         Comment("EA OFF for News");
  //         return true;
  // Apagado = true;
  // Print("HayPróximas:", HayProximas);
  // }

  // está apagado, y no tiene próximas, por lo tanto tiene que controlar el tiempo a la útlima noticia pasada
  //  if (Apagado == true && HayProximas == 0)
  //  {

  // vá a registrar la mayor hora de la noticia del pasado
  //  int UltimaNewsPasada = 0;
  ...
  //   }
  // }
  // Print("UltimaNewsPasada: ", UltimaNewsPasada);
