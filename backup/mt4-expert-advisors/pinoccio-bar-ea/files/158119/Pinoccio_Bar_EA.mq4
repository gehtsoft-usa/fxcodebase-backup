//Available @  https://fxcodebase.com/code/viewtopic.php?f=38&t=75575
...
input int param1 = 33; // Body Lengt
input bool param2 = true; // Left Eye Check
input int param3 = 33; // Body Position
input int param4 = 33; // Nose Lengt
input bool param5 = true; // Use Filter
input int param6 = 8; // Alligator Teeth smoothing periods
input int param7 = 5; // Alligator Teeth shifting periods
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double value = iCustom(_symbol, _timeframe, "Pinoccio_Bar", param1, param2, param3, param4, param5, param6, param7, 0, period);
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double value = iCustom(_symbol, _timeframe, "Pinoccio_Bar", param1, param2, param3, param4, param5, param6, param7, 1, period);
      return value != EMPTY_VALUE;
   }
};
...
int OnInit()
{
   double temp = iCustom(NULL, 0, "Pinoccio_Bar", 0, 0);
   if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
   {
      Alert("Please, install the 'Pinoccio_Bar' indicator");
      return INIT_FAILED;
   }
