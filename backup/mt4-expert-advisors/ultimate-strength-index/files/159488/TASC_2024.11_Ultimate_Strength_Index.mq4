...
public:
   ...
   bool GetValue(const int pos, double &__out1)
   {
      ...
      double srcValue_1;
      if (!src.GetValue(pos + 1, srcValue_1)) { srcValue_1 = EMPTY_VALUE; }
      double diff = SafeMinus(srcValue, srcValue_1);
      ...
      UltimateSmoother_fS_i1_param1.SetValue(pos, sma1Value);
      ...
      UltimateSmoother_fS_i2_param1.SetValue(pos, sma2Value);
                ...
                const int &spread[])
{
   ...
   for (int pos = MathMin(bars_limit, rates_total - 1 - MathMax(prev_calculated - 1, toSkip)); pos >= 0 && !IsStopped(); --pos)
   {
      ...
      stitle = "USI";
      double param2StreamValue;
      if (!param2Stream.GetValue(pos, param2StreamValue)) { param2StreamValue = EMPTY_VALUE; }
      double src = param2StreamValue;
      UltimateStrengthIndex_fS_i_i3_param1.SetValue(pos, src);
      double UltimateStrengthIndex_fS_i_i3Value;
      if (!UltimateStrengthIndex_fS_i_i3.GetValue(pos, UltimateStrengthIndex_fS_i_i3Value)) { UltimateStrengthIndex_fS_i_i3Value = EMPTY_VALUE; }
