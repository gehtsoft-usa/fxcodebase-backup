...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=74698
...
color        clrLineas    = RoyalBlue;         // Color Lineas:
  ...
  public:
    bool evaluate()
    {
        ...
        if (!Habilitado())
            return false;
        bool filter, time;
        filter = maFilterOn == true ? iClose(NULL, 0, 1) > maFilter.index(1) : true;
        time   = iTime(NULL, 0, 0) > HoraFin;
