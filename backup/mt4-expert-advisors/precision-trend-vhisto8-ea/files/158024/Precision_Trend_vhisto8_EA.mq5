//Available @  https://fxcodebase.com/code/viewtopic.php?f=38&t=75552
...
public:
   ...
   {
      refs = 1;
      indi = iCustom(symbol, timeframe, "Precision_Trend_vhisto8");
   }
   ~EntryStreamData()
   {
   ...
   int GetColor(int period)
   {
      double buffer[1];
      if (CopyBuffer(indi, 1, period, 1, buffer) == 1)
      {
         return buffer[0];
      }
      return -1;
