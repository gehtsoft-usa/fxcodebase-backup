...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=64955
...
int start()
  {
   ...
   for (i=0; i < Sym_count; i++) {
      ...
      if (Include_M5){
         atr0 = iATR(Sym_arr[i],PERIOD_M5,ATR_Period,0);
         atr1 = iATR(Sym_arr[i],PERIOD_M5,ATR_Period,1);
         if (atr0 > atr1){
            diff_color = Up_Color;
            arrow = "é";
         }else if (atr0 < atr1){
         ...
         ObjectMakeLabel(Sym_arr[i]+"_M5_label", M5_x-10, Pair_y, atr0, diff_color, 1, WindowNumber, "Arial", 9 );
      }
      if (Include_M15){
         atr0 = iATR(Sym_arr[i],PERIOD_M15,ATR_Period,0);
         atr1 = iATR(Sym_arr[i],PERIOD_M15,ATR_Period,1);
         if (atr0 > atr1){
            diff_color = Up_Color;
            arrow = "é";
         }else if (atr0 < atr1){
         ...
         ObjectMakeLabel(Sym_arr[i]+"_M15_label", M15_x-10, Pair_y, atr0, diff_color, 1, WindowNumber, "Arial", 9 );
      }
      if (Include_M30){
         atr0 = iATR(Sym_arr[i],PERIOD_M30,ATR_Period,0);
         atr1 = iATR(Sym_arr[i],PERIOD_M30,ATR_Period,1);
         if (atr0 > atr1){
            diff_color = Up_Color;
            arrow = "é";
         }else if (atr0 < atr1){
         ...
         ObjectMakeLabel(Sym_arr[i]+"_M30_label", M30_x-10, Pair_y, atr0, diff_color, 1, WindowNumber, "Arial", 9 );
      }
      if (Include_H1){
         atr0 = iATR(Sym_arr[i],PERIOD_H1,ATR_Period,0);
         atr1 = iATR(Sym_arr[i],PERIOD_H1,ATR_Period,1);
         if (atr0 > atr1){
            diff_color = Up_Color;
            arrow = "é";
         }else if (atr0 < atr1){
         ...
         ObjectMakeLabel(Sym_arr[i]+"_H1_label", H1_x-10, Pair_y, atr0, diff_color, 1, WindowNumber, "Arial", 9 );
      }
      if (Include_H4){
         atr0 = iATR(Sym_arr[i],PERIOD_H4,ATR_Period,0);
         atr1 = iATR(Sym_arr[i],PERIOD_H4,ATR_Period,1);
         if (atr0 > atr1){
            diff_color = Up_Color;
            arrow = "é";
         }else if (atr0 < atr1){
         ...
         ObjectMakeLabel(Sym_arr[i]+"_H4_label", H4_x-10, Pair_y, atr0, diff_color, 1, WindowNumber, "Arial", 9 );
      }
      if (Include_D1){
         atr0 = iATR(Sym_arr[i],PERIOD_D1,ATR_Period,0);
         atr1 = iATR(Sym_arr[i],PERIOD_D1,ATR_Period,1);
         if (atr0 > atr1){
            diff_color = Up_Color;
            arrow = "é";
         }else if (atr0 < atr1){
         ...
         ObjectMakeLabel(Sym_arr[i]+"_D1_label", D1_x-10, Pair_y, atr0, diff_color, 1, WindowNumber, "Arial", 9 );
      }
      if (Include_W1){
         atr0 = iATR(Sym_arr[i],PERIOD_W1,ATR_Period,0);
         atr1 = iATR(Sym_arr[i],PERIOD_W1,ATR_Period,1);
         if (atr0 > atr1){
            diff_color = Up_Color;
            arrow = "é";
         }else if (atr0 < atr1){
         ...
         ObjectMakeLabel(Sym_arr[i]+"_W1_label", W1_x-10, Pair_y, atr0, diff_color, 1, WindowNumber, "Arial", 9 );
      }
      if (Include_MN1){
         atr0 = iATR(Sym_arr[i],PERIOD_MN1,ATR_Period,0);
         atr1 = iATR(Sym_arr[i],PERIOD_MN1,ATR_Period,1);
         if (atr0 > atr1){
            diff_color = Up_Color;
            arrow = "é";
         }else if (atr0 < atr1){
         ...
         ObjectMakeLabel(Sym_arr[i]+"_MN1_label", MN1_x-7, Pair_y, atr0, diff_color, 1, WindowNumber, "Arial", 9 );
      }
