...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=70093
//+------------------------------------------------------------------+
...
int init()
{
   IndicatorObjPrefix = GenerateIndicatorPrefix("tpi");
   IndicatorShortName("Trade Profit Info");
                ...
                const int &spread[])
{
   ...
   if (last == 0)
   {
      ...
      double profit = unitCost * lots * pips;
      Comment("Pips: " + DoubleToString(pips) + " $: " + DoubleToString(profit, 2));
   }
   else
   {
      Comment("Pips: 0 $: 0");
