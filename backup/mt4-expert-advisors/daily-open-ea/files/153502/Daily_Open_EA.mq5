...
string file_custom_indicator = "Daily_High_Low_Indicator.ex5";
int handle = 0;
...
input int          userTPpips = 15;                            // Pips TP
...
class BUYcondition1 : public iConditions
{
    ...
    bool evaluate()
    {
        ...
        return ask >= iHigh(NULL, PERIOD_D1, 1);
        // return false;
    }
};
...
class SELLcondition1 : public iConditions
{
    ...
    bool evaluate()
    {
        ...
        return bid <= iLow(NULL, PERIOD_D1, 1);
    }
};
...
void OnTick()
{
    ...
    if(sesionControl.isNewDay()) availableToTrade = true;
