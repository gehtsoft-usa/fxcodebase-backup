...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=73662
...
string file_custom_indicator = "03-Swing Catcher.ex4";
...
input bool stoch_on = true; // Stoch On:
...
#define _ma1
#ifdef _ma1
input string             ma1_title = "== Moving Average Setup ==";  // ————————————
input bool ma1_on = true; // Ma On:
input int                ma1_Period = 50;                            // Period
...
#define _ma2
#ifdef _ma2
input string             ma2_title = "== Moving Average Setup ==";  // ————————————
input bool ma2_on = true; // Ma On:
input int                ma2_Period = 100;                            // Period
...
#define _ma3
#ifdef _ma3
input string             ma3_title = "== Moving Average Setup ==";  // ————————————
input bool ma3_on = true; // Ma On:
input int                ma3_Period = 200;                            // Period
...
class BUYcondition1 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    return iCustom(NULL, 0, file_custom_indicator, TimeFrame, Amplitude, 4, 1)!=EMPTY_VALUE;
    // return false;
  }
};
 ...
 public:
  bool evaluate()
  {
    // TODO: condition sell 1
		return iCustom(NULL, 0, file_custom_indicator, TimeFrame, Amplitude, 5, 1)!=EMPTY_VALUE;
		// return false;
  }
};
...
//--- SESSIONS CONTROL:
  ...
  ma1.setSetup(ma1_Period, ma1_Shift, ma1_Method, ma1_AppliedPrice);
#endif
#ifdef _ma2  
  ma2 = new MovingAverage();
  ma2.setSetup(ma2_Period, ma2_Shift, ma2_Method, ma2_AppliedPrice);
#endif
#ifdef _ma3  
  ma3 = new MovingAverage();
  ma3.setSetup(ma3_Period, ma3_Shift, ma3_Method, ma3_AppliedPrice);
#endif
...
{
    if (ma1_on) { ma1.index(0); }
    if (ma2_on) { ma2.index(0); }
    if (ma3_on) { ma3.index(0); }
    if (stoch_on) { stoch.main(0); }    
}
