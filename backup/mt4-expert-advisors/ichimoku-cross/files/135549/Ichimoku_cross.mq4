...
input ENUM_TIMEFRAMES tf_fixed = PERIOD_CURRENT; // Timeframe
input int tf_next = 2; // + Timeframes (use 0 for fixed)
                ...
                const int &spread[])
{
   ...
   int toSkip = 0;
   for (int pos = MathMax(1, rates_total - 1 - toSkip); pos >= 1; --pos)
   {
