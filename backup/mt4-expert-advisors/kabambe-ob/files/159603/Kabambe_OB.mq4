// https://fxcodebase.com/code/viewtopic.php?f=38&t=76033
...
bool haveSignalUp(int i)
{
    ...
    return (lo3 < lo4 && lo2 > lo3 && (lo2 > lo3 ||  lo1 > lo3));
...
bool haveSignalDown(int i)
{
    ...
    // candleB_high > candleA_high and candleC_high < candleB_high and (candleC_high < candleB_low or candleD_high < candleB_low)
    return (hi3 > hi4 && hi2 < hi3 && (hi2 < hi3 ||  hi1 < lo3));
