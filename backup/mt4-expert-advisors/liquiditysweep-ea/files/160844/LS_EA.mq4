...
Version:     
Date:        
Repository:  Available @ https://fxcodebase.com/code/viewtopic.php?f=38&t=76364
License:     GNU
*/
...
input const string indicator_file = "LiquiditySweep_v2";         // Indicator File:
//---
int  bufferToBuy              = 3;
int  bufferToSell             = 4;
bool indicator_init           = true;
input int  candles_back_for_signals = 1;
//---
