...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=71444
...
SimplePriceStream* highest1Source;
IStream* highest1;
...
int init()
{
   ...
   IndicatorShortName("Price Density");
   IndicatorBuffers(1);
   SetIndexBuffer(0, plot1);
   highest1Source = new SimplePriceStream(_Symbol, (ENUM_TIMEFRAMES)_Period, PriceHigh);
   highest1 = new HighestHighStream(highest1Source, length);
   lowest2Source = new SimplePriceStream(_Symbol, (ENUM_TIMEFRAMES)_Period, PriceLow);
                ...
                const int &spread[])
{
   ...
   for (int pos = MathMin(bars_limit, rates_total - 1 - MathMax(prev_calculated - 1, toSkip)); pos >= 0 && !IsStopped(); --pos)
   {
      ...
      {
         range += high[pos + i] - low[pos + i];
      }
      plot1[pos] = (highest1Value - lowest2Value) == 0 ? 0 : range / (highest1Value - lowest2Value);
   }
