...
double Blau_MACD[], Signal[];
double MACD[];

int init()
{
 IndicatorShortName("William Blau Ergodic MACD");
...
int start()
{
 ...
 while(pos>=0)
 {
  Signal[pos]=iMAOnArray(Blau_MACD, 0, Signal_Length, 0, MODE_EMA, pos);
  pos--;
 }  
