...
int init()
{
 IndicatorShortName("William Blau Momentum oscillator");
 IndicatorDigits(Digits);
 SetIndexStyle(0,DRAW_LINE);
 SetIndexBuffer(0,Blau_Mtm);
 SetIndexStyle(1,DRAW_NONE);
 SetIndexBuffer(1,Mtm);
...
int start()
{
 ...
 while(pos>=0)
 {
  Blau_Mtm[pos]=iMAOnArray(EMA2, 0, Smooth_Length3, 0, MODE_EMA, pos)/Point;
  pos--;
 }  
 return(0);
}
