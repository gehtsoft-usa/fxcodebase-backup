...
void OnInit()
{
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, "TRAMA - Trend Regularity Adaptive Moving Average");
   IndicatorSetInteger(INDICATOR_DIGITS, Digits());
   SetIndexBuffer(id++, trama, INDICATOR_CALCULATIONS);
   SetIndexBuffer(id++, smoothLine, INDICATOR_CALCULATIONS);
                ...
                const int &spread[])
{
   ...
   for (int pos = MathMax(rates_total - 1 - bars_limit, MathMax(first, prev_calculated - 1)); pos < rates_total; ++pos)
   {
      ...
      double plot1Value = plot1.Set(pos, smoothLine[pos], trendColor);
   }
   return rates_total;
}
//Available @  https://fxcodebase.com/code/viewtopic.php?f=38&t=75851
