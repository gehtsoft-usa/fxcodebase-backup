//Available @  https://fxcodebase.com/code/viewtopic.php?f=38&p=155693#p155693
...
class ActionCloseGrid : public iActions
{
  public:
    bool execute()
    {
        ...
        for (int i = OrdersTotal() - 1; i >= 0; i--) {
            if (OrderSelect(i, SELECT_BY_POS) && OrderSymbol() == _Symbol && OrderMagicNumber() == magico && (OrderComment() == grid_id || OrderTicket() == tk)) {
...
input const string indicator_file = "six_soldiers_Indicator";    // Indicator File:
//---
int  bufferToBuy              = 0;
int  bufferToSell             = 1;
