    ...
    enum enMaTypes
{
   ...
   int start()
 {
   int doWhat = _doNothing;
      double stepma_trend_current  = iCustom(NULL,0,"StepMA averages nmc 3.142 + arrows",MaType,PriceFirstList,MaPriceSecondList,MaLength,Sensitivity,StepMaPrice,ATRScaling,5,BarToUse);
      double stepma_trend_previous = iCustom(NULL,0,"StepMA averages nmc 3.142 + arrows",MaType,PriceFirstList,MaPriceSecondList,MaLength,Sensitivity,StepMaPrice,ATRScaling,5,BarToUse+1);
