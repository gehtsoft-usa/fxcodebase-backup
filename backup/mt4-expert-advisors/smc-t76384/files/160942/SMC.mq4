...
Version:     1.00
Date:        2025
Repository:  Available @ https://fxcodebase.com/code/viewtopic.php?f=38&t=76384&sid=baec0945c152f95e4b18c4be8650fe82
License:     GNU
*/
   ...
   if(ShowIob)
     {
      ...
      for(int i = 0; i < show_count; i++)
        {
         string name = obj_prefix + "IOB_" + IntegerToString(i);
