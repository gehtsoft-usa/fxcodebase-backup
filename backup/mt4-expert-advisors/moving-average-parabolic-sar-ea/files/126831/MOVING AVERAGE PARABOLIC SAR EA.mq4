...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=68558
...
input int ma_period_1 = 20; // Period for MA1
input int ma_shift_1 = 10; // Shift for MA1
input int ma_period_2 = 10; // Period for MA2
input int ma_shift_2 = 0; // Shift for MA2
input bool filter_using_sar = false; // Filter using Parabolic SAR
...
public:
   ...
   bool IsPass(const int period)
   {
      double ma1_0 = iMA(_symbol, _timeframe, ma_period_1, ma_shift_1, MODE_EMA, PRICE_CLOSE, period);
      double ma1_1 = iMA(_symbol, _timeframe, ma_period_1, ma_shift_1, MODE_EMA, PRICE_CLOSE, period + 1);
      double ma2_0 = iMA(_symbol, _timeframe, ma_period_2, ma_shift_2, MODE_EMA, PRICE_CLOSE, period);
      double ma2_1 = iMA(_symbol, _timeframe, ma_period_2, ma_shift_2, MODE_EMA, PRICE_CLOSE, period + 1);
      if (filter_using_sar)
      {
         double sarValue = iSAR(_symbol, _timeframe, Step, Max, period);
         if (sarValue >= ma1_0 || sarValue >= ma2_0)
            return false;
      }
      return ma2_0 < ma1_0 && ma2_1 >= ma1_1;
   }
};
