...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=69593
...
input int STOMethod=0;
input int STOMode=0;
input int ApplyTo=0;
input double os = 30; // Oversold level
input double ob = 70; // Overbought level
...
public:
   ...
   {
      double stoch0 = iStochastic(_symbol, _timeframe, STOKPeriod, STODPeriod, STOSlowing, STOMethod, ApplyTo, STOMode, period);
      double stoch1 = iStochastic(_symbol, _timeframe, STOKPeriod, STODPeriod, STOSlowing, STOMethod, ApplyTo, STOMode, period + 1);
      return stoch0 >= ob && stoch1 < ob;
   }
};
