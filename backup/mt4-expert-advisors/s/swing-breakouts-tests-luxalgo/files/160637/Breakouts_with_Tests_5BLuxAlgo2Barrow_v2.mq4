...
Version:     
Date:        
Repository:  Available @ https://fxcodebase.com/code/viewtopic.php?f=38&p=160583#p160583
License:     GNU
*/
...
input color ArrowUpColor = Blue; // Up Arrow Color
input int ArrowUpSize = 3; // Up Arrow Size
input int ArrowUpCode = 241; // Up Arrow Code
input color ArrowDownColor = Red; // Down Arrow Color
input int ArrowDownSize = 3; // Down Arrow Size
input int ArrowDownCode = 242; // Down Arrow Code
...
public:
   mayAdd_lbaSStream(TStream<ICustomTypeArray<Label*>*>* aLab, string indicatorObjPrefix)
   {
      _initialized = false;
   ...
   {
      ICustomTypeArray<Label*>* aLabValue;
      if (!aLab.GetValue(pos, aLabValue)) { aLabValue = NULL; }
      __out1 = (((Array::Size<int, ICustomTypeArray<Label*>*>(aLabValue, INT_MIN) == 0) || (showReTest == "Last")) ? true : (showReTest == "All") && SafeGreater(SafeMinus(n, Label::GetX(Array::First<Label*, ICustomTypeArray<Label*>*>(aLabValue, NULL))), minBars));
      return true;
   }
};
...
class addLabel_lbaS_lbSStream
{
   ...
   string IndicatorObjPrefix;
public:
   addLabel_lbaS_lbSStream(TStream<ICustomTypeArray<Label*>*>* aLab, TIStream<Label*>* lab, string indicatorObjPrefix)
   {
      _initialized = false;
      IndicatorObjPrefix = indicatorObjPrefix;
      this.aLab = aLab;
   ...
   bool GetValue(const int pos, Label* &__out1)
   {
      ...
      if (!aLab.GetValue(pos, aLabValue)) { aLabValue = NULL; }
      Label* labValue;
      if (!lab.GetValue(pos, labValue)) { labValue = NULL; }
      Array::Unshift<ICustomTypeArray<Label*>*, Label*>(aLabValue, labValue);
      if ((showReTest == "Last") && SafeGreater(Array::Size<int, ICustomTypeArray<Label*>*>(aLabValue, INT_MIN), 1))
      {
         __out1 = Array::Pop<Label*, ICustomTypeArray<Label*>*>(aLabValue, NULL);
      }
      return true;
   }
};
class label__custom_s_i_fStream
{
   ...
   string IndicatorObjPrefix;
public:
   label__custom_s_i_fStream(string dir, int state, double y, string indicatorObjPrefix)
   {
      _initialized = false;
      IndicatorObjPrefix = indicatorObjPrefix;
      this.dir = dir;
   ...
   bool GetValue(const int pos, Label* &__out1)
   {
      Label* lab = LabelsCollection::Create(IndicatorObjPrefix + "label_1_id", n, y, iTime(_Symbol, (ENUM_TIMEFRAMES)_Period, pos)).SetColor((uint)(INT_MAX)).SetText("").SetStyle("down").SetSize(labSize).SetYLoc("price").SetTextAlign("center");
      if ((dir == "bull"))
      {
         if ((state == 1))
         {
...
int init()
{
   ...
   arrowUpSize = ArrowUpSize;
   arrowUpCode = ArrowUpCode;
   arrowDownColor = ArrowDownColor;
   arrowDownSize = ArrowDownSize;
   arrowDownCode = ArrowDownCode;
   ...
   IndicatorShortName("Swing Breakouts Tests & Retests [LuxAlgo]");
   ICustomTypeArray<Label*>* __array1 = new LabelArray(0, NULL);
   ICustomTypeArray<Label*>* __array2 = new LabelArray(0, NULL);
      bull = new bin((Box*)(NULL), 0, NULL, __array1, __array2);
   ICustomTypeArray<Label*>* __array3 = new LabelArray(0, NULL);
   ICustomTypeArray<Label*>* __array4 = new LabelArray(0, NULL);
      bear = new bin((Box*)(NULL), 0, NULL, __array3, __array4);
   mayAdd_lbaS1_param1 = new LabelArrayStream(_Symbol, (ENUM_TIMEFRAMES)_Period, NULL);
   mayAdd_lbaS1 = new mayAdd_lbaSStream(mayAdd_lbaS1_param1, IndicatorObjPrefix + "_1");
   id = mayAdd_lbaS1.Init(id);
   label__custom_s_i_f3 = new label__custom_s_i_fStream("bull", 1, bin::Getprice(bull), IndicatorObjPrefix + "_3");
   id = label__custom_s_i_f3.Init(id);
   addLabel_lbaS_lbS2_param1 = new LabelArrayStream(_Symbol, (ENUM_TIMEFRAMES)_Period, NULL);
   addLabel_lbaS_lbS2_param2 = new LabelStream(_Symbol, (ENUM_TIMEFRAMES)_Period, NULL);
   addLabel_lbaS_lbS2 = new addLabel_lbaS_lbSStream(addLabel_lbaS_lbS2_param1, addLabel_lbaS_lbS2_param2, IndicatorObjPrefix + "_3");
   id = addLabel_lbaS_lbS2.Init(id);
   mayAdd_lbaS4_param1 = new LabelArrayStream(_Symbol, (ENUM_TIMEFRAMES)_Period, NULL);
   mayAdd_lbaS4 = new mayAdd_lbaSStream(mayAdd_lbaS4_param1, IndicatorObjPrefix + "_4");
   id = mayAdd_lbaS4.Init(id);
   label__custom_s_i_f6 = new label__custom_s_i_fStream("bull", 2, bin::Getprice(bull), IndicatorObjPrefix + "_6");
   id = label__custom_s_i_f6.Init(id);
   addLabel_lbaS_lbS5_param1 = new LabelArrayStream(_Symbol, (ENUM_TIMEFRAMES)_Period, NULL);
   addLabel_lbaS_lbS5_param2 = new LabelStream(_Symbol, (ENUM_TIMEFRAMES)_Period, NULL);
   addLabel_lbaS_lbS5 = new addLabel_lbaS_lbSStream(addLabel_lbaS_lbS5_param1, addLabel_lbaS_lbS5_param2, IndicatorObjPrefix + "_6");
   id = addLabel_lbaS_lbS5.Init(id);
   mayAdd_lbaS7_param1 = new LabelArrayStream(_Symbol, (ENUM_TIMEFRAMES)_Period, NULL);
   mayAdd_lbaS7 = new mayAdd_lbaSStream(mayAdd_lbaS7_param1, IndicatorObjPrefix + "_7");
   id = mayAdd_lbaS7.Init(id);
   label__custom_s_i_f9 = new label__custom_s_i_fStream("bear", 1, bin::Getprice(bear), IndicatorObjPrefix + "_9");
   id = label__custom_s_i_f9.Init(id);
   addLabel_lbaS_lbS8_param1 = new LabelArrayStream(_Symbol, (ENUM_TIMEFRAMES)_Period, NULL);
   addLabel_lbaS_lbS8_param2 = new LabelStream(_Symbol, (ENUM_TIMEFRAMES)_Period, NULL);
   addLabel_lbaS_lbS8 = new addLabel_lbaS_lbSStream(addLabel_lbaS_lbS8_param1, addLabel_lbaS_lbS8_param2, IndicatorObjPrefix + "_9");
   id = addLabel_lbaS_lbS8.Init(id);
   mayAdd_lbaS10_param1 = new LabelArrayStream(_Symbol, (ENUM_TIMEFRAMES)_Period, NULL);
   mayAdd_lbaS10 = new mayAdd_lbaSStream(mayAdd_lbaS10_param1, IndicatorObjPrefix + "_10");
   id = mayAdd_lbaS10.Init(id);
   label__custom_s_i_f12 = new label__custom_s_i_fStream("bear", 2, bin::Getprice(bear), IndicatorObjPrefix + "_12");
   id = label__custom_s_i_f12.Init(id);
   addLabel_lbaS_lbS11_param1 = new LabelArrayStream(_Symbol, (ENUM_TIMEFRAMES)_Period, NULL);
   addLabel_lbaS_lbS11_param2 = new LabelStream(_Symbol, (ENUM_TIMEFRAMES)_Period, NULL);
   addLabel_lbaS_lbS11 = new addLabel_lbaS_lbSStream(addLabel_lbaS_lbS11_param1, addLabel_lbaS_lbS11_param2, IndicatorObjPrefix + "_12");
                ...
                const int &spread[])
{
   ...
   {
      n = ((rates_total - 1) - pos);
      BuyArrowBuffer[pos] = EMPTY_VALUE;
      SellArrowBuffer[pos] = EMPTY_VALUE;
      double atr1Value;
      ...
      double atr = SafeMultiply(Nz(atr1Value, SafeDivide(cum1Value, (n + 1))), mult);
      double highestpivot1Value;
      if (!PivotHighStream::GetValue(pos, highestpivot1Value, _Symbol, (ENUM_TIMEFRAMES)_Period, left, right)) { highestpivot1Value = EMPTY_VALUE; }
      double ph = highestpivot1Value;
      double lowestpivot1Value;
      if (!PivotLowStream::GetValue(pos, lowestpivot1Value, _Symbol, (ENUM_TIMEFRAMES)_Period, left, right)) { lowestpivot1Value = EMPTY_VALUE; }
      ...
      if ((((display == "Bullish") || (display == "Bullish AND Bearish")) || ((display == "Bullish OR Bearish") && (bin::Getstate(bear) == 0))))
      {
         if ((bin::Getstate(bull) == 0))
         {
            if (!((pl) == EMPTY_VALUE))
            {
               bin::Setbx(bull, BoxesCollection::Create(IndicatorObjPrefix + "box_1_id", n - right, SafePlus(pl, atr), n, pl, time[pos])
                  ...
                  .SetExtend("none"));
               bin::Setstate(bull, 1);
               Array::Clear<ICustomTypeArray<Label*>*>(bin::Getlab1(bull));
               Array::Clear<ICustomTypeArray<Label*>*>(bin::Getlab2(bull));
         ...
         else if ((bin::Getstate(bull) == 1))
         {
            ...
            else
            {
               ...
               {
                  // Draw down arrow for bullish breakout
                  SellArrowBuffer[pos] = high[pos] + arrowOffset * Point;
                  string arrowName = IndicatorObjPrefix + "_ArrowDown_" + IntegerToString(pos);
                  if (ObjectFind(0, arrowName) == -1)
                  {
                     ObjectCreate(0, arrowName, OBJ_ARROW, 0, time[pos], high[pos] + arrowOffset * Point);
                     ObjectSetInteger(0, arrowName, OBJPROP_COLOR, arrowDownColor);
                     ObjectSetInteger(0, arrowName, OBJPROP_WIDTH, arrowDownSize);
                     ObjectSetInteger(0, arrowName, OBJPROP_ARROWCODE, arrowDownCode);
               ...
               if (!mayAdd_lbaS1.GetValue(pos, mayAdd_lbaS1Value)) { mayAdd_lbaS1Value = (-1); }
               if (SafeGreater(close[pos], box_bull_top) && SafeLess(open[pos], box_bull_top) && mayAdd_lbaS1Value)
               {
                  Label* label__custom_s_i_f3Value;
                  if (!label__custom_s_i_f3.GetValue(pos, label__custom_s_i_f3Value)) { label__custom_s_i_f3Value = NULL; }
                  ...
                  if (!addLabel_lbaS_lbS2.GetValue(pos, addLabel_lbaS_lbS2Value)) { addLabel_lbaS_lbS2Value = NULL; }
                  LabelsCollection::Delete(addLabel_lbaS_lbS2Value);
               }
            }
         }
         else if ((bin::Getstate(bull) == 2))
         {
            if (SafeGE(SafeMinus(box_bull_right, box_bull_left), maxBars))
            {
            ...
            else
            {
               ...
               {
                  // Draw up arrow for bullish breakout
                  BuyArrowBuffer[pos] = low[pos] - arrowOffset * Point;
                  string arrowName = IndicatorObjPrefix + "_ArrowUp_" + IntegerToString(pos);
                  if (ObjectFind(0, arrowName) == -1)
                  {
                     ObjectCreate(0, arrowName, OBJ_ARROW, 0, time[pos], low[pos] - arrowOffset * Point);
                     ObjectSetInteger(0, arrowName, OBJPROP_COLOR, arrowUpColor);
                     ObjectSetInteger(0, arrowName, OBJPROP_WIDTH, arrowUpSize);
                     ObjectSetInteger(0, arrowName, OBJPROP_ARROWCODE, arrowUpCode);
               ...
               if (!mayAdd_lbaS4.GetValue(pos, mayAdd_lbaS4Value)) { mayAdd_lbaS4Value = (-1); }
               if (SafeLess(close[pos], box_bull_bottom) && SafeGreater(open[pos], box_bull_bottom) && mayAdd_lbaS4Value)
               {
                  ...
                  if (!label__custom_s_i_f6.GetValue(pos, label__custom_s_i_f6Value)) { label__custom_s_i_f6Value = NULL; }
                  ...
                  if (!addLabel_lbaS_lbS5.GetValue(pos, addLabel_lbaS_lbS5Value)) { addLabel_lbaS_lbS5Value = NULL; }
      ...
      if ((((display == "Bearish") || (display == "Bullish AND Bearish")) || ((display == "Bullish OR Bearish") && (bin::Getstate(bull) == 0))))
      {
         if ((bin::Getstate(bear) == 0))
         {
            if (!((ph) == EMPTY_VALUE))
            {
               bin::Setbx(bear, BoxesCollection::Create(IndicatorObjPrefix + "box_3_id", n - right, ph, n, SafeMinus(ph, atr), time[pos])
                  ...
                  .SetExtend("none"));
               bin::Setstate(bear, 1);
               Array::Clear<ICustomTypeArray<Label*>*>(bin::Getlab1(bear));
               Array::Clear<ICustomTypeArray<Label*>*>(bin::Getlab2(bear));
         ...
         else if ((bin::Getstate(bear) == 1))
         {
            ...
            else
            {
               ...
               {
                  // Draw up arrow for bearish breakout
                  BuyArrowBuffer[pos] = low[pos] - arrowOffset * Point;
                  string arrowName = IndicatorObjPrefix + "_ArrowUp_" + IntegerToString(pos);
                  if (ObjectFind(0, arrowName) == -1)
                  {
               ...
               if (!mayAdd_lbaS7.GetValue(pos, mayAdd_lbaS7Value)) { mayAdd_lbaS7Value = (-1); }
               if (SafeLess(close[pos], box_bear_bottom) && SafeGreater(open[pos], box_bear_bottom) && mayAdd_lbaS7Value)
               {
                  ...
                  if (!label__custom_s_i_f9.GetValue(pos, label__custom_s_i_f9Value)) { label__custom_s_i_f9Value = NULL; }
                  ...
                  if (!addLabel_lbaS_lbS8.GetValue(pos, addLabel_lbaS_lbS8Value)) { addLabel_lbaS_lbS8Value = NULL; }
                  LabelsCollection::Delete(addLabel_lbaS_lbS8Value);
               }
            }
         }
         else if ((bin::Getstate(bear) == 2))
         {
            if (SafeGE(SafeMinus(box_bear_right, box_bear_left), maxBars))
            {
            ...
            else
            {
               ...
               {
                  // Draw down arrow for bearish breakout
                  SellArrowBuffer[pos] = high[pos] + arrowOffset * Point;
                  string arrowName = IndicatorObjPrefix + "_ArrowDown_" + IntegerToString(pos);
                  if (ObjectFind(0, arrowName) == -1)
                  {
               ...
               if (!mayAdd_lbaS10.GetValue(pos, mayAdd_lbaS10Value)) { mayAdd_lbaS10Value = (-1); }
               if (SafeGreater(close[pos], box_bear_top) && SafeLess(open[pos], box_bear_top) && mayAdd_lbaS10Value)
               {
                  Label* label__custom_s_i_f12Value;
                  if (!label__custom_s_i_f12.GetValue(pos, label__custom_s_i_f12Value)) { label__custom_s_i_f12Value = NULL; }
                  ...
                  if (!addLabel_lbaS_lbS11.GetValue(pos, addLabel_lbaS_lbS11Value)) { addLabel_lbaS_lbS11Value = NULL; }
