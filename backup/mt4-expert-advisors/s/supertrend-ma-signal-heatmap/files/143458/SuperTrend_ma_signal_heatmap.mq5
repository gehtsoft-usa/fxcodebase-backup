...
void OnInit()
{
   ...
   IndicatorObjPrefix = GenerateIndicatorPrefix("STMASH");
   IndicatorSetString(INDICATOR_SHORTNAME, "STMASH");
   ...
   id = CreateHeatmap(id, index--, "ST", 
      new UpSTAlertCondition(_Symbol, (ENUM_TIMEFRAMES)_Period), 
      new DownSTAlertCondition(_Symbol, (ENUM_TIMEFRAMES)_Period));
   id = CreateHeatmap(id, index--, "MA", 
      new UpMAAlertCondition(_Symbol, (ENUM_TIMEFRAMES)_Period), 
      new DownMAAlertCondition(_Symbol, (ENUM_TIMEFRAMES)_Period));
   id = CreateHeatmap(id, index--, "Direction", 
      new UpDirAlertCondition(_Symbol, (ENUM_TIMEFRAMES)_Period), 
      new DownDirAlertCondition(_Symbol, (ENUM_TIMEFRAMES)_Period));
}
