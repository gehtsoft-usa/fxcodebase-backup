...
//https://fxcodebase.com/code/viewtopic.php?f=38&t=71361
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double macdValue = iMACD(_Symbol, _Period, fast_ema_period, slow_ema_period, signal_period, PRICE_CLOSE, MODE_MAIN, period);
      return macdValue > 0;
   }
};
