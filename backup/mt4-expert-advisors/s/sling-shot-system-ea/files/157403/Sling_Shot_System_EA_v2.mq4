...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=75366
...
input string TclosePositions      = "== Close Positions by Ema Cross =="; // ————————————————————————
...
input const string indicator_file = "Sling_Shot_System";                          // Indicator File:
//---
int  bufferToBuy              = 2;
int  bufferToSell             = 3;
