...
Name:        SupDem_EA_v1.00
Version:     1.00
Date:        2025
Repository:  Available @ https://fxcodebase.com/code/viewtopic.php?f=38&p=161067#p161067
License:     GNU
...
#property strict
#define EANAME "SupDem_EA"
string custom_indicator1 = "SupDem_Zone_button_v4";
...
#define CUSTOM_INDICATOR_PARAMS1 forced_tf, use_narrow_bands, kill_retouch
...
int checkEntry(int bar, string sym)
  {
   double arrUp = iCustom(sym, PERIOD_CURRENT, custom_indicator1, CUSTOM_INDICATOR_PARAMS1, 2, bar);
   double arrDn = iCustom(sym, PERIOD_CURRENT, custom_indicator1, CUSTOM_INDICATOR_PARAMS1, 3, bar);
   if(arrUp != EMPTY_VALUE && arrUp > 0)
      OP(sym, 1);
   if(arrDn != EMPTY_VALUE && arrDn > 0)
      OP(sym, -1);
   return 0;
  }
