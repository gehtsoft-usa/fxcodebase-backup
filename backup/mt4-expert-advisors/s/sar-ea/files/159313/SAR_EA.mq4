//Available @  https://fxcodebase.com/code/viewtopic.php?f=38&p=159259#p159259
...
class ConditionSAR_Buy : public iConditions {
   public:
    bool evaluate() { return sar(0, 1) < iLow(NULL, 0, 1) && sar(0, 2) > iHigh(NULL, 0, 2); }
};
ConditionSAR_Buy cdSAR_Buy;

class ConditionSAR_Sell : public iConditions {
   public:
    bool evaluate() { return sar(0, 1) > iHigh(NULL, 0, 1) && sar(0, 2) < iLow(NULL, 0, 2); }
};
...
BUYcondition1  cdCloseOnOppositeSell;
SELLcondition1 cdCloseOnOppositeBuy;
