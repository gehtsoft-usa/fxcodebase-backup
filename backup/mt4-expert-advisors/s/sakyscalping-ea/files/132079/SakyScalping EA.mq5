...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=69550
...
input int ma_length_1 = 2; // MA Length #1
input ENUM_MA_METHOD ma_method_1 = MODE_SMA; // Smoothing method #1
input int ma_length_2 = 5; // MA Length #2
input ENUM_MA_METHOD ma_method_2 = MODE_SMA; // Smoothing method #2
input int  Tenkan_Sen_Period                = 9; // Tenkan Sen Period
input int  Kijun_Sen_Period                 = 26; // Kijun Sen Period
input int  Senkou_Span_B_Period             = 52; // Senkou Span B Period
...
ICondition* CreateLongCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   condition.Add(new MAMACondition(symbol, timeframe, FirstCrossOverSecond, ma_method_1, ma_length_1, ma_method_2, ma_length_2), false);
   condition.Add(new IchimokuStreamsCondition(symbol, PERIOD_D1, FirstAboveSecond, Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, SENKOUSPANA_LINE, SENKOUSPANB_LINE, -Kijun_Sen_Period, -Kijun_Sen_Period), false);
   condition.Add(new IchimokuStreamsCondition(symbol, PERIOD_H4, FirstAboveSecond, Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, SENKOUSPANA_LINE, SENKOUSPANB_LINE, -Kijun_Sen_Period, -Kijun_Sen_Period), false);
   condition.Add(new IchimokuStreamsCondition(symbol, PERIOD_H1, FirstAboveSecond, Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, SENKOUSPANA_LINE, SENKOUSPANB_LINE, -Kijun_Sen_Period, -Kijun_Sen_Period), false);
   #ifdef ACT_ON_SWITCH_CONDITION
...
ICondition* CreateShortCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(new MAMACondition(symbol, timeframe, FirstCrossUnderSecond, ma_method_1, ma_length_1, ma_method_2, ma_length_2), false);
   condition.Add(new IchimokuStreamsCondition(symbol, PERIOD_D1, FirstBelowSecond, Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, SENKOUSPANA_LINE, SENKOUSPANB_LINE, -Kijun_Sen_Period, -Kijun_Sen_Period), false);
   condition.Add(new IchimokuStreamsCondition(symbol, PERIOD_H4, FirstBelowSecond, Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, SENKOUSPANA_LINE, SENKOUSPANB_LINE, -Kijun_Sen_Period, -Kijun_Sen_Period), false);
   condition.Add(new IchimokuStreamsCondition(symbol, PERIOD_H1, FirstBelowSecond, Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, SENKOUSPANA_LINE, SENKOUSPANB_LINE, -Kijun_Sen_Period, -Kijun_Sen_Period), false);
   #ifdef ACT_ON_SWITCH_CONDITION
      ActOnSwitchCondition* switchCondition = new ActOnSwitchCondition(symbol, timeframe, (ICondition*) condition);
      condition.Release();
      return switchCondition;
