...
ICondition* CreateLongCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   condition.Add(new MACrossOverMACondition(symbol, timeframe, ma_method_1, ma_length_1, ma_method_2, ma_length_2), false);
   condition.Add(new IchimokeStreamAboveIchimokuStreamCondition(symbol, PERIOD_D1, 
      Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, MODE_SENKOUSPANA, MODE_SENKOUSPANB, -Kijun_Sen_Period, -Kijun_Sen_Period), false);
   condition.Add(new IchimokeStreamAboveIchimokuStreamCondition(symbol, PERIOD_H4, 
      Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, MODE_SENKOUSPANA, MODE_SENKOUSPANB, -Kijun_Sen_Period, -Kijun_Sen_Period), false);
   condition.Add(new IchimokeStreamAboveIchimokuStreamCondition(symbol, PERIOD_H1, 
      Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, MODE_SENKOUSPANA, MODE_SENKOUSPANB, -Kijun_Sen_Period, -Kijun_Sen_Period), false);
...
ICondition* CreateShortCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(new MACrossUnderMACondition(symbol, timeframe, ma_method_1, ma_length_1, ma_method_2, ma_length_2), false);
   condition.Add(new IchimokeStreamAboveIchimokuStreamCondition(symbol, PERIOD_D1, 
      Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, MODE_SENKOUSPANB, MODE_SENKOUSPANA, -Kijun_Sen_Period, -Kijun_Sen_Period), false);
   condition.Add(new IchimokeStreamAboveIchimokuStreamCondition(symbol, PERIOD_H4, 
      Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, MODE_SENKOUSPANB, MODE_SENKOUSPANA, -Kijun_Sen_Period, -Kijun_Sen_Period), false);
   condition.Add(new IchimokeStreamAboveIchimokuStreamCondition(symbol, PERIOD_H1, 
      Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, MODE_SENKOUSPANB, MODE_SENKOUSPANA, -Kijun_Sen_Period, -Kijun_Sen_Period), false);
