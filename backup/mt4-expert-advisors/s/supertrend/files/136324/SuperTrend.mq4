...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=69405
...
public:
   ...
   {
      return DN[period] == EMPTY_VALUE && DN[period + 1] != EMPTY_VALUE;
   }
};
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      return DN[period + 1] == EMPTY_VALUE && DN[period] != EMPTY_VALUE;
   }
};
...
int init()
{
   ...
   IndicatorObjPrefix = GenerateIndicatorPrefix("st");
...
int start()
{
  int counted_bars = IndicatorCounted();
   ...
   {
      double CCI = iCCI(NULL, 0, Length, PRICE_TYPICAL, pos);
      UP[pos] = UP[pos + 1];
      Flag[pos] = Flag[pos + 1];
