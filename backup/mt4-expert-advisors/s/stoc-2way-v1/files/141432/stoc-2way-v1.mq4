...
//https://fxcodebase.com/code/viewtopic.php?f=38&t=71070
...
input int stoch_os = 20; // Stoch OS
input int stoch_ob = 80; // Stoch OB
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double main = iStochastic(_symbol, _timeframe, K_periods, D_periods, Slowing, MODE_SMA, 0, MODE_MAIN, period);
      double signal = iStochastic(_symbol, _timeframe, K_periods, D_periods, Slowing, MODE_SMA, 0, MODE_SIGNAL, period);
      return main > signal && main < stoch_os;
   }
};
