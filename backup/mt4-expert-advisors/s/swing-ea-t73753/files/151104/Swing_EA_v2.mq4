...
string file_custom_indicator = "Swing_Indicator";
...
enum ModeEntry { Market,
                 ...
                 PendingLimit };
// ——————————————————————————————————————————————————————————————————
input string Tindi = "== Swing Indicator Setup ==";    // ————————————
...
class BUYcondition1 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    if (iCustom(NULL, 0, file_custom_indicator, Tindi, range, shift, 0, shift+1) != EMPTY_VALUE)return true;
 ...
 public:
  bool evaluate()
  {
    // TODO: condition sell 1
      if (iCustom(NULL, 0, file_custom_indicator, Tindi, range, shift, 1, shift+1) != EMPTY_VALUE)return true;
