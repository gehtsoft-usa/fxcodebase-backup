...
// https://fxcodebase.com/code/viewtopic.php?f=38&p=159116#p159116
...
string file_custom_indicator = "slope-direction-line-indicator+alert";
...
class FinderPattern
{
  ...
  public:
    ...
    bool havePatternUp(int i, ENUM_TIMEFRAMES tf)
    {
        ...
        double up = iCustom(_symbol,tf, file_custom_indicator, 
                                    periode,
                                    method,
                                    price,
                                    renko,
        ...
        return up >0 && up != EMPTY_VALUE;
    }

    bool havePatternDn(int i, ENUM_TIMEFRAMES tf)
    {
        // TODO: escribir el patrón bajista
double dn = iCustom(_symbol,tf, file_custom_indicator, 
                                    periode,
                                    method,
                                    price,
                                    renko,
