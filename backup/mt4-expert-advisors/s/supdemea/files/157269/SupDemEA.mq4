...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=75359
...
input const string indicator_file = "supdem";                          // Indicator File:
//---
int  bufferToBuy              = 0;
int  bufferToSell             = 1;
...
class ConditionIndicatorBuy : public iConditions
{
  ...
  public:
    bool evaluate()
    {
       ...
       double DnPrDn = ObjectGet("loboxdnl", OBJPROP_PRICE1);
       if(lo < DnPrDn && Ask > DnPrDn) return true;
...
class ConditionIndicatorSell : public iConditions
{
  ...
  public:
    bool evaluate()
    {
       ...
       double UpPrUP = ObjectGet("upboxdnl", OBJPROP_PRICE1);
       if(hi > UpPrUP && Bid < UpPrUP) return true;
