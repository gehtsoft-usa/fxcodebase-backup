...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=74762
...
string file_custom_indicator = "trexper";
int    bufferToBuy           = 104;
...
class BUYcondition1 : public iConditions
{
  public:
    bool evaluate()
    {
        ...
        double indi0 =  Indi(bufferToBuy, 1);
        double indi1 =  Indi(bufferToBuy, 2);
        Print(__FUNCTION__," indi0: ",indi0);
        Print(__FUNCTION__," indi1: ",indi1);
        return indi0 == 1 && indi1 == -1;
