...
void EntryOrders()
{
 ...
 if (i>2)
 {
  res=OrderSend(Symbol(),OP_BUYLIMIT,Lots,MinPrice,5,0,MaxPrice,"",MAGICMA,0,Blue);
  res=OrderSend(Symbol(),OP_SELLLIMIT,Lots,MaxPrice,5,0,MinPrice,"",MAGICMA,0,Blue);
 } 
}
