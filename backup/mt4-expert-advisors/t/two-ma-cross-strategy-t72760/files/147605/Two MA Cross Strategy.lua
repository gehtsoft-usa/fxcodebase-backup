...
-- https://fxcodebase.com/code/viewtopic.php?f=38&t=72760
...
function Init() --The strategy profile initialization
    ...
    strategy.parameters:addInteger("Period2", "Period", "", 88); 
...
function CreateTradingParameters()
   ...
   -- strategy.parameters:addStringAlternative("ExitExecutionType", "End of Turn", "", "EndOfTurn");
    ...
    strategy.parameters:addString("CustomID", "Custom Identifier", "The identifier that can be used to distinguish strategy instances", "TMACC");
...
function Prepare( nameOnly)
    ...
    Indicator1 = core.indicators:create(instance.parameters.Method1, Source[instance.parameters.Price1], instance.parameters.Period1 );
    Indicator2 = core.indicators:create(instance.parameters.Method1, Source[instance.parameters.Price2], instance.parameters.Period2);
