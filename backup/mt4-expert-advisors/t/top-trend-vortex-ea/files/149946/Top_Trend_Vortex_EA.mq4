...
input ModeLevels   modeTP         = TP_ByRatioRR;            // Mode Take Profit:
...
input ModeLevelsSL modeSL         = byATR;             // Mode Stop Loss:
input double       atr_m          = 3;                 // ATR multiplier
...
int OnInit()
{
  ...
  //--- buys:
  if (indi_vol_on) conditionsToBuy.AddCondition(buyCondition1 = new BUYcondition1());
  if (indi_trend_on) conditionsToBuy.AddCondition(buyCondition2 = new BUYcondition2());
  if (vortex_on) conditionsToBuy.AddCondition(buyCondition3 = new BUYcondition3());
  ...
  //--- sell:
  if (indi_vol_on) conditionsToSell.AddCondition(sellCondition1 = new SELLcondition1());
  if (indi_trend_on) conditionsToSell.AddCondition(sellCondition2 = new SELLcondition2());
  if (vortex_on) conditionsToSell.AddCondition(sellCondition3 = new SELLcondition3());
