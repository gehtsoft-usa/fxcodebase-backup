...
bool   closeByCandleOn         = false;                   // Close by candles on:
int    candlestoclose          = 5;                       // Candles to close:
bool   closeByDesviationOn     = false;                   // Close by desviation threshold on:
double qDesviations            = 2.0;                     // St. Desviations:
bool   closeByEMAOn            = true;                    // Close by ema on:
