//Available @  https://fxcodebase.com/code/viewtopic.php?f=38&t=75160
...
extern string mySigalname    = "... your signal name";
...
//|                                                                  |
//+------------------------------------------------------------------+
void OnDeinit(const int reason) { StopTelegramServer(); }
bool copmod = false;
//+------------------------------------------------------------------+
