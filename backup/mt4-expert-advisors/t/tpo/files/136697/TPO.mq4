...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70272
...
// ��������� ��������
input int RangePeriod = PERIOD_D1; // �� ���������, ������ ���� ����� �� �����������
input int RangeCount = 20;         // ���������� ����������/����������

//tf#input string TimeFrom = "00:00";			// ������ ��������� (������ �����)
//tf#input string TimeTo = "00:00";			// ����� ��������� (������ �����) + 1 ������

input int ModeStep = 10;  // ��� ������ ���, ���������� � 2 ���� ������ + 1
int Smooth = 0;           // ������� �����������, ����������� �������� ����������������� ���������� ����� ��������� ����� ���
input int PriceStep = 0;  // ��� ����, 0 - ���� (��. #1)
input int DataPeriod = 1; // ������ ��� ������, ������� - ����� ������
bool ShowHorizon = true;  // �������� �������� ������

// �����������
input color HGColor = C'160,192,224'; // ���� �����������
input int HGStyle = 1;                 // ����� �����������: 0 - �����, 1 - ������ ��������������, 2 - ����������� ��������������
input color ModeColor = Blue;          // ���� ���
input color MaxModeColor = CLR_NONE;   // �������� ��������
...
int start()
{
   ...
   lastOK = true;
   for (int i = 1; i < RangeCount; i++) //1 - ShowLast
   {
