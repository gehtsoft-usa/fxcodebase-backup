...
int init()
{
   ...
   SetIndexStyle(id++, DRAW_ARROW, STYLE_SOLID, 1, AddTransparency(0x758a28, 25));
   SetIndexBuffer(id, plot2);
   SetIndexArrow(id, 161);
   SetIndexStyle(id++, DRAW_ARROW, STYLE_SOLID, 1, AddTransparency(0x3C14DC, 32));
   ...
   id = plot3.RegisterArrowStream(id, INT_MIN, 161);
   ...
   id = plot6.RegisterArrowStream(id, INT_MIN, 253);
   plot9 = new ColoredStream(_Symbol, (ENUM_TIMEFRAMES)_Period);
   id = plot9.RegisterArrowStream(id, INT_MIN, 161);
   ...
   id = plot12.RegisterArrowStream(id, INT_MIN, 161);
   ...
   id = plot15.RegisterArrowStream(id, INT_MIN, 161);
   ...
   id = plot18.RegisterStream(id, INT_MIN);
   id = plot18.RegisterStream(id, AddTransparency(Green, 15));
   id = plot18.RegisterStream(id, AddTransparency(Red, 20));
   plot21 = new ColoredStream(_Symbol, (ENUM_TIMEFRAMES)_Period);
   id = plot21.RegisterStream(id, INT_MIN);
   id = plot21.RegisterStream(id, AddTransparency(Green, 15));
   id = plot21.RegisterStream(id, AddTransparency(Red, 20));
   plot24 = new ColoredStream(_Symbol, (ENUM_TIMEFRAMES)_Period);
   id = plot24.RegisterStream(id, INT_MIN);
   id = plot24.RegisterStream(id, AddTransparency(Green, 15));
   id = plot24.RegisterStream(id, AddTransparency(Red, 20));
   plot27 = new ColoredStream(_Symbol, (ENUM_TIMEFRAMES)_Period);
   id = plot27.RegisterStream(id, INT_MIN);
   id = plot27.RegisterStream(id, AddTransparency(Green, 15));
   id = plot27.RegisterStream(id, AddTransparency(Red, 20));
   SetIndexBuffer(id, plot30);
   SetIndexStyle(id++, DRAW_LINE, STYLE_SOLID, 1, AddTransparency(White, 100));
                ...
                const int &spread[])
{
   ...
   for (int pos = MathMin(bars_limit, rates_total - 1 - MathMax(prev_calculated - 1, toSkip)); pos >= 0 && !IsStopped(); --pos)
   {
      ...
      if ((MA1_Type == "SMA"))
      {
         ...
         SetStream(MA1, pos, sma2Value, MA1_DEFAULT_VALUE);
      }
      else
      {
         ...
         SetStream(MA1, pos, ema4Value, MA1_DEFAULT_VALUE);
      }
      if ((MA2_Type == "SMA"))
      {
         ...
         SetStream(MA2, pos, sma3Value, MA2_DEFAULT_VALUE);
      }
      else
      {
         ...
         SetStream(MA2, pos, ema5Value, MA2_DEFAULT_VALUE);
      }
      if ((MA3_Type == "SMA"))
      {
         ...
         SetStream(MA3, pos, sma4Value, MA3_DEFAULT_VALUE);
      }
      else
      {
         ...
         SetStream(MA3, pos, ema6Value, MA3_DEFAULT_VALUE);
      }
      if ((MA4_Type == "SMA"))
      {
         ...
         SetStream(MA4, pos, sma5Value, MA4_DEFAULT_VALUE);
      }
      else
      {
         ...
         SetStream(MA4, pos, ema7Value, MA4_DEFAULT_VALUE);
      }
      ...
      SetStream(TopDogDad, pos, ema16Value, TopDogDad_DEFAULT_VALUE);
      if (pos + 1 > (rates_total - 1)) { continue; }
      ...
      color plot1_color = AddTransparency(0x758a28, 25);
      ...
      color plot2_color = AddTransparency(0x3C14DC, 32);
      ...
      double plot3Value = plot3.SetByColor((TMSetups ? 134.5 : EMPTY_VALUE), pos, MSBar2Color);
      double plot6Value = plot6.SetByColor((TMSetupsANDWT && (((PositiveWaveTrendCross && NumberToBool(TrendBars3Positive[pos])) || (NegativeWaveTrendCross && NumberToBool(TrendBars3Negative[pos])))) ? 134.5 : EMPTY_VALUE), pos, MSBar2Color);
      double plot9Value = plot9.SetByColor(128.5, pos, TrendBar1Color);
      double plot12Value = plot12.SetByColor(122.5, pos, TrendBar2Color);
      double plot15Value = plot15.SetByColor(116.5, pos, TrendBar3Color);
      double plot18Value = plot18.SetByColor((ShowTrendBar1 && ShowTrendBar2 ? 110 : EMPTY_VALUE), pos, TrendBar4Color1);
      double plot21Value = plot21.SetByColor((ShowTrendBar1 && !ShowTrendBar2 ? 110 : EMPTY_VALUE), pos, TrendBar4Color1);
      double plot24Value = plot24.SetByColor((ShowTrendBar2 && ShowTrendBar1 ? 104.5 : EMPTY_VALUE), pos, TrendBar5Color1);
      double plot27Value = plot27.SetByColor((ShowTrendBar2 && !ShowTrendBar1 ? 110 : EMPTY_VALUE), pos, TrendBar5Color1);
      ...
      int MaxValueMACrossUp = crossover1Value;
      ...
      int MaxValueMACrossDown = crossunder1Value;
      ...
      int TB1MACrossUp = crossover2Value;
      ...
      int TB1MACrossDown = crossunder2Value;
      ...
      int TB2MACrossUp = crossover3Value;
      ...
      int TB2MACrossDown = crossunder3Value;
