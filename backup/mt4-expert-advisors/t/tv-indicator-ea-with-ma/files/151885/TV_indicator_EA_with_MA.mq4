...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=73991
...
class BUYcondition1 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    return iCustom(NULL, 0, file_custom_indicator, m, atrPeriods, h, 0, 1)!=EMPTY_VALUE;
  }
};
...
class BUYcondition2 : public iConditions
{
 public:
  bool evaluate()
  {
      ...
      if(iClose(NULL, 0, 1) > iMA(NULL, 0, maPeriod, maShift, maMethod, maAppliedPrice, 1))
      {
        return true;
      }
 ...
 public:
  bool evaluate()
  {
    // TODO: condition sell 1
		 return iCustom(NULL, 0, file_custom_indicator, m, atrPeriods, h, 1, 1)!=EMPTY_VALUE;
  }
};
...
int OnInit()
{
  ...
  if(maFilterOn) conditionsToBuy.AddCondition(buyCondition2 = new BUYcondition2());
  ...
  if(maFilterOn) conditionsToSell.AddCondition(sellCondition2 = new SELLcondition2());
...
double Lots()
{
  ...
  if(MartingaleON && martingale.Lot()>0)
  {
    lots = martingale.Lot();
  }
