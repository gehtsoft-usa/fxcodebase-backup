...
ICondition* CreateLongCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   condition.Add(new MAAboveMACondition(symbol, timeframe, method1, period1, timeframe, method2, period2), false);
...
ICondition* CreateLongFilterCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(new PriceAboveKumhoCondition(symbol, tf1, tenkan_sen, kijun_sen, senkoi_span_b), false);
   condition.Add(new PriceAboveKumhoCondition(symbol, tf2, tenkan_sen, kijun_sen, senkoi_span_b), false);
   condition.Add(new PriceAboveKumhoCondition(symbol, tf3, tenkan_sen, kijun_sen, senkoi_span_b), false);
   return condition;
}
...
ICondition* CreateShortCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(new MABelowMACondition(symbol, timeframe, method1, period1, timeframe, method2, period2), false);
   #ifdef ACT_ON_SWITCH_CONDITION
      ActOnSwitchCondition* switchCondition = new ActOnSwitchCondition(symbol, timeframe, (ICondition*) condition);
      condition.Release();
      return switchCondition;
...
ICondition* CreateShortFilterCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(new PriceBelowKumhoCondition(symbol, tf1, tenkan_sen, kijun_sen, senkoi_span_b), false);
   condition.Add(new PriceBelowKumhoCondition(symbol, tf2, tenkan_sen, kijun_sen, senkoi_span_b), false);
   condition.Add(new PriceBelowKumhoCondition(symbol, tf3, tenkan_sen, kijun_sen, senkoi_span_b), false);
   return condition;
}
