...
input int keh = 12; // Double HullMA
...
#include <conditions/ich_Conditions.mq4>


class Long1Condition : public ACondition
{
public:
   Long1Condition(const string symbol, ENUM_TIMEFRAMES timeframe)
   ...
   {
      double n1 = iCustom(_symbol, _timeframe, "HMA", keh, 0, period);
      double n2 = iCustom(_symbol, _timeframe, "HMA", keh, 1, period);
      return n1 > n2;
   }
};

class Short1Condition : public ACondition
{
public:
   Short1Condition(const string symbol, ENUM_TIMEFRAMES timeframe)
      :ACondition(symbol, timeframe)
   {
...
public:
   ...
   {
      double n2 = iCustom(_symbol, _timeframe, "HMA", keh, 1, period);
      return iClose(_symbol, _timeframe, period) > n2;
   }
};
...
ICondition* CreateLongCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   condition.Add(new Lond1Condition(symbol, timeframe), false);
   condition.Add(new Lond2Condition(symbol, timeframe), false);
   condition.Add(new PriceAboveKumhoCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, -kijun_sen), false);
   condition.Add(new PriceAboveIchimokuStreamCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, MODE_CHIKOUSPAN, kijun_sen), false);
   
   OrCondition* or = new OrCondition();
   or.Add(new IchimokeStreamAboveOrEqualIchimokuStreamCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, 
      MODE_TENKANSEN, MODE_KIJUNSEN), false);
   or.Add(new PriceAboveIchimokuStreamCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, MODE_KIJUNSEN), false);
...
ICondition* CreateShortCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(new Short1Condition(symbol, timeframe), false);
   condition.Add(new Short2Condition(symbol, timeframe), false);
   condition.Add(new PriceBelowKumhoCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, -kijun_sen), false);
   condition.Add(new PriceBelowIchimokuStreamCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, MODE_CHIKOUSPAN, kijun_sen), false);
   
   OrCondition* or = new OrCondition();
   or.Add(new IchimokeStreamBelowOrEqualIchimokuStreamCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, 
      MODE_TENKANSEN, MODE_KIJUNSEN), false);
   or.Add(new PriceBelowIchimokuStreamCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, MODE_KIJUNSEN), false);
   condition.Add(or, false);
...
ICondition* CreateExitLongCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   OrCondition* or = new OrCondition();
   or.Add(new Short2Condition(symbol, timeframe), false);
   or.Add(new IchimokeStreamBelowOrEqualIchimokuStreamCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, 
      MODE_TENKANSEN, MODE_KIJUNSEN), false);
   or.Add(new PriceBelowIchimokuStreamCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, MODE_KIJUNSEN), false);
   or.Add(new PriceBelowIchimokuStreamCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, MODE_TENKANSEN), false);
   or.Add(new PriceBelowIchimokuStreamCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, MODE_CHIKOUSPAN, kijun_sen), false);
   or.Add(new ExitLongCondition(symbol, timeframe), false);
   condition.Add(or, false);
...
{
   AndCondition* condition = new AndCondition();
   condition.Add(new Long1Condition(symbol, timeframe), false);

   OrCondition* or = new OrCondition();
   or.Add(new Long2Condition(symbol, timeframe), false);
   or.Add(new IchimokeStreamAboveOrEqualIchimokuStreamCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, 
      MODE_TENKANSEN, MODE_KIJUNSEN), false);
   or.Add(new PriceAboveIchimokuStreamCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, MODE_KIJUNSEN), false);
   or.Add(new PriceAboveIchimokuStreamCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, MODE_TENKANSEN), false);
   or.Add(new PriceAboveIchimokuStreamCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, MODE_CHIKOUSPAN, kijun_sen), false);
   or.Add(new ExitShortCondition(symbol, timeframe), false);
   condition.Add(or, false);
