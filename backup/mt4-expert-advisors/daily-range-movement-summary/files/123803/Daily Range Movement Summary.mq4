...
extern int Text_Size = 20; // Text_Size
...
int init()
{
   ...
   dm = new MoveStream(_Symbol, (ENUM_TIMEFRAMES)_Period, PERIOD_D1);
...
int start()
{
   ...
   string adrText = "ADR: " + DoubleToStr(adrValue / instr.GetPipSize(), 1) + " (" + IntegerToString((int)adrPr) + "%)";
   ...
   ObjectSetInteger(0, adrLabel, OBJPROP_FONTSIZE, Text_Size); 
   ...
   string admText = "ADM: " + DoubleToStr(admValue / instr.GetPipSize(), 1) + " (" + IntegerToString((int)admPr) + "%)";
   ...
   ObjectSetInteger(0, admLabel, OBJPROP_FONTSIZE, Text_Size); 
   ObjectSetInteger(0, admLabel, OBJPROP_COLOR, labelColor);

   ObjectSetInteger(0, adrLabel, OBJPROP_XDISTANCE, x_shift);
   ObjectSetInteger(0, adrLabel, OBJPROP_YDISTANCE, y_shift+Text_Size);
   ObjectSetInteger(0, admLabel, OBJPROP_XDISTANCE, x_shift);
   ObjectSetInteger(0, admLabel, OBJPROP_YDISTANCE, y_shift+Text_Size + Text_Size*2);
