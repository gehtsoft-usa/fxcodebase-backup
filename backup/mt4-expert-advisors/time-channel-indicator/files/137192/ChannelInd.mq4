...
public:
   ...
   {
      datetime EndTime = StrToTime(TimeToStr(date, TIME_DATE) + " " + DoubleToStr(EndHour, 0) + ":00");
      datetime AlertEndTime = StrToTime(TimeToStr(date, TIME_DATE) + " " + DoubleToStr(AlertEndHour, 0) + ":00");
