//Available @  https://fxcodebase.com/code/viewtopic.php?f=38&t=75033
...
double ArrowUp[];
double ArrowDn[];
extern int CandlesBack = 10; // Look Candles Back:
...
int start()
  {
   ...
   if(nb)
      ...
      limit = 3;
   for(int Li_4 = 0 ; Li_4 < limit; Li_4++)
     {
      if(Li_4 >= Bars - CandlesBack - 1)
         continue;
      Li_8 = Li_4;
      Ld_132 = 0;
      Ld_140 = 0;
      for(Li_8 = Li_4; Li_8 <= Li_4 + CandlesBack; Li_8++)
        {
      ...
      if(Gi_132 == TRUE && Gi_136 == TRUE && Gi_144 == TRUE && Gi_140 == TRUE && Gi_148 == TRUE && Gi_172 != 1)
        {
         ArrowUp[Li_4] = Low[Li_4] - (Point * Utstup); //1.3 * Ld_132;
