...
string file_custom_indicator = "Squeeze_Momentum.ex4";
...
// NOTE: indi inputs
// ——————————————————————————————————————————————————————————————————
input string T_           = "== Squeeze Momentum Setup ==";  // ————————————
...
input ModeLevelsTP modeTP         = midleBB;            // Mode Take Profit:
 ...
 public:
  bool evaluate()
  {
    // TODO: condition Buy 1
		int sqon = iCustom(Symbol(), PERIOD_CURRENT, file_custom_indicator, length, mult, lengthKC, multKC, useTrueRange, 10, 1);
		Print(__FUNCTION__," sqon: ",sqon);

    if(sqon == 1)return true;
 ...
 public:
  bool evaluate()
  {
    // TODO: condition Buy 2
		double bb1_prev = iBands(NULL, 0, bb1_period, bb1_deviation, bb1_bands_shift, bb1_AppliedPrice, 2, 0);    
 ...
 public:
  bool evaluate()
  {
    // TODO: condition sell 2
		double bb1_prev = iBands(NULL, 0, bb1_period, bb1_deviation, bb1_bands_shift, bb1_AppliedPrice, 1, 0);    
    return Bid > bb1_prev;
  ...
  if (takeProfitOn)
    switch (modeTP)
    {
      ...
      case midleBB:
        ...
        break;
      case oppositeBB:
			if(side=="buy") result = iBands(NULL, 0, bb1_period, bb1_deviation, bb1_bands_shift, bb1_AppliedPrice, 1, 0);    
			if(side=="sell") result = iBands(NULL, 0, bb1_period, bb1_deviation, bb1_bands_shift, bb1_AppliedPrice, 2, 0);    
        break;
