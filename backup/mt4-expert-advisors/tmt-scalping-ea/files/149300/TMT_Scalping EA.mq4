...
input double             rsiLevelUp           = 50;                                 // RSI Level Over Bougth
input double             rsiLevelDn           = 50;                                 // RSI Level Over Sold
int                      rsiCandlesDivergence = 50;                                 // RSI Candles Divergences
input string             Imfi                 = "== MFI Setup ==";                  // == MFI Setup ==
input int                mfiPeriod            = 14;                                 // Period
input double             mfiLevelUp           = 50;                                 // MFI Level Over Bougth
input double             mfiLevelDn           = 50;                                 // MFI Level Over Sold
...
class BUYcondition3 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    return iMFI(NULL, 0, mfiPeriod, 1) > mfiLevelUp;
  }
};
...
class SELLcondition3 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    return iMFI(NULL, 0, mfiPeriod, 1) < mfiLevelDn;
  }
};
