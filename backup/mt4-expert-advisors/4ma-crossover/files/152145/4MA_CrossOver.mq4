...
input string TEMA1 = "== Moving Average 1 ==";  // ————————————
...
input string TEMA2 = "== Moving Average 2 ==";  // ————————————
...
input string TEMA3 = "== Moving Average 3 ==";  // ————————————
...
input string TEMA4 = "== Moving Average 4 ==";  // ————————————
...
int OnInit()
{
    ...
    ma1 = new MovingAverage(NULL, 0, ma1_Period, ma1_Shift, ma1_Method, ma1_AppliedPrice);
    ma2 = new MovingAverage(NULL, 0, ma2_Period, ma2_Shift, ma2_Method, ma2_AppliedPrice);
    ma3 = new MovingAverage(NULL, 0, ma3_Period, ma3_Shift, ma3_Method, ma3_AppliedPrice);
    ma4 = new MovingAverage(NULL, 0, ma4_Period, ma4_Shift, ma4_Method, ma4_AppliedPrice);
...
{
    // TODO: signal up
    // Buy := ma1 > ma4, and ma2 > ma4, and ma3 > ma4
...
{
    // TODO: signal down
    // Sell := ma1 < ma4, and ma2 < ma4, and ma3 < ma4
    return  ma1.index(i) < ma4.index(i) && ma2.index(i) < ma4.index(i) && ma3.index(i) < ma4.index(i) && ma3.index(i+1) > ma4.index(i+1);
