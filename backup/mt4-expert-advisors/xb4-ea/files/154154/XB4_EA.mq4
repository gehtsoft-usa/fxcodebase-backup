...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=74557
...
string file_custom_indicator = "Xb4d";
int    bufferToBuy           = 0;
int    bufferToSell          = 0;

input string          Tindi        = "== Indicator Current TF Setup =="; // ————————————
int                   indi1_period = 27;                                 // Period:
input string          Tindi2       = "== Indicator Other TF Setup ==";   // ————————————
input ENUM_TIMEFRAMES indi2_TF     = PERIOD_H4;                          // TimeFrame:
int                   indi2_period = 27;                                 // Period:

double Indi1(int buffer, int candle)
{
    return iCustom(NULL, 0, file_custom_indicator, indi1_period, buffer, candle);
}
double Indi2(int buffer, int candle)
{
    return iCustom(NULL, indi2_TF, file_custom_indicator, indi2_period, buffer, candle);
}
#endif
...
class BUYcondition1 : public iConditions
{
  public:
    bool evaluate()
    {
        ...
        return Indi1(bufferToBuy, 1) > 0 && Indi2(bufferToBuy, 1) > 0;
    }
};
