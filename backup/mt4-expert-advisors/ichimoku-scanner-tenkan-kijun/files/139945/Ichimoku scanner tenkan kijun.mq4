...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70773
...
public:
   ...
   {
		double tenkan = iIchimoku(_symbol, _timeframe, tenkan_sen, kijun_sen, senkou_span_b, MODE_TENKANSEN, period);
		double kijun = iIchimoku(_symbol, _timeframe, tenkan_sen, kijun_sen, senkou_span_b, MODE_KIJUNSEN, period);
      ...
      return MathAbs(tenkan - kijun) < MathAbs(a - b);
   }
};
