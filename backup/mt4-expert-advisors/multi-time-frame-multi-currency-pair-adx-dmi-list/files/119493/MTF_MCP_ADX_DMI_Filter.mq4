...
string   WindowName = "MTF_MCP_ADX_DMI_Filter";
...
public:
    ...
    virtual void Draw()
    {
        ...
        ObjectMakeLabel(_id, _x, _y, GetDirectionSymbol(direction), GetDirectionColor(direction, confirmed), 1, WindowNumber, "Arial", 10);
    }
