...
private:
    void SendNotifications(const int direction)
    {
        ...
        string alert_Subject = "WDMI on " + _symbol;
        string alert_Body = "WDMI on " + _symbol + (direction == 1 ? " All TFs in Sync for the Up" : " All TFs in Sync for the Down");
...
public:
    ...
    virtual int Draw()
    {
        ...
        ObjectMakeLabel(_id, _x, _y, GetDirectionSymbol(direction), GetDirectionColor(direction), 1, WindowNumber, "Wingdings", 10);
        return direction;
    }
