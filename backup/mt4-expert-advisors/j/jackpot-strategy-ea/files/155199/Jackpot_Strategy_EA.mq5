...
string Tindicator = "== Indicator Setup ==";  // ————————————

string file_custom_indicator = "JackPot_Strategy_Elite";
int    handle                = 0;
int bBuy  = 0;
int bSell = 1;
...
double jackpot(int buffer, int shift)
{
  double value[1];
...
class BUYcondition1 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    return (jackpot(bBuy, 1) >0 && jackpot(bBuy, 1)!= EMPTY_VALUE);
...
class SELLcondition1 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    return (jackpot(bSell, 1) >0 && jackpot(bSell, 1)!= EMPTY_VALUE);    
    // return iOpen(NULL, 0, 1) > iClose(NULL, 0, 1);
    // return false;
  }
};
