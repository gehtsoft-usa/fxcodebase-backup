...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70001
...
ICondition* CreateLongCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   condition.Add(new PriceAboveIchimokuStreamCondition(symbol, timeframe, Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, MODE_KIJUNSEN), false);
...
ICondition* CreateShortCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   condition.Add(new PriceBelowIchimokuStreamCondition(symbol, timeframe, Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, MODE_KIJUNSEN), false);
   #ifdef ACT_ON_SWITCH_CONDITION
      ActOnSwitchCondition* switchCondition = new ActOnSwitchCondition(symbol, timeframe, (ICondition*) condition);
      condition.Release();
      return switchCondition;
