...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=75412
...
input const string indicator_file = "Damjan";                          // Indicator File:
//---
int  bufferToBuy              = 0;
int  bufferToSell             = 0;
bool indicator_init           = true;
int  candles_back_for_signals = 3;
//---
int  handle = 0;
  ...
  public:
    bool evaluate()
    {
        for (int i = 1; i <= candles_back_for_signals; i++) {
            ...
            if (indi > 0 && indi_prev < 0 && indi != EMPTY_VALUE && indi != lastSignal) {
                // lastSignal = indi;
                return true;
            }
        }
