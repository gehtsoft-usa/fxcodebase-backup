...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=73477
...
string file_custom_indicator = "HalfTrend.ex4";
...
input int    _amplitud              = 2;
input int    _channelDeviation      = 2;
...
class BUYcondition1 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    // double indi = iCustom(NULL, 0, file_custom_indicator, _amplitud, _channelDeviation, 0, 1);
    double indi = iCustom(NULL, 0, file_custom_indicator, _amplitud, _channelDeviation, 0, 1);
...
class SELLcondition1 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    double indi = iCustom(NULL, 0, file_custom_indicator, _amplitud, _channelDeviation, 1, 1);
    return indi != EMPTY_VALUE;
  }
};
...
int OnInit()
{
  ...
  {
    Alert("Please, install: " + file_custom_indicator + " , in folder MQL4/Indicators");
    return INIT_FAILED;
  }
#endif
...
double Lots()
{
  lotProvider = new LotCalculator();
	...
	double lots = -1;	
	if(MartingaleON==true && martingale.count()>0)
  {
    lots = martingale.Lot();
  }
