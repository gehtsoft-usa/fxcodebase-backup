...
// ------------------------------------------------------------------
string file_custom_indicator = "^Pivot_AllLevels.ex4";
...
input bool closeWhenNewDayOn= true; // Close all at the end of the day:
...
class BUYcondition2 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    // if(Ask > sop1 && Bid < sop1) return true;
...
class SELLcondition2 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    if(Ask > res1 && Bid < res1) return true;
