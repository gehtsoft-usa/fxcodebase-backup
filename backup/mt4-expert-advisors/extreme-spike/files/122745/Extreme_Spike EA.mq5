...
// http://fxcodebase.com/code/viewtopic.php?f=38&p=135641 
...
public:
   ...
   {
      _lastSignal = 0;
      _indi = iCustom(symbol, timeframe, "Extreme_Spike", MinorMinExtremeHeightATRs, MajorToMinorHeightRatio, MinorMinExtremeWidth, MajorMinExtremeWidth);
   }
   ...
   {
      double buffer[1000];
      int items = CopyBuffer(_indi, 4, period, max_lookback, buffer);
