...
#define WITH_EXIT_LOGIC
   ...
   string EA_NAME = "[EMA + Ichimoku Kinko Hyo Strategy]";
#endif
...
ICondition* CreateLongCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   condition.Add(new IchimokeStreamAboveOrEqualIchimokuStreamCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, 
      MODE_TENKANSEN, MODE_KIJUNSEN), false);
   condition.Add(new IchimokeStreamAboveOrEqualIchimokuStreamCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, 
      MODE_SENKOUSPANA, MODE_SENKOUSPANB), false);
   condition.Add(new MAAboveMACondition(symbol, timeframe, MODE_EMA, 13, timeframe, MODE_EMA, 21), false);
...
ICondition* CreateShortCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   condition.Add(new IchimokeStreamBelowOrEqualIchimokuStreamCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, 
      MODE_TENKANSEN, MODE_KIJUNSEN), false);
   condition.Add(new IchimokeStreamBelowOrEqualIchimokuStreamCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, 
      MODE_SENKOUSPANA, MODE_SENKOUSPANB), false);
   condition.Add(new MABelowMACondition(symbol, timeframe, MODE_EMA, 13, timeframe, MODE_EMA, 21), false);
   #ifdef ACT_ON_SWITCH_CONDITION
      ActOnSwitchCondition* switchCondition = new ActOnSwitchCondition(symbol, timeframe, (ICondition*) condition);
      condition.Release();
      return switchCondition;
...
{
   AndCondition* condition = new AndCondition();
   condition.Add(new PriceBelowIchimokuStreamCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, MODE_KIJUNSEN), false);
   condition.Add(new MABelowMACondition(symbol, timeframe, MODE_EMA, 13, timeframe, MODE_EMA, 21), false);
   condition.Add(new PriceBelowKumhoCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, -kijun_sen), false);
   #ifdef ACT_ON_SWITCH_CONDITION
      ActOnSwitchCondition* switchCondition = new ActOnSwitchCondition(symbol, timeframe, (ICondition*) condition);
...
{
   AndCondition* condition = new AndCondition();
   condition.Add(new PriceAboveIchimokuStreamCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, MODE_KIJUNSEN), false);
   condition.Add(new MAAboveMACondition(symbol, timeframe, MODE_EMA, 13, timeframe, MODE_EMA, 21), false);
   condition.Add(new PriceAboveKumhoCondition(symbol, timeframe, tenkan_sen, kijun_sen, senkoi_span_b, -kijun_sen), false);
   #ifdef ACT_ON_SWITCH_CONDITION
      ActOnSwitchCondition* switchCondition = new ActOnSwitchCondition(symbol, timeframe, (ICondition*) condition);
