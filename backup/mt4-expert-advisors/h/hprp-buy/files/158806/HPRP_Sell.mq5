                ...
                const long &tick_volume[], const long &volume[], const int &spread[])
{
    ...
    for (int i = start; i < rates_total && !IsStopped(); i++) {
            ...
            G_ibuf_200[i] = HPRPSell(rsi1, rsi2, rsi3, stoch1, stoch2, stoch3);
        }
    ...
    //+------------------------------------------------------------------+
    double HPRPSell(double a0, double a1, double a2, double a3, double a4, double a5) { 
        // return (MathArctan(a0 * a3 * a5)); 
        return(MathArctan((100-a0)*(100-a3)*(100-a5)));
    }
//Available @  https://fxcodebase.com/code/viewtopic.php?f=38&t=75766
