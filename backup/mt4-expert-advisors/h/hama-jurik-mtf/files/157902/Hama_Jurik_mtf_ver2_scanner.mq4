...
public:
   ...
   {
      double value1 = iCustom(_symbol, _timeframe, "Hama_Jurik_mtf_ver2", _TimeFrame, MaPeriod, MaMetod, Step, 
         BetterFormula, jurik, Length, Phase, FillWidth, 0, period);
      double value2 = iCustom(_symbol, _timeframe, "Hama_Jurik_mtf_ver2", _TimeFrame, MaPeriod, MaMetod, Step, 
         BetterFormula, jurik, Length, Phase, FillWidth, 1, period);
...
string IndicatorName = "Hama Jurik mtf ver2 scanner";
int init()
{
   ...
   double temp = iCustom(0, 0, "Hama_Jurik_mtf_ver2", _TimeFrame, MaPeriod, MaMetod, Step, 
         BetterFormula, jurik, Length, Phase, FillWidth, 0, 0);
   if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
   {
      Alert("Please, install the 'Hama_Jurik_mtf_ver2' indicator");
      return INIT_FAILED;
   }
