//Available @ https://fxcodebase.com/code/viewtopic.php?f=38&t=73640
...
string file_custom_indicator = "hilo-activator-profi";
int    indicator_side=-1;
int    indicator_last_side=-1;
...
class BUYcondition1 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    double indi_Buy_Curr1 = iCustom(NULL, 0, file_custom_indicator, Range, 0, 1);
    double indi_Buy_Curr2 = iCustom(NULL, 0, file_custom_indicator, Range, 0, 3);
    double indi_Buy_Curr3 = iCustom(NULL, 0, file_custom_indicator, Range, 0, 5);
		
		if(indicator_side<=0)
		{
			if (indi_Buy_Curr1 > 0 && indi_Buy_Curr2 > 0 && indi_Buy_Curr3 > 0)
			{ 
				indicator_side = 1;
        return true;
      }
 ...
 public:
  bool evaluate()
  {
    // TODO: condition sell 1
		...
		double indi_Sell_Curr1 = iCustom(NULL, 0, file_custom_indicator, Range, 1, 1);
		double indi_Sell_Curr2 = iCustom(NULL, 0, file_custom_indicator, Range, 1, 3);
		double indi_Sell_Curr3 = iCustom(NULL, 0, file_custom_indicator, Range, 1, 5);
		
	if(indicator_side>0)
	{
			if (indi_Sell_Curr1 > 0 && indi_Sell_Curr2 > 0 && indi_Sell_Curr3 > 0)
			{ 
				indicator_side = 0;
        return true;
      }
