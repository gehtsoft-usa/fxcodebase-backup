...
Version:     
Date:        
Repository:  Available @ https://fxcodebase.com/code/viewtopic.php?f=38&p=149770#p149770
License:     GNU
*/
...
class Martingale
{
 ...
 public:
  ...
  bool lastWasLoss()
  {
    ...
    {
      if (OrderSelect(i, SELECT_BY_POS, MODE_HISTORY) && OrderSymbol() == _symbol && OrderMagicNumber() == _magic && OrderCloseTime() > 0)
      {
        _lastLot = OrderLots();
