...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70280
...
public:
   ...
   {
      double value0 = iCustom(_symbol, _timeframe, "Hull moving average", inpPeriod, inpDivisor, inpPrice, 0, period);
      double value1 = iCustom(_symbol, _timeframe, "Hull moving average", inpPeriod, inpDivisor, inpPrice, 0, period + 1);
...
string IndicatorName = "Hull Moving AVerage Dashboard";
int init()
{
   double temp = iCustom(NULL, 0, "Hull moving average", inpPeriod, inpDivisor, inpPrice, 0, 0);
   ...
   IndicatorObjPrefix = GenerateIndicatorPrefix("hmad");
