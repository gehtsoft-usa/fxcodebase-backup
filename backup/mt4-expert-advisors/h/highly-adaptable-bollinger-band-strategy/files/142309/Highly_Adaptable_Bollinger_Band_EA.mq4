...
input CustomActionType BB_Top_Line_Cross_Under       = Sell;
input CustomActionType BB_Center_Line_Cross_Over     = No_Action;
input CustomActionType BB_Center_Line_Cross_Under    = No_Action;
input CustomActionType BB_Bottom_Line_Cross_Over     = Buy;
input CustomActionType BB_Bottom_Line_Cross_Under    = Close_Sell_Positions;
...
{
   ICondition* mainCondition = new PriceBandsStreamCondition(symbol, timeframe,
      FirstCrossOverSecond, bb_period, bb_deviation, bb_shift, bb_price, MODE_UPPER);
   ...
   mainCondition = new PriceBandsStreamCondition(symbol, timeframe,
      FirstCrossUnderSecond, bb_period, bb_deviation, bb_shift, bb_price, MODE_UPPER);
   CreateAction(BB_Top_Line_Cross_Under, mainCondition, symbol, timeframe, tradingCalculator, tradingTimeCondition);
   mainCondition.Release();

   mainCondition = new PriceBandsStreamCondition(symbol, timeframe,
      FirstCrossOverSecond, bb_period, bb_deviation, bb_shift, bb_price, MODE_MAIN);
   CreateAction(BB_Center_Line_Cross_Over, mainCondition, symbol, timeframe, tradingCalculator, tradingTimeCondition);
   mainCondition.Release();

   mainCondition = new PriceBandsStreamCondition(symbol, timeframe,
      FirstCrossUnderSecond, bb_period, bb_deviation, bb_shift, bb_price, MODE_MAIN);
   CreateAction(BB_Center_Line_Cross_Under, mainCondition, symbol, timeframe, tradingCalculator, tradingTimeCondition);
   mainCondition.Release();

   mainCondition = new PriceBandsStreamCondition(symbol, timeframe,
      FirstCrossOverSecond, bb_period, bb_deviation, bb_shift, bb_price, MODE_LOWER);
   CreateAction(BB_Bottom_Line_Cross_Over, mainCondition, symbol, timeframe, tradingCalculator, tradingTimeCondition);
   mainCondition.Release();

   mainCondition = new PriceBandsStreamCondition(symbol, timeframe,
      FirstCrossUnderSecond, bb_period, bb_deviation, bb_shift, bb_price, MODE_LOWER);
   CreateAction(BB_Bottom_Line_Cross_Under, mainCondition, symbol, timeframe, tradingCalculator, tradingTimeCondition);
   mainCondition.Release();
}
