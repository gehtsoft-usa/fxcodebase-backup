//Available @  https://fxcodebase.com/code/viewtopic.php?f=38&t=75574
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double ht = iCustom(_symbol, _timeframe, "HalfTrend", amplitud, channelDeviation, 4, period + 1);
      double QQE_1 = iCustom(_symbol, _timeframe, "QQE", SF, RSI_Period, 0, period);
      double QQE_2 = iCustom(_symbol, _timeframe, "QQE", SF, RSI_Period, 1, period);
      return ht != EMPTY_VALUE && QQE_1 > QQE_2;
   }
};
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double ht = iCustom(_symbol, _timeframe, "HalfTrend", amplitud, channelDeviation, 5, period + 1);
      double QQE_1 = iCustom(_symbol, _timeframe, "QQE", SF, RSI_Period, 0, period);
      double QQE_2 = iCustom(_symbol, _timeframe, "QQE", SF, RSI_Period, 1, period);
      return ht != EMPTY_VALUE && QQE_1 < QQE_2;
   }
...
int OnInit()
{
   double temp = iCustom(NULL, 0, "HalfTrend", 0, 0);
   if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
   {
      Alert("Please, install the 'HalfTrend' indicator (http://fxcodebase.com/code/viewtopic.php?f=38&t=73477)");
      return INIT_FAILED;
   }
   temp = iCustom(NULL, 0, "QQE", 0, 0);
   if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
   {
      Alert("Please, install the 'QQE' indicator (http://fxcodebase.com/code/viewtopic.php?f=38&t=72683)");
      return INIT_FAILED;
   }
