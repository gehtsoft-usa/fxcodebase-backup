...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double value = iCustom(_symbol, _timeframe, "HalfTmtf", "Current time frame", Amplitude, 4, period);
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double value = iCustom(_symbol, _timeframe, "HalfTmtf", "Current time frame", Amplitude, 5, period);
      return value != 0 && value != EMPTY_VALUE;
   }
};
