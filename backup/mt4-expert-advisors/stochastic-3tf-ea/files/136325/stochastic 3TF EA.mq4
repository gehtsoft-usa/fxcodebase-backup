...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70229
...
input double os = 10; // Oversold
input double ob = 90; // Overbought
...
ICondition* CreateLongCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   condition.Add(new StochKOversoldCondition(symbol, timeframe, K_periods, D_periods, Slowing, os), false);
   condition.Add(new StochKOversoldCondition(symbol, tf2, K_periods, D_periods, Slowing, os), false);
   condition.Add(new StochKOversoldCondition(symbol, tf3, K_periods, D_periods, Slowing, os), false);
...
ICondition* CreateShortCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(new StochKOverboughtCondition(symbol, timeframe, K_periods, D_periods, Slowing, ob), false);
   condition.Add(new StochKOverboughtCondition(symbol, tf2, K_periods, D_periods, Slowing, ob), false);
   condition.Add(new StochKOverboughtCondition(symbol, tf3, K_periods, D_periods, Slowing, ob), false);
   #ifdef ACT_ON_SWITCH_CONDITION
      ActOnSwitchCondition* switchCondition = new ActOnSwitchCondition(symbol, timeframe, (ICondition*) condition);
      condition.Release();
      return switchCondition;
