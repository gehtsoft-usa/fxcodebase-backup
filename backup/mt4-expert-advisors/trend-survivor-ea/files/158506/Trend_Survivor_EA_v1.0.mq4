...
class OrderCreator : public iActions
{
  ...
  public:
    ...
    bool execute()
    {
        ...
        int result = OrderSend(_symbol, _cmd, _lots, _price, _slippage, _sl, _tp, "Trend Flexible", _magic, 0, clrNONE);
...
input const string indicator_file = "Trend_Flexible_Indi_MTF";                          // Indicator File:
//---
int  bufferToBuy              = 4;
int  bufferToSell             = 5;
