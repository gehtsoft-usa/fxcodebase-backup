...
// https://fxcodebase.com/code/viewtopic.php?f=27&p=155695#p155695
...
input const string indicator_file = "3-drives indicator";        // Indicator File:
input int          InpDepth       = 10;                          // Depth
//---
input int candles_back_for_signals = 10; // Candles back for signals:
int       bufferToBuy              = 3;
int       bufferToSell             = 4;
bool      indicator_init           = true;
//---
double Indi(int buffer, int candle = 1) { return iCustom(NULL, 0, indicator_file, InpDepth, buffer, candle); }
