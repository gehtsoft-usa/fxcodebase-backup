...
class CheckLastCloseTrade
{
    ...
    public:
    CheckLastCloseTrade(string symbol, long magic=0) :_symbol(symbol), _magic(magic) { ; }
    ~CheckLastCloseTrade() { ; }
    ...
    // ------------------------------------------------------------------
    void setPositions(datetime dateIni=0, datetime dateFin = 0)
    {
    ...
    bool LastWasLoss()
    {
        ...
        int pos = ArrayRange(positions, 0) - 1;
        if(pos > 0)
        {
            double profit = positions[pos, 1];
            return profit < 0;
        }
        return false;
    }
...
{
    // ------------------------------------------------------------------
    lastTrade = new CheckLastCloseTrade(_Symbol);
