...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double value = iCustom(_symbol, _timeframe, "2 bar supply and demand", true, 12, period + 1);
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double value = iCustom(_symbol, _timeframe, "2 bar supply and demand", true, 8, period + 1);
      return value != EMPTY_VALUE;
   }
};
