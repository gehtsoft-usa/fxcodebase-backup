...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=69322
...
public:
   ...
   {
      double value = iCustom(_Symbol, _Period, "2MA RSI Cross", 0, 0, FastMaPeriod, FastMaMethod, FastMaPrice, 
         SlowMaPeriod, SlowMaMethod, SlowMaPeriod, RsiPeriod, false, false, false, false, false, 2, period);
...
public:
   ...
   {
      double value = iCustom(_Symbol, _Period, "2MA RSI Cross", 0, 0, FastMaPeriod, FastMaMethod, FastMaPrice, 
         SlowMaPeriod, SlowMaMethod, SlowMaPeriod, RsiPeriod, false, false, false, false, false, 3, period);
...
int init()
{
   double temp = iCustom(NULL, 0, "2MA RSI Cross", 0, 0);
   if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
   {
      Alert("Please, install the '2MA RSI Cross' indicator");
      return INIT_FAILED;
   }
   ...
   IndicatorName = GenerateIndicatorName("2MA RSI Cross Dashboard");
