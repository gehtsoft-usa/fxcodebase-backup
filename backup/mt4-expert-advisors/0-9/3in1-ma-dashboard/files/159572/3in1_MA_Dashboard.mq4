...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=76026
...
enum setIntpl { Intp0,/*OFF*/ Intp1,/*HALF*/ Intp2/*FULL*/ };
extern setIntpl     Interpolation  =  Intp2;           // Interpolation
input int              FMAPeriod  =  1;              // Fast MA Period
input int              MMAPeriod  =  4;              // Medium MA Period
input int              SMAPeriod  =  24;             // Slow MA Period
...
int maCalc(string sym, ENUM_TIMEFRAMES tf)
  {
#define PARAM sym, tf, "3in1 MA 3 Color MTF BT", tf, Interpolation, FMAPeriod, MMAPeriod, SMAPeriod, MAMethod, MAPrice
   if(iCustom(PARAM, 1, 0) != EMPTY_VALUE && iCustom(PARAM, 1, 1) != EMPTY_VALUE)
      return 1;
   if(iCustom(PARAM, 2, 0) != EMPTY_VALUE && iCustom(PARAM, 2, 1) != EMPTY_VALUE)
      return -1;
   return 0;
  }
