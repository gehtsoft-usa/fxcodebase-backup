...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=73261
...
string file_custom_indicator = "123PatternsV6.ex4";
...
input string Tindisetup      = "== Indicator 123Patterns Setup ==";  // ————————————
...
input double closeGridTP         = 100;                 // Take Profit Grid (zero deactivate) $
input double closeGridSL         = -100;                // Stop Loss Grid (zero deactivate) -$
#else
...
class BUYcondition1 : public iConditions
{
 ...
 public:
  bool evaluate()
  {
    ...
    {
      arrow = iCustom(NULL, 0, file_custom_indicator, Notes, ZigZagDepth, RetraceDepthMin, RetraceDepthMax, ShowAllLines, ShowAllBreaks, ShowTargets, Target1Multiply, Target2Multiply, HideTransitions, 4, i);
...
class SELLcondition1 : public iConditions
{
 ...
 public:
  bool evaluate()
  {
    ...
    for (int i = 1; i <= tolerance; i++)
    {
      arrow = iCustom(NULL, 0, file_custom_indicator, Notes, ZigZagDepth, RetraceDepthMin, RetraceDepthMax, ShowAllLines, ShowAllBreaks, ShowTargets, Target1Multiply, Target2Multiply, HideTransitions, 5, i);
			if(arrow != EMPTY_VALUE && arrow!= _lastSignal) 
			{
        _lastSignal = arrow;
				return true;
