...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=68797
...
input int trend_ema_period_1 = 350; // Trend MA period 1
input ENUM_MA_METHOD trend_method_1 = MODE_EMA; // Trend smoothing method #1
input int trend_ema_period_2 = 200; // Trend MA period 2
input ENUM_MA_METHOD trend_method_2 = MODE_EMA; // Trend smoothing method #2
...
public:
   ...
   {
      double trendMASlow = iMA(_symbol, _timeframe, trend_ema_period_1, 0, trend_method_1, PRICE_CLOSE, period);
      double trendMAFast = iMA(_symbol, _timeframe, trend_ema_period_2, 0, trend_method_2, PRICE_CLOSE, period);
      if (trendMASlow > trendMAFast)
         return false;

      double maSlow = iMA(_symbol, _timeframe, ema_period_1, 0, method_1, PRICE_CLOSE, period);
      double maFast = iMA(_symbol, _timeframe, ema_period_2, 0, method_2, PRICE_CLOSE, period);
