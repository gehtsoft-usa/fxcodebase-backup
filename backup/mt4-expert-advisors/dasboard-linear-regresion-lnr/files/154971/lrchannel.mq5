...
//---- buffers
double rlBuffer[],upBuffer[],downBuffer[],highBuffer[],lowBuffer[],extra_highBuffer[],extra_lowBuffer[]; 
//+------------------------------------------------------------------+
...
//--- check input variables
   ...
   SetIndexBuffer(5,extra_highBuffer,INDICATOR_DATA);
   SetIndexBuffer(6,extra_lowBuffer,INDICATOR_DATA);
   ...
   PlotIndexSetString(5,PLOT_LABEL,"Extra High Line("+string(ExChPeriod)+")");
   PlotIndexSetString(6,PLOT_LABEL,"Extra Low Line("+string(ExChPeriod)+")");
  }
//+------------------------------------------------------------------+
       ...
       for(int i=rates_total-1-ExChPeriod;i<rates_total;i++)
         {
          ...
          extra_highBuffer[i]=rlBuffer[i]+3*S;
          extra_lowBuffer[i]=rlBuffer[i]-3*S;
         }
