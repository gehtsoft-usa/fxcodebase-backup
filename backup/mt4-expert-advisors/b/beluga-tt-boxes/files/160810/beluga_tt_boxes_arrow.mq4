...
Version:     1.00
Date:        2025
Repository:  Available @ https://fxcodebase.com/code/viewtopic.php?f=38&p=160748#p160748
License:     GNU
*/
...
input color  ArrowUpColor = clrLime;    // Arrow up color
input color  ArrowDnColor = clrRed;     // Arrow down color
input int    ArrowUpCode = 233;         // Arrow up code
input int    ArrowDnCode = 234;         // Arrow down code
