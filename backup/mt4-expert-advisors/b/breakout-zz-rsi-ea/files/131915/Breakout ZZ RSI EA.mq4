...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double BrU = iCustom(_symbol, _timeframe, "Breakout", PeriodBegin, PeriodEnd, BoxEnd, 2, period);
      return iClose(_symbol, _timeframe, period) > BrU;
   }
};
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double BrL = iCustom(_symbol, _timeframe, "Breakout", PeriodBegin, PeriodEnd, BoxEnd, 3, period);
      return iClose(_symbol, _timeframe, period) < BrL;
   }
};
