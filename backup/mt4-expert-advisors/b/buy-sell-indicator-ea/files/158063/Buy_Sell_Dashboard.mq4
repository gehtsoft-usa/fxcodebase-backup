//Available @  https://fxcodebase.com/code/viewtopic.php?f=38&t=71693
...
public:
   ...
   {
      double value = iCustom(_symbol, _timeframe, "Buy Sell Indicator", bb, bb_period, bb_bands_shift, bb_deviation, bb_applied_price, ma1, ma_period2, ma_shift2, ma_method2, applied_price2, 
         0, period);
...
string IndicatorName = "Buy Sell Dashboard";
int init()
{
   ...
   double temp = iCustom(NULL, 0, "Buy Sell Indicator", 0, 0);
   if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
   {
      Alert("Please, install the 'Buy Sell Indicator' indicator");
      return INIT_FAILED;
   }

   IndicatorObjPrefix = GenerateIndicatorPrefix("BSD");
