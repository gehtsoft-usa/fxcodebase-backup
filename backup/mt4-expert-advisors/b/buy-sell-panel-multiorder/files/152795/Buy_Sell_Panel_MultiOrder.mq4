...
bool OnInit_GUI()
{
    ...
    {
        res = gui.Create(0, "Panel Buy - Sell", 0, 400, 0, 590, 150);
        if(res) gui.Run();
    }
    return res;
}
...
class BuyAction : public iActions
{
    bool doAction()
    {
        ...
        do
        {
            ...
            if(n == 0)
                pr = distance == 0 ? 0 : Price("buy", distance, _Symbol);
...
class SellAction : public iActions
{
    bool doAction()
    {
        ...
        do
        {
            ...
            if(n == 0)
                pr = distance == 0 ? 0 : Price("sell", distance, _Symbol);
...
class GUI : public CAppDialog
{
    ...
    bool Create(const long chart, const string name, const int subwin, const int x1, const int y1, const int x2, const int y2)
    {
        ...
        if(!Create_label("Gap betwen", Col(0), Row(4), _high, _width, lb3)) return false;
        if(!Create_Edit("Gap", Col(1), Row(4), _high, _width, edit3, (string)GapBtwOrders)) return false;
