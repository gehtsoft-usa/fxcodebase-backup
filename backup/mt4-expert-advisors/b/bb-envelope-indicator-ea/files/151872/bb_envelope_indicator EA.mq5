...
string file_custom_indicator = "bb envelope indicator";
int handle = 0;
...
input string       Ti = "== BB Envelope Indicator Setup ==";        // **********
...
class BUYcondition1 : public iConditions
{
    ...
    bool evaluate()
    {
        ...
        return custom_indicator(0, 1) != EMPTY_VALUE;
        // return false;
    }
};
...
class SELLcondition1 : public iConditions
{
    ...
    bool evaluate()
    {
        // NOTE: condition sell 1
            // return iOpen(NULL, 0, 1) > iClose(NULL, 0, 1);
        return custom_indicator(1, 1) != EMPTY_VALUE;
        // return false;
    }
};
