...
//| squeeze modified by maumax AKA foreverold                                      |
//+------------------------------------------------------------------+
...
#property indicator_color4 White//Aqua
//---- input parameters
extern int       bolPrd=20;
extern double    bolDev=2.0;
extern int       keltPrd=18;//20
extern double    keltFactor=1.8;//1.5
extern int       momPrd=14;//12
//---- buffers
double upB[];
double loB[];
double upK[];
