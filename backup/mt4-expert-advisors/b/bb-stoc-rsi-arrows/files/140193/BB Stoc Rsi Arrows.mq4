...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70818
...
input double stoch_down = 80; // Stochastics down arrow level
input double stoch_up = 20; // Stochastics up arrow level
input int rsi_period = 14; // RSI period
input double rsi_down = 80; // RSI down arrow level
input double rsi_up = 20; // RSI up arrow level
...
int init()
{
   ...
   IndicatorBuffers(8);
   IndicatorObjPrefix = GenerateIndicatorPrefix("bbvsrsi");
   IndicatorShortName("BB Stoch RSI");
