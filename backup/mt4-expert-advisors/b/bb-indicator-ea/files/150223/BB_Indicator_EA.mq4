...
string file_custom_indicator = "BB_Arrows_indicator.ex4";
...
class BUYcondition1 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    return iCustom(NULL, 0, file_custom_indicator, BBPeriod, BBDeviations, BBShift, UseRsi, RsiPeriod, RsiUpperLevel, RsiLowerLevel, UseStochastic, StochMainKPeriod, StochMainDPeriod, StochMainSlowing, StochSignalKPeriod, StochSignalDPeriod, StochSignalSlowing, StochUpperLevel, StochLowerLevel , 0,1) != EMPTY_VALUE;
 ...
 public:
  bool evaluate()
  {
    // TODO: condition sell 1
		return iCustom(NULL, 0, file_custom_indicator, BBPeriod, BBDeviations, BBShift, UseRsi, RsiPeriod, RsiUpperLevel, RsiLowerLevel, UseStochastic, StochMainKPeriod, StochMainDPeriod, StochMainSlowing, StochSignalKPeriod, StochSignalDPeriod, StochSignalSlowing, StochUpperLevel, StochLowerLevel , 1,1) != EMPTY_VALUE;
		// return false;
  }
};
