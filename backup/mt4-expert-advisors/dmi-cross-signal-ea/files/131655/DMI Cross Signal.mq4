...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=69485
...
input int Period = 14; // DMI Period
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double dip0 = iADX(_symbol, _timeframe, Period, PRICE_CLOSE, MODE_PLUSDI, period);
      double dim0 = iADX(_symbol, _timeframe, Period, PRICE_CLOSE, MODE_MINUSDI, period);
      return dip0 > dim0;
   }
};
