...
//https://fxcodebase.com/code/viewtopic.php?f=38&t=71358
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      return iCustom(_symbol, _timeframe, "AROON", Length, 0, period) > iCustom(_symbol, _timeframe, "AROON", Length, 1, period);
   }
};
