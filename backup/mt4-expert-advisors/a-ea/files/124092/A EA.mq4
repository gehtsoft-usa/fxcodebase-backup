...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=67383
...
public:
   ...
   {
      double indi0 = iCustom(_symbol, _timeframe, "A", 1, period);
      double indi1 = iCustom(_symbol, _timeframe, "A", 1, period + 1);
      double close0 = iCustom(_symbol, _timeframe, "A", 0, period);
      double close1 = iCustom(_symbol, _timeframe, "A", 0, period + 1);
      return indi0 > close0 && indi1 <= close1;
   }
};
...
int OnInit()
{
   ...
   double temp = iCustom(NULL, 0, "A", 0, 0);
   if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
   {
      Alert("Please, install the 'A' indicator");
      return INIT_FAILED;
   }
