...
input int Signal_Period    = 5;
input int Signal_Method    = MODE_SMA;

input int BB_Up_Period     = 12;
input int BB_Up_Deviation  = 2;

input int BB_Dn_Period     = 12;
input int BB_Dn_Deviation  = 2;

input double levelOb                  = 6;
input double levelOs                  = -6;
input double extremelevelOb           = 10;
input double extremelevelOs           = -10;
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double value0 = iCustom(_symbol, _timeframe, "vertex-mod-3-01-alerts-arrows-mtf", _timeframe, Processed, Control_Period, Signal_Period, Signal_Method, 
         BB_Up_Period, BB_Up_Deviation, BB_Dn_Period, BB_Dn_Deviation, levelOb, levelOs, extremelevelOb, extremelevelOs, false, false, false, false, false, false, 4, period);
      return value0 == 1;
   }
};
