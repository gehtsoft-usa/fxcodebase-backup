...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=71173
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      ...
      double signalValue = iMACD(_symbol, _timeframe, fast_ema_period, slow_ema_period, signal_period, PRICE_CLOSE, MODE_SIGNAL, period);
