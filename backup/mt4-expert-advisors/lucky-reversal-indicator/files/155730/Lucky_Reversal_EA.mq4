...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=73775
...
string file_custom_indicator = "lucky-reversal-indicator1.ex4";
int    bufferToBuy           = 6;
int    bufferToSell          = 7;

input string Tindi = "== Indicator Setup =="; // ————————————
input int    SRZZ  = 60;                      // 60;//36;//24;//13; // =4..12..20..12
...
input bool   closeAllInOpositeSignal = false;                  // Close on opposite signal
#ifdef CLOSE_ALL_ON
...
int    offset         = 0;                                 // Your Time Zone, GMT (for news)
bool   DrawLines      = false;                              // Draw lines on the chart
...
BUYcondition1* oppositeSellCondition;

// class OppositeSellCondition : public iConditions
// {
//     double lastSignal;
//  public:
//   bool evaluate()
...
//   }
// };
// OppositeSellCondition* oppositeSellCondition;
...
SELLcondition1* oppositeBuyCondition;

// class OppositeBuyCondition : public iConditions
// {
// double lastSignal;
//  public:
//   bool evaluate()
...
//   }
// };
// OppositeBuyCondition* oppositeBuyCondition;
  ...
  public:
    bool evaluate()
    {
        if (closeAllInOpositeSignal)
            if (oppositeBuyCondition.evaluate())
                return true;
...
class ConditionToCloseSell : public iConditions
{
  public:
    ...
    {
        if (closeAllInOpositeSignal)
            if (oppositeSellCondition.evaluate())
                return true;
...
// Oninit News
    ...
    oppositeSellCondition = new BUYcondition1();
    ...
    oppositeBuyCondition = new SELLcondition1();
