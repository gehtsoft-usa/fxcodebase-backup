...
// https://fxcodebase.com/code/viewtopic.php?f=38&p=156259#p156259
...
{
    stCloseBuy.set(&cdRsiOverbougth, &acCloseBuy);
    stCloseSell.set(&cdRsiOversold, &acCloseSell);
...
input const string indicator_file = "Perfect_Trend_line";        // Indicator File:
//---
int  bufferToBuy              = 5;
int  bufferToSell             = 4;
