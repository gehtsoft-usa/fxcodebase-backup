...
int OnInit()
{
     double temp = iCustom(NULL, 0, "Trend_Lord", 0, 0);
   if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
   {
       Alert("Please, install the 'Trend_Lord' indicator");
       return INIT_FAILED;
   }
   LastBar=0;
...
void OnTick()
{
 ...
 double TL0, TL1;
 TL0=iCustom(NULL, 0, "Trend_Lord", Length, 0, 1);
 TL1=iCustom(NULL, 0, "Trend_Lord", Length, 0, 2);
