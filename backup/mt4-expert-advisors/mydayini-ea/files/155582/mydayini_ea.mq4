//Available @  https://fxcodebase.com/code/viewtopic.php?f=38&t=74932
...
input const string indicator_file = "mydayindi.ex4";                          // Indicator File:
...
{
    return iCustom(NULL, 0, indicator_file,"", Verbose, MinRange, MaxRange, HighLowFilter, MaxHistoryBars,
                   buffer, candle);
}
...
input int    count_max_positions = 4;                           // # Total positions:
