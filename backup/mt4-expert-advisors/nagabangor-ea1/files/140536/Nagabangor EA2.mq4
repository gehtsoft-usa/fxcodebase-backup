...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70883
...
input int ma1_period = 12; // MA 1 period
input ENUM_MA_METHOD ma1_method = MODE_EMA; // Smoothing method
input int ma2_period = 26; // MA 2 period
input ENUM_MA_METHOD ma2_method = MODE_EMA; // Smoothing method
input int ma3_period = 50; // MA 3 period
input ENUM_MA_METHOD ma3_method = MODE_SMA; // Smoothing method
...
public:
   ...
   virtual double GetValue(const int period, double entryPrice)
   {
      double val = iMA(_symbol, _timeframe, ma3_period, 0, ma3_method, PRICE_CLOSE, period);
      for (int i = period; i < iBars(_symbol, _timeframe); ++i)
      {
         double avg = iMA(_symbol, _timeframe, ma3_period, 0, ma3_method, PRICE_CLOSE, period);
         if (_isBuy)
         {
            if (avg > val)
            {
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double val0 = iMA(_symbol, _timeframe, ma1_period, 0, ma1_method, PRICE_CLOSE, period);
      double val1 = iMA(_symbol, _timeframe, ma1_period, 0, ma1_method, PRICE_CLOSE, period + 1);
      return val0 > val1;
   }
};
...
class FilterColorLongCondition : public ACondition
{
public:
   FilterColorLongCondition(const string symbol, ENUM_TIMEFRAMES timeframe)
      :ACondition(symbol, timeframe)
   {
   ...
   bool IsPass(const int period, const datetime date)
   {
      double val0 = iMA(_symbol, _timeframe, ma3_period, 0, ma3_method, PRICE_CLOSE, period);
      double val1 = iMA(_symbol, _timeframe, ma3_period, 0, ma3_method, PRICE_CLOSE, period + 1);
      return val0 > val1;
   }
};

class FilterColorShortCondition : public ACondition
{
public:
   FilterColorShortCondition(const string symbol, ENUM_TIMEFRAMES timeframe)
      :ACondition(symbol, timeframe)
   {
...
class FilterSideLongCondition : public ACondition
{
public:
   FilterSideLongCondition(const string symbol, ENUM_TIMEFRAMES timeframe)
      :ACondition(symbol, timeframe)
   {
   ...
   bool IsPass(const int period, const datetime date)
   {
      double val1 = iMA(_symbol, _timeframe, ma1_period, 0, ma1_method, PRICE_CLOSE, period);
      double val2 = iMA(_symbol, _timeframe, ma2_period, 0, ma2_method, PRICE_CLOSE, period);
      double val3 = iMA(_symbol, _timeframe, ma3_period, 0, ma3_method, PRICE_CLOSE, period);
      return val1 > val3 && val2 > val3;
   }
};

class FilterSideShortCondition : public ACondition
{
public:
   FilterSideShortCondition(const string symbol, ENUM_TIMEFRAMES timeframe)
      :ACondition(symbol, timeframe)
   {
...
ICondition* CreateLongFilterCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(new FilterColorLongCondition(symbol, timeframe), false);
   condition.Add(new FilterSideLongCondition(symbol, timeframe), false);
   return condition;
}
...
ICondition* CreateShortCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(new FilterColorShortCondition(symbol, timeframe), false);
   condition.Add(new FilterSideShortCondition(symbol, timeframe), false);
   #ifdef ACT_ON_SWITCH_CONDITION
      ActOnSwitchCondition* switchCondition = new ActOnSwitchCondition(symbol, timeframe, (ICondition*) condition);
      condition.Release();
      return switchCondition;
