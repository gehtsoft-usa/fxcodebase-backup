...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=72806
...
int OnCalculate(const int rates_total, const int prev_calculated, const datetime &time[], const double &open[], const double &high[],
   ...
   for(int pos=startPos; pos>=0; pos--) 
	...
	if (up[1]!= EMPTY_VALUE && newCandle.IsNewCandle()) { Notifications(0); }
	if (dn[1]!= EMPTY_VALUE && newCandle.IsNewCandle()) { Notifications(1); }
