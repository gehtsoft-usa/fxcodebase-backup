...
input  AveragesMethod slow_MA_Type = EMA; // Slow MA Type
...
public:
   ...
   {
      double main_current = iCustom(_symbol, _timeframe, "MACD_Custom_averages_Indicator", fast_ema_period, slow_ema_period, signal_period, Price, fast_MA_Type, slow_MA_Type, signal_type, 0, 0);
      double main_previous = iCustom(_symbol, _timeframe, "MACD_Custom_averages_Indicator", fast_ema_period, slow_ema_period, signal_period, Price, fast_MA_Type, slow_MA_Type, signal_type, 0, 1);
      double signal_current = iCustom(_symbol, _timeframe, "MACD_Custom_averages_Indicator", fast_ema_period, slow_ema_period, signal_period, Price, fast_MA_Type, slow_MA_Type, signal_type, 1, 0);
      double signal_previous = iCustom(_symbol, _timeframe, "MACD_Custom_averages_Indicator", fast_ema_period, slow_ema_period, signal_period, Price, fast_MA_Type, slow_MA_Type, signal_type, 1, 1);
      return main_current > signal_current && main_previous <= signal_previous;
   }
};
...
int init()
{
   double temp = iCustom(NULL, 0, "MACD_Custom_averages_Indicator", 0, 0);
   if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
   {
      Alert("Please, install the 'MACD_Custom_averages_Indicator' indicator");
      return INIT_FAILED;
   }
   ...
   IndicatorName = GenerateIndicatorName("MACD Dashboard");
