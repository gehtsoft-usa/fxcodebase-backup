    ...
    if (rectanglesOn)
    {
        ...
        } else
        {
            ...
            drawRectangle(i);
					...
					if (lastValueChanged()) { drawTheNewRectangle(); }
        }
...
void drawTheNewRectangle()
{
    string name = "LastRect";
    ObjectDelete(0, name);

    int candle1 = 0;
    int candle2 = points[2].candle;

    datetime tm1 = iTime(NULL, 0, candle1);

    double pr1 = Price_ZZ_0;

    datetime tm2 = iTime(NULL, 0, candle2);
    double   pr2 = points[2].price;
