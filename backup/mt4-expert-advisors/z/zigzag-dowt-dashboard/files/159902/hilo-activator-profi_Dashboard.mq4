...
//
   shortName = "hilo-activator-profi_Dashboard";
...
int maCalc(string sym, ENUM_TIMEFRAMES tf)
  {
#define PARAM sym, tf, "hilo-activator-profi", Range
   if(iCustom(PARAM, 0, 0) > 0 && iCustom(PARAM, 0, 0) != EMPTY_VALUE)
      return 1;
   if(iCustom(PARAM, 1, 0) > 0 && iCustom(PARAM, 1, 0) != EMPTY_VALUE)
      return -1;
   return 0;
  }
...
void Notify(int type)
  {
   string text = "hilo-activator-profi Direction: ";
   switch(type)
     {
      case 1:
