//Available @  https://fxcodebase.com/code/viewtopic.php?f=38&t=75500&p=157819#p157819
...
public:
   ...
   {
      return iCustom(_symbol, _timeframe, "ZigZag_DowT", InpDepth, InpDeviation, InpBackstep, 3, period) != EMPTY_VALUE;
   }
};
...
public:
   ...
   virtual bool IsPass(const int period, const datetime date)
   {
      return iCustom(_symbol, _timeframe, "ZigZag_DowT", InpDepth, InpDeviation, InpBackstep, 4, period) != EMPTY_VALUE;
   }
};
