...
enum TimeframesShift
{
    Plus1, // +1
    Plus2 // +2
};
input TimeframesShift AutoHTF = Plus1; // Automatic higher time frame
...
void OnInit(void)
{
    ...
    {
        case PERIOD_M1:
            HigherTimeFrame = AutoHTF == Plus1 ? PERIOD_M5 : PERIOD_M15;
            break;
        case PERIOD_M5:
            HigherTimeFrame = AutoHTF == Plus1 ? PERIOD_M15 : PERIOD_M30;
            break;
        case PERIOD_M15:
            HigherTimeFrame = AutoHTF == Plus1 ? PERIOD_M30 : PERIOD_H1;
            break;
        case PERIOD_M30:
            HigherTimeFrame = AutoHTF == Plus1 ? PERIOD_H1 : PERIOD_H4;
            break;
        case PERIOD_H1:
            HigherTimeFrame = AutoHTF == Plus1 ? PERIOD_H4 : PERIOD_D1;
            break;
        case PERIOD_H4:
            HigherTimeFrame = AutoHTF == Plus1 ? PERIOD_D1 : PERIOD_W1;
            break;
        case PERIOD_D1:
            HigherTimeFrame = AutoHTF == Plus1 ? PERIOD_W1 : PERIOD_MN1;
            break;
        case PERIOD_W1:
            HigherTimeFrame = PERIOD_MN1;
            break;
        case PERIOD_MN1:
            HigherTimeFrame = PERIOD_MN1;
            break;
