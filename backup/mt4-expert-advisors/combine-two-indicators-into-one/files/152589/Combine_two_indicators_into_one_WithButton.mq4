//Available @ https://fxcodebase.com/code/viewtopic.php?f=38&t=73457
...
bool               AlertsMessage = true,  // false,
AlertsSound = true,  // false,
    AlertsEmail                         = false,
    AlertsMobile                = false;
string SoundFile                 = "alert2.wav";  //"news.wav";   //"expert.wav";  //   //"stops.wav"   //"alert2.wav"   //
...
// NOTE: donde poner las notificaciones
    //---
...
void Notifications(int type)
{
   string text = "";
   if (type == 0)
      text += _Symbol + " " + GetTimeFrame(_Period) + " BUY Signal";
   else
      text += _Symbol + " " + GetTimeFrame(_Period) + " SELL Signal";
