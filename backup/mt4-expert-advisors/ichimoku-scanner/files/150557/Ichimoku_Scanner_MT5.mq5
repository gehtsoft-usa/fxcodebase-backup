...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=68827
 ...
 public:
  ...
  bool havePatternUp(int i, int tf_index)
  {
    // TODO: escribir el patrón alcista
		...
		return handles[tf_index].Tenkansen(i) > handles[tf_index].Kijunsen(i) && handles[tf_index].Tenkansen(i+1) <= handles[tf_index].Kijunsen(i+1);
  }
