...
input bool price_cs = true; // Price/Chikou Span alert
input bool sl_tl = true; // Tenkan/Kijun
input bool cloud_price = true; // Cloud/price
...
int init()
{
   ...
   IndicatorBuffers(24);
   IndicatorObjPrefix = GenerateIndicatorPrefix("ich");
   IndicatorShortName("Ichimoku Kinko Hyo");
   ...
   if (price_cs)
   {
      IStream* chikou = new IchimokuStdStream(_Symbol, (ENUM_TIMEFRAMES)_Period, tenkan_sen, kijun_sen, senkou_span_b, MODE_CHIKOUSPAN);
      IStream* price = new PriceStream(_Symbol, (ENUM_TIMEFRAMES)_Period, PriceClose);
      ICondition* upCondition = (ICondition*) new StreamStreamCondition(_Symbol, (ENUM_TIMEFRAMES)_Period, FirstCrossOverSecond, chikou, price, "Chikou", "Close", kijun_sen, kijun_sen);
      ICondition* downCondition = (ICondition*) new StreamStreamCondition(_Symbol, (ENUM_TIMEFRAMES)_Period, FirstCrossUnderSecond, chikou, price, "Chikou", "Close", kijun_sen, kijun_sen);
      id = CreateAlert(id, upCondition, NULL, downCondition, NULL, 217, 218, "Chikou CO Price", "Chikou CU Price");
      chikou.Release();
      price.Release();
   }
   if (sl_tl)
   {
      IStream* tenkan = new IchimokuStdStream(_Symbol, (ENUM_TIMEFRAMES)_Period, tenkan_sen, kijun_sen, senkou_span_b, MODE_TENKANSEN);
      IStream* kijun = new IchimokuStdStream(_Symbol, (ENUM_TIMEFRAMES)_Period, tenkan_sen, kijun_sen, senkou_span_b, MODE_KIJUNSEN);
      ICondition* upCondition = (ICondition*) new StreamStreamCondition(_Symbol, (ENUM_TIMEFRAMES)_Period, FirstCrossOverSecond, tenkan, kijun, "Tenkan", "Kijun");
      ICondition* downCondition = (ICondition*) new StreamStreamCondition(_Symbol, (ENUM_TIMEFRAMES)_Period, FirstCrossUnderSecond, tenkan, kijun, "Tenkan", "Kijun");
      id = CreateAlert(id, upCondition, NULL, downCondition, NULL, 217, 218, "Tenkan CO Kijun", "Tenkan CU Kijun");
      tenkan.Release();
      kijun.Release();
   }
   if (cloud_price)
   {
      IStream* top = new IchimokuStdCloudStream(_Symbol, (ENUM_TIMEFRAMES)_Period, tenkan_sen, kijun_sen, senkou_span_b, true);
      IStream* bottom = new IchimokuStdCloudStream(_Symbol, (ENUM_TIMEFRAMES)_Period, tenkan_sen, kijun_sen, senkou_span_b, false);
      IStream* price = new PriceStream(_Symbol, (ENUM_TIMEFRAMES)_Period, PriceClose);
      ICondition* upCondition = (ICondition*) new StreamStreamCondition(_Symbol, (ENUM_TIMEFRAMES)_Period, FirstCrossOverSecond, price, top, "Close", "Cloud");
      ICondition* downCondition = (ICondition*) new StreamStreamCondition(_Symbol, (ENUM_TIMEFRAMES)_Period, FirstCrossUnderSecond, price, bottom, "Close", "Cloud");
      id = CreateAlert(id, upCondition, NULL, downCondition, NULL, 217, 218, "Close CO Could", "Close CU Could");
      top.Release();
      bottom.Release();
      price.Release();
   }
