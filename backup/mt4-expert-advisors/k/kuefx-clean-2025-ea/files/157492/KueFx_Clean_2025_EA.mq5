...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=75411
...
input const string indicator_file = "Kijun-sen";                          // Indicator File:
input int      inp_kijun_period     = 26;       // Kijun Period
...
//---
int  handle = 0;
void setHandle() { handle = iCustom(Symbol(), NULL, indicator_file, inp_kijun_period, inp_shift); }
