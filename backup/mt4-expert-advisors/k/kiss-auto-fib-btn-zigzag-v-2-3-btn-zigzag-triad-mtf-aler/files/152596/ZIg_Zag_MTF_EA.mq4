...
// https://fxcodebase.com/code/viewtopic.php?f=38&p=152443#p152443
...
string file_custom_indicator = "ZigZag_Triad_MTF_Alerts_3_btn";
int bufferToBuy = 0;
int bufferToSell = 1;

input string  Tindi = "== Indicator Setup ==";  // ————————————
extern int    zz_History = 2222;  //288=D1/M5 //576=D2/M5; //864=D3/M5; //1152=D4/M5;  //1440=D5/M5;
extern string zz_TimeFrame = "";
...
class ZigZag
{
    ...
    ZigZag()
    {
        _symbol = _Symbol;
        _tf = Period();
        _file = "ZigZag_Triad_MTF_Alerts_3_btn";
    }
    ...
    void setSetup()
    {
        _setup.history = zz_History;
        _setup.tf = zz_TimeFrame;
        _setup.depth = zz_ExtDepth;
        _setup.desviation = zz_ExtDeviation;
        _setup.backStep = zz_ExtBackstep;
    }

bool buySignal()
{
    // Print("buffer4 : ", calculate(1, 4));
    
    return (calculate(1, 4) == -1 && calculate(2, 4) == 0);
}
bool sellSignal()
{
    // Print("buffer4 : ", calculate(1, 4));
...
class BUYcondition1 : public iConditions
{
    ...
    bool evaluate()
    {
        ...
        // zz.actualSide();
        // Print(__FUNCTION__," zz.actualSide = ",zz.actualSide());
        // Print(__FUNCTION__," Buy Signal = ",zz.buySignal());
        // Print(__FUNCTION__," sell Signal = ",zz.sellSignal());
