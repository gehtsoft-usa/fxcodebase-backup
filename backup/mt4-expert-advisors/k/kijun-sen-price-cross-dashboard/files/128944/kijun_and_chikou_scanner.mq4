...
public:
   ...
   {
      double kijun = iIchimoku(_symbol, _timeframe, tenkan_sen, kijun_sen, senkoi_span_b, MODE_KIJUNSEN, period);
      double chikou = iIchimoku(_symbol, _timeframe, tenkan_sen, kijun_sen, senkoi_span_b, MODE_CHIKOUSPAN, period);
      return kijun > chikou;
   }
};
