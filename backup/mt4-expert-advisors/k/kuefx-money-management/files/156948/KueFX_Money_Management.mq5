...
// https://fxcodebase.com/code/viewtopic.php?f=38&p=156966#p156966
...
class ActionCloseLosers : public iActions
{
  public:
    bool execute()
    {
...
ActionCloseLosers acCloseLosers;
...
void oninit_close_strategy()
{
    ...
    stCloseLossWhenTarget.set(&cdTargetReached, &acCloseLosers);
