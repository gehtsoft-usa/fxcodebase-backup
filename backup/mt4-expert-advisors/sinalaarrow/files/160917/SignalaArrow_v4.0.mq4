...
Version:     3.00
Date:        2025
Repository:  Available @ https://fxcodebase.com/code/viewtopic.php?f=38&p=160714#p160714
License:     GNU
*/
      ...
      if(zzValue > 0.0001)
        {
         ...
         if(diffLow < diffHigh * Point)
           {
            if(lastSignal == 1) continue;
            ArrowUp[i+1] = Low[i+1] - Move_Arrow * Point;
            lastSignal = 1;
           }
         else
           {
            if(lastSignal == -1) continue;
            ArrowDn[i+1] = High[i+1] + Move_Arrow * Point;
            lastSignal = -1;
           }
        }
     }
