...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=73334
...
string file_custom_indicator = "Tornado1.ex4";
...
class BUYcondition1 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    return iCustom(NULL, 0, file_custom_indicator, 0, 1) != EMPTY_VALUE;
    // return false;
  }
};
 ...
 public:
  bool evaluate()
  {
    // TODO: condition sell 1
		return iCustom(NULL, 0, file_custom_indicator, 1, 1) != EMPTY_VALUE;
  }
};
