//Available @ https://fxcodebase.com/code/viewtopic.php?f=38&t=73912
...
#property indicator_color2 0xB71C1C
#property indicator_style2 STYLE_SOLID
#property indicator_width2 1
#property indicator_label3 "Lagging Span"
#property indicator_type3 DRAW_LINE
#property indicator_color3 0x43A047
#property indicator_style3 STYLE_SOLID
#property indicator_width3 1
#property indicator_label4 "Leading Span A"
#property indicator_type4 DRAW_LINE
#property indicator_color4 0xA5D6A7
#property indicator_style4 STYLE_SOLID
#property indicator_width4 1
#property indicator_label5 "Leading Span B"
#property indicator_type5 DRAW_LINE
#property indicator_color5 0xEF9A9A
#property indicator_style5 STYLE_SOLID
#property indicator_width5 1

input int conversionPeriods = 9; // Conversion Line Length
input int basePeriods = 26; // Base Line Length
input int laggingSpan2Periods = 52; // Leading Span B Length
input int displacement = 26; // Lagging Span
...
class donchianStream
{
   ...
   IStream* ta_highest2;
public:
   donchianStream(int len)
   {
      this.len = len;
      ta_lowest1 = new LowestLowStream(_Symbol, (ENUM_TIMEFRAMES)_Period, len);
      ta_highest2 = new HighestHighStream(_Symbol, (ENUM_TIMEFRAMES)_Period, len);
   }
   ~donchianStream()
   {
      ta_lowest1.Release();
   ...
   bool GetValue(const int period, double &__out1)
   {
      ...
      __out1 = (ta_lowest1Value + ta_highest2Value) / 2;
      return true;
   }
};
color ColorRGB(int red, int green, int blue)
{
...
donchianStream* donchianFunc1;
donchianStream* donchianFunc2;
donchianStream* donchianFunc3;
double plot1[];
double plot2[];
double plot3[];
double plot4[];
...
int init()
{
   IndicatorObjPrefix = GenerateIndicatorPrefix("Ichimoku");
   IndicatorShortName("Ichimoku Cloud");
   IndicatorBuffers(5);
   int id = 0;
   SetIndexBuffer(id++, plot1);
   SetIndexBuffer(id++, plot2);
   SetIndexBuffer(id, plot3);
   SetIndexShift(id++, (-displacement) + 1);
   SetIndexBuffer(id, plot4);
   SetIndexShift(id++, displacement - 1);
   SetIndexBuffer(id, plot5);
   SetIndexShift(id++, displacement - 1);
   donchianFunc1 = new donchianStream(conversionPeriods);
   donchianFunc2 = new donchianStream(basePeriods);
   donchianFunc3 = new donchianStream(laggingSpan2Periods);
...
int deinit()
{
   ...
   delete donchianFunc1;
   delete donchianFunc2;
   delete donchianFunc3;
   return 0;
}
                ...
                const int &spread[])
{
   ...
   {
      double donchianFunc1Value;
      if (!donchianFunc1.GetValue(pos, donchianFunc1Value))
      {
         continue;
      }
      double conversionLine = donchianFunc1Value;
      double donchianFunc2Value;
      if (!donchianFunc2.GetValue(pos, donchianFunc2Value))
      {
         continue;
      }
      double baseLine = donchianFunc2Value;
      double leadLine1 = (conversionLine + baseLine) / 2;
      double donchianFunc3Value;
      if (!donchianFunc3.GetValue(pos, donchianFunc3Value))
      {
         continue;
      }
      double leadLine2 = donchianFunc3Value;
      plot1[pos] = conversionLine;
      plot2[pos] = baseLine;
      plot3[pos] = close[pos];
      double p1 = plot4[pos] = leadLine1;
      double p2 = plot5[pos] = leadLine2;
   }
