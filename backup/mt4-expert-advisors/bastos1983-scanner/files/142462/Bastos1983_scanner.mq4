...
public:
   ...
   virtual ICell* Create(const string id, const int x, const int y, ENUM_BASE_CORNER corner, const string symbol, const ENUM_TIMEFRAMES timeframe, bool showHistorical)
   {
      ...
      upCondition.Add(new UpCondition(symbol, timeframe), false);
      upCondition.Add(new RSIUpCondition(symbol, timeframe), false);
      ...
      downCondition.Add(new DownCondition(symbol, timeframe), false);
      downCondition.Add(new RSIDownCondition(symbol, timeframe), false);
