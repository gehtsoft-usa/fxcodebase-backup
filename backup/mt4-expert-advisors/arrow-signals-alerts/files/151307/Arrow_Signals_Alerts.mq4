//Available @ https://fxcodebase.com/code/viewtopic.php?f=38&t=73847
...
input string file = "ArrowsSignal.ex4"; // Indicator File:
input int sellBuffer = 0; // Sell Buffer:
input int buyBuffer = 1; // Buy Buffer:
...
{
    // TODO: signal up
    double indicator_buy_buffer = iCustom(NULL, 0, file, buyBuffer, 0);
    if(indicator_buy_buffer != EMPTY_VALUE)
    {
...
bool haveSignalDown(int i)
{
    ...
    double indicator_sell_buffer = iCustom(NULL, 0, file, sellBuffer, 0);
    if(indicator_sell_buffer != EMPTY_VALUE)
    {
