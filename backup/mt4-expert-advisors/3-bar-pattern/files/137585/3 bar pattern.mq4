...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70431
...
public:
   ...
   {
      return iLow(_symbol, _timeframe, period) < iClose(_symbol, _timeframe, period + 1)
         && MathMin(iClose(_symbol, _timeframe, period + 1), iOpen(_symbol, _timeframe, period + 1)) < MathMin(iClose(_symbol, _timeframe, period + 2), iOpen(_symbol, _timeframe, period + 2))
         && MathMin(iClose(_symbol, _timeframe, period + 2), iOpen(_symbol, _timeframe, period + 2)) > MathMin(iClose(_symbol, _timeframe, period + 3), iOpen(_symbol, _timeframe, period + 3));
   }
};
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      return iHigh(_symbol, _timeframe, period) > iClose(_symbol, _timeframe, period + 1)
         && MathMax(iClose(_symbol, _timeframe, period + 1), iOpen(_symbol, _timeframe, period + 1)) > MathMax(iClose(_symbol, _timeframe, period + 2), iOpen(_symbol, _timeframe, period + 2))
         && MathMax(iClose(_symbol, _timeframe, period + 2), iOpen(_symbol, _timeframe, period + 2)) < MathMax(iClose(_symbol, _timeframe, period + 3), iOpen(_symbol, _timeframe, period + 3));
   }
};
