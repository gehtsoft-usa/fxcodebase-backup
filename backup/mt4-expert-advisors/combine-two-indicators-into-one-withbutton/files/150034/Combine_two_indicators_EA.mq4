...
string file_custom_indicator = "Combine_two_indicators_into_one_WithButton.ex4";
...
input string    IndicatorFile          = "Combine_two_indicators_into_one_WithButton.ex4"; // Indicator File Name (can't be changed)
input bool               Email         = TRUE;
input int                SL_add_pips   = 11;
input int                changeLiner   = 1;
input int                Gup           = 4;
input int                Length        = 12;           // 45;  //50;
input ENUM_MA_METHOD     Mode          = MODE_SMMA;    // MODE_LWMA;
input ENUM_APPLIED_PRICE Price         = PRICE_CLOSE;  // Applied price
input bool               ShowHighLow   = false;
...
class BUYcondition1 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    return iCustom(NULL, 0, file_custom_indicator, Email, SL_add_pips, changeLiner, Gup, Length, Mode, Price, ShowHighLow, 6, 1)!=EMPTY_VALUE;
  }
};
 ...
 public:
  bool evaluate()
  {
    // TODO: condition sell 1
		return iCustom(NULL, 0, file_custom_indicator, Email, SL_add_pips, changeLiner, Gup, Length, Mode, Price, ShowHighLow, 7, 1)!=EMPTY_VALUE;
  }
};
