...
input int             uPeriod               = 14;                     // ATR periods:
input int             iniCalc               = 3;                      // Initial candle Max and Min:
input int             endCalc               = 100;                    // End candle to Max and Min:
input double          multiplier            = 3;                      // TPBS Multiplier:
...
{
	double minAtr=0;
	for(int i=index+iniCalc;i < index+endCalc; i++)
	{
