...
Strategy  closeOppositeBuy(&conditionCloseOnOppositeBuy, &actionCloseBuy);
Strategy  closeOppositeSell(&conditionCloseOnOppositeSell, &actionCloseSell);
...
Strategy        StrategyToCloseBuy(&conditionCloseBuy, &actionCloseBuy);
Strategy        StrategyToCloseSell(&conditionCloseSell, &actionCloseSell);
...
input const string indicator_file = "ut_bot_exact";              // Indicator File:
...
Strategy               IndicatorStrategyLong(&conditionIndicatorBuy, &buy);
Strategy               IndicatorStrategyShort(&conditionIndicatorSell, &sell);
