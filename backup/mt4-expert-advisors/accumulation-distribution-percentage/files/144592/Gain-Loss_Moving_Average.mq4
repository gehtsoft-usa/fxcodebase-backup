...
#property indicator_label1 "Gain/Loss Moving Average"
#property indicator_type1 DRAW_LINE
#property indicator_color1 Green
#property indicator_style1 STYLE_SOLID
#property indicator_width1 1
#property indicator_label2 "Neutral line"
...
enum param2_enum
{
   param2_value_1, // Simple
   param2_value_2 // Smoothed
};
input param2_enum param2_e = param2_value_2; // Moving Average Type
string Get_param2()
{
   switch (param2_e)
   {
      case param2_value_1: return "Simple";
      case param2_value_2: return "Smoothed";
   }
   return NULL;
}
input int param3 = 14; // Length
...
int init()
{
   ...
   IndicatorObjPrefix = GenerateIndicatorPrefix("GLMA [cI8DH]");
   IndicatorShortName("Gain/Loss Moving Average [cI8DH]");
                ...
                const int &spread[])
{
   ...
   for (int pos = MathMin(bars_limit, rates_total - 1 - MathMax(prev_calculated - 1, toSkip)); pos >= 0 && !IsStopped(); --pos)
   {
      ...
      double gain_loss = SafeMultiply(SafeDivide(change1Value, Nz(SafeDivide((SafePlus(srcValue_1, srcValue)), 2), 0.0000000001)), 100);
      double gain_loss_MA = EMPTY_VALUE;
      if ((MA_type == "Smoothed"))
      {
         rma1Source.SetValue(pos, gain_loss);
         double rma1Value;
         if (!rma1.GetValue(pos, rma1Value)) { rma1Value = EMPTY_VALUE; }
         gain_loss_MA = rma1Value;
      }
      else
      {
         sma1Source.SetValue(pos, gain_loss);
         double sma1Value;
         if (!sma1.GetValue(pos, sma1Value)) { sma1Value = EMPTY_VALUE; }
         gain_loss_MA = sma1Value;
      }
      plot1[pos] = gain_loss_MA;
   }
