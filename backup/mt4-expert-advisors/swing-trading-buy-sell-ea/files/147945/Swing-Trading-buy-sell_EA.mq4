...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=72745
...
string file_custom_indicator = "swing-trading-buy-sell-indicator.ex4";
...
enum enumDays { sunday,
                ...
                EA_OFF };
// ------------------------------------------------------------------
input int    candlesBack    = 3; // Candles to confirm Signal:
...
bool SignalBuy()
{
  if (iCustom(NULL, 0, "swing-trading-buy-sell-indicator.ex4", 15, 500, 3, candlesBack) > 0)
  {
    return true;
  }
...
bool SignalSell()
{
  if (iCustom(NULL, 0, "swing-trading-buy-sell-indicator.ex4", 15, 500, 2, candlesBack) > 0)
  {
    return true;
  }
