...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=67770
...
extern int ADXLength = 20; // ADX Length
extern double Entry = 30; // Entry Level
extern double Exit = 45; // Exit Level
extern int DMI_Period = 20; // DMI Period
...
private:
   ...
   int GetDirection()
   {
      double adx0 = iADX(_symbol, _timeframe, ADXLength, PRICE_CLOSE, MODE_MAIN, 0);
      double adx1 = iADX(_symbol, _timeframe, ADXLength, PRICE_CLOSE, MODE_MAIN, 1);
      double dip0 = iADX(_symbol, _timeframe, DMI_Period, PRICE_CLOSE, MODE_PLUSDI, 0);
      double dim0 = iADX(_symbol, _timeframe, DMI_Period, PRICE_CLOSE, MODE_MINUSDI, 0);
      if (adx0 > adx1 && adx0 > Entry && adx0 < Exit && dip0 > dim0)
	      return 1;
...
int init()
{
   IndicatorName = GenerateIndicatorName("MTF MCP ADX DMI List");
