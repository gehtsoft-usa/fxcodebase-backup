...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=76104
// +------------------------------------------------------------------------------------------------+
...
input const string indicator_file = "zeusindi2";                          // Indicator File:
//---
int  bufferToBuy              = 0;
int  bufferToSell             = 1;
  ...
  public:
    bool evaluate()
    {
        for (int i = 1; i <= candles_back_for_signals; i++) {
            ...
            double indi2 = Indi(bufferToBuy, i+1);
            if (indi > 0 && indi != EMPTY_VALUE && (indi2 == EMPTY_VALUE || indi2 == 0)) {
                return true;
            }
        }
        return false;
  ...
  public:
    bool evaluate()
    {
        for (int i = 1; i <= candles_back_for_signals; i++) {
            ...
            double indi2 = Indi(bufferToSell, i+1);
            if (indi < 0 && indi != EMPTY_VALUE && (indi2 == EMPTY_VALUE || indi2 == 0)) {
                return true;
            }
        }
