//Available @  https://fxcodebase.com/code/viewtopic.php?f=38&p=158258#p158258
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double value1 = iCustom(_symbol, _timeframe, "Silver_Trend", SSP, K, 0, period + SSP);
      double value2 = iCustom(_symbol, _timeframe, "Silver_Trend", SSP, K, 1, period + SSP);
...
int OnInit()
{
   ...
   #endif
   double temp = iCustom(NULL, 0, "Silver_Trend", 0, 0);
   if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
   {
      Alert("Please, install the 'Silver_Trend' indicator");
      return INIT_FAILED;
   }
