...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double value0 = iCustom(_symbol, _timeframe, "Open_Close_Cross_Strategy_R5.1_revised_by_JustUncleL", basisType, basisLen, 0, period);
      double value1 = iCustom(_symbol, _timeframe, "Open_Close_Cross_Strategy_R5.1_revised_by_JustUncleL", basisType, basisLen, 1, period);
...
int OnInit()
{
   double temp = iCustom(NULL, 0, "Open_Close_Cross_Strategy_R5.1_revised_by_JustUncleL", 0, 0);
   if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
   {
      Alert("Please, install the 'Open_Close_Cross_Strategy_R5.1_revised_by_JustUncleL' indicator");
      return INIT_FAILED;
   }
