...
// https://fxcodebase.com/code/viewtopic.php?f=38&p=150338
...
input int                maFastPeriod       = 40;                           // Period
...
class MACD
{
  ...
  public:
    ...
    bool isCrossing_Up(int shift)
    {
        return signal_line(shift) > macd_line(shift) && signal_line(shift + 1) <= macd_line(shift + 1);
    }
    bool isCrossing_Dn(int shift)
    {
        return signal_line(shift) < macd_line(shift) && signal_line(shift + 1) >= macd_line(shift + 1);
    }
};
...
void OnTick()
{
    ...
    // NOTE: Check Conditions to close
    // ——————————————————————————————————————————————————————————————————
    if (!uTradeReverse) {
