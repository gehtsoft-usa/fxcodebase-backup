...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70999
...
input int ma_periods = 7; // EMA Period
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double maValue = iMA(_symbol, _timeframe, ma_periods, 0, MODE_EMA, PRICE_CLOSE, period);
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      return iADX(_symbol, _timeframe, adx_period, PRICE_CLOSE, MODE_PLUSDI, period) 
         > iADX(_symbol, _timeframe, adx_period, PRICE_CLOSE, MODE_MINUSDI, period);
   }
};
