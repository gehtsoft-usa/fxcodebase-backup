...
//https://fxcodebase.com/code/viewtopic.php?f=38&t=71611
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      return iRSI(_symbol, _timeframe, rsi_period, PRICE_CLOSE, period) > iRSI(_symbol, _timeframe, rsi_period, PRICE_CLOSE, period + 1);
   }
};
