...
//https://fxcodebase.com/code/viewtopic.php?f=38&t=73916
...
input double    uEntryDistance    = 15;                              // Pips distance for pending orders:
...
input string timePendings = "18:05:00";                // Time to put orders (GMT)
#ifdef MAX_TRADES_AT_SAME_TIME
input int uMaxTrades = 2;  // Max Trades At Same Time:
#endif
...
input int          userTPpips     = 100;                 // Pips TP
...
// #ifdef TIMER_MINI
  ...
  sesionControl.AddSession(timePendings, timeEnd);
// #endif
...
void OnTick()
{
 ...
 // Close controls:
  ...
  // para limpiar la pendiente que no se abrió
  ...
  // para limpiar las pendientes si no se abrieron
  if(!countPendings.evaluate()) { DeletePendings(); }
