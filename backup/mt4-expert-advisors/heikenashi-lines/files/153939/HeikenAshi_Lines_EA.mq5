...
input int periods = 3; // Periods:

//--- 
input string file_custom_indicator = "HeikenAshi_Lines"; // Indicator File:
int handle = 0;
...
input int          userTPpips = 35;                            // Pips TP
