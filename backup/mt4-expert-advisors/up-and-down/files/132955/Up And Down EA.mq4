...
input int    period_1          = 18; // Period #1
input ENUM_TIMEFRAMES tf_1 = PERIOD_M5; // Timeframe #1
input int    period_2          = 18; // Period #2
input ENUM_TIMEFRAMES tf_2 = PERIOD_M15; // Timeframe #2
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double value00 = iCustom(_symbol, tf_1, "Up_and_Down", _symbol, period_1, 0, period);
      double value01 = iCustom(_symbol, tf_2, "Up_and_Down", _symbol, period_2, 0, period);
...
int OnInit()
{
      ...
      stats = NULL;
   #endif
   double temp = iCustom(NULL, 0, "Up_and_Down", 0, 0);
   if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
   {
      Alert("Please, install the 'Up_and_Down' indicator");
      return INIT_FAILED;
   }
