...
ICondition* CreateLongCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   condition.Add(
      new PriceIchimokuStreamCondition(symbol, timeframe, FirstAboveSecond, 
         Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, PRICE_CLOSE, MODE_SENKOUSPANB, 0, -Kijun_Sen_Period), 
      false
   );
   condition.Add(
      new IchimokuStreamsCondition(symbol, timeframe, FirstAboveSecond, 
...
ICondition* CreateShortCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(
      new PriceIchimokuStreamCondition(symbol, timeframe, FirstBelowSecond,
         Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, PRICE_CLOSE, MODE_SENKOUSPANA, 0, -Kijun_Sen_Period), 
      false
   );
   condition.Add(
      new IchimokuStreamsCondition(symbol, timeframe, FirstBelowSecond, 
         Tenkan_Sen_Period, Kijun_Sen_Period, Senkou_Span_B_Period, MODE_TENKANSEN, MODE_KIJUNSEN), 
      false
   );
   condition.Add(
