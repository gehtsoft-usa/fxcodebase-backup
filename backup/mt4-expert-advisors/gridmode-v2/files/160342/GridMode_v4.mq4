...
input bool   IchimokuOn     = true;                    // Ichimoku On ?
...
Ichimoku ichimoku;
Ichimoku ichi_H4(_Symbol, PERIOD_H4);
Ichimoku ichi_H1(_Symbol, PERIOD_H1);
Ichimoku ichi_M15(_Symbol, PERIOD_M15);


bool IchimokuSignal(string side)
{
    if (side == "buy") {
        // -H4: Price   > kijun, price is out of the cloud
        // -H1: Chikou  > prices and prices are above the clouds
        // -M15: Tenkan > kijun m15, chikou > price, blue future clouds
        double price = SymbolInfoDouble(_Symbol, SYMBOL_ASK);
        if (price > ichi_H4.Kijunsen(0) && price > ichi_H4.SenkouSpanA(0) && price > ichi_H4.SenkouSpanB(0)) {
            if (ichi_H1.ChikouSpan(0) > ichi_H1.Kijunsen(0) && ichi_H1.ChikouSpan(0) > ichi_H1.SenkouSpanA(0) && ichi_H1.ChikouSpan(0) > ichi_H1.SenkouSpanB(0)) {
                if (ichi_M15.Tenkansen(0) > ichi_M15.Kijunsen(0) && ichi_M15.ChikouSpan(0) > price && ichi_M15.SenkouSpanA(26) > ichi_M15.SenkouSpanB(26)) {
                    return true;
                }
            }
        }
...
int OnInit()
{
    ...
    ichi_H4.set(uTenkan_sen, uKijun_sen, uSenkou_span_b);
    ichi_H1.set(uTenkan_sen, uKijun_sen, uSenkou_span_b);
    ichi_M15.set(uTenkan_sen, uKijun_sen, uSenkou_span_b);
