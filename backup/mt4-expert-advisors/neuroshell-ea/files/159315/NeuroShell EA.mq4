...
// https://fxcodebase.com/code/viewtopic.php?f=27&p=160062#p160062
...
class OrderCreator : public iActions
{
  ...
  public:
    ...
    bool execute()
    {
        ...
        int result = OrderSend(_symbol, _cmd, _lots, _price, _slippage, _sl, _tp, "HKFX_FAZ_EA", _magic, 0, clrNONE);
...
input const string indicator_file = "NeuroShell";                // Indicator File:
input int    iperiod    = 30; // Period
input double iSensi     = 4;  // Sensitivity
//---
int  bufferToBuy              = 2;
int  bufferToSell             = 3;
...
//---
double Indi(int buffer, int candle = 1) { return iCustom(NULL, 0, indicator_file, iperiod, iSensi, buffer, candle); }
