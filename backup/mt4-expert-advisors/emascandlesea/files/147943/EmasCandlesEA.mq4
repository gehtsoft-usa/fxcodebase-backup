...
double op3 = iOpen(NULL,0,3);
double op4 = iOpen(NULL,0,4);
double cl1 = iClose(NULL,0,1);
double cl2 = iClose(NULL,0,2);
double cl3 = iClose(NULL,0,3);
double cl4 = iClose(NULL,0,4);

if(op4>cl4 && cl4<=maFast.index(4) && 
	 op3>cl3 && cl3<=maFast.index(3) &&
	 op2>cl2 && cl2<=maFast.index(2) &&
	 op1<cl1 && cl1>maFast.index(1))
	 {
		return true;
	 }
if(op3>cl3 && cl3<=maFast.index(3) &&
	 op2>cl2 && cl2<=maFast.index(2) &&
	 op1<cl1 && cl1>maFast.index(1))
	 {
		return true;
