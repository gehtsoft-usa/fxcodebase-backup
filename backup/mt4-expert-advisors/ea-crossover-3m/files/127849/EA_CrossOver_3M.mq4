...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=68776
...
input int ema_period_1 = 20; // EMA Period 1
input ENUM_MA_METHOD method_1 = MODE_EMA; // Smoothing method #1
input int ema_period_2 = 9; // EMA Period 2
input ENUM_MA_METHOD method_2 = MODE_EMA; // Smoothing method #2
input int ema_period_3 = 3; // EMA Period 3
input ENUM_MA_METHOD method_3 = MODE_EMA; // Smoothing method #3
...
public:
   ...
   {
      double ma1_0 = iMA(_symbol, _timeframe, ema_period_1, 0, method_1, PRICE_CLOSE, period);
      double ma1_1 = iMA(_symbol, _timeframe, ema_period_1, 0, method_1, PRICE_CLOSE, period + 1);
      double ma2_0 = iMA(_symbol, _timeframe, ema_period_2, 0, method_2, PRICE_CLOSE, period);
      double ma2_1 = iMA(_symbol, _timeframe, ema_period_2, 0, method_2, PRICE_CLOSE, period + 1);

      return ma1_0 > ma2_0 && ma1_1 <= ma2_1;
   }
};
...
public:
   ...
   bool IsPass(const int period)
   {
      double ma2_0 = iMA(_symbol, _timeframe, ema_period_2, 0, method_2, PRICE_CLOSE, period);
      double ma2_1 = iMA(_symbol, _timeframe, ema_period_2, 0, method_2, PRICE_CLOSE, period + 1);
      double ma3_0 = iMA(_symbol, _timeframe, ema_period_3, 0, method_3, PRICE_CLOSE, period);
      double ma3_1 = iMA(_symbol, _timeframe, ema_period_3, 0, method_3, PRICE_CLOSE, period + 1);
      return ma3_0 > ma2_0 && ma3_1 <= ma2_1;
   }
};
