...
// http://fxcodebase.com/code/viewtopic.php?f=38t&t=67145
...
input string symbol_2 = "EURJPY"; // Symbol 2
...
int init()
{
   ...
   double temp = iCustom(NULL, 0, "Cumulative_Volume v1.3", 0, 0);
...
int start()
{
   ...
   {
      int index1 = iBarShift(symbol_1, timeframe, Time[pos]);
      int index2 = iBarShift(symbol_2, timeframe, Time[pos]);
      int index3 = iBarShift(symbol_3, timeframe, Time[pos]);
      ...
      if (Combined)
      {
         double cumulative1 = iCustom(_Symbol, timeframe, "Cumulative_Volume v1.3", Length, Combined, Relative, 0, index1);
         double cumulative2 = iCustom(_Symbol, timeframe, "Cumulative_Volume v1.3", Length, Combined, Relative, 0, index2);
         double cumulative3 = iCustom(_Symbol, timeframe, "Cumulative_Volume v1.3", Length, Combined, Relative, 0, index3);
         double cumulative = cumulative1 + cumulative2 + cumulative3;
         Cumulative.Set(cumulative, pos, cumulative >= 0 ? 0 : 1);
      }
      else
      {
         double pos1 = iCustom(_Symbol, timeframe, "Cumulative_Volume v1.3", Length, Combined, Relative, 0, index1);
         double pos2 = iCustom(_Symbol, timeframe, "Cumulative_Volume v1.3", Length, Combined, Relative, 0, index2);
         double pos3 = iCustom(_Symbol, timeframe, "Cumulative_Volume v1.3", Length, Combined, Relative, 0, index3);
         double posVal = pos1 + pos2 + pos3;
         double neg1 = iCustom(_Symbol, timeframe, "Cumulative_Volume v1.3", Length, Combined, Relative, 1, index1);
         double neg2 = iCustom(_Symbol, timeframe, "Cumulative_Volume v1.3", Length, Combined, Relative, 1, index2);
         double neg3 = iCustom(_Symbol, timeframe, "Cumulative_Volume v1.3", Length, Combined, Relative, 1, index3);
         double negVal = neg1 + neg2 + neg3;
         Positive[pos] = posVal;
         Negative[pos] = negVal;
      }
   }
