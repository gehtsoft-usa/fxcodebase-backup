...
//Available @ https://fxcodebase.com/code/viewtopic.php?f=38&t=73714
...
string file_custom_indicator = "Mango-indicator.ex4";
...
class CustomConditionBUY : public iConditions
{
  public:
   ...
   {
       // TODO: dev condition
       if (iCustom(NULL, 0, file_custom_indicator, 6, 1) != 0)
       {
           return true;
       }
...
class CustomConditionSELL : public iConditions
{
  public:
   ...
   {
       // TODO: dev condition       
       if (iCustom(NULL, 0, file_custom_indicator, 7, 1) != 0) {
           return true;
       }
       return false;
   }
