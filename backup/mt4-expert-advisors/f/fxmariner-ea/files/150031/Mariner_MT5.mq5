...
// https://fxcodebase.com/code/viewtopic.php?f=38&p=150045
...
int                      maMedium_Shift        = 0;                                    // Ma Shift
 ...
 string             Iema3                 = "== Moving Average Slow Setup ==";    // == Moving Average Setup ==
 int                maSlow_Period         = 24;                                   // Period
int                      maSlow_Shift          = 0;                                    // Ma Shift
 ENUM_MA_METHOD     maSlow_Method         = MODE_EMA;                             // Method
 ENUM_APPLIED_PRICE maSlow_AppliedPrice   = PRICE_CLOSE;                          // Applied Price
...
input int    GridUser_maxCount   = 20;                   // Max attempts:
input double GridUser_maxLot     = 10;                   // Max lot value:
input double GridUser_multiplier = 1.15;                 // Multiplier:
input int    GridUser_gap        = 5;                  // Gap betwen orders (pips):
input bool   closeGridOn         = true;                // Use Close Grid?
input double closeGridTP         = 20;                 // Take Profit Grid $
input double closeGridSL         = 0;                // Stop Loss Grid -$
#else
