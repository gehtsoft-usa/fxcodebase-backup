...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=68893
...
input int        Bollinger_Bands_Periods       = 20;
input double     Bollinger_Bands_Deviations    = 2;
...
{
   return new BandCrossOverCondition(symbol, timeframe, Bollinger_Bands_Periods, Bollinger_Bands_Deviations);
}

ICondition* CreateDownCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   return new BandCrossUnderCondition(symbol, timeframe, Bollinger_Bands_Periods, Bollinger_Bands_Deviations);
}
