...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70471
...
input string Fibonacci_id = ""; // ID of the Fibonacci
input double level = 0.618; // Level
...
public:
   ...
   {
      double val1 = ObjectGetDouble(0, Fibonacci_id, OBJPROP_PRICE, 0);
      double val2 = ObjectGetDouble(0, Fibonacci_id, OBJPROP_PRICE, 1);
...
int init()
{
   ...
   IndicatorBuffers(8);
   IndicatorObjPrefix = GenerateIndicatorPrefix("fca");
   IndicatorShortName("Fibonacci Cross Alert");
