...
input int indi_period = 4; // Period
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      ...
      double value0 = iCustom(_symbol, _timeframe, "Fractal_Forex_Trader_indicator", indi_period, 0, period);
      double value1 = iCustom(_symbol, _timeframe, "Fractal_Forex_Trader_indicator", indi_period, 0, period + 1);
      return high0 >= value0 && high1 < value1;
   }
};
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      ...
      double value0 = iCustom(_symbol, _timeframe, "Fractal_Forex_Trader_indicator", indi_period, 1, period);
      double value1 = iCustom(_symbol, _timeframe, "Fractal_Forex_Trader_indicator", indi_period, 1, period + 1);
      return low0 <= value0 && low1 > value1;
   }
};
