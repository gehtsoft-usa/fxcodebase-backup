...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=70705
...
bool alert_on_close = true; // Alert on bar close
...
public:
   ...
   {
      return iLow(_symbol, _timeframe, period + 1) > iOpen(_symbol, _timeframe, period);
   }
};
...
public:
   ...
   virtual bool IsPass(const int period, const datetime date)
   {
      return iHigh(_symbol, _timeframe, period + 1) < iOpen(_symbol, _timeframe, period);
   }
};
