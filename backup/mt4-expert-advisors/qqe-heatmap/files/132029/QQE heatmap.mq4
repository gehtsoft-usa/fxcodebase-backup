...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      ...
      double value4 = iCustom(_symbol, _timeframe, "qqe_new", SF, RSIPeriod, WP, 4, index);
      double value5 = iCustom(_symbol, _timeframe, "qqe_new", SF, RSIPeriod, WP, 5, index);
...
int init()
{
   double temp = iCustom(NULL, 0, "qqe_new", 0, 0);
