...
extern int   Sidney_Session_Start  = 0;
extern int   Sidney_Session_End    = 9;
extern color Sidney_Color          = clrYellow;
extern int   Tokyo_Session_Start   = 2;
extern int   Tokyo_Session_End     = 11;
extern color Tokyo_Color           = clrRed;
extern int   London_Session_Start  = 10;
extern int   London_Session_End    = 19;
extern color London_Color          = clrGreen;
extern int   NewYork_Session_Start = 15;
extern int   NewYork_Session_End   = 0;
extern color NewYork_Color         = clrDodgerBlue;
extern bool  Show_Labels           = true;
extern bool  Show_Session_End_Line = true;
...
void Calculations(int shift, string Sess_Label){
   ...
   if (Session_Duration(Current_Session_Start,Current_Session_End)*3600 > (Time[0] - Line_Start)) Line_End = Time[0];
   
   double rectangle_pos2 = 3;
   if (Digits==3||Digits==5){ pips_position*=10; rectangle_pos2*=10; }
