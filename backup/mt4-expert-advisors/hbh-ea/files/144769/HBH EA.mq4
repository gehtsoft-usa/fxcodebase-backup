...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=71800
...
class CustomConditionSELL : public iConditions
{
  public:
   bool evaluate()
   {
		Print(__FUNCTION__," ","hbh.calculate(4, 1)"," ",hbh.calculate(4, 1));
		Print(__FUNCTION__," ","hbh.calculate(4, 2)"," ",hbh.calculate(4, 2));
