...
//https://fxcodebase.com/code/viewtopic.php?f=38&t=72479
...
class BUYcondition1 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    {
      double indi = iCustom(Symbol(), 0, "Reversal_Fractals.ex4", 0, i);
      if (indi != EMPTY_VALUE) { return true; } 
    }
...
class SELLcondition1 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    for (int i = 0; i < uCandlesBack; i++)
    {
      double indi = iCustom(Symbol(), 0, "Reversal_Fractals.ex4", 1, i);
      Print("indi BUY: ", indi);
      if (indi != EMPTY_VALUE) { return true; } 
    }
    return false;
