...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=74796
...
double lastSignal_Buy, lastSignal_Sell;

// ------------------------------------------------------------------

input string T2                    = "== Set Arrows ==";    // ————————————
input bool   ArrowsOn              = true;                  // Arrows On?
input color  ArrowDnClr            = C'236,45,83';          // Sell Zone Color:
input color  ArrowUpClr            = MediumSeaGreen;        // Buy zone Color:
input color  BuyClr                = MediumSeaGreen;        // Buy Signal Color:
input color  SellClr               = C'236,45,83';          // Sell Signal Color:
...
bool isValley(int i)
{
    ...
    return lo < cl2 && lo < cl1 && lo < cl4 && lo < cl5 && cl2 < cl1 && cl4 < cl5;
    // return lo < cl2 && lo < cl1 && lo < cl4 && lo < cl5;
}
...
bool isPeack(int i)
{
    ...
    return hi > cl2 && hi > cl1 && hi > cl4 && hi > cl5 && cl2 > cl1 && cl4 > cl5;
    // return hi > cl2 && hi > cl1 && hi > cl4 && hi > cl5;
}
