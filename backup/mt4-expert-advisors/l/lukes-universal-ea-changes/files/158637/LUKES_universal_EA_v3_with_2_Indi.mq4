...
input string               _I1_                = "___ Indicator 1 ___";     //
input string               Indi_File           = "SuperArrow";              // Custom Indicator 2 Name
input int                  Buy_Buffer_NO       = 0;                         // Buy Buffer NO
input int                  Sell_Buffer_NO      = 1;                         // Sell Buffer NO
input string               _I2_                = "___ Options ___";         //
...
int GetSign()
  {
   ...
   bool filter_buy = true;
   bool filter_sell = true;
   if (filter_on) {
      double indi_buy = i_custom_filter(buf_filter_buy, 0);
      double indi_sell = i_custom_filter(buf_filter_sell, 0);
   ...
   if(i_val != 0.0  &&  i_val != EMPTY_VALUE)
   {
      ...
      if (trendFilterOn && !trendUp) return(0);
   ...
   if(i_val != 0.0  &&  i_val != EMPTY_VALUE)
   {
      ...
      if (trendFilterOn && !trendDn) return(0);
...
//xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx//
double i_custom(int buf, int bar) { return(iCustom(_Symbol, Tf, Indi_File, buf, bar)); }
