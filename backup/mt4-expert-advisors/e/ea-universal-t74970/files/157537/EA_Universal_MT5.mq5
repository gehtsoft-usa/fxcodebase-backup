...
// https://fxcodebase.com/code/viewtopic.php?f=38&p=157478#p157478
...
input string indicator_file = "MA_Crossover";                          // Indicator File (put your indicator name here):
input int  bufferToBuy              = 2;// Buffer To Buy Signals
input int  bufferToSell             = 3;// Buffer To Sell Signals
input int  candles_back_for_signals = 1;// Allowed Signal Candles back:

bool indicator_init           = true;
//---
int  handle = 0;
void setHandle() { handle = iCustom(Symbol(), 0, indicator_file); }
