//Available @  https://fxcodebase.com/code/viewtopic.php?f=38&p=159338#p159338
...
class BUYcondition1 : public iConditions
{
  public:
    bool evaluate()
    {
        ...
        double wma5  = iMA(NULL, 0, 5, 0, MODE_LWMA, PRICE_CLOSE,  shift);
        double wma8  = iMA(NULL, 0, 8, 0, MODE_LWMA, PRICE_CLOSE,  shift);
        double ema18 = iMA(NULL, 0, 18, 0, MODE_EMA, PRICE_CLOSE, shift);
        double ema28 = iMA(NULL, 0, 28, 0, MODE_EMA, PRICE_CLOSE, shift);
        double wma8_  = iMA(NULL, 0, 8, 0, MODE_LWMA, PRICE_CLOSE,  shift +1);
        double ema18_ = iMA(NULL, 0, 18, 0, MODE_EMA, PRICE_CLOSE, shift +1);
        double ema28_ = iMA(NULL, 0, 28, 0, MODE_EMA, PRICE_CLOSE, shift +1);
