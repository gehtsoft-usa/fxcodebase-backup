...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=69819
...
input int period89 = 89; // Period 89
input ENUM_MA_METHOD method89 = MODE_EMA; // Smoothing method 89
input int period18 = 18; // Period 18
input ENUM_MA_METHOD method18 = MODE_EMA; // Smoothing method 18
...
public:
   ...
   {
      double ma89 = iMA(_symbol, _timeframe, period89, 0, method89, PRICE_CLOSE, period);
      double ma18 = iMA(_symbol, _timeframe, period18, 0, method18, PRICE_CLOSE, period);
      double close = iClose(_symbol, _timeframe, period);
      double close1 = iClose(_symbol, _timeframe, period + 1);
      double open = iOpen(_symbol, _timeframe, period);
      double open1 = iOpen(_symbol, _timeframe, period + 1);
      return ma89 > ma18
         && open > ma89
         && close < ma18
         && open <= close1 && close >= open1;
   }
};
...
int init()
{
   ...
   IndicatorName = GenerateIndicatorName("Engulfing MA Dashboard");
