...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=72850
 ...
 public:
  ...
  bool havePatternUp(int i, ENUM_TIMEFRAMES tf)
  {
    ...
    if (maFast.index(i) > maSlow.index(i))
    {
      ...
      if (op4 > cl4 && cl4 <= maFast.index(i+4) &&
          op3 > cl3 && cl3 <= maFast.index(i+3) &&
          op2 > cl2 && cl2 <= maFast.index(i+2) &&
          op1 < cl1 && cl1 > maFast.index(i+1))
      {
        return true;
      }
      if (op3 > cl3 && cl3 <= maFast.index(i+3) &&
          op2 > cl2 && cl2 <= maFast.index(i+2) &&
          op1 < cl1 && cl1 > maFast.index(i+1))
      {
        return true;
