...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70566
...
public:
   ...
   virtual bool IsPass(const int period, const datetime date)
   {
      ...
      return iLow(_symbol, _timeframe, period) <= maValue && iClose(_symbol, _timeframe, period) > maValue;
   }
};
...
public:
   ...
   {
      double maValue = iMA(_symbol, _timeframe, ma_periods, 0, MODE_EMA, PRICE_CLOSE, period);
      return iHigh(_symbol, _timeframe, period) >= maValue && iClose(_symbol, _timeframe, period) < maValue;
   }
};
...
public:
   ...
   virtual ICell* Create(const string id, const int x, const int y, ENUM_BASE_CORNER corner, const string symbol, const ENUM_TIMEFRAMES timeframe, bool withHistorical)
   {
