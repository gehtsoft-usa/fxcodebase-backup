...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=68810
...
public:
   ...
   {
      double value = iCustom(_symbol, _timeframe, "INDIC_BUYSELL", 0, period);
      return value > 0;
   }
};
...
public:
   ...
   bool IsPass(const int period)
   {
      double value = iCustom(_symbol, _timeframe, "INDIC_BUYSELL", 1, period);
      return value > 0;
   }
};
...
int OnInit()
{
   double temp = iCustom(NULL, 0, "INDIC_BUYSELL", 0, 0);
   if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
   {
      Alert("Please, install the 'INDIC_BUYSELL' indicator");
      return INIT_FAILED;
   }
#ifdef SHOW_ACCOUNT_STAT
   stats = NULL;
