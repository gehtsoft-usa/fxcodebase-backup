...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=74022
...
string file_custom_indicator = "Donchian.ex4";
int bufferToBuy  = 0;
int bufferToSell = 1;
...
int         MaxChannelPeriod     =       30;
double      Margin               =        0;
double      MinChannelWidth      =       10;  
color       UpTrendColor         = clrDodgerBlue;   
color       DnTrendColor         = clrLightCoral;
bool        ShowFilledBoxes      =     false;
bool        ShowChannel          =     false; 
string      AnalysisSets         = "=== Trade Analysis ===";
bool        ShowAnalysis         =     false;
bool        ShowStatsComment     =     false;
bool        ShowArrows           =     false;
bool        ShowProfit           =     false;
bool        ShowExits            =     false;
color       WinColor             = clrLimeGreen;   
color       LossColor            = clrTomato;
string      alerts               = "==== Alerts & Emails: ====";
bool        AlertOn              =    false;       //
...
string      UpTrendSound         = "alert.wav";
string      DnTrendSound         = "alert2.wav";
bool        EmailOn              =    false;       // 
int         EmailsNumber         =        1;       //
