...
public:
   ...
   {
      double fasterEMAafter = iMA(_symbol, _timeframe, ema_period_1, 0, method_1, PRICE_CLOSE, period);
      double fasterEMAnow = iMA(_symbol, _timeframe, ema_period_1, 0, method_1, PRICE_CLOSE, period + 1);
      double fasterEMAprevious = iMA(_symbol, _timeframe, ema_period_1, 0, method_1, PRICE_CLOSE, period + 2);
      double slowerEMAafter = iMA(_symbol, _timeframe, ema_period_2, 0, method_2, PRICE_CLOSE, period);
      double slowerEMAnow = iMA(_symbol, _timeframe, ema_period_2, 0, method_2, PRICE_CLOSE, period + 1);
      double slowerEMAprevious = iMA(_symbol, _timeframe, ema_period_2, 0, method_2, PRICE_CLOSE, period + 2);

      return (fasterEMAnow > slowerEMAnow) && (fasterEMAprevious < slowerEMAprevious) && (fasterEMAafter > slowerEMAafter);
   }
};
