...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=74665
...
string file_custom_indicator = "Enigma_Scalper_Arrows";
int    bufferToBuy           = 2;
int    bufferToSell          = 3;
...
input int uMaxTrades = 10; // Max Trades At Same Time:
#endif
