...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=69551
...
public:
   ...
   {
      return iOpen(_symbol, _timeframe, period + 2) < iClose(_symbol, _timeframe, period + 2)
         && iOpen(_symbol, _timeframe, period + 1) < iClose(_symbol, _timeframe, period + 1)
         && iOpen(_symbol, _timeframe, period + 2) > iLow(_symbol, _timeframe, period);
   }
};
...
public:
   ...
   virtual bool IsPass(const int period, const datetime date)
   {
      return iOpen(_symbol, _timeframe, period + 2) > iClose(_symbol, _timeframe, period + 2)
         && iOpen(_symbol, _timeframe, period + 1) > iClose(_symbol, _timeframe, period + 1)
         && iOpen(_symbol, _timeframe, period + 2) < iHigh(_symbol, _timeframe, period);
   }
};
