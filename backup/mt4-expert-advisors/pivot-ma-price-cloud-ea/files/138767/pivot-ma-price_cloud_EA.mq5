...
input ENUM_STO_PRICE ssd_price = 0; // Price Field
...
public:
   MA1LongCondition(const string symbol, ENUM_TIMEFRAMES timeframe)
      :ACondition(symbol, timeframe)
   {
      _indi = iMA(_symbol, _timeframe, ma1_period, 0, ma1_method, PRICE_CLOSE);
   }
   ...
   {
      double maValue[1];
      if (CopyBuffer(_indi, 0, period, 1, maValue) != 1)
      {
         return false;
      }
      return iClose(_symbol, _timeframe, period) > maValue[0];
   }
};
...
public:
   MA1MA2LongCondition(const string symbol, ENUM_TIMEFRAMES timeframe)
      :ACondition(symbol, timeframe)
   {
      _indi1 = iMA(_symbol, _timeframe, ma1_period, 0, ma1_method, PRICE_CLOSE);
      _indi2 = iMA(_symbol, _timeframe, ma2_period, 0, ma2_method, PRICE_CLOSE);
   }
   ...
   {
      double ma1Value[1];
      if (CopyBuffer(_indi1, 0, period, 1, ma1Value) != 1)
      {
         return false;
      }
      double ma2Value[1];
      if (CopyBuffer(_indi2, 0, period, 1, ma2Value) != 1)
      {
         return false;
      }
      return ma1Value[0] > ma2Value[0];
   }
};
...
public:
   MA2MA3LongCondition(const string symbol, ENUM_TIMEFRAMES timeframe)
      :ACondition(symbol, timeframe)
   {
      _indi3 = iMA(_symbol, _timeframe, ma3_period, 0, ma3_method, PRICE_CLOSE);
      _indi2 = iMA(_symbol, _timeframe, ma2_period, 0, ma2_method, PRICE_CLOSE);
   }

   ~MA2MA3LongCondition()
   {
      IndicatorRelease(_indi3);
      IndicatorRelease(_indi2);
   }
   ...
   {
      double ma3Value[1];
      if (CopyBuffer(_indi3, 0, period, 1, ma3Value) != 1)
      {
         return false;
      }
      double ma2Value[1];
...
public:
   SSDLongCondition(const string symbol, ENUM_TIMEFRAMES timeframe)
      :ACondition(symbol, timeframe)
   {
      _indi = iStochastic(_symbol, _timeframe, ssd_k, ssd_d, ssd_slowing, MODE_SMA, ssd_price);
   }
   ...
   {
      double stochValue[1];
      if (CopyBuffer(_indi, 0, period, 1, stochValue) != 1)
      {
         return false;
      }
      return stochValue[0] < os;
   }
};
