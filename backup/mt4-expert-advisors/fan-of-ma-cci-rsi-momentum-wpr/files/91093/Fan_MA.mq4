...
int init()
{
 IndicatorShortName("Fan of MA indicator");
...
int start()
{
 ...
 while(pos>=0)
 {
  MA2[pos]=iMA(NULL, 0, Length, 0, Method, Price, pos);
  pos--;
 } 
 ...
 while(pos>=0)
 {
  MA3[pos]=iMA(NULL, 0, Length, 0, Method, Price, pos);
  pos--;
 } 
 ...
 while(pos>=0)
 {
  MA4[pos]=iMA(NULL, 0, Length, 0, Method, Price, pos);
  pos--;
 } 
 ...
 while(pos>=0)
 {
  MA5[pos]=iMA(NULL, 0, Length, 0, Method, Price, pos);
  pos--;
 } 
 ...
 while(pos>=0)
 {
  MA6[pos]=iMA(NULL, 0, Length, 0, Method, Price, pos);
  pos--;
 } 
 ...
 while(pos>=0)
 {
  MA7[pos]=iMA(NULL, 0, Length, 0, Method, Price, pos);
  pos--;
 } 
 ...
 while(pos>=0)
 {
  MA8[pos]=iMA(NULL, 0, Length, 0, Method, Price, pos);
  pos--;
 } 
