...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=73427
 ...
 public:
  bool evaluate()
  {
    // TODO: condition Buy 2
		return stoch.main(1) > stoch.signal(1) && stoch.main(2) < stoch.signal(2) && stoch.main(1) <=20 && stoch.signal(1)<=20;
  }
};
...
class SELLcondition2 : public iConditions
{
 public:
  bool evaluate()
  {
    ...
    return stoch.main(1) < stoch.signal(1) && stoch.main(2) > stoch.signal(2) && stoch.main(1)>=80 && stoch.signal(1)>=80;
    // return false;
  }
};
