//Available @  https://fxcodebase.com/code/viewtopic.php?f=38&t=75506
...
input double param2 = (-80); // Overlosd
input double param3 = 80; // overbought
...
void OnInit()
{
   ...
   PlotIndexSetInteger(1, PLOT_LINE_COLOR, Green);
   ...
   sma1 = new SmaOnStream(sma1Source, 14);
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, "MVA Oversold/overbought");
                ...
                const int &spread[])
{
   ...
   {
      ArrayInitialize(plot1, os);
      ArrayInitialize(plot2, ob);
      sma1Source.Init();
      lowest1Source.Init();
      highest1Source.Init();
   ...
   for (int pos = MathMax(rates_total - 1 - bars_limit, MathMax(first, prev_calculated - 1)); pos < rates_total; ++pos)
   {
      ...
      double distance = SafeMinus(close[pos], sma1Value[0]);
      lowest1Source.SetValue(pos, distance);
      ...
      highest1Source.SetValue(pos, distance);
      ...
      double hh = highest1Value[0];
      double ma = SafeMultiply((SafeDivide(distance, (SafeMinus(hh, ll)))), 100);
      plot3[pos] = ma;
      crossunder1X.SetValue(pos, ma);
      crossunder1Y.SetValue(pos, os);
      int crossunder1Value[1];
      if (!crossunder1.GetValues(pos, 1, crossunder1Value)) { crossunder1Value[0] = (-1); }
      int plotshape4_condition = crossunder1Value[0];
      if (plotshape4_condition == true) { plot4[pos] = low[pos]; }
      crossover1X.SetValue(pos, ma);
