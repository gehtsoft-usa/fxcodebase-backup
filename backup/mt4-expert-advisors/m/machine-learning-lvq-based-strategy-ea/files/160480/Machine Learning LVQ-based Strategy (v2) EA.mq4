...
#ifndef MartingaleLotSizingType_IMPL
#define MartingaleLotSizingType_IMPL
...
#endif
#define INDI_NAME "Machine_Learning_Indicator"
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double value = iCustom(_symbol, _timeframe, INDI_NAME, param1, param2, param3, param4, param5_e, 0, period);
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double value = iCustom(_symbol, _timeframe, INDI_NAME, (int)param1, param2, param3, param4, param5_e, 1, period);
      return value != EMPTY_VALUE && value != 0;
   }
};
...
int OnInit()
{
   ...
   #endif
   double temp = iCustom(NULL, 0, INDI_NAME, 0, 0);
   if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
   {
      Alert("Please, install the " + INDI_NAME + ", indicator");
      return INIT_FAILED;
   }
