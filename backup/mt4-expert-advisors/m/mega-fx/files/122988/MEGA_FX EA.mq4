...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double value = iCustom(_symbol, _timeframe, "MEGA_FX", false, false, "", false, 4, period);
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double value = iCustom(_symbol, _timeframe, "MEGA_FX", false, false, "", false, 5, period);
      return value != 0 && value != EMPTY_VALUE;
   }
};
...
int OnInit()
{
   double temp = iCustom(NULL, 0, "MEGA_FX", false, false, "", false, 0, 0);
