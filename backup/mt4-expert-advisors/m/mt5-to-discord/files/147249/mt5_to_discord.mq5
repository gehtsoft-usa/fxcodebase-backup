...
//https://fxcodebase.com/code/viewtopic.php?f=38&t=72665
//+------------------------------------------------------------------------------------------------+
...
int  timmer_value    =     2;
string  order_handle[]    ;
input string  discord_url   = "https://discord.com/api/webhooks/1013079506313031690/ZKAKXNZUDNH4nPddD2sZWYMqiNOtF-A-Etp8L54K0KP3QfslWzqEwDiy7OW5XMi1jWw2"; //  Discord URL
datetime NewCandleTimeCurrent;
input    string   s3    =  "===   Discord Signal Trade ===";
input     bool   open_trade    =     true  ;   //  On Open Trade 
input    bool      close_trade    =   true  ; //  On Close Trade 
input    bool       take_profit_trade     =  true  ; //  On Take Profit
input    bool     stop_loss_trade     =  true  ;    //  On Stop  Loss 
input    bool   volume_trade   =  true     ;   //  On Volume Trade 
