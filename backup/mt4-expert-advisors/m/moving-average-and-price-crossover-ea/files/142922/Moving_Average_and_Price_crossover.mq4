...
input int ma_periods1 = 14; // MA #1 period
input int ma_shift1 = 0; // MA #1 shift
input ENUM_MA_METHOD ma_method1 = MODE_SMA; // MA #1 Smoothing method
input ENUM_APPLIED_PRICE ma_price1 = PRICE_CLOSE; // MA #1 Price type

input int ma_periods2 = 21; // MA #2 period
input int ma_shift2 = 0; // MA #2 shift
input ENUM_MA_METHOD ma_method2 = MODE_SMA; // MA #2 Smoothing method
input ENUM_APPLIED_PRICE ma_price2 = PRICE_CLOSE; // MA #2 Price type
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double maValue = iMA(_symbol, _timeframe, ma_periods1, ma_shift1, ma_method1, ma_price1, period);
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double maValue = iMA(_symbol, _timeframe, ma_periods2, ma_shift2, ma_method2, ma_price2, period);
      return iClose(_symbol, _timeframe, period) > maValue;
   }
};
