...
//https://fxcodebase.com/code/viewtopic.php?f=38&t=71335
...
input ENUM_APPLIED_PRICE ma1_price = PRICE_HIGH; // MA #1 price
input int ma2_period = 14; // MA #2 period
input ENUM_MA_METHOD ma2_method = MODE_SMA; // MA #2 method
input ENUM_APPLIED_PRICE ma2_price = PRICE_LOW; // MA #2 price
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      double maValue = iMA(_symbol, _timeframe, ma1_period, 0, ma1_method, ma1_price, period);
