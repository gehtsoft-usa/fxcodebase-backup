...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=65977
...
#property description "Multi Time Frame Heatmap showing AC position or slope"
...
enum e_method{ ZeroLine=1, Slope=2 };

extern string   Comment0                 = "- Parameters -";
input  e_method Method                   = ZeroLine;
extern string   Comment1       = "<< Currency Pair: Leave Blank for Current >>";
...
int init(){
   ...
   IndName = "MTF_AC_Oscillator_Heatmap";
...
int start(){
   ...
   if (Period() < 43200){
      ...
      for(i=limit ; i>=0; i--){
         ...
         ac0 = iAC(Symbolo,period,current);
         ac1 = iAC(Symbolo,period,current+1);
         w1_up[i] = -1.0;
         w1_dn[i] = -1.0;
         if (Method==1){
            if (ac0 > 0) w1_up[i] = 1.0; else w1_dn[i] = 1.0;
         }else{
            if (ac0 > ac1) w1_up[i] = 1.0; else w1_dn[i] = 1.0;
         }
   ...
   if (Period() < 10080){
      ...
      for(i=limit ; i>=0; i--){
         ...
         d1_dn[i] = -1.0;
         if (Method==1){
            if (ac0 > 0) d1_up[i] = 1.5; else d1_dn[i] = 1.5;
         }else{
            if (ac0 > ac1) d1_up[i] = 1.5; else d1_dn[i] = 1.5;
         }
   ...
   if (Period() < 1440){
      ...
      for(i=limit ; i>=0; i--){
         ...
         h4_dn[i] = -1.0;
         if (Method==1){
            if (ac0 > 0) h4_up[i] = 2.0; else h4_dn[i] = 2.0;
         }else{
            if (ac0 > ac1) h4_up[i] = 2.0; else h4_dn[i] = 2.0;
         }
   ...
   if (Period() < 240){
      ...
      for(i=limit ; i>=0; i--){
         ...
         h1_dn[i] = -1.0;
         if (Method==1){
            if (ac0 > 0) h1_up[i] = 2.5; else h1_dn[i] = 2.5;
         }else{
            if (ac0 > ac1) h1_up[i] = 2.5; else h1_dn[i] = 2.5;
         }
   ...
   if (Period() < 60){
      ...
      for(i=limit ; i>=0; i--){
         ...
         m30_dn[i] = -1.0;
         if (Method==1){
            if (ac0 > 0) m30_up[i] = 3.0; else m30_dn[i] = 3.0;
         }else{
            if (ac0 > ac1) m30_up[i] = 3.0; else m30_dn[i] = 3.0;
         }
   ...
   if (Period() < 30){
      ...
      for(i=limit ; i>=0; i--){
         ...
         m15_dn[i] = -1.0;
         if (Method==1){
            if (ac0 > 0) m15_up[i] = 3.5; else m15_dn[i] = 3.5;
         }else{
            if (ac0 > ac1) m15_up[i] = 3.5; else m15_dn[i] = 3.5;
         }
   ...
   if (Period() < 15){
      ...
      for(i=limit ; i>=0; i--){
         ...
         m5_dn[i] = -1.0;
         if (Method==1){
            if (ac0 > 0) m5_up[i] = 4.0; else m5_dn[i] = 4.0;
         }else{
            if (ac0 > ac1) m5_up[i] = 4.0; else m5_dn[i] = 4.0;
         }
