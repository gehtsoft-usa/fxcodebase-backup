...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=70806
...
public:
   CCILongCondition(const string symbol, ENUM_TIMEFRAMES timeframe, int period, ENUM_APPLIED_PRICE price, double level)
      :ACondition(symbol, timeframe)
   {
      _period = period;
      _price = price;
   ...
   bool IsPass(const int period, const datetime date)
   {
      double cciValue = iCCI(_symbol, _timeframe, _period, _price, period);
      return cciValue < _level;
   }
};
class MACD1LongCondition : public ACondition
{
   int _fast;
   int _slow;
   int _signal;
   ENUM_APPLIED_PRICE _price;
public:
   MACD1LongCondition(const string symbol, ENUM_TIMEFRAMES timeframe, int fast, int slow, int signal, ENUM_APPLIED_PRICE price)
      :ACondition(symbol, timeframe)
   {
      _fast = fast;
      _slow = slow;
   ...
   bool IsPass(const int period, const datetime date)
   {
      double macdValue = iMACD(_symbol, _timeframe, _fast, _slow, _signal, _price, MODE_MAIN, period);
      double signalValue = iMACD(_symbol, _timeframe, _fast, _slow, _signal, _price, MODE_SIGNAL, period);
      return macdValue < signalValue;
   }
};
class MACD2LongCondition : public ACondition
{
   int _fast;
   int _slow;
   int _signal;
   ...
   double _level;
public:
   MACD2LongCondition(const string symbol, ENUM_TIMEFRAMES timeframe, int fast, int slow, int signal, ENUM_APPLIED_PRICE price, double level)
      :ACondition(symbol, timeframe)
   {
      _fast = fast;
      _slow = slow;
...
class CCIShortCondition : public ACondition
{
   ...
   ENUM_APPLIED_PRICE _price;
public:
   CCIShortCondition(const string symbol, ENUM_TIMEFRAMES timeframe, int period, ENUM_APPLIED_PRICE price, double level)
      :ACondition(symbol, timeframe)
   {
      _period = period;
      _price = price;
...
class MACD1ShortCondition : public ACondition
{
   int _fast;
   int _slow;
   int _signal;
   ENUM_APPLIED_PRICE _price;
public:
   MACD1ShortCondition(const string symbol, ENUM_TIMEFRAMES timeframe, int fast, int slow, int signal, ENUM_APPLIED_PRICE price)
      :ACondition(symbol, timeframe)
   {
      _fast = fast;
      _slow = slow;
...
class MACD2ShortCondition : public ACondition
{
   int _fast;
   int _slow;
   int _signal;
   ...
   double _level;
public:
   MACD2ShortCondition(const string symbol, ENUM_TIMEFRAMES timeframe, int fast, int slow, int signal, ENUM_APPLIED_PRICE price, double level)
      :ACondition(symbol, timeframe)
   {
      _fast = fast;
      _slow = slow;
...
ICondition* CreateLongCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   condition.Add(new MACD1LongCondition(symbol, timeframe, MacdFastEMA1, MacdSlowEMA1, MacdSignalSMA1, MacdPrice1), false);
...
ICondition* CreateLongFilterCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(new MACD2LongCondition(symbol, Macd1Tf, MacdFastEMA1, MacdSlowEMA1, MacdSignalSMA1, MacdPrice1, MacdSellLevel1), false);
   condition.Add(new MACD2LongCondition(symbol, Macd2Tf, MacdFastEMA2, MacdSlowEMA2, MacdSignalSMA2, MacdPrice2, MacdSellLevel2), false);
   condition.Add(new MACD2LongCondition(symbol, Macd3Tf, MacdFastEMA3, MacdSlowEMA3, MacdSignalSMA3, MacdPrice3, MacdSellLevel3), false);
   condition.Add(new MACD2LongCondition(symbol, Macd4Tf, MacdFastEMA4, MacdSlowEMA4, MacdSignalSMA4, MacdPrice4, MacdSellLevel4), false);
   condition.Add(new CCILongCondition(symbol, Cci1Tf, CciPeriod1, CciPrice1, CciSellLevel1), false);
   condition.Add(new CCILongCondition(symbol, Cci2Tf, CciPeriod2, CciPrice2, CciSellLevel2), false);
   condition.Add(new CCILongCondition(symbol, Cci3Tf, CciPeriod3, CciPrice3, CciSellLevel3), false);
   condition.Add(new CCILongCondition(symbol, Cci4Tf, CciPeriod4, CciPrice4, CciSellLevel4), false);
   return condition;
}
...
ICondition* CreateShortCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(new MACD1ShortCondition(symbol, timeframe, MacdFastEMA1, MacdSlowEMA1, MacdSignalSMA1, MacdPrice1), false);
   #ifdef ACT_ON_SWITCH_CONDITION
      ActOnSwitchCondition* switchCondition = new ActOnSwitchCondition(symbol, timeframe, (ICondition*) condition);
      condition.Release();
      return switchCondition;
...
ICondition* CreateShortFilterCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   AndCondition* condition = new AndCondition();
   condition.Add(new MACD2ShortCondition(symbol, Macd1Tf, MacdFastEMA1, MacdSlowEMA1, MacdSignalSMA1, MacdPrice1, MacdBuyLevel1), false);
   condition.Add(new MACD2ShortCondition(symbol, Macd2Tf, MacdFastEMA2, MacdSlowEMA2, MacdSignalSMA2, MacdPrice2, MacdBuyLevel2), false);
   condition.Add(new MACD2ShortCondition(symbol, Macd3Tf, MacdFastEMA3, MacdSlowEMA3, MacdSignalSMA3, MacdPrice3, MacdBuyLevel3), false);
   condition.Add(new MACD2ShortCondition(symbol, Macd4Tf, MacdFastEMA4, MacdSlowEMA4, MacdSignalSMA4, MacdPrice4, MacdBuyLevel4), false);
   condition.Add(new CCIShortCondition(symbol, Cci1Tf, CciPeriod1, CciPrice1, CciBuyLevel1), false);
   condition.Add(new CCIShortCondition(symbol, Cci2Tf, CciPeriod2, CciPrice2, CciBuyLevel2), false);
   condition.Add(new CCIShortCondition(symbol, Cci3Tf, CciPeriod3, CciPrice3, CciBuyLevel3), false);
   condition.Add(new CCIShortCondition(symbol, Cci4Tf, CciPeriod4, CciPrice4, CciBuyLevel4), false);
   return condition;
}
