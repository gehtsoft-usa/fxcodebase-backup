...
//https://fxcodebase.com/code/viewtopic.php?f=38&t=71316
...
input bool mavilimold = false; // Show Previous Version of MavilimW?
input int fmal = 3; // First Moving Average length
input int smal = 5; // Second Moving Average length
...
int init()
{
   ...
   IndicatorShortName("MavilimW");
   IndicatorBuffers(3);
   SetIndexBuffer(0, plot1);
   SetIndexBuffer(1, plot2);
   SetIndexBuffer(2, MAVW);
   double tmal = fmal + smal;
   double Fmal = smal + tmal;
   double Ftmal = tmal + Fmal;
   double Smal = Fmal + Ftmal;
   wma1Source = new SimplePriceStream(_Symbol, (ENUM_TIMEFRAMES)_Period, PriceClose);
   wma1 = new WMAOnStream(wma1Source, fmal);
   wma2 = new WMAOnStream(wma1, smal);
   wma3 = new WMAOnStream(wma2, tmal);
   wma4 = new WMAOnStream(wma3, Fmal);
   wma5 = new WMAOnStream(wma4, Ftmal);
   wma6 = new WMAOnStream(wma5, Smal);
   wma7Source = new SimplePriceStream(_Symbol, (ENUM_TIMEFRAMES)_Period, PriceClose);
   wma7 = new WMAOnStream(wma7Source, 3);
   wma8 = new WMAOnStream(wma7, 5);
   wma9 = new WMAOnStream(wma8, 8);
   wma10 = new WMAOnStream(wma9, 13);
   wma11 = new WMAOnStream(wma10, 21);
   wma12 = new WMAOnStream(wma11, 34);
                ...
                const int &spread[])
{
   ...
   for (int pos = MathMin(bars_limit, rates_total - 1 - MathMax(prev_calculated - 1, toSkip)); pos >= 0 && !IsStopped(); --pos)
   {
      ...
      MAVW[pos] = wma6Value;
      bool col1 = (MAVW[pos] > MAVW[pos + 1]);
      bool col3 = (MAVW[pos] < MAVW[pos + 1]);
      plot1[pos] = MAVW[pos];
      double wma12Value;
      if (!wma12.GetValue(pos, wma12Value))
      {
         continue;
      }
      double MAVW2 = wma12Value;
      plot2[pos] = ((mavilimold && MAVW2) ? MAVW2 : EMPTY_VALUE);
   }
