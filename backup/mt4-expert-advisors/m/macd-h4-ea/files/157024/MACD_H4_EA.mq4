...
// https://fxcodebase.com/code/viewtopic.php?f=38&t=75289
...
class ConditionMACDBuy : public iConditions
{
  public:
    bool evaluate()
    {
        ...
        return macd1 > macd2 && macd2 < macd3 && macd3 < macd4 && macd4 < macd5;
    }
};
...
{
    LongStrategy.set(&cdMACDBuy, &buy);
    ShortStrategy.set(&cdMACDSell, &sell);
