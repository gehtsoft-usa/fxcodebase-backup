...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=68728
...
input int ma_period_1 = 10; // MA #1 period
input AveragesMethod ma_method_1 = SMA; // MA #1 method
input int ma_period_2 = 30; // MA #2 period
input AveragesMethod ma_method_2 = SMA; // MA #2 method
...
input double lots_value_1 = 0.1; // Position size #1
input PositionSizeType lots_type_1 = PositionSizeContract; // Position size type #1
input double lots_value_2 = 0.1; // Position size #2
input PositionSizeType lots_type_2 = PositionSizeContract; // Position size type #2
input double lots_value_3 = 0.1; // Position size #3
input PositionSizeType lots_type_3 = PositionSizeContract; // Position size type #3
input double lots_value_4 = 0.1; // Position size #4
input PositionSizeType lots_type_4 = PositionSizeContract; // Position size type #4
input double lots_value_5 = 0.1; // Position size #5
input PositionSizeType lots_type_5 = PositionSizeContract; // Position size type #5
input double lots_value_6 = 0.1; // Position size #6
input PositionSizeType lots_type_6 = PositionSizeContract; // Position size type #6
input double lots_value_7 = 0.1; // Position size #7
input PositionSizeType lots_type_7 = PositionSizeContract; // Position size type #7
input double lots_value_8 = 0.1; // Position size #8
input PositionSizeType lots_type_8 = PositionSizeContract; // Position size type #8
input double lots_value_9 = 0.1; // Position size #9
input PositionSizeType lots_type_9 = PositionSizeContract; // Position size type #9
input double lots_value_10 = 0.1; // Position size #19
input PositionSizeType lots_type_10 = PositionSizeContract; // Position size type #10
...
public:
   ...
   {
      double value1_0 = iCustom(_symbol, _timeframe, "averages", ma_period_1, ma_method_1, 0, period);
      double value1_1 = iCustom(_symbol, _timeframe, "averages", ma_period_1, ma_method_1, 0, period + 1);
      double value2_0 = iCustom(_symbol, _timeframe, "averages", ma_period_2, ma_method_2, 0, period);
      double value2_1 = iCustom(_symbol, _timeframe, "averages", ma_period_2, ma_method_2, 0, period + 1);
      return value1_0 > value2_0 && value1_1 <= value2_1;
   }
};
...
protected:
   void GetData(double& lots, PositionSizeType& lotsType)
   {
      OrdersIterator trades;
      int count = trades.WhenTrade().WhenSide(BuySide).WhenMagicNumber(magic_number).Count();
      switch (count)
      {
         case 0:
            lotsType = lots_type_1;
            lots = lots_value_1;
            break;
         case 1:
            lotsType = lots_type_2;
            lots = lots_value_2;
            break;
         case 2:
            lotsType = lots_type_3;
            lots = lots_value_3;
            break;
         case 3:
            lotsType = lots_type_4;
            lots = lots_value_4;
            break;
         case 4:
            lotsType = lots_type_5;
            lots = lots_value_5;
            break;
         case 5:
            lotsType = lots_type_6;
            lots = lots_value_6;
            break;
         case 6:
            lotsType = lots_type_7;
            lots = lots_value_7;
            break;
         case 7:
            lotsType = lots_type_8;
            lots = lots_value_8;
            break;
         case 8:
            lotsType = lots_type_9;
            lots = lots_value_9;
            break;
         default:
            lotsType = lots_type_10;
            lots = lots_value_10;
            break;
      }
   }
...
public:
   ...
   {
      double lots;
      PositionSizeType lotsType;
      GetData(lots, lotsType);

      if (lotsType == PositionSizeRisk)
      {
         stopLoss = _calculator.CalculateStopLoss(true, _stopLoss, _stopLossType, 0.0, entryPrice);
         amount = _calculator.GetLots(lotsType, lots, entryPrice - stopLoss, _leverageOverride);
      }
      else
      {
         amount = _calculator.GetLots(lotsType, lots, 0.0, _leverageOverride);
...
public:
   ...
   void Get(const int period, const double entryPrice, double &amount, double &stopLoss, double &takeProfit)
   {
      ...
      if (lotsType == PositionSizeRisk)
      {
         ...
         amount = _calculator.GetLots(lotsType, lots, stopLoss - entryPrice, _leverageOverride);
      }
      else
      {
         amount = _calculator.GetLots(lotsType, lots, 0.0, _leverageOverride);
...
TradingController *CreateController(const string symbol, const ENUM_TIMEFRAMES timeframe, string &error)
{
   ...
   if (!tradingCalculator.IsLotsValid(lots_value_1, lots_type_1, error)
      || !tradingCalculator.IsLotsValid(lots_value_2, lots_type_2, error)
      || !tradingCalculator.IsLotsValid(lots_value_3, lots_type_3, error)
      || !tradingCalculator.IsLotsValid(lots_value_4, lots_type_4, error)
      || !tradingCalculator.IsLotsValid(lots_value_5, lots_type_5, error)
      || !tradingCalculator.IsLotsValid(lots_value_6, lots_type_6, error)
      || !tradingCalculator.IsLotsValid(lots_value_7, lots_type_7, error)
      || !tradingCalculator.IsLotsValid(lots_value_8, lots_type_8, error)
      || !tradingCalculator.IsLotsValid(lots_value_9, lots_type_9, error)
      || !tradingCalculator.IsLotsValid(lots_value_10, lots_type_10, error))
   {
   ...
   IMoneyManagementStrategy *longMoneyManagement = new LongMoneyManagementStrategy(tradingCalculator, (PositionSizeType)0, 0, stop_loss_type, stop_loss_value, take_profit_type, take_profit_value, 0);
   IMoneyManagementStrategy *shortMoneyManagement = new ShortMoneyManagementStrategy(tradingCalculator, (PositionSizeType)0, 0, stop_loss_type, stop_loss_value, take_profit_type, take_profit_value, 0);
