...
void OnTick()
{
 ...
 MA_H0=iMA(NULL, 0, MA_Length, 0, MA_Method, PRICE_HIGH, 1);
 MA_H1=iMA(NULL, 0, MA_Length, 0, MA_Method, PRICE_HIGH, 2);
 MA_L0=iMA(NULL, 0, MA_Length, 0, MA_Method, PRICE_LOW, 1);
 MA_L1=iMA(NULL, 0, MA_Length, 0, MA_Method, PRICE_LOW, 2);
