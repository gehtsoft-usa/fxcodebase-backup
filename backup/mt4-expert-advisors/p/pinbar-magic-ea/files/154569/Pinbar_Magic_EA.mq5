...
void setHandle()
{
  handle = iCustom(Symbol(), NULL, file_custom_indicator,
    Iema1, maFast_Period, maFast_Method, maFast_AppliedPrice, Iema2, maMedium_Period, maMedium_Method, maMedium_AppliedPrice, Iema3, maSlow_Period, maSlow_Method, maSlow_AppliedPrice);
}
