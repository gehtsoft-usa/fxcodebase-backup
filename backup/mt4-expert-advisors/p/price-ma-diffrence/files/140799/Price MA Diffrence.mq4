...
int init()
{
   IndicatorObjPrefix = GenerateIndicatorPrefix("pricemadiff");
   IndicatorShortName("Price MA Difference");

   IndicatorBuffers(1);

   SetIndexStyle(0, DRAW_LINE);
   SetIndexBuffer(0, out);
   SetIndexLabel(0, "Price-MA");
                ...
                const int &spread[])
{
   ...
   {
      out[pos] = close[pos] - iMA(_Symbol, _Period, period, 0, method, PRICE_CLOSE, pos);
   }
