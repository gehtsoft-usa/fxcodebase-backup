...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=69129
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      ...
      if (!pivot.Get(period, p, s1, s2, s3, r1, r2, r3))
         return false;
      
      if (close0 >= p && close1 < p)
         return true;
      if (close0 >= s1 && close1 < s1)
         return true;
      if (close0 >= s2 && close1 < s2)
         return true;
      if (close0 >= s3 && close1 < s3)
         return true;
      if (close0 >= r1 && close1 < r1)
         return true;
      if (close0 >= r2 && close1 < r2)
         return true;
      if (close0 >= r3 && close1 < r3)
         return true;
      return false;
   }
};
...
int init()
{
   ...
   IndicatorName = GenerateIndicatorName("Pivot Signal");
   ...
   pivot = new Pivot(_Symbol, PERIOD_D1, (ENUM_TIMEFRAMES)_Period);
