...
//https://fxcodebase.com/code/viewtopic.php?f=38&t=71344
...
//based on mrak297 https://www.mql5.com/ru/users/mrak297
#property strict
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      return PinUp(date, iOpen(_symbol, _timeframe, period), iHigh(_symbol, _timeframe, period), iLow(_symbol, _timeframe, period), iClose(_symbol, _timeframe, period), Depth);
   }
};
...
public:
   ...
   bool IsPass(const int period, const datetime date)
   {
      return PinDown(date, iOpen(_symbol, _timeframe, period), iHigh(_symbol, _timeframe, period), iLow(_symbol, _timeframe, period), iClose(_symbol, _timeframe, period), Depth);
   }
};
...
int OnInit()
{
   ...
   IndicatorBuffers(8);
   IndicatorObjPrefix = GenerateIndicatorPrefix("pin");
   IndicatorShortName("Pin");
