...
//https://fxcodebase.com/code/viewtopic.php?f=38&t=72989
...
// ------------------------------------------------------------------
input string T0                    = "== SAR setup ==";      // ————————————
input double uStep                 = 0.02;                   // Step:
input double uMax                  = 0.2;                    // Maximum:
...
{
  return SAR(i) < iClose(NULL, 0, i) && SAR(i + 1) > iClose(NULL, 0, i + 1);
}
...
{
	return iSAR(NULL, 0, uStep, uMax, index);
}
