...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=64189
...
public:
   ...
   { 
      ...
      if (GetDirection(1) == direction)
         direction = 0;
      SendNotifications(direction); ObjectMakeLabel(_id, _x, _y, GetDirectionSymbol(direction), GetDirectionColor(direction), 1, WindowNumber, "Arial", 10); 
   }
