...
int OnInit()
{
     double temp = iCustom(NULL, 0, "MACD_Flat_Trend", 0, 0);
   if (GetLastError() == ERR_INDICATOR_CANNOT_LOAD)
   {
       Alert("Please, install the 'MACD_Flat_Trend' indicator");
       return INIT_FAILED;
   }
   LastBar=0;
...
void OnTick()
{
 ...
 double FT0U, FT0D, FT1U, FT1D;
 
 FT0U=iCustom(NULL, 0, "MACD_Flat_Trend", MACD_Fast, MACD_Slow, MACD_Signal, Price, 0, 1);
 FT0D=iCustom(NULL, 0, "MACD_Flat_Trend", MACD_Fast, MACD_Slow, MACD_Signal, Price, 1, 1);
 FT1U=iCustom(NULL, 0, "MACD_Flat_Trend", MACD_Fast, MACD_Slow, MACD_Signal, Price, 0, 2);
 FT1D=iCustom(NULL, 0, "MACD_Flat_Trend", MACD_Fast, MACD_Slow, MACD_Signal, Price, 1, 2);
