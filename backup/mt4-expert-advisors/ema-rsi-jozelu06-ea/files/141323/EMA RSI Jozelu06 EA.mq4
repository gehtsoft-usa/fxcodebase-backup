...
//http://fxcodebase.com/code/viewtopic.php?f=38&t=71042
...
input int ma_periods = 14; // EMA Period
...
ICondition* CreateLongCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   condition.Add(new MAPriceCondition(symbol, timeframe, FirstBelowSecond, MODE_EMA, ma_periods, PRICE_CLOSE), false);
...
ICondition* CreateShortCondition(string symbol, ENUM_TIMEFRAMES timeframe)
{
   ...
   condition.Add(new MAPriceCondition(symbol, timeframe, FirstAboveSecond, MODE_EMA, ma_periods, PRICE_CLOSE), false);
   #ifdef ACT_ON_SWITCH_CONDITION
      ActOnSwitchCondition* switchCondition = new ActOnSwitchCondition(symbol, timeframe, (ICondition*) condition);
      condition.Release();
      return switchCondition;
