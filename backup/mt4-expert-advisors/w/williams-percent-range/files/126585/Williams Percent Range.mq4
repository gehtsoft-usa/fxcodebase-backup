...
// http://fxcodebase.com/code/viewtopic.php?f=38&t=68517
...
input int wpr_period = 10; // WPR Period
...
public:
   ...
   {
      double wprValue = iWPR(_symbol, _timeframe, wpr_period, period);
      return wprValue > overbought_level;
   }
};
...
public:
   ...
   {
      double wprValue = iWPR(_symbol, _timeframe, wpr_period, period);
      return wprValue < oversold_level;
   }
};
