...
double Blau_CMI[], Signal[];
double CM[], EMA1[], EMA2[];
double Abs_CM[], Abs_EMA1[], Abs_EMA2[];

int init()
{
 IndicatorShortName("William Blau Ergodic Candlestick Momentum Index");
...
int start()
{
 ...
 while(pos>=0)
 {
  Signal[pos]=iMAOnArray(Blau_CMI, 0, Signal_Length, 0, MODE_EMA, pos);
  pos--;
 }  
